package io.github.dungeonmakers.armouranditem.data.util;
...
/**
 * Taken from https://github.com/SilentChaos512/SilentLib/blob/1.18.x/src/main/java/net/silentchaos512/lib/util/NameUtils.java
 */
