...
public class Commands {
   ...
   public Commands(boolean p_i49161_1_) {
      ...
      SeedCommand.func_198671_a(this.dispatcher);
      ...
      try {
         try {
            ...
            if (commandsyntaxexception.getInput() != null && commandsyntaxexception.getCursor() >= 0) {
               ...
               p_197059_1_.sendFailure(itextcomponent1);
            }
            ...
            p_197059_1_.sendFailure((new TranslationTextComponent("command.failed")).func_211710_a((p_211704_1_) -> {
