   ...
   public static class Message {
      ...
      public ITextComponent toComponent(CommandSource p_201312_1_, boolean p_201312_2_) throws CommandSyntaxException {
         if (this.parts.length != 0 && p_201312_2_) {
            ITextComponent itextcomponent = new StringTextComponent(this.text.substring(0, this.parts[0].getStart()));
            int i = this.parts[0].getStart();

            for(MessageArgument.Part messageargument$part : this.parts) {
               ITextComponent itextcomponent1 = messageargument$part.toComponent(p_201312_1_);
               if (i < messageargument$part.getStart()) {
                  itextcomponent.func_150258_a(this.text.substring(i, messageargument$part.getStart()));
               }
            ...
            if (i < this.text.length()) {
               itextcomponent.func_150258_a(this.text.substring(i, this.text.length()));
            }
