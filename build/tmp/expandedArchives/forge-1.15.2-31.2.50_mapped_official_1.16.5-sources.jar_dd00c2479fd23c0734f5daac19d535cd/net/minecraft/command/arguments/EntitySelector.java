...
public class EntitySelector {
   ...
   public List<? extends Entity> findEntities(CommandSource p_197341_1_) throws CommandSyntaxException {
      ...
      if (!this.includesEntities) {
         ...
         Vec3d vec3d = this.position.apply(p_197341_1_.getPosition());
         ...
         if (this.currentEntity) {
            ...
            if (this.isWorldLimited()) {
               this.addEntities(list, p_197341_1_.getLevel(), vec3d, predicate);
            } else {
               for(ServerWorld serverworld : p_197341_1_.getServer().getAllLevels()) {
                  this.addEntities(list, serverworld, vec3d, predicate);
               }
            }
   ...
   private void addEntities(List<Entity> p_197348_1_, ServerWorld p_197348_2_, Vec3d p_197348_3_, Predicate<Entity> p_197348_4_) {
      if (this.aabb != null) {
   ...
   public List<ServerPlayerEntity> findPlayers(CommandSource p_197342_1_) throws CommandSyntaxException {
      ...
      if (this.playerName != null) {
         ...
         Vec3d vec3d = this.position.apply(p_197342_1_.getPosition());
         Predicate<Entity> predicate = this.getPredicate(vec3d);
         if (this.currentEntity) {
   ...
   private Predicate<Entity> getPredicate(Vec3d p_197349_1_) {
   ...
   public static ITextComponent joinNames(List<? extends Entity> p_197350_0_) {
      return TextComponentUtils.func_197677_b(p_197350_0_, Entity::getDisplayName);
   }
}