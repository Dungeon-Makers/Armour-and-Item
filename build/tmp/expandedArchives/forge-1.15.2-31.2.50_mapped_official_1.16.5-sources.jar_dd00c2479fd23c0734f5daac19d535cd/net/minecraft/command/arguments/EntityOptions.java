         ...
         register("name", (p_197440_0_) -> {
            ...
            if (p_197440_0_.hasNameNotEquals() && !flag) {
               ...
               p_197440_0_.addPredicate((p_197446_2_) -> {
                  return p_197446_2_.getName().getContents().equals(s) != flag;
               });
            }
         }, (p_202016_0_) -> {
         ...
         register("type", (p_197447_0_) -> {
            ...
            if (p_197447_0_.isTypeLimitedInversely() && !flag) {
               ...
               if (p_197447_0_.isTag()) {
                  ...
                  if (tag == null) {
                     p_197447_0_.getReader().setCursor(i);
                     throw ERROR_ENTITY_TYPE_INVALID.createWithContext(p_197447_0_.getReader(), resourcelocation.toString());
                  }

                  p_197447_0_.addPredicate((p_218127_2_) -> {
                     return tag.func_199685_a_(p_218127_2_.getType()) != flag;
                  });
               } else {
                  ResourceLocation resourcelocation1 = ResourceLocation.read(p_197447_0_.getReader());
                  EntityType<?> entitytype = Registry.ENTITY_TYPE.func_218349_b(resourcelocation1).orElseThrow(() -> {
                     p_197447_0_.getReader().setCursor(i);
            ...
            p_229367_0_.addPredicate((p_229366_2_) -> {
               if (!(p_229366_2_.level instanceof ServerWorld)) {
                  ...
                  if (ilootcondition == null) {
                     ...
                     LootContext lootcontext = (new LootContext.Builder(serverworld)).withParameter(LootParameters.THIS_ENTITY, p_229366_2_).withParameter(LootParameters.field_216286_f, new BlockPos(p_229366_2_)).create(LootParameterSets.SELECTOR);
