...
public class EntitySelectorParser {
   ...
   public static final BiConsumer<Vec3d, List<? extends Entity>> ORDER_ARBITRARY = (p_197402_0_, p_197402_1_) -> {
   };
   public static final BiConsumer<Vec3d, List<? extends Entity>> ORDER_NEAREST = (p_197392_0_, p_197392_1_) -> {
   ...
   public static final BiConsumer<Vec3d, List<? extends Entity>> ORDER_FURTHEST = (p_197383_0_, p_197383_1_) -> {
   ...
   public static final BiConsumer<Vec3d, List<? extends Entity>> ORDER_RANDOM = (p_197368_0_, p_197368_1_) -> {
   ...
   public void setOrder(BiConsumer<Vec3d, List<? extends Entity>> p_197376_1_) {
