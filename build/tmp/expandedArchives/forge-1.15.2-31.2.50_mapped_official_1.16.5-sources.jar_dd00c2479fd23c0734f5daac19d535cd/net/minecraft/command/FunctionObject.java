...
public class FunctionObject {
   ...
   public static FunctionObject func_197000_a(ResourceLocation p_197000_0_, FunctionManager p_197000_1_, List<String> p_197000_2_) {
      ...
      for(int i = 0; i < p_197000_2_.size(); ++i) {
         ...
         if (stringreader.canRead() && stringreader.peek() != '#') {
            ...
            try {
               ParseResults<CommandSource> parseresults = p_197000_1_.getServer().getCommands().getDispatcher().parse(stringreader, p_197000_1_.func_223402_g());
