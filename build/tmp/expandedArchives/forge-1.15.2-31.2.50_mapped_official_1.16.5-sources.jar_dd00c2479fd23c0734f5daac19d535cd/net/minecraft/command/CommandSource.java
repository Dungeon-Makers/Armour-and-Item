...
public class CommandSource implements ISuggestionProvider {
   ...
   public CommandSource withPosition(Vec3d p_201009_1_) {
   ...
   public CommandSource withLevel(ServerWorld p_201003_1_) {
      return p_201003_1_ == this.level ? this : new CommandSource(this.source, this.worldPosition, this.rotation, p_201003_1_, this.permissionLevel, this.textName, this.displayName, this.server, this.entity, this.silent, this.consumer, this.anchor);
   }
   ...
   public CommandSource facing(Vec3d p_201005_1_) throws CommandSyntaxException {
      Vec3d vec3d = this.anchor.apply(this);
   ...
   private void broadcastToAdmins(ITextComponent p_197020_1_) {
      ITextComponent itextcomponent = (new TranslationTextComponent("chat.type.admin", this.getDisplayName(), p_197020_1_)).func_211709_a(new TextFormatting[]{TextFormatting.GRAY, TextFormatting.ITALIC});
   ...
   public void sendFailure(ITextComponent p_197021_1_) {
      if (this.source.acceptsFailure() && !this.silent) {
         this.source.sendMessage((new StringTextComponent("")).func_150257_a(p_197021_1_).func_211708_a(TextFormatting.RED));
      }
