...
public class BanListCommand {
   public static void register(CommandDispatcher<CommandSource> p_198229_0_) {
      p_198229_0_.register(Commands.literal("banlist").requires((p_198233_0_) -> {
         return (p_198233_0_.getServer().getPlayerList().getBans().func_152689_b() || p_198233_0_.getServer().getPlayerList().getIpBans().func_152689_b()) && p_198233_0_.hasPermission(3);
