...
public class ParticleCommand {
   ...
   public static void register(CommandDispatcher<CommandSource> p_198563_0_) {
      p_198563_0_.register(Commands.literal("particle").requires((p_198568_0_) -> {
         ...
         return sendParticles(p_198562_0_.getSource(), ParticleArgument.getParticle(p_198562_0_, "name"), p_198562_0_.getSource().getPosition(), Vec3d.ZERO, 0.0F, 0, false, p_198562_0_.getSource().getServer().getPlayerList().getPlayers());
      }).then(Commands.argument("pos", Vec3Argument.vec3()).executes((p_201226_0_) -> {
         return sendParticles(p_201226_0_.getSource(), ParticleArgument.getParticle(p_201226_0_, "name"), Vec3Argument.getVec3(p_201226_0_, "pos"), Vec3d.ZERO, 0.0F, 0, false, p_201226_0_.getSource().getServer().getPlayerList().getPlayers());
   ...
   private static int sendParticles(CommandSource p_198564_0_, IParticleData p_198564_1_, Vec3d p_198564_2_, Vec3d p_198564_3_, float p_198564_4_, int p_198564_5_, boolean p_198564_6_, Collection<ServerPlayerEntity> p_198564_7_) throws CommandSyntaxException {
      int i = 0;
