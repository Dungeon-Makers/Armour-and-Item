...
public class BossBarCommand {
   ...
   private static int getPlayers(CommandSource p_201425_0_, CustomServerBossInfo p_201425_1_) {
      if (p_201425_1_.getPlayers().isEmpty()) {
         ...
         p_201425_0_.sendSuccess(new TranslationTextComponent("commands.bossbar.get.players.some", p_201425_1_.getDisplayName(), p_201425_1_.getPlayers().size(), TextComponentUtils.func_197677_b(p_201425_1_.getPlayers(), PlayerEntity::getDisplayName)), true);
      }
   ...
   private static int setName(CommandSource p_201420_0_, CustomServerBossInfo p_201420_1_, ITextComponent p_201420_2_) throws CommandSyntaxException {
      ITextComponent itextcomponent = TextComponentUtils.func_197680_a(p_201420_0_, p_201420_2_, (Entity)null, 0);
   ...
   private static int setPlayers(CommandSource p_201405_0_, CustomServerBossInfo p_201405_1_, Collection<ServerPlayerEntity> p_201405_2_) throws CommandSyntaxException {
      ...
      if (!flag) {
         ...
         if (p_201405_1_.getPlayers().isEmpty()) {
            ...
            p_201405_0_.sendSuccess(new TranslationTextComponent("commands.bossbar.set.players.success.some", p_201405_1_.getDisplayName(), p_201405_2_.size(), TextComponentUtils.func_197677_b(p_201405_2_, PlayerEntity::getDisplayName)), true);
         }
   ...
   private static int listBars(CommandSource p_201428_0_) {
      ...
      if (collection.isEmpty()) {
         ...
         p_201428_0_.sendSuccess(new TranslationTextComponent("commands.bossbar.list.bars.some", collection.size(), TextComponentUtils.func_197677_b(collection, CustomServerBossInfo::getDisplayName)), false);
      }
   ...
   private static int createBar(CommandSource p_201400_0_, ResourceLocation p_201400_1_, ITextComponent p_201400_2_) throws CommandSyntaxException {
      ...
      if (customserverbossinfomanager.get(p_201400_1_) != null) {
         ...
         CustomServerBossInfo customserverbossinfo = customserverbossinfomanager.create(p_201400_1_, TextComponentUtils.func_197680_a(p_201400_0_, p_201400_2_, (Entity)null, 0));
