...
public class LootCommand {
   ...
   private static <T extends ArgumentBuilder<CommandSource, T>> T addTargets(T p_218868_0_, LootCommand.ISourceArgumentBuilder p_218868_1_) {
      return (T)p_218868_0_.then(Commands.literal("replace").then(Commands.literal("entity").then(Commands.argument("entities", EntityArgument.entities()).then(p_218868_1_.construct(Commands.argument("slot", SlotArgument.slot()), (p_218866_0_, p_218866_1_, p_218866_2_) -> {
         ...
         return blockReplace((CommandSource)p_218864_0_.getSource(), BlockPosArgument.getLoadedBlockPos(p_218864_0_, "targetPos"), SlotArgument.getSlot(p_218864_0_, "slot"), p_218864_1_.size(), p_218864_1_, p_218864_2_);
      }).then(p_218868_1_.construct(Commands.argument("count", IntegerArgumentType.integer(0)), (p_218870_0_, p_218870_1_, p_218870_2_) -> {
         return blockReplace((CommandSource)p_218870_0_.getSource(), BlockPosArgument.getLoadedBlockPos(p_218870_0_, "targetPos"), IntegerArgumentType.getInteger(p_218870_0_, "slot"), IntegerArgumentType.getInteger(p_218870_0_, "count"), p_218870_1_, p_218870_2_);
         ...
         return blockDistribute((CommandSource)p_218885_0_.getSource(), BlockPosArgument.getLoadedBlockPos(p_218885_0_, "targetPos"), p_218885_1_, p_218885_2_);
         ...
         return dropInWorld((CommandSource)p_218877_0_.getSource(), Vec3Argument.getVec3(p_218877_0_, "targetPos"), p_218877_1_, p_218877_2_);
      })));
   }
   ...
   private static int dropInWorld(CommandSource p_218881_0_, Vec3d p_218881_1_, List<ItemStack> p_218881_2_, LootCommand.ISuccessListener p_218881_3_) throws CommandSyntaxException {
   ...
   private static int dropKillLoot(CommandContext<CommandSource> p_218869_0_, Entity p_218869_1_, LootCommand.ITargetHandler p_218869_2_) throws CommandSyntaxException {
      if (!(p_218869_1_ instanceof LivingEntity)) {
         ...
         lootcontext$builder.withParameter(LootParameters.field_216286_f, new BlockPos(commandsource.getPosition()));
   ...
   private static int dropChestLoot(CommandContext<CommandSource> p_218887_0_, ResourceLocation p_218887_1_, LootCommand.ITargetHandler p_218887_2_) throws CommandSyntaxException {
      ...
      LootContext.Builder lootcontext$builder = (new LootContext.Builder(commandsource.getLevel())).withOptionalParameter(LootParameters.THIS_ENTITY, commandsource.getEntity()).withParameter(LootParameters.field_216286_f, new BlockPos(commandsource.getPosition()));
   ...
   private static int dropFishingLoot(CommandContext<CommandSource> p_218876_0_, ResourceLocation p_218876_1_, BlockPos p_218876_2_, ItemStack p_218876_3_, LootCommand.ITargetHandler p_218876_4_) throws CommandSyntaxException {
      ...
      LootContext lootcontext = (new LootContext.Builder(commandsource.getLevel())).withParameter(LootParameters.field_216286_f, p_218876_2_).withParameter(LootParameters.TOOL, p_218876_3_).create(LootParameterSets.FISHING);
