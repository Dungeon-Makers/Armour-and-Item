...
public class ScoreboardCommand {
   ...
   private static int listObjectives(CommandSource p_198662_0_) {
      ...
      if (collection.isEmpty()) {
         ...
         p_198662_0_.sendSuccess(new TranslationTextComponent("commands.scoreboard.objectives.list.success", collection.size(), TextComponentUtils.func_197677_b(collection, ScoreObjective::getFormattedDisplayName)), false);
      }
