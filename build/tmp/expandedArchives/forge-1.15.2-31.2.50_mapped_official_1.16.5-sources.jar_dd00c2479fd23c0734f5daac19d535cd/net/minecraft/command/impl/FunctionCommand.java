...
public class FunctionCommand {
   public static final SuggestionProvider<CommandSource> SUGGEST_FUNCTION = (p_198477_0_, p_198477_1_) -> {
      ...
      ISuggestionProvider.suggestResource(functionmanager.func_200000_g().getAvailableTags(), p_198477_1_, "#");
      return ISuggestionProvider.suggestResource(functionmanager.func_193066_d().keySet(), p_198477_1_);
   };
