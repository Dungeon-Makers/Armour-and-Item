...
public class SayCommand {
   public static void register(CommandDispatcher<CommandSource> p_198625_0_) {
      p_198625_0_.register(Commands.literal("say").requires((p_198627_0_) -> {
         ...
         p_198626_0_.getSource().getServer().getPlayerList().func_148539_a(new TranslationTextComponent("chat.type.announcement", p_198626_0_.getSource().getDisplayName(), itextcomponent));
         return 1;
      })));
   }
}