...
public class WeatherCommand {
   ...
   private static int setClear(CommandSource p_198869_0_, int p_198869_1_) {
      p_198869_0_.getLevel().getLevelData().func_176142_i(p_198869_1_);
      p_198869_0_.getLevel().getLevelData().setRainTime(0);
      p_198869_0_.getLevel().getLevelData().setThunderTime(0);
      p_198869_0_.getLevel().getLevelData().setRaining(false);
      p_198869_0_.getLevel().getLevelData().setThundering(false);
   ...
   private static int setRain(CommandSource p_198865_0_, int p_198865_1_) {
      p_198865_0_.getLevel().getLevelData().func_176142_i(0);
      p_198865_0_.getLevel().getLevelData().setRainTime(p_198865_1_);
      p_198865_0_.getLevel().getLevelData().setThunderTime(p_198865_1_);
      p_198865_0_.getLevel().getLevelData().setRaining(true);
      p_198865_0_.getLevel().getLevelData().setThundering(false);
   ...
   private static int setThunder(CommandSource p_198863_0_, int p_198863_1_) {
      p_198863_0_.getLevel().getLevelData().func_176142_i(0);
      p_198863_0_.getLevel().getLevelData().setRainTime(p_198863_1_);
      p_198863_0_.getLevel().getLevelData().setThunderTime(p_198863_1_);
      p_198863_0_.getLevel().getLevelData().setRaining(true);
      p_198863_0_.getLevel().getLevelData().setThundering(true);
