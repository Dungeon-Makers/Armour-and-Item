...
public class ForceLoadCommand {
   ...
   private static int queryForceLoad(CommandSource p_212713_0_, ColumnPos p_212713_1_) throws CommandSyntaxException {
      ...
      DimensionType dimensiontype = p_212713_0_.getLevel().func_201675_m().func_186058_p();
      boolean flag = p_212713_0_.getServer().getLevel(dimensiontype).getForcedChunks().contains(chunkpos.toLong());
      if (flag) {
         p_212713_0_.sendSuccess(new TranslationTextComponent("commands.forceload.query.success", chunkpos, dimensiontype), false);
         return 1;
      } else {
   ...
   private static int listForceLoad(CommandSource p_212721_0_) {
      DimensionType dimensiontype = p_212721_0_.getLevel().func_201675_m().func_186058_p();
      LongSet longset = p_212721_0_.getServer().getLevel(dimensiontype).getForcedChunks();
      int i = longset.size();
      if (i > 0) {
         String s = Joiner.on(", ").join(longset.stream().sorted().map(ChunkPos::new).map(ChunkPos::toString).iterator());
         if (i == 1) {
            p_212721_0_.sendSuccess(new TranslationTextComponent("commands.forceload.list.single", dimensiontype, s), false);
         } else {
            p_212721_0_.sendSuccess(new TranslationTextComponent("commands.forceload.list.multiple", i, dimensiontype, s), false);
         }
      } else {
         p_212721_0_.sendFailure(new TranslationTextComponent("commands.forceload.added.none", dimensiontype));
      }
   ...
   private static int removeAll(CommandSource p_212722_0_) {
      DimensionType dimensiontype = p_212722_0_.getLevel().func_201675_m().func_186058_p();
      ServerWorld serverworld = p_212722_0_.getServer().getLevel(dimensiontype);
      ...
      p_212722_0_.sendSuccess(new TranslationTextComponent("commands.forceload.removed.all", dimensiontype), true);
      return 0;
   }
   ...
   private static int changeForceLoad(CommandSource p_212719_0_, ColumnPos p_212719_1_, ColumnPos p_212719_2_, boolean p_212719_3_) throws CommandSyntaxException {
      ...
      if (i >= -30000000 && j >= -30000000 && k < 30000000 && l < 30000000) {
         ...
         if (i2 > 256L) {
            ...
            DimensionType dimensiontype = p_212719_0_.getLevel().func_201675_m().func_186058_p();
            ServerWorld serverworld = p_212719_0_.getServer().getLevel(dimensiontype);
            ...
            if (j2 == 0) {
               ...
               if (j2 == 1) {
                  p_212719_0_.sendSuccess(new TranslationTextComponent("commands.forceload." + (p_212719_3_ ? "added" : "removed") + ".single", chunkpos, dimensiontype), true);
               } else {
                  ChunkPos chunkpos1 = new ChunkPos(i1, j1);
                  ChunkPos chunkpos2 = new ChunkPos(k1, l1);
                  p_212719_0_.sendSuccess(new TranslationTextComponent("commands.forceload." + (p_212719_3_ ? "added" : "removed") + ".multiple", j2, dimensiontype, chunkpos1, chunkpos2), true);
               }
