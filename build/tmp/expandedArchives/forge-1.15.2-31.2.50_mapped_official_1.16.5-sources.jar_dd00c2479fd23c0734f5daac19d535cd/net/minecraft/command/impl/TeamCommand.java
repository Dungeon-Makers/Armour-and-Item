...
public class TeamCommand {
   ...
   private static int joinTeam(CommandSource p_198768_0_, ScorePlayerTeam p_198768_1_, Collection<String> p_198768_2_) {
      ...
      if (p_198768_2_.size() == 1) {
         p_198768_0_.sendSuccess(new TranslationTextComponent("commands.team.join.success.single", p_198768_2_.iterator().next(), p_198768_1_.func_197892_d()), true);
      } else {
         p_198768_0_.sendSuccess(new TranslationTextComponent("commands.team.join.success.multiple", p_198768_2_.size(), p_198768_1_.func_197892_d()), true);
      }
   ...
   private static int setNametagVisibility(CommandSource p_198777_0_, ScorePlayerTeam p_198777_1_, Team.Visible p_198777_2_) throws CommandSyntaxException {
      if (p_198777_1_.getNameTagVisibility() == p_198777_2_) {
         ...
         p_198777_0_.sendSuccess(new TranslationTextComponent("commands.team.option.nametagVisibility.success", p_198777_1_.func_197892_d(), p_198777_2_.getDisplayName()), true);
         return 0;
      }
   }
   ...
   private static int setDeathMessageVisibility(CommandSource p_198776_0_, ScorePlayerTeam p_198776_1_, Team.Visible p_198776_2_) throws CommandSyntaxException {
      if (p_198776_1_.getDeathMessageVisibility() == p_198776_2_) {
         ...
         p_198776_0_.sendSuccess(new TranslationTextComponent("commands.team.option.deathMessageVisibility.success", p_198776_1_.func_197892_d(), p_198776_2_.getDisplayName()), true);
         return 0;
      }
   }
   ...
   private static int setCollision(CommandSource p_198787_0_, ScorePlayerTeam p_198787_1_, Team.CollisionRule p_198787_2_) throws CommandSyntaxException {
      if (p_198787_1_.getCollisionRule() == p_198787_2_) {
         ...
         p_198787_0_.sendSuccess(new TranslationTextComponent("commands.team.option.collisionRule.success", p_198787_1_.func_197892_d(), p_198787_2_.getDisplayName()), true);
         return 0;
      }
   }
   ...
   private static int setFriendlySight(CommandSource p_198783_0_, ScorePlayerTeam p_198783_1_, boolean p_198783_2_) throws CommandSyntaxException {
      if (p_198783_1_.canSeeFriendlyInvisibles() == p_198783_2_) {
         ...
         p_198783_0_.sendSuccess(new TranslationTextComponent("commands.team.option.seeFriendlyInvisibles." + (p_198783_2_ ? "enabled" : "disabled"), p_198783_1_.func_197892_d()), true);
         return 0;
      }
   }
   ...
   private static int setFriendlyFire(CommandSource p_198781_0_, ScorePlayerTeam p_198781_1_, boolean p_198781_2_) throws CommandSyntaxException {
      if (p_198781_1_.isAllowFriendlyFire() == p_198781_2_) {
         ...
         p_198781_0_.sendSuccess(new TranslationTextComponent("commands.team.option.friendlyfire." + (p_198781_2_ ? "enabled" : "disabled"), p_198781_1_.func_197892_d()), true);
         return 0;
      }
   }
   ...
   private static int setDisplayName(CommandSource p_211920_0_, ScorePlayerTeam p_211920_1_, ITextComponent p_211920_2_) throws CommandSyntaxException {
      if (p_211920_1_.getDisplayName().equals(p_211920_2_)) {
         ...
         p_211920_0_.sendSuccess(new TranslationTextComponent("commands.team.option.name.success", p_211920_1_.func_197892_d()), true);
         return 0;
      }
   }
   ...
   private static int setColor(CommandSource p_198757_0_, ScorePlayerTeam p_198757_1_, TextFormatting p_198757_2_) throws CommandSyntaxException {
      if (p_198757_1_.getColor() == p_198757_2_) {
         ...
         p_198757_0_.sendSuccess(new TranslationTextComponent("commands.team.option.color.success", p_198757_1_.func_197892_d(), p_198757_2_.getName()), true);
         return 0;
      }
   }
   ...
   private static int emptyTeam(CommandSource p_198788_0_, ScorePlayerTeam p_198788_1_) throws CommandSyntaxException {
      ...
      if (collection.isEmpty()) {
         ...
         p_198788_0_.sendSuccess(new TranslationTextComponent("commands.team.empty.success", collection.size(), p_198788_1_.func_197892_d()), true);
   ...
   private static int deleteTeam(CommandSource p_198784_0_, ScorePlayerTeam p_198784_1_) {
      ...
      p_198784_0_.sendSuccess(new TranslationTextComponent("commands.team.remove.success", p_198784_1_.func_197892_d()), true);
   ...
   private static int createTeam(CommandSource p_211917_0_, String p_211917_1_, ITextComponent p_211917_2_) throws CommandSyntaxException {
      ...
      if (scoreboard.getPlayerTeam(p_211917_1_) != null) {
         ...
         p_211917_0_.sendSuccess(new TranslationTextComponent("commands.team.add.success", scoreplayerteam.func_197892_d()), true);
         return scoreboard.getPlayerTeams().size();
      }
   }
   ...
   private static int listMembers(CommandSource p_198782_0_, ScorePlayerTeam p_198782_1_) {
      ...
      if (collection.isEmpty()) {
         p_198782_0_.sendSuccess(new TranslationTextComponent("commands.team.list.members.empty", p_198782_1_.func_197892_d()), false);
      } else {
         p_198782_0_.sendSuccess(new TranslationTextComponent("commands.team.list.members.success", p_198782_1_.func_197892_d(), collection.size(), TextComponentUtils.formatList(collection)), false);
      }
   ...
   private static int listTeams(CommandSource p_198792_0_) {
      ...
      if (collection.isEmpty()) {
         ...
         p_198792_0_.sendSuccess(new TranslationTextComponent("commands.team.list.teams.success", collection.size(), TextComponentUtils.func_197677_b(collection, ScorePlayerTeam::func_197892_d)), false);
      }
