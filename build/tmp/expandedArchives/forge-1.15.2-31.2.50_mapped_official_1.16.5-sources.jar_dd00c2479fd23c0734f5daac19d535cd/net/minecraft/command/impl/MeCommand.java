...
public class MeCommand {
   public static void register(CommandDispatcher<CommandSource> p_198364_0_) {
      p_198364_0_.register(Commands.literal("me").then(Commands.argument("action", StringArgumentType.greedyString()).executes((p_198365_0_) -> {
         p_198365_0_.getSource().getServer().getPlayerList().func_148539_a(new TranslationTextComponent("chat.type.emote", p_198365_0_.getSource().getDisplayName(), StringArgumentType.getString(p_198365_0_, "action")));
         return 1;
      })));
   }
}