...
public class TeleportCommand {
   ...
   private static int teleportToPos(CommandSource p_200559_0_, Collection<? extends Entity> p_200559_1_, ServerWorld p_200559_2_, ILocationArgument p_200559_3_, @Nullable ILocationArgument p_200559_4_, @Nullable TeleportCommand.Facing p_200559_5_) throws CommandSyntaxException {
      ...
      for(Entity entity : p_200559_1_) {
         if (p_200559_4_ == null) {
            performTeleport(p_200559_0_, entity, p_200559_2_, vec3d.x, vec3d.y, vec3d.z, set, entity.yRot, entity.xRot, p_200559_5_);
         } else {
            performTeleport(p_200559_0_, entity, p_200559_2_, vec3d.x, vec3d.y, vec3d.z, set, vec2f.y, vec2f.x, p_200559_5_);
         }
      }

      if (p_200559_1_.size() == 1) {
         p_200559_0_.sendSuccess(new TranslationTextComponent("commands.teleport.success.location.single", p_200559_1_.iterator().next().getDisplayName(), vec3d.x, vec3d.y, vec3d.z), true);
      } else {
         p_200559_0_.sendSuccess(new TranslationTextComponent("commands.teleport.success.location.multiple", p_200559_1_.size(), vec3d.x, vec3d.y, vec3d.z), true);
      }

      return p_200559_1_.size();
   }

   private static void performTeleport(CommandSource p_201127_0_, Entity p_201127_1_, ServerWorld p_201127_2_, double p_201127_3_, double p_201127_5_, double p_201127_7_, Set<SPlayerPositionLookPacket.Flags> p_201127_9_, float p_201127_10_, float p_201127_11_, @Nullable TeleportCommand.Facing p_201127_12_) {
      if (p_201127_1_ instanceof ServerPlayerEntity) {
         ...
         if (p_201127_2_ == p_201127_1_.level) {
            ...
            p_201127_1_.unRide();
            p_201127_1_.field_71093_bK = p_201127_2_.dimension.func_186058_p();
