...
public class ServerStatisticsManager extends StatisticsManager {
         ...
         if (compoundnbt.contains("stats", 10)) {
            ...
            for(String s : compoundnbt1.getAllKeys()) {
               if (compoundnbt1.contains(s, 10)) {
                  Util.ifElse(Registry.STAT_TYPE.func_218349_b(new ResourceLocation(s)), (p_219731_3_) -> {
   ...
   private <T> Optional<Stat<T>> getStat(StatType<T> p_219728_1_, String p_219728_2_) {
      return Optional.ofNullable(ResourceLocation.tryParse(p_219728_2_)).flatMap(p_219728_1_.getRegistry()::func_218349_b).map(p_219728_1_::get);
   }
