...
public class DamageSource {
   ...
   public static DamageSource func_76362_a(DamagingProjectileEntity p_76362_0_, @Nullable Entity p_76362_1_) {
      return p_76362_1_ == null ? (new IndirectEntityDamageSource("onFire", p_76362_0_, p_76362_0_)).setIsFire().setProjectile() : (new IndirectEntityDamageSource("fireball", p_76362_0_, p_76362_1_)).setIsFire().setProjectile();
   }
   ...
   public static DamageSource explosion(@Nullable Explosion p_94539_0_) {
      return p_94539_0_ != null && p_94539_0_.getSourceMob() != null ? (new EntityDamageSource("explosion.player", p_94539_0_.getSourceMob())).setScalesWithDifficulty().setExplosion() : (new DamageSource("explosion")).setScalesWithDifficulty().setExplosion();
   }
