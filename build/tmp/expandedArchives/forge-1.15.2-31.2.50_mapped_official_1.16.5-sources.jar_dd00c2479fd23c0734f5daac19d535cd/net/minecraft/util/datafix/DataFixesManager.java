...
public class DataFixesManager {
   ...
   private static void addFixers(DataFixerBuilder p_210891_0_) {
      ...
      p_210891_0_.addFixer(BlockRename.create(schema53, "Rename coral blocks", (p_207104_0_) -> {
         return RenamedCoral.RENAMED_IDS.getOrDefault(p_207104_0_, p_207104_0_);
      }));
      p_210891_0_.addFixer(ItemRename.create(schema53, "Rename coral items", (p_207103_0_) -> {
         return RenamedCoral.RENAMED_IDS.getOrDefault(p_207103_0_, p_207103_0_);
      }));
      ...
      p_210891_0_.addFixer(ItemRename.create(schema55, "Rename pufferfish egg item", (p_207552_0_) -> {
         return PufferfishRename.RENAMED_IDS.getOrDefault(p_207552_0_, p_207552_0_);
      }));
      ...
      p_210891_0_.addFixer(ItemRename.create(schema57, "Rename cod/salmon egg items", (p_207551_0_) -> {
         return EntityCodSalmonFix.RENAMED_EGG_IDS.getOrDefault(p_207551_0_, p_207551_0_);
      }));
      ...
      Schema schema68 = p_210891_0_.addSchema(1508, SAME_NAMESPACED);
      ...
      p_210891_0_.addFixer(BlockRename.create(schema69, "Block renamening fix", (p_209169_0_) -> {
         return EntityRenaming1510.RENAMED_BLOCKS.getOrDefault(p_209169_0_, p_209169_0_);
      }));
      p_210891_0_.addFixer(ItemRename.create(schema69, "Item renamening fix", (p_210900_0_) -> {
         return EntityRenaming1510.RENAMED_ITEMS.getOrDefault(p_210900_0_, p_210900_0_);
      }));
      p_210891_0_.addFixer(new RecipeRenamer1510(schema69, false));
      p_210891_0_.addFixer(new EntityRenaming1510(schema69, true));
      p_210891_0_.addFixer(new SwimStatsRename(schema69, false));
      Schema schema70 = p_210891_0_.addSchema(1514, SAME_NAMESPACED);
      ...
      Schema schema71 = p_210891_0_.addSchema(1515, SAME_NAMESPACED);
      p_210891_0_.addFixer(BlockRename.create(schema71, "Rename coral fan blocks", (p_211924_0_) -> {
         return CoralFansRenameList.RENAMED_IDS.getOrDefault(p_211924_0_, p_211924_0_);
      }));
      Schema schema72 = p_210891_0_.addSchema(1624, SAME_NAMESPACED);
      p_210891_0_.addFixer(new TrappedChestTileEntitySplit(schema72, false));
      Schema schema73 = p_210891_0_.addSchema(1800, V1800::new);
      p_210891_0_.addFixer(new AddNewChoices(schema73, "Added 1.14 mobs fix", TypeReferences.ENTITY));
      p_210891_0_.addFixer(ItemRename.create(schema73, "Rename dye items", (p_219813_0_) -> {
         return DyeRenameMap.RENAMED_IDS.getOrDefault(p_219813_0_, p_219813_0_);
      }));
      Schema schema74 = p_210891_0_.addSchema(1801, V1801::new);
      p_210891_0_.addFixer(new AddNewChoices(schema74, "Added Illager Beast", TypeReferences.ENTITY));
      Schema schema75 = p_210891_0_.addSchema(1802, SAME_NAMESPACED);
      p_210891_0_.addFixer(BlockRename.create(schema75, "Rename sign blocks & stone slabs", (p_219812_0_) -> {
      ...
      p_210891_0_.addFixer(ItemRename.create(schema75, "Rename sign item & stone slabs", (p_219815_0_) -> {
      ...
      Schema schema76 = p_210891_0_.addSchema(1803, SAME_NAMESPACED);
      p_210891_0_.addFixer(new ItemLoreComponentizeFix(schema76, false));
      Schema schema77 = p_210891_0_.addSchema(1904, V1904::new);
      p_210891_0_.addFixer(new AddNewChoices(schema77, "Added Cats", TypeReferences.ENTITY));
      p_210891_0_.addFixer(new EntityCatSplitFix(schema77, false));
      Schema schema78 = p_210891_0_.addSchema(1905, SAME_NAMESPACED);
      p_210891_0_.addFixer(new ChunkStatusFix(schema78, false));
      Schema schema79 = p_210891_0_.addSchema(1906, V1906::new);
      p_210891_0_.addFixer(new AddNewChoices(schema79, "Add POI Blocks", TypeReferences.BLOCK_ENTITY));
      Schema schema80 = p_210891_0_.addSchema(1909, V1909::new);
      p_210891_0_.addFixer(new AddNewChoices(schema80, "Add jigsaw", TypeReferences.BLOCK_ENTITY));
      Schema schema81 = p_210891_0_.addSchema(1911, SAME_NAMESPACED);
      p_210891_0_.addFixer(new ChunkStatusFix2(schema81, false));
      Schema schema82 = p_210891_0_.addSchema(1917, SAME_NAMESPACED);
      p_210891_0_.addFixer(new CatTypeFix(schema82, false));
      Schema schema83 = p_210891_0_.addSchema(1918, SAME_NAMESPACED);
      p_210891_0_.addFixer(new VillagerProfessionFix(schema83, "minecraft:villager"));
      p_210891_0_.addFixer(new VillagerProfessionFix(schema83, "minecraft:zombie_villager"));
      Schema schema84 = p_210891_0_.addSchema(1920, V1920::new);
      p_210891_0_.addFixer(new NewVillageFix(schema84, false));
      p_210891_0_.addFixer(new AddNewChoices(schema84, "Add campfire", TypeReferences.BLOCK_ENTITY));
      Schema schema85 = p_210891_0_.addSchema(1925, SAME_NAMESPACED);
      p_210891_0_.addFixer(new MapIdFix(schema85, false));
      Schema schema86 = p_210891_0_.addSchema(1928, V1928::new);
      p_210891_0_.addFixer(new EntityRavagerRenameFix(schema86, true));
      p_210891_0_.addFixer(ItemRename.create(schema86, "Rename ravager egg item", (p_219814_0_) -> {
         return EntityRavagerRenameFix.RENAMED_IDS.getOrDefault(p_219814_0_, p_219814_0_);
      }));
      Schema schema87 = p_210891_0_.addSchema(1929, V1929::new);
      p_210891_0_.addFixer(new AddNewChoices(schema87, "Add Wandering Trader and Trader Llama", TypeReferences.ENTITY));
      Schema schema88 = p_210891_0_.addSchema(1931, V1931::new);
      p_210891_0_.addFixer(new AddNewChoices(schema88, "Added Fox", TypeReferences.ENTITY));
      Schema schema89 = p_210891_0_.addSchema(1936, SAME_NAMESPACED);
      p_210891_0_.addFixer(new OptionsAddTextBackgroundFix(schema89, false));
      Schema schema90 = p_210891_0_.addSchema(1946, SAME_NAMESPACED);
      p_210891_0_.addFixer(new PointOfInterestReorganizationFix(schema90, false));
      Schema schema91 = p_210891_0_.addSchema(1948, SAME_NAMESPACED);
      p_210891_0_.addFixer(new OminousBannerRenameFix(schema91, false));
      Schema schema92 = p_210891_0_.addSchema(1953, SAME_NAMESPACED);
      p_210891_0_.addFixer(new OminousBannerTileEntityRenameFix(schema92, false));
      Schema schema93 = p_210891_0_.addSchema(1955, SAME_NAMESPACED);
      p_210891_0_.addFixer(new VillagerLevelAndXpFix(schema93, false));
      p_210891_0_.addFixer(new ZombieVillagerXpFix(schema93, false));
      Schema schema94 = p_210891_0_.addSchema(1961, SAME_NAMESPACED);
      p_210891_0_.addFixer(new ChunkLightRemoveFix(schema94, false));
      ...
      p_210891_0_.addFixer(new RecipeRenamer(schema95, false, "Rename sugar recipe", (p_230063_0_) -> {
         return "minecraft:sugar".equals(p_230063_0_) ? "sugar_from_sugar_cane" : p_230063_0_;
      }));
      p_210891_0_.addFixer(new AdvancementRenamer(schema95, false, "Rename sugar recipe advancement", (p_230062_0_) -> {
      ...
      p_210891_0_.addFixer(ItemRename.create(schema97, "Rename bee_hive item to beehive", (p_226189_0_) -> {
      ...
      p_210891_0_.addFixer(BlockRename.create(schema97, "Rename bee_hive block to beehive", (p_226188_0_) -> {
