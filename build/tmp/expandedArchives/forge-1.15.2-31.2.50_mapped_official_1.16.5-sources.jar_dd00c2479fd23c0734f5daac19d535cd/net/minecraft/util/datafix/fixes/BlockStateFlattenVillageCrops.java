...
public class BlockStateFlattenVillageCrops extends DataFix {
   ...
   private static <T> Dynamic<T> updateCrop(Dynamic<T> p_209676_0_, String p_209676_1_) {
      return p_209676_0_.get(p_209676_1_).asNumber().isPresent() ? p_209676_0_.set(p_209676_1_, BlockStateFlatteningMap.getTag(p_209676_0_.get(p_209676_1_).asInt(0) << 4)) : p_209676_0_;
   }
}