         ...
         return this.fixTypeEverywhere("Biomes fix", type, (p_210916_0_) -> {
            return (p_210917_0_) -> {
               return p_210917_0_.mapSecond((p_210918_0_) -> {
                  return BIOMES.getOrDefault(p_210918_0_, p_210918_0_);
               });
            };
         });
      }
