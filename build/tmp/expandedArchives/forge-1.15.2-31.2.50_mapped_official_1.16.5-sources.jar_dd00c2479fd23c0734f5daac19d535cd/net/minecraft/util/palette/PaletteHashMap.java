...
public class PaletteHashMap<T> implements IPalette<T> {
   ...
   public int idFor(T p_186041_1_) {
      int i = this.values.func_186815_a(p_186041_1_);
      if (i == -1) {
   ...
   public boolean func_222626_b(T p_222626_1_) {
      return this.values.func_186815_a(p_222626_1_) != -1;
   }
   ...
   public void write(PacketBuffer p_186037_1_) {
      ...
      for(int j = 0; j < i; ++j) {
         p_186037_1_.writeVarInt(this.registry.func_148747_b(this.values.byId(j)));
      }
   ...
   public int getSerializedSize() {
      ...
      for(int j = 0; j < this.getSize(); ++j) {
         i += PacketBuffer.getVarIntSize(this.registry.func_148747_b(this.values.byId(j)));
      }
