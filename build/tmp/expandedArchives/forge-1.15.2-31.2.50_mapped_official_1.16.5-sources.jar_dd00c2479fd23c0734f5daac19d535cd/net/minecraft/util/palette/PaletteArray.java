...
public class PaletteArray<T> implements IPalette<T> {
   ...
   public boolean func_222626_b(T p_222626_1_) {
      return ArrayUtils.contains(this.values, p_222626_1_);
   }
   ...
   public void write(PacketBuffer p_186037_1_) {
      ...
      for(int i = 0; i < this.size; ++i) {
         p_186037_1_.writeVarInt(this.registry.func_148747_b(this.values[i]));
      }
   ...
   public int getSerializedSize() {
      ...
      for(int j = 0; j < this.getSize(); ++j) {
         i += PacketBuffer.getVarIntSize(this.registry.func_148747_b(this.values[j]));
      }
