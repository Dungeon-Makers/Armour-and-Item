...
public class PalettedContainer<T> implements IResizeCallback<T> {
   ...
   private void setBits(int bitsIn, boolean forceBits) {
      if (bitsIn != this.bits) {
         ...
         if (this.bits <= 4) {
            this.bits = 4;
            this.palette = new PaletteArray<>(this.registry, this.bits, this, this.reader);
         } else if (this.bits < 9) {
            this.palette = new PaletteHashMap<>(this.registry, this.bits, this, this.reader, this.writer);
         } else {
   ...
   public T getAndSet(int p_222641_1_, int p_222641_2_, int p_222641_3_, T p_222641_4_) {
      this.acquire();
      T t = (T)this.getAndSet(getIndex(p_222641_1_, p_222641_2_, p_222641_3_), p_222641_4_);
      this.release();
      return t;
   }

   public T getAndSetUnchecked(int p_222639_1_, int p_222639_2_, int p_222639_3_, T p_222639_4_) {
      return (T)this.getAndSet(getIndex(p_222639_1_, p_222639_2_, p_222639_3_), p_222639_4_);
   }
   ...
   public void read(ListNBT p_222642_1_, long[] p_222642_2_) {
      ...
      if (this.palette == this.globalPalette) {
         IPalette<T> ipalette = new PaletteHashMap<>(this.registry, i, this.dummyPaletteResize, this.reader, this.writer);
   ...
   public void write(CompoundNBT p_196963_1_, String p_196963_2_, String p_196963_3_) {
      this.acquire();
      PaletteHashMap<T> palettehashmap = new PaletteHashMap<>(this.registry, this.bits, this.dummyPaletteResize, this.reader, this.writer);
      T t = this.defaultValue;
      int i = palettehashmap.idFor(this.defaultValue);
   ...
   public boolean func_222640_a(T p_222640_1_) {
      return this.palette.func_222626_b(p_222640_1_);
   }
