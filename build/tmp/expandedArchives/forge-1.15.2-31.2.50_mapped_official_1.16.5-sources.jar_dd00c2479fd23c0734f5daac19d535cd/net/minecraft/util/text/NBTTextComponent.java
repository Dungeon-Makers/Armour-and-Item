...
public abstract class NBTTextComponent extends TextComponent implements ITargetedTextComponent {
   ...
   public ITextComponent func_197668_a(@Nullable CommandSource p_197668_1_, @Nullable net.minecraft.entity.Entity p_197668_2_, int p_197668_3_) throws CommandSyntaxException {
      if (p_197668_1_ != null && this.compiledNbtPath != null) {
         Stream<String> stream = this.getData(p_197668_1_).flatMap((p_218675_1_) -> {
            try {
         ...
         return (ITextComponent)(this.interpreting ? stream.flatMap((p_223137_3_) -> {
            try {
               ITextComponent itextcomponent = ITextComponent.Serializer.func_150699_a(p_223137_3_);
               return Stream.of(TextComponentUtils.func_197680_a(p_197668_1_, itextcomponent, p_197668_2_, p_197668_3_));
            } catch (Exception exception) {
               LOGGER.warn("Failed to parse component: " + p_223137_3_, (Throwable)exception);
               return Stream.of();
            }
         }).reduce((p_218671_0_, p_218671_1_) -> {
            return p_218671_0_.func_150258_a(", ").func_150257_a(p_218671_1_);
