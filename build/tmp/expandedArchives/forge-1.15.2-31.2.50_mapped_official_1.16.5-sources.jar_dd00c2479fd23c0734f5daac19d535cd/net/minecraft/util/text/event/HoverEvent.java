...
public class HoverEvent {
   ...
   public static enum Action {
      ...
      private static final Map<String, HoverEvent.Action> LOOKUP = Arrays.stream(values()).collect(Collectors.toMap(HoverEvent.Action::getName, (p_199854_0_) -> {
         return p_199854_0_;
      }));
      ...
      private Action(String p_i45157_3_, boolean p_i45157_4_) {
         this.name = p_i45157_3_;
         this.allowFromServer = p_i45157_4_;
      }
