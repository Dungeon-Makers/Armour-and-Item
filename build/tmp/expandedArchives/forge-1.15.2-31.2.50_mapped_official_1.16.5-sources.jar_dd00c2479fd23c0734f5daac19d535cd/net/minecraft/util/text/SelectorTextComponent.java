...
public class SelectorTextComponent extends TextComponent implements ITargetedTextComponent {
   ...
   public ITextComponent func_197668_a(@Nullable CommandSource p_197668_1_, @Nullable Entity p_197668_2_, int p_197668_3_) throws CommandSyntaxException {
      return (ITextComponent)(p_197668_1_ != null && this.selector != null ? EntitySelector.joinNames(this.selector.findEntities(p_197668_1_)) : new StringTextComponent(""));
   }
   ...
   public SelectorTextComponent func_150259_f() {
