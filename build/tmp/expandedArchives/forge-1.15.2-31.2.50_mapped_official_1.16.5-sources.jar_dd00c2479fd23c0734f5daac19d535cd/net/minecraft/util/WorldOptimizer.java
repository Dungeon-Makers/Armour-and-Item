...
public class WorldOptimizer {
   ...
   private final SaveHandler levelStorage;
   ...
   public WorldOptimizer(String p_i50400_1_, SaveFormat p_i50400_2_, WorldInfo p_i50400_3_, boolean p_i50400_4_) {
      this.field_212237_s = p_i50400_3_.getLevelName();
      this.eraseCache = p_i50400_4_;
      this.levelStorage = p_i50400_2_.func_197715_a(p_i50400_1_, (MinecraftServer)null);
      this.levelStorage.func_75761_a(p_i50400_3_);
      this.overworldDataStorage = new DimensionSavedDataManager(new File(DimensionType.field_223227_a_.func_212679_a(this.levelStorage.func_75765_b()), "data"), this.levelStorage.func_197718_i());
      this.field_219958_g = this.levelStorage.func_75765_b();
   ...
   private void work() {
      File file1 = this.levelStorage.func_75765_b();
      this.totalChunks = 0;
      ...
      if (this.totalChunks == 0) {
         ...
         for(DimensionType dimensiontype1 : DimensionType.func_212681_b()) {
            File file2 = dimensiontype1.func_212679_a(file1);
            builder1.put(dimensiontype1, new ChunkLoader(new File(file2, "region"), this.levelStorage.func_197718_i()));
         }
         ...
         while(this.running) {
            ...
            for(DimensionType dimensiontype2 : DimensionType.func_212681_b()) {
               ...
               this.progressMap.put(dimensiontype2, f2);
               f += f2;
            }
   ...
   private List<ChunkPos> func_219953_b(DimensionType p_219953_1_) {
      File file1 = p_219953_1_.func_212679_a(this.field_219958_g);
   ...
   public float func_212543_a(DimensionType p_212543_1_) {
      return this.progressMap.getFloat(p_212543_1_);
   }
