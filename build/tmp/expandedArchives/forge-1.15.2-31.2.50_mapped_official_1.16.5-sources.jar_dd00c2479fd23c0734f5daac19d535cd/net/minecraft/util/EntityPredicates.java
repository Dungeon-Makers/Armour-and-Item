...
public final class EntityPredicates {
   ...
   public static final Predicate<Entity> NO_SPECTATORS = (p_200818_0_) -> {
   ...
   public static Predicate<Entity> withinDistance(double p_188443_0_, double p_188443_2_, double p_188443_4_, double p_188443_6_) {
      ...
      return (p_200819_8_) -> {
         return p_200819_8_ != null && p_200819_8_.distanceToSqr(p_188443_0_, p_188443_2_, p_188443_4_) <= d0;
      };
   }
   ...
   public static Predicate<Entity> pushableBy(Entity p_200823_0_) {
      ...
      return (Predicate<Entity>)(team$collisionrule == Team.CollisionRule.NEVER ? Predicates.alwaysFalse() : NO_SPECTATORS.and((p_210290_3_) -> {
         if (!p_210290_3_.isPushable()) {
            return false;
         } else if (!p_200823_0_.level.isClientSide || p_210290_3_ instanceof PlayerEntity && ((PlayerEntity)p_210290_3_).isLocalPlayer()) {
      ...
      return (p_210289_1_) -> {
         while(true) {
            if (p_210289_1_.isPassenger()) {
               p_210289_1_ = p_210289_1_.getVehicle();
