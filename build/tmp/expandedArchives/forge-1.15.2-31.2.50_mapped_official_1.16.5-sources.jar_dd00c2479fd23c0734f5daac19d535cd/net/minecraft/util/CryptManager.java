...
public class CryptManager {
   ...
   public static byte[] digestData(String p_75895_0_, PublicKey p_75895_1_, SecretKey p_75895_2_) {
      try {
   ...
   public static PublicKey byteToPublicKey(byte[] p_75896_0_) {
      try {
   ...
   public static SecretKey decryptByteToSecretKey(PrivateKey p_75887_0_, byte[] p_75887_1_) {
      return new SecretKeySpec(decryptUsingKey(p_75887_0_, p_75887_1_), "AES");
   }

   @OnlyIn(Dist.CLIENT)
   public static byte[] encryptUsingKey(Key p_75894_0_, byte[] p_75894_1_) {
      return cipherData(1, p_75894_0_, p_75894_1_);
   }

   public static byte[] decryptUsingKey(Key p_75889_0_, byte[] p_75889_1_) {
      return cipherData(2, p_75889_0_, p_75889_1_);
   }

   private static byte[] cipherData(int p_75885_0_, Key p_75885_1_, byte[] p_75885_2_) {
      try {
   ...
   private static Cipher setupCipher(int p_75886_0_, String p_75886_1_, Key p_75886_2_) {
      try {
   ...
   public static Cipher getCipher(int p_151229_0_, Key p_151229_1_) {
      try {
