...
public class Vec3d implements IPosition {
   ...
   public Vec3d vectorTo(Vec3d p_72444_1_) {
   ...
   public double dot(Vec3d p_72430_1_) {
      return this.x * p_72430_1_.x + this.y * p_72430_1_.y + this.z * p_72430_1_.z;
   }

   public Vec3d cross(Vec3d p_72431_1_) {
   ...
   public double distanceToSqr(Vec3d p_72436_1_) {
   ...
   public Vec3d multiply(Vec3d p_216369_1_) {
      return this.multiply(p_216369_1_.x, p_216369_1_.y, p_216369_1_.z);
   }

   public Vec3d multiply(double p_216372_1_, double p_216372_3_, double p_216372_5_) {
   ...
   public Vec3d xRot(float p_178789_1_) {
   ...
   public static Vec3d directionFromRotation(Vec2f p_189984_0_) {
      return directionFromRotation(p_189984_0_.x, p_189984_0_.y);
   }

   public static Vec3d directionFromRotation(float p_189986_0_, float p_189986_1_) {
