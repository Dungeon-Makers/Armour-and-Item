...
public enum PackCompatibility {
   ...
   private PackCompatibility(String p_i47910_3_) {
      this.description = new TranslationTextComponent("resourcePack.incompatible." + p_i47910_3_);
      this.confirmation = new TranslationTextComponent("resourcePack.incompatible.confirm." + p_i47910_3_);
   }
