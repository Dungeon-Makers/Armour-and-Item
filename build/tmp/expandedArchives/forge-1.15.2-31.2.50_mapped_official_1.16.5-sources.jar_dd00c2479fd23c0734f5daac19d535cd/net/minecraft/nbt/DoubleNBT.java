...
public class DoubleNBT extends NumberNBT {
   ...
   public ITextComponent getPrettyDisplay(String p_199850_1_, int p_199850_2_) {
      ITextComponent itextcomponent = (new StringTextComponent("d")).func_211708_a(SYNTAX_HIGHLIGHTING_NUMBER_TYPE);
      return (new StringTextComponent(String.valueOf(this.data))).func_150257_a(itextcomponent).func_211708_a(SYNTAX_HIGHLIGHTING_NUMBER);
   }
