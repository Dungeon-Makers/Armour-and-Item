...
public final class NBTUtil {
   ...
   public static CompoundNBT func_186862_a(UUID p_186862_0_) {
      CompoundNBT compoundnbt = new CompoundNBT();
      compoundnbt.putLong("M", p_186862_0_.getMostSignificantBits());
      compoundnbt.putLong("L", p_186862_0_.getLeastSignificantBits());
      return compoundnbt;
   }

   public static UUID loadUUID(CompoundNBT p_186860_0_) {
      ...
      if (!p_190008_0_.contains("Name", 8)) {
         ...
         if (p_190008_0_.contains("Properties", 10)) {
            ...
            for(String s : compoundnbt.getAllKeys()) {
               ...
               if (iproperty != null) {
                  blockstate = setValueHelper(blockstate, iproperty, s, compoundnbt, p_190008_0_);
               }
            }
         }
   ...
   private static <S extends IStateHolder<S>, T extends Comparable<T>> S setValueHelper(S p_193590_0_, IProperty<T> p_193590_1_, String p_193590_2_, CompoundNBT p_193590_3_, CompoundNBT p_193590_4_) {
      ...
      if (optional.isPresent()) {
         return (S)(p_193590_0_.setValue(p_193590_1_, (T)(optional.get())));
      } else {
