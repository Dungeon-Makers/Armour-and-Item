...
public class LongArrayNBT extends CollectionNBT<LongNBT> {
   ...
   public ITextComponent getPrettyDisplay(String p_199850_1_, int p_199850_2_) {
      ITextComponent itextcomponent = (new StringTextComponent("L")).func_211708_a(SYNTAX_HIGHLIGHTING_NUMBER_TYPE);
      ITextComponent itextcomponent1 = (new StringTextComponent("[")).func_150257_a(itextcomponent).func_150258_a(";");

      for(int i = 0; i < this.data.length; ++i) {
         ITextComponent itextcomponent2 = (new StringTextComponent(String.valueOf(this.data[i]))).func_211708_a(SYNTAX_HIGHLIGHTING_NUMBER);
