   ...
   public ITextComponent getPrettyDisplay(String p_199850_1_, int p_199850_2_) {
      if (this.isEmpty()) {
         ...
         for(int j = 0; j < this.list.size(); ++j) {
            if (j != 0) {
               itextcomponent2.func_150258_a(", ");
            }

            itextcomponent2.func_150257_a(this.list.get(j).getPrettyDisplay());
         }
         ...
         for(int i = 0; i < this.list.size(); ++i) {
            ITextComponent itextcomponent1 = new StringTextComponent(Strings.repeat(p_199850_1_, p_199850_2_ + 1));
            itextcomponent1.func_150257_a(this.list.get(i).getPrettyDisplay(p_199850_1_, p_199850_2_ + 1));
            if (i != this.list.size() - 1) {
               itextcomponent1.func_150258_a(s).func_150258_a(p_199850_1_.isEmpty() ? " " : "\n");
            }
