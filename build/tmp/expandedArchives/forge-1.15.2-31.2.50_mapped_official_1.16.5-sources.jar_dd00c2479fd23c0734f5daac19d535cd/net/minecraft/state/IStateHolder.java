...
public interface IStateHolder<C> {
   ...
   <T extends Comparable<T>> T getValue(IProperty<T> p_177229_1_);

   <T extends Comparable<T>, V extends T> C setValue(IProperty<T> p_206870_1_, V p_206870_2_);
   ...
   static <S extends IStateHolder<S>, T extends Comparable<T>> S func_215671_a(S p_215671_0_, IProperty<T> p_215671_1_, String p_215671_2_, String p_215671_3_, String p_215671_4_) {
      Optional<T> optional = p_215671_1_.getValue(p_215671_4_);
      if (optional.isPresent()) {
         return (S)(p_215671_0_.setValue(p_215671_1_, (T)(optional.get())));
      } else {
