...
public class FilledProfileResult implements IProfileResult {
   ...
   public List<DataPoint> getTimes(String p_219917_1_) {
      ...
      for(String s : this.entries.keySet()) {
         if (isDirectChild(p_219917_1_, s)) {
            l += this.getEntry(s).getDuration();
         }
      }
      ...
      for(String s1 : this.entries.keySet()) {
         if (isDirectChild(p_219917_1_, s1)) {
            IProfilerSection iprofilersection2 = this.getEntry(s1);
            ...
            list.add(new DataPoint(s2, d0, d1, iprofilersection2.getCount()));
         }
      }
   ...
   private void appendProfilerResults(int p_219928_1_, String p_219928_2_, StringBuilder p_219928_3_) {
      ...
      Object2LongMap<String> object2longmap = this.entries.get(p_219928_2_).getCounters();
