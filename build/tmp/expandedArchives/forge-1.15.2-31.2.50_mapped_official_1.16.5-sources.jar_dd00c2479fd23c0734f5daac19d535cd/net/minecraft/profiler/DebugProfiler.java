...
public class DebugProfiler implements IProfiler {
   ...
   public void push(String p_76320_1_) {
      this.field_219903_c.field_219940_a.push(p_76320_1_);
      this.field_219904_d.field_219940_a.push(p_76320_1_);
   }

   public void push(Supplier<String> p_194340_1_) {
      this.field_219903_c.field_219940_a.push(p_194340_1_);
      this.field_219904_d.field_219940_a.push(p_194340_1_);
   }

   public void pop() {
      this.field_219903_c.field_219940_a.pop();
      this.field_219904_d.field_219940_a.pop();
   }

   public void popPush(String p_219895_1_) {
      this.field_219903_c.field_219940_a.popPush(p_219895_1_);
      this.field_219904_d.field_219940_a.popPush(p_219895_1_);
   }

   @OnlyIn(Dist.CLIENT)
   public void popPush(Supplier<String> p_194339_1_) {
      this.field_219903_c.field_219940_a.popPush(p_194339_1_);
      this.field_219904_d.field_219940_a.popPush(p_194339_1_);
   }

   public void incrementCounter(String p_230035_1_) {
      this.field_219903_c.field_219940_a.incrementCounter(p_230035_1_);
      this.field_219904_d.field_219940_a.incrementCounter(p_230035_1_);
   }

   public void incrementCounter(Supplier<String> p_230036_1_) {
      this.field_219903_c.field_219940_a.incrementCounter(p_230036_1_);
      this.field_219904_d.field_219940_a.incrementCounter(p_230036_1_);
   }
   ...
   class DebugResultEntryImpl implements DebugProfiler.IDebugResultEntry {
      ...
      public void func_219939_d() {
         if (this.field_219940_a == EmptyProfiler.INSTANCE) {
            this.field_219940_a = new Profiler(Util.getNanos(), DebugProfiler.this.field_219902_b, true);
         }
