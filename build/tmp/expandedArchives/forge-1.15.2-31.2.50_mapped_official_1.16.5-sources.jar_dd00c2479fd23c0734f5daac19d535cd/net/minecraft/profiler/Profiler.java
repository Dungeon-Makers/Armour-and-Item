...
public class Profiler implements IResultableProfiler {
   ...
   public Profiler(long p_i225707_1_, IntSupplier p_i225707_3_, boolean p_i225707_4_) {
      this.startTimeNano = p_i225707_1_;
      this.startTimeTicks = p_i225707_3_.getAsInt();
      this.getTickTime = p_i225707_3_;
      this.warn = p_i225707_4_;
   }
   ...
   public IProfileResult getResults() {
      return new FilledProfileResult(this.entries, this.startTimeNano, this.startTimeTicks, Util.getNanos(), this.getTickTime.getAsInt());
   }
