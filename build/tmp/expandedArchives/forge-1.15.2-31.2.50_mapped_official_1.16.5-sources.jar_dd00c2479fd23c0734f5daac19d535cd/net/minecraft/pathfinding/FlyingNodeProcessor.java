...
public class FlyingNodeProcessor extends WalkNodeProcessor {
   ...
   public PathPoint getStart() {
      ...
      BlockPos blockpos1 = new BlockPos(this.mob);
   ...
   public int getNeighbors(PathPoint[] p_222859_1_, PathPoint p_222859_2_) {
      ...
      if (this.isOpen(pathpoint18) && this.hasMalus(pathpoint14) && this.hasMalus(pathpoint9) && this.hasMalus(pathpoint8)) {
         p_222859_1_[i++] = pathpoint18;
      }

      PathPoint pathpoint19 = this.getNode(p_222859_2_.x + 1, p_222859_2_.y + 1, p_222859_2_.z + 1);
      if (this.isOpen(pathpoint19) && this.hasMalus(pathpoint15) && this.hasMalus(pathpoint6) && this.hasMalus(pathpoint8)) {
         p_222859_1_[i++] = pathpoint19;
      }

      PathPoint pathpoint20 = this.getNode(p_222859_2_.x - 1, p_222859_2_.y + 1, p_222859_2_.z - 1);
      if (this.isOpen(pathpoint20) && this.hasMalus(pathpoint16) && this.hasMalus(pathpoint9) && this.hasMalus(pathpoint7)) {
         p_222859_1_[i++] = pathpoint20;
      }

      PathPoint pathpoint21 = this.getNode(p_222859_2_.x - 1, p_222859_2_.y + 1, p_222859_2_.z + 1);
      if (this.isOpen(pathpoint21) && this.hasMalus(pathpoint17) && this.hasMalus(pathpoint6) && this.hasMalus(pathpoint7)) {
         p_222859_1_[i++] = pathpoint21;
      }

      PathPoint pathpoint22 = this.getNode(p_222859_2_.x + 1, p_222859_2_.y - 1, p_222859_2_.z - 1);
      if (this.isOpen(pathpoint22) && this.hasMalus(pathpoint14) && this.hasMalus(pathpoint13) && this.hasMalus(pathpoint12)) {
         p_222859_1_[i++] = pathpoint22;
      }

      PathPoint pathpoint23 = this.getNode(p_222859_2_.x + 1, p_222859_2_.y - 1, p_222859_2_.z + 1);
      if (this.isOpen(pathpoint23) && this.hasMalus(pathpoint15) && this.hasMalus(pathpoint10) && this.hasMalus(pathpoint12)) {
         p_222859_1_[i++] = pathpoint23;
      }

      PathPoint pathpoint24 = this.getNode(p_222859_2_.x - 1, p_222859_2_.y - 1, p_222859_2_.z - 1);
      if (this.isOpen(pathpoint24) && this.hasMalus(pathpoint16) && this.hasMalus(pathpoint13) && this.hasMalus(pathpoint11)) {
         p_222859_1_[i++] = pathpoint24;
      }

      PathPoint pathpoint25 = this.getNode(p_222859_2_.x - 1, p_222859_2_.y - 1, p_222859_2_.z + 1);
      if (this.isOpen(pathpoint25) && this.hasMalus(pathpoint17) && this.hasMalus(pathpoint10) && this.hasMalus(pathpoint11)) {
   ...
   public PathNodeType getBlockPathType(IBlockReader p_186330_1_, int p_186330_2_, int p_186330_3_, int p_186330_4_) {
      PathNodeType pathnodetype = func_189553_b(p_186330_1_, p_186330_2_, p_186330_3_, p_186330_4_);
      if (pathnodetype == PathNodeType.OPEN && p_186330_3_ >= 1) {
         ...
         PathNodeType pathnodetype1 = func_189553_b(p_186330_1_, p_186330_2_, p_186330_3_ - 1, p_186330_4_);
      ...
      if (pathnodetype == PathNodeType.WALKABLE || pathnodetype == PathNodeType.OPEN) {
         pathnodetype = func_193578_a(p_186330_1_, p_186330_2_, p_186330_3_, p_186330_4_, pathnodetype);
      }
