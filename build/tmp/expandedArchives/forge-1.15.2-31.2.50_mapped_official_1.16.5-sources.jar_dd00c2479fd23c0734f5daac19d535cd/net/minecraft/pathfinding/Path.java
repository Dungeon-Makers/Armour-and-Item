...
public class Path {
   ...
   public Vec3d getEntityPosAtNode(Entity p_75881_1_, int p_75881_2_) {
   ...
   public Vec3d getNextEntityPos(Entity p_75878_1_) {
      return this.getEntityPosAtNode(p_75878_1_, this.nextNodeIndex);
   }

   public Vec3d func_186310_f() {
      PathPoint pathpoint = this.nodes.get(this.nextNodeIndex);
