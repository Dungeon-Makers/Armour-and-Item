...
public abstract class LavaFluid extends FlowingFluid {
   ...
   public int getSlopeFindDistance(IWorldReader p_185698_1_) {
      return p_185698_1_.func_201675_m().func_177500_n() ? 4 : 2;
   }

   public BlockState createLegacyBlock(IFluidState p_204527_1_) {
   ...
   public int getDropOff(IWorldReader p_204528_1_) {
      return p_204528_1_.func_201675_m().func_177500_n() ? 1 : 2;
   }

   public boolean canBeReplacedWith(IFluidState p_215665_1_, IBlockReader p_215665_2_, BlockPos p_215665_3_, Fluid p_215665_4_, Direction p_215665_5_) {
      return p_215665_1_.getHeight(p_215665_2_, p_215665_3_) >= 0.44444445F && p_215665_4_.is(FluidTags.WATER);
   }

   public int getTickDelay(IWorldReader p_205569_1_) {
      return p_205569_1_.func_201675_m().func_177495_o() ? 10 : 30;
   }

   public int getSpreadDelay(World p_215667_1_, BlockPos p_215667_2_, IFluidState p_215667_3_, IFluidState p_215667_4_) {
   ...
   protected void spreadTo(IWorld p_205574_1_, BlockPos p_205574_2_, BlockState p_205574_3_, Direction p_205574_4_, IFluidState p_205574_5_) {
      if (p_205574_4_ == Direction.DOWN) {
         ...
         if (this.is(FluidTags.LAVA) && ifluidstate.is(FluidTags.WATER)) {
