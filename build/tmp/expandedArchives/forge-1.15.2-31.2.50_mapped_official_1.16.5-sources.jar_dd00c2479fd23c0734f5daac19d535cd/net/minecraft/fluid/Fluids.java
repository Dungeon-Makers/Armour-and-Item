...
public class Fluids {
   ...
   private static <T extends Fluid> T register(String p_215710_0_, T p_215710_1_) {
      return (T)(Registry.register(Registry.FLUID, p_215710_0_, p_215710_1_));
   }

   static {
      for(Fluid fluid : Registry.FLUID) {
         for(IFluidState ifluidstate : fluid.getStateDefinition().getPossibleStates()) {
            Fluid.FLUID_STATE_REGISTRY.add(ifluidstate);
         }
      }
