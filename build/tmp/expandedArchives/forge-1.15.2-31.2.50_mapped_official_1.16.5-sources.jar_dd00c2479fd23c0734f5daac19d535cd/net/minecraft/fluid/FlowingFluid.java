...
public abstract class FlowingFluid extends Fluid {
   ...
   private final Map<IFluidState, VoxelShape> shapes = Maps.newIdentityHashMap();
   ...
   public Vec3d getFlow(IBlockReader p_215663_1_, BlockPos p_215663_2_, IFluidState p_215663_3_) {
      ...
      try (BlockPos.PooledMutable blockpos$pooledmutable = BlockPos.PooledMutable.func_185346_s()) {
         for(Direction direction : Direction.Plane.HORIZONTAL) {
            blockpos$pooledmutable.set(p_215663_2_).move(direction);
            IFluidState ifluidstate = p_215663_1_.getFluidState(blockpos$pooledmutable);
            if (this.affectsFlow(ifluidstate)) {
               float f = ifluidstate.getOwnHeight();
               float f1 = 0.0F;
               if (f == 0.0F) {
                  if (!p_215663_1_.getBlockState(blockpos$pooledmutable).getMaterial().blocksMotion()) {
                     BlockPos blockpos = blockpos$pooledmutable.below();
                     IFluidState ifluidstate1 = p_215663_1_.getFluidState(blockpos);
                     if (this.affectsFlow(ifluidstate1)) {
                        f = ifluidstate1.getOwnHeight();
                        if (f > 0.0F) {
         ...
         if (p_215663_3_.getValue(FALLING)) {
            for(Direction direction1 : Direction.Plane.HORIZONTAL) {
               blockpos$pooledmutable.set(p_215663_2_).move(direction1);
               if (this.isSolidFace(p_215663_1_, blockpos$pooledmutable, direction1) || this.isSolidFace(p_215663_1_, blockpos$pooledmutable.above(), direction1)) {
   ...
   private boolean affectsFlow(IFluidState p_212189_1_) {
   ...
   protected boolean isSolidFace(IBlockReader p_205573_1_, BlockPos p_205573_2_, Direction p_205573_3_) {
      ...
      if (ifluidstate.getType().isSame(this)) {
         return false;
   ...
   protected void spread(IWorld p_205575_1_, BlockPos p_205575_2_, IFluidState p_205575_3_) {
      if (!p_205575_3_.isEmpty()) {
         ...
         IFluidState ifluidstate = this.getNewLiquid(p_205575_1_, blockpos, blockstate1);
         if (this.canSpreadTo(p_205575_1_, p_205575_2_, blockstate, Direction.DOWN, blockpos, blockstate1, p_205575_1_.getFluidState(blockpos), ifluidstate.getType())) {
            this.spreadTo(p_205575_1_, blockpos, blockstate1, Direction.DOWN, ifluidstate);
            if (this.sourceNeighborCount(p_205575_1_, p_205575_2_) >= 3) {
               this.spreadToSides(p_205575_1_, p_205575_2_, p_205575_3_, blockstate);
            }
         } else if (p_205575_3_.isSource() || !this.isWaterHole(p_205575_1_, ifluidstate.getType(), p_205575_2_, blockstate, blockpos, blockstate1)) {
            this.spreadToSides(p_205575_1_, p_205575_2_, p_205575_3_, blockstate);
         }
   ...
   private void spreadToSides(IWorld p_207937_1_, BlockPos p_207937_2_, IFluidState p_207937_3_, BlockState p_207937_4_) {
      ...
      if (i > 0) {
         Map<Direction, IFluidState> map = this.getSpread(p_207937_1_, p_207937_2_, p_207937_4_);
         ...
         for(Entry<Direction, IFluidState> entry : map.entrySet()) {
            ...
            if (this.canSpreadTo(p_207937_1_, p_207937_2_, p_207937_4_, direction, blockpos, blockstate, p_207937_1_.getFluidState(blockpos), ifluidstate.getType())) {
               this.spreadTo(p_207937_1_, blockpos, blockstate, direction, ifluidstate);
            }
         }
   ...
   protected IFluidState getNewLiquid(IWorldReader p_205576_1_, BlockPos p_205576_2_, BlockState p_205576_3_) {
      int i = 0;
      int j = 0;
      ...
      for(Direction direction : Direction.Plane.HORIZONTAL) {
         ...
         if (ifluidstate.getType().isSame(this) && this.canPassThroughWall(direction, p_205576_1_, p_205576_2_, p_205576_3_, blockpos, blockstate)) {
            if (ifluidstate.isSource()) {
               ++j;
            }

            i = Math.max(i, ifluidstate.getAmount());
         }
      }
      ...
      if (this.canConvertToSource() && j >= 2) {
         ...
         if (blockstate1.getMaterial().isSolid() || this.isSourceBlockOfThisType(ifluidstate1)) {
      ...
      if (!ifluidstate2.isEmpty() && ifluidstate2.getType().isSame(this) && this.canPassThroughWall(Direction.UP, p_205576_1_, p_205576_2_, p_205576_3_, blockpos1, blockstate2)) {
   ...
   public IFluidState getFlowing(int p_207207_1_, boolean p_207207_2_) {
   ...
   public IFluidState getSource(boolean p_207204_1_) {
   ...
   protected void spreadTo(IWorld p_205574_1_, BlockPos p_205574_2_, BlockState p_205574_3_, Direction p_205574_4_, IFluidState p_205574_5_) {
   ...
   protected int getSlopeDistance(IWorldReader p_205571_1_, BlockPos p_205571_2_, int p_205571_3_, Direction p_205571_4_, BlockState p_205571_5_, BlockPos p_205571_6_, Short2ObjectMap<Pair<BlockState, IFluidState>> p_205571_7_, Short2BooleanMap p_205571_8_) {
      int i = 1000;
      ...
      for(Direction direction : Direction.Plane.HORIZONTAL) {
         if (direction != p_205571_4_) {
            ...
            if (this.canPassThrough(p_205571_1_, this.getFlowing(), p_205571_2_, p_205571_5_, direction, blockpos, blockstate, ifluidstate)) {
   ...
   private boolean canPassThrough(IBlockReader p_211760_1_, Fluid p_211760_2_, BlockPos p_211760_3_, BlockState p_211760_4_, Direction p_211760_5_, BlockPos p_211760_6_, BlockState p_211760_7_, IFluidState p_211760_8_) {
   ...
   private boolean isSourceBlockOfThisType(IFluidState p_211758_1_) {
   ...
   private int sourceNeighborCount(IWorldReader p_207936_1_, BlockPos p_207936_2_) {
      ...
      for(Direction direction : Direction.Plane.HORIZONTAL) {
         ...
         if (this.isSourceBlockOfThisType(ifluidstate)) {
            ++i;
         }
      }
   ...
   protected Map<Direction, IFluidState> getSpread(IWorldReader p_205572_1_, BlockPos p_205572_2_, BlockState p_205572_3_) {
      int i = 1000;
      ...
      for(Direction direction : Direction.Plane.HORIZONTAL) {
         ...
         BlockState blockstate = pair.getFirst();
         IFluidState ifluidstate = pair.getSecond();
         IFluidState ifluidstate1 = this.getNewLiquid(p_205572_1_, blockpos, blockstate);
         if (this.canPassThrough(p_205572_1_, ifluidstate1.getType(), p_205572_2_, p_205572_3_, direction, blockpos, blockstate, ifluidstate)) {
            BlockPos blockpos1 = blockpos.below();
   ...
   protected boolean canSpreadTo(IBlockReader p_205570_1_, BlockPos p_205570_2_, BlockState p_205570_3_, Direction p_205570_4_, BlockPos p_205570_5_, BlockState p_205570_6_, IFluidState p_205570_7_, Fluid p_205570_8_) {
   ...
   protected int getSpreadDelay(World p_215667_1_, BlockPos p_215667_2_, IFluidState p_215667_3_, IFluidState p_215667_4_) {
   ...
   public void tick(World p_207191_1_, BlockPos p_207191_2_, IFluidState p_207191_3_) {
      if (!p_207191_3_.isSource()) {
         IFluidState ifluidstate = this.getNewLiquid(p_207191_1_, p_207191_2_, p_207191_1_.getBlockState(p_207191_2_));
         int i = this.getSpreadDelay(p_207191_1_, p_207191_2_, p_207191_3_, ifluidstate);
         if (ifluidstate.isEmpty()) {
            ...
            p_207191_3_ = ifluidstate;
            BlockState blockstate = ifluidstate.createLegacyBlock();
            p_207191_1_.setBlock(p_207191_2_, blockstate, 2);
            p_207191_1_.getLiquidTicks().scheduleTick(p_207191_2_, ifluidstate.getType(), i);
   ...
   protected static int getLegacyLevel(IFluidState p_207205_0_) {
      return p_207205_0_.isSource() ? 0 : 8 - Math.min(p_207205_0_.getAmount(), 8) + (p_207205_0_.getValue(FALLING) ? 8 : 0);
   }

   private static boolean hasSameAbove(IFluidState p_215666_0_, IBlockReader p_215666_1_, BlockPos p_215666_2_) {
      return p_215666_0_.getType().isSame(p_215666_1_.getFluidState(p_215666_2_.above()).getType());
   }

   public float getHeight(IFluidState p_215662_1_, IBlockReader p_215662_2_, BlockPos p_215662_3_) {
      return hasSameAbove(p_215662_1_, p_215662_2_, p_215662_3_) ? 1.0F : p_215662_1_.getOwnHeight();
   }

   public float getOwnHeight(IFluidState p_223407_1_) {
      return (float)p_223407_1_.getAmount() / 9.0F;
   }

   public VoxelShape getShape(IFluidState p_215664_1_, IBlockReader p_215664_2_, BlockPos p_215664_3_) {
