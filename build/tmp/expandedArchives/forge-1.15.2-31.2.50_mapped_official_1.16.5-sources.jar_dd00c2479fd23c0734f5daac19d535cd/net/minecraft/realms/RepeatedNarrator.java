...
public class RepeatedNarrator {
   ...
   public void narrate(String p_narrate_1_) {
      RepeatedNarrator.Parameter repeatednarrator$parameter = this.params.updateAndGet((p_229956_2_) -> {
         return p_229956_2_ != null && p_narrate_1_.equals(p_229956_2_.narration) ? p_229956_2_ : new RepeatedNarrator.Parameter(p_narrate_1_, RateLimiter.create((double)this.permitsPerSecond));
      });
      if (repeatednarrator$parameter.rateLimiter.tryAcquire(1)) {
         ...
         narratorchatlistener.handle(ChatType.SYSTEM, new StringTextComponent(p_narrate_1_));
      }
