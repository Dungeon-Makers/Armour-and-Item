...
public interface IDispenseItemBehavior {
   ...
   static void bootStrap() {
      DispenserBlock.registerBehavior(Items.ARROW, new ProjectileDispenseBehavior() {
         protected IProjectile getProjectile(World p_82499_1_, IPosition p_82499_2_, ItemStack p_82499_3_) {
            ...
            return (new ProjectileDispenseBehavior() {
               protected IProjectile getProjectile(World p_82499_1_, IPosition p_82499_2_, ItemStack p_82499_3_) {
                  return Util.make(new PotionEntity(p_82499_1_, p_82499_2_.x(), p_82499_2_.y(), p_82499_2_.z()), (p_218411_1_) -> {
                     p_218411_1_.func_184541_a(p_82499_3_);
                  });
               }
            ...
            return (new ProjectileDispenseBehavior() {
               protected IProjectile getProjectile(World p_82499_1_, IPosition p_82499_2_, ItemStack p_82499_3_) {
                  return Util.make(new PotionEntity(p_82499_1_, p_82499_2_.x(), p_82499_2_.y(), p_82499_2_.z()), (p_218413_1_) -> {
                     p_218413_1_.func_184541_a(p_82499_3_);
                  });
               }
      ...
      DispenserBlock.registerBehavior(Items.FIREWORK_ROCKET, new DefaultDispenseItemBehavior() {
         public ItemStack execute(IBlockSource p_82487_1_, ItemStack p_82487_2_) {
            ...
            FireworkRocketEntity fireworkrocketentity = new FireworkRocketEntity(p_82487_1_.getLevel(), p_82487_2_, d3, d4, d5, true);
      ...
      DispenserBlock.registerBehavior(Items.LAVA_BUCKET, idispenseitembehavior);
      DispenserBlock.registerBehavior(Items.WATER_BUCKET, idispenseitembehavior);
      DispenserBlock.registerBehavior(Items.SALMON_BUCKET, idispenseitembehavior);
      DispenserBlock.registerBehavior(Items.COD_BUCKET, idispenseitembehavior);
      DispenserBlock.registerBehavior(Items.PUFFERFISH_BUCKET, idispenseitembehavior);
      DispenserBlock.registerBehavior(Items.TROPICAL_FISH_BUCKET, idispenseitembehavior);
      ...
      DispenserBlock.registerBehavior(Items.FLINT_AND_STEEL, new OptionalDispenseBehavior() {
         protected ItemStack execute(IBlockSource p_82487_1_, ItemStack p_82487_2_) {
            ...
            if (this.success && p_82487_2_.hurt(1, world.random, (ServerPlayerEntity)null)) {
      ...
      IDispenseItemBehavior idispenseitembehavior1 = new OptionalDispenseBehavior() {
         protected ItemStack execute(IBlockSource p_82487_1_, ItemStack p_82487_2_) {
            this.success = ArmorItem.dispenseArmor(p_82487_1_, p_82487_2_);
            return p_82487_2_;
         }
      };
      DispenserBlock.registerBehavior(Items.CREEPER_HEAD, idispenseitembehavior1);
      DispenserBlock.registerBehavior(Items.ZOMBIE_HEAD, idispenseitembehavior1);
      DispenserBlock.registerBehavior(Items.DRAGON_HEAD, idispenseitembehavior1);
      DispenserBlock.registerBehavior(Items.SKELETON_SKULL, idispenseitembehavior1);
      DispenserBlock.registerBehavior(Items.PLAYER_HEAD, idispenseitembehavior1);
      ...
      DispenserBlock.registerBehavior(Items.GLASS_BOTTLE.asItem(), new OptionalDispenseBehavior() {
         ...
         public ItemStack execute(IBlockSource p_82487_1_, ItemStack p_82487_2_) {
            ...
            if (block.is(BlockTags.BEEHIVES) && blockstate.getValue(BeehiveBlock.HONEY_LEVEL) >= 5) {
               ((BeehiveBlock)blockstate.getBlock()).releaseBeesAndResetHoneyLevel(iworld.getLevel(), blockstate, blockpos, (PlayerEntity)null, BeehiveTileEntity.State.BEE_RELEASED);
               this.success = true;
               return this.takeLiquid(p_82487_1_, p_82487_2_, new ItemStack(Items.HONEY_BOTTLE));
            } else if (iworld.getFluidState(blockpos).is(FluidTags.WATER)) {
               this.success = true;
      ...
      DispenserBlock.registerBehavior(Items.SHEARS.asItem(), new OptionalDispenseBehavior() {
         ...
         protected ItemStack execute(IBlockSource p_82487_1_, ItemStack p_82487_2_) {
            ...
            if (!world.isClientSide()) {
               ...
               for(net.minecraft.entity.Entity entity : world.getEntities((net.minecraft.entity.Entity)null, new AxisAlignedBB(blockpos), e -> !e.isSpectator() && e instanceof net.minecraftforge.common.IShearable)) {
                  net.minecraftforge.common.IShearable target = (net.minecraftforge.common.IShearable)entity;
                  if (target.isShearable(p_82487_2_, world, blockpos)) {
                     java.util.List<ItemStack> drops = target.onSheared(p_82487_2_, entity.level, blockpos,
                             net.minecraft.enchantment.EnchantmentHelper.getItemEnchantmentLevel(net.minecraft.enchantment.Enchantments.BLOCK_FORTUNE, p_82487_2_));
                     java.util.Random rand = new java.util.Random();
                     drops.forEach(d -> {
                        net.minecraft.entity.item.ItemEntity ent = entity.spawnAtLocation(d, 1.0F);
                        ent.setDeltaMovement(ent.getDeltaMovement().add((double)((rand.nextFloat() - rand.nextFloat()) * 0.1F), (double)(rand.nextFloat() * 0.05F), (double)((rand.nextFloat() - rand.nextFloat()) * 0.1F)));
                     });
                     if (p_82487_2_.hurt(1, world.random, (ServerPlayerEntity)null)) {
                        p_82487_2_.setCount(0);
                     }
               ...
               if (!this.success) {
                  ...
                  if (blockstate.is(BlockTags.BEEHIVES)) {
                     ...
                     if (i >= 5) {
                        ...
                        ((BeehiveBlock)blockstate.getBlock()).releaseBeesAndResetHoneyLevel(world, blockstate, blockpos, (PlayerEntity)null, BeehiveTileEntity.State.BEE_RELEASED);
                        this.success = true;
                     }
                  }
               }
