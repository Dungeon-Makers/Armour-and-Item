...
public class LoomContainer extends Container {
   ...
   public void slotsChanged(IInventory p_75130_1_) {
      ...
      if (itemstack3.isEmpty() || !itemstack.isEmpty() && !itemstack1.isEmpty() && this.selectedBannerPatternIndex.get() > 0 && (this.selectedBannerPatternIndex.get() < BannerPattern.COUNT - 5 || !itemstack2.isEmpty())) {
