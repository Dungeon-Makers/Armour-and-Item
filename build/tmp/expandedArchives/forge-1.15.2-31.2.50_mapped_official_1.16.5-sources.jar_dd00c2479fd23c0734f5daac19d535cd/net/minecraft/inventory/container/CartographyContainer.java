   ...
   public CartographyContainer(int p_i50094_1_, PlayerInventory p_i50094_2_, final IWorldPosCallable p_i50094_3_) {
      ...
      this.addSlot(new Slot(this.resultContainer, 2, 145, 39) {
         ...
         public ItemStack remove(int p_75209_1_) {
            ItemStack itemstack = super.remove(p_75209_1_);
            ItemStack itemstack1 = p_i50094_3_.evaluate((p_216936_2_, p_216936_3_) -> {
               if (!CartographyContainer.this.field_217000_e && CartographyContainer.this.container.getItem(1).getItem() == Items.GLASS_PANE) {
                  ItemStack itemstack2 = FilledMapItem.lockMap(p_216936_2_, CartographyContainer.this.container.getItem(0));
                  if (itemstack2 != null) {
            ...
            CartographyContainer.this.container.removeItem(0, 1);
            CartographyContainer.this.container.removeItem(1, 1);
            return itemstack1;
         }

         protected void onQuickCraft(ItemStack p_75210_1_, int p_75210_2_) {
            this.remove(p_75210_2_);
            super.onQuickCraft(p_75210_1_, p_75210_2_);
         }

         public ItemStack onTake(PlayerEntity p_190901_1_, ItemStack p_190901_2_) {
            p_190901_2_.getItem().onCraftedBy(p_190901_2_, p_190901_1_.level, p_190901_1_);
            p_i50094_3_.execute((p_216935_1_, p_216935_2_) -> {
      ...
      if (slot != null && slot.hasItem()) {
         ...
         if (p_82846_2_ == 2) {
            if (this.container.getItem(1).getItem() == Items.GLASS_PANE) {
               itemstack2 = this.access.evaluate((p_216997_2_, p_216997_3_) -> {
                  ItemStack itemstack3 = FilledMapItem.lockMap(p_216997_2_, this.container.getItem(0));
                  if (itemstack3 != null) {
            ...
            item.onCraftedBy(itemstack2, p_82846_1_.level, p_82846_1_);
         ...
         slot.onTake(p_82846_1_, itemstack2);
