...
public class EnchantmentContainer extends Container {
   ...
   public EnchantmentContainer(int p_i50086_1_, PlayerInventory p_i50086_2_, IWorldPosCallable p_i50086_3_) {
      ...
      this.addSlot(new Slot(this.enchantSlots, 1, 35, 47) {
         public boolean mayPlace(ItemStack p_75214_1_) {
            return net.minecraftforge.common.Tags.Items.GEMS_LAPIS.func_199685_a_(p_75214_1_.getItem());
         }
      });
      ...
      if (slot != null && slot.hasItem()) {
         ...
         if (p_82846_2_ == 0) {
            ...
            if (itemstack1.hasTag()) { // Forge: Fix MC-17431
               ((Slot)this.slots.get(0)).set(itemstack1.split(1));
            } else if (!itemstack1.isEmpty()) {
               this.slots.get(0).set(new ItemStack(itemstack1.getItem()));
               itemstack1.shrink(1);
            }
         }
