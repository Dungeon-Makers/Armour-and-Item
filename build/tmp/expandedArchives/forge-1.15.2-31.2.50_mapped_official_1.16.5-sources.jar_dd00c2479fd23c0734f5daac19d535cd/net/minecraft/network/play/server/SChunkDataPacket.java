...
public class SChunkDataPacket implements IPacket<IClientPlayNetHandler> {
   ...
   public SChunkDataPacket(Chunk p_i47124_1_, int p_i47124_2_) {
      ChunkPos chunkpos = p_i47124_1_.getPos();
      this.x = chunkpos.x;
      this.z = chunkpos.z;
      this.fullChunk = p_i47124_2_ == 65535;
      this.heightmaps = new CompoundNBT();

      for(Entry<Heightmap.Type, Heightmap> entry : p_i47124_1_.getHeightmaps()) {
      ...
      if (this.fullChunk) {
         this.biomes = p_i47124_1_.getBiomes().func_227057_b_();
      }

      this.buffer = new byte[this.calculateChunkSize(p_i47124_1_, p_i47124_2_)];
      this.availableSections = this.extractChunkData(new PacketBuffer(this.getWriteBuffer()), p_i47124_1_, p_i47124_2_);
      this.blockEntitiesTags = Lists.newArrayList();

      for(Entry<BlockPos, TileEntity> entry1 : p_i47124_1_.getBlockEntities().entrySet()) {
   ...
   public void read(PacketBuffer p_148837_1_) throws IOException {
      ...
      if (this.fullChunk) {
         this.biomes = new BiomeContainer(p_148837_1_);
      }
   ...
   public void write(PacketBuffer p_148840_1_) throws IOException {
      ...
      if (this.biomes != null) {
         this.biomes.func_227056_a_(p_148840_1_);
      }
   ...
   public BiomeContainer func_229739_i_() {
      return this.biomes == null ? null : this.biomes.func_227057_b_();
   }
}