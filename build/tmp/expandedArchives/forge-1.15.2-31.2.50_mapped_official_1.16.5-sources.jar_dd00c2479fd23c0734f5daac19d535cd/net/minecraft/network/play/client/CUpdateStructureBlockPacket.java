...
public class CUpdateStructureBlockPacket implements IPacket<IServerPlayNetHandler> {
   ...
   public void read(PacketBuffer p_148837_1_) throws IOException {
      ...
      this.offset = new BlockPos(MathHelper.clamp(p_148837_1_.readByte(), -32, 32), MathHelper.clamp(p_148837_1_.readByte(), -32, 32), MathHelper.clamp(p_148837_1_.readByte(), -32, 32));
