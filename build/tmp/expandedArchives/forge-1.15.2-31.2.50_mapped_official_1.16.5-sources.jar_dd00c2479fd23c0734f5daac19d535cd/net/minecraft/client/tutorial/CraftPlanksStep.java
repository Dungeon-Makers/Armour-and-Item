...
public class CraftPlanksStep implements ITutorialStep {
   ...
   public void onGetItem(ItemStack p_193252_1_) {
      ...
      if (ItemTags.PLANKS.func_199685_a_(item)) {
         this.tutorial.setStep(TutorialSteps.NONE);
      }

   }

   public static boolean hasCraftedPlanksPreviously(ClientPlayerEntity p_199761_0_, Tag<Item> p_199761_1_) {
      for(Item item : p_199761_1_.func_199885_a()) {
