...
public class PlayerController {
   ...
   private final Object2ObjectLinkedOpenHashMap<Pair<BlockPos, CPlayerDiggingPacket.Action>, PosAndRotation> unAckedActions = new Object2ObjectLinkedOpenHashMap<>();
   ...
   public static void func_178891_a(Minecraft p_178891_0_, PlayerController p_178891_1_, BlockPos p_178891_2_, Direction p_178891_3_) {
      if (!p_178891_0_.level.func_175719_a(p_178891_0_.player, p_178891_2_, p_178891_3_)) {
         p_178891_1_.destroyBlock(p_178891_2_);
      }
      ...
      if (this.minecraft.player.blockActionRestricted(this.minecraft.level, p_187103_1_, this.localPlayerMode)) {
         ...
         if (!this.minecraft.player.getMainHandItem().getItem().canAttackBlock(blockstate, world, p_187103_1_, this.minecraft.player)) {
            ...
            if ((block instanceof CommandBlockBlock || block instanceof StructureBlock || block instanceof JigsawBlock) && !this.minecraft.player.canUseGameMasterBlocks()) {
               ...
               boolean flag = blockstate.removedByPlayer(world, p_187103_1_, minecraft.player, false, ifluidstate);
               if (flag) {
   ...
   public boolean startDestroyBlock(BlockPos p_180511_1_, Direction p_180511_2_) {
      if (this.minecraft.player.blockActionRestricted(this.minecraft.level, p_180511_1_, this.localPlayerMode)) {
         ...
         if (this.localPlayerMode.isCreative()) {
            ...
            func_178891_a(this.minecraft, this, p_180511_1_, p_180511_2_);
            this.destroyDelay = 5;
   ...
   public boolean continueDestroyBlock(BlockPos p_180512_1_, Direction p_180512_2_) {
      ...
      if (this.destroyDelay > 0) {
         ...
         func_178891_a(this.minecraft, this, p_180512_1_, p_180512_2_);
         return true;
   ...
   public float getPickRange() {
      float attrib = (float)minecraft.player.getAttribute(PlayerEntity.REACH_DISTANCE).getValue();
   ...
   public ActionResultType useItemOn(ClientPlayerEntity p_217292_1_, ClientWorld p_217292_2_, Hand p_217292_3_, BlockRayTraceResult p_217292_4_) {
      ...
      if (!this.minecraft.level.getWorldBorder().isWithinBounds(blockpos)) {
         ...
         net.minecraftforge.event.entity.player.PlayerInteractEvent.RightClickBlock event = net.minecraftforge.common.ForgeHooks
                 .onRightClickBlock(p_217292_1_, p_217292_3_, blockpos, p_217292_4_.getDirection());
         if (event.isCanceled()) {
   ...
   public ClientPlayerEntity createPlayer(ClientWorld p_199681_1_, StatisticsManager p_199681_2_, ClientRecipeBook p_199681_3_) {
      return new ClientPlayerEntity(this.minecraft, p_199681_1_, this.connection, p_199681_2_, p_199681_3_);
   }

   public void attack(PlayerEntity p_78764_1_, Entity p_78764_2_) {
      this.ensureHasSentCarriedItem();
      this.connection.send(new CUseEntityPacket(p_78764_2_));
      if (this.localPlayerMode != GameType.SPECTATOR) {
   ...
   public ActionResultType interact(PlayerEntity p_187097_1_, Entity p_187097_2_, Hand p_187097_3_) {
      this.ensureHasSentCarriedItem();
      this.connection.send(new CUseEntityPacket(p_187097_2_, p_187097_3_));
   ...
   public ActionResultType interactAt(PlayerEntity p_187102_1_, Entity p_187102_2_, EntityRayTraceResult p_187102_3_, Hand p_187102_4_) {
      this.ensureHasSentCarriedItem();
      Vec3d vec3d = p_187102_3_.getLocation().subtract(p_187102_2_.getX(), p_187102_2_.getY(), p_187102_2_.getZ());
      this.connection.send(new CUseEntityPacket(p_187102_2_, p_187102_4_, vec3d));
      if (this.localPlayerMode == GameType.SPECTATOR) return ActionResultType.PASS; // don't fire for spectators to match non-specific EntityInteract
      ...
      if(cancelResult != null) return cancelResult;
      return this.localPlayerMode == GameType.SPECTATOR ? ActionResultType.PASS : p_187102_2_.interactAt(p_187102_1_, vec3d, p_187102_4_);
   }
   ...
   private void sendBlockAction(CPlayerDiggingPacket.Action p_225324_1_, BlockPos p_225324_2_, Direction p_225324_3_) {
      ...
      this.unAckedActions.put(Pair.of(p_225324_2_, p_225324_1_), new PosAndRotation(clientplayerentity.position(), clientplayerentity.xRot, clientplayerentity.yRot));
   ...
   public void handleBlockBreakAck(ClientWorld p_225323_1_, BlockPos p_225323_2_, BlockState p_225323_3_, CPlayerDiggingPacket.Action p_225323_4_, boolean p_225323_5_) {
      PosAndRotation posandrotation = this.unAckedActions.remove(Pair.of(p_225323_2_, p_225323_4_));
      if (posandrotation == null || !p_225323_5_ || p_225323_4_ != CPlayerDiggingPacket.Action.START_DESTROY_BLOCK && p_225323_1_.getBlockState(p_225323_2_) != p_225323_3_) {
         ...
         if (posandrotation != null) {
            ...
            this.minecraft.player.absMoveTo(vec3d.x, vec3d.y, vec3d.z, posandrotation.func_224785_c(), posandrotation.func_224784_b());
         }
      }
