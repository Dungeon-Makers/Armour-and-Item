...
public class ClientChunkProvider extends AbstractChunkProvider {
   ...
   public ClientChunkProvider(ClientWorld p_i51057_1_, int p_i51057_2_) {
      ...
      this.lightEngine = new WorldLightManager(this, true, p_i51057_1_.func_201675_m().func_191066_m());
   ...
   @Nullable
   public Chunk replaceWithPacketData(int p_228313_1_, int p_228313_2_, @Nullable BiomeContainer p_228313_3_, PacketBuffer p_228313_4_, CompoundNBT p_228313_5_, int p_228313_6_) {
      if (!this.storage.inRange(p_228313_1_, p_228313_2_)) {
         ...
         if (!isValidChunk(chunk, p_228313_1_, p_228313_2_)) {
            if (p_228313_3_ == null) {
