...
public class SimpleSound extends LocatableSound {
   ...
   public static SimpleSound forUI(SoundEvent p_194007_0_, float p_194007_1_, float p_194007_2_) {
      return new SimpleSound(p_194007_0_.getLocation(), SoundCategory.MASTER, p_194007_2_, p_194007_1_, false, 0, ISound.AttenuationType.NONE, 0.0F, 0.0F, 0.0F, true);
   }

   public static SimpleSound forMusic(SoundEvent p_184370_0_) {
      return new SimpleSound(p_184370_0_.getLocation(), SoundCategory.MUSIC, 1.0F, 1.0F, false, 0, ISound.AttenuationType.NONE, 0.0F, 0.0F, 0.0F, true);
   }

   public static SimpleSound forRecord(SoundEvent p_184372_0_, float p_184372_1_, float p_184372_2_, float p_184372_3_) {
   ...
   private SimpleSound(SoundEvent p_i46529_1_, SoundCategory p_i46529_2_, float p_i46529_3_, float p_i46529_4_, boolean p_i46529_5_, int p_i46529_6_, ISound.AttenuationType p_i46529_7_, float p_i46529_8_, float p_i46529_9_, float p_i46529_10_) {
      this(p_i46529_1_.getLocation(), p_i46529_2_, p_i46529_3_, p_i46529_4_, p_i46529_5_, p_i46529_6_, p_i46529_7_, p_i46529_8_, p_i46529_9_, p_i46529_10_, false);
   }
   ...
   public SimpleSound(ResourceLocation p_i50897_1_, SoundCategory p_i50897_2_, float p_i50897_3_, float p_i50897_4_, boolean p_i50897_5_, int p_i50897_6_, ISound.AttenuationType p_i50897_7_, float p_i50897_8_, float p_i50897_9_, float p_i50897_10_, boolean p_i50897_11_) {
      ...
      this.y = p_i50897_9_;
      this.z = p_i50897_10_;
      this.looping = p_i50897_5_;
      this.delay = p_i50897_6_;
      this.attenuation = p_i50897_7_;
      this.relative = p_i50897_11_;
   }
}