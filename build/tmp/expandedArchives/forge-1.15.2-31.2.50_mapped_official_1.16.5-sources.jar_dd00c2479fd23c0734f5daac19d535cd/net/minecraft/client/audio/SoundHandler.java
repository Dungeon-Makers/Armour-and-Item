...
public class SoundHandler extends ReloadListener<SoundHandler.Loader> {
         ...
         try {
            for(IResource iresource : p_212854_1_.getResources(new ResourceLocation(s, "sounds.json"))) {
               ...
               try {
                  ...
                  Map<String, SoundList> map = func_175085_a(iresource.getInputStream());
   ...
   @Nullable
   protected static Map<String, SoundList> func_175085_a(InputStream p_175085_0_) {
      Map map;
      try {
         map = JSONUtils.func_193841_a(GSON, new InputStreamReader(p_175085_0_, StandardCharsets.UTF_8), SOUND_EVENT_REGISTRATION_TYPE);
      } finally {
