...
public class RedstoneParticle extends SpriteTexturedParticle {
   ...
   private RedstoneParticle(World p_i51039_1_, double p_i51039_2_, double p_i51039_4_, double p_i51039_6_, double p_i51039_8_, double p_i51039_10_, double p_i51039_12_, RedstoneParticleData p_i51039_14_, IAnimatedSprite p_i51039_15_) {
      ...
      this.sprites = p_i51039_15_;
      this.xd *= (double)0.1F;
      this.yd *= (double)0.1F;
      this.zd *= (double)0.1F;
      float f = (float)Math.random() * 0.4F + 0.6F;
      this.rCol = ((float)(Math.random() * (double)0.2F) + 0.8F) * p_i51039_14_.getR() * f;
      this.gCol = ((float)(Math.random() * (double)0.2F) + 0.8F) * p_i51039_14_.getG() * f;
      this.bCol = ((float)(Math.random() * (double)0.2F) + 0.8F) * p_i51039_14_.getB() * f;
      this.quadSize *= 0.75F * p_i51039_14_.getScale();
      int i = (int)(8.0D / (Math.random() * 0.8D + 0.2D));
      this.lifetime = (int)Math.max((float)i * p_i51039_14_.getScale(), 1.0F);
      this.setSpriteFromAge(p_i51039_15_);
   }
   ...
   public static class Factory implements IParticleFactory<RedstoneParticleData> {
      ...
      public Particle createParticle(RedstoneParticleData p_199234_1_, World p_199234_2_, double p_199234_3_, double p_199234_5_, double p_199234_7_, double p_199234_9_, double p_199234_11_, double p_199234_13_) {
