...
public class ParticleManager implements IFutureReloadListener {
   ...
   public ParticleManager(World p_i1220_1_, TextureManager p_i1220_2_) {
      p_i1220_2_.register(this.textureAtlas.location(), this.textureAtlas);
      this.level = p_i1220_1_;
      this.textureManager = p_i1220_2_;
   ...
   private void registerProviders() {
      ...
      this.register(ParticleTypes.UNDERWATER, UnderwaterParticle.Factory::new);
   ...
   public void setLevel(@Nullable World p_78870_1_) {
