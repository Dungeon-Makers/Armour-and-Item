...
public class EnchantmentTableParticle extends SpriteTexturedParticle {
   ...
   private EnchantmentTableParticle(World p_i1204_1_, double p_i1204_2_, double p_i1204_4_, double p_i1204_6_, double p_i1204_8_, double p_i1204_10_, double p_i1204_12_) {
      ...
      this.yd = p_i1204_10_;
      this.zd = p_i1204_12_;
      this.xStart = p_i1204_2_;
      this.yStart = p_i1204_4_;
      this.zStart = p_i1204_6_;
      this.xo = p_i1204_2_ + p_i1204_8_;
      this.yo = p_i1204_4_ + p_i1204_10_;
      this.zo = p_i1204_6_ + p_i1204_12_;
      this.x = this.xo;
      this.y = this.yo;
      this.z = this.zo;
