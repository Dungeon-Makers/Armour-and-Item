...
public abstract class Particle {
   ...
   protected Particle(World p_i46352_1_, double p_i46352_2_, double p_i46352_4_, double p_i46352_6_) {
      this.level = p_i46352_1_;
      this.setSize(0.2F, 0.2F);
      this.setPos(p_i46352_2_, p_i46352_4_, p_i46352_6_);
      this.xo = p_i46352_2_;
      this.yo = p_i46352_4_;
      this.zo = p_i46352_6_;
   ...
   public Particle(World p_i1219_1_, double p_i1219_2_, double p_i1219_4_, double p_i1219_6_, double p_i1219_8_, double p_i1219_10_, double p_i1219_12_) {
      ...
      this.xd = p_i1219_8_ + (Math.random() * 2.0D - 1.0D) * (double)0.4F;
      this.yd = p_i1219_10_ + (Math.random() * 2.0D - 1.0D) * (double)0.4F;
      this.zd = p_i1219_12_ + (Math.random() * 2.0D - 1.0D) * (double)0.4F;
   ...
   public void move(double p_187110_1_, double p_187110_3_, double p_187110_5_) {
      if (!this.stoppedByCollision) {
         ...
         if (this.hasPhysics && (p_187110_1_ != 0.0D || p_187110_3_ != 0.0D || p_187110_5_ != 0.0D)) {
            Vec3d vec3d = Entity.collideBoundingBoxHeuristically((Entity)null, new Vec3d(p_187110_1_, p_187110_3_, p_187110_5_), this.getBoundingBox(), this.level, ISelectionContext.empty(), new ReuseableStream<>(Stream.empty()));
            p_187110_1_ = vec3d.x;
            p_187110_3_ = vec3d.y;
            p_187110_5_ = vec3d.z;
         }
