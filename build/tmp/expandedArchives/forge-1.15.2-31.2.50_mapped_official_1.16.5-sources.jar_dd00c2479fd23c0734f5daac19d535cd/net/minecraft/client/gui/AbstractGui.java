...
public abstract class AbstractGui {
   ...
   public static void fill(Matrix4f p_fill_0_, int p_fill_1_, int p_fill_2_, int p_fill_3_, int p_fill_4_, int p_fill_5_) {
      ...
      bufferbuilder.vertex(p_fill_0_, (float)p_fill_1_, (float)p_fill_4_, 0.0F).color(f, f1, f2, f3).endVertex();
      bufferbuilder.vertex(p_fill_0_, (float)p_fill_3_, (float)p_fill_4_, 0.0F).color(f, f1, f2, f3).endVertex();
      bufferbuilder.vertex(p_fill_0_, (float)p_fill_3_, (float)p_fill_2_, 0.0F).color(f, f1, f2, f3).endVertex();
      bufferbuilder.vertex(p_fill_0_, (float)p_fill_1_, (float)p_fill_2_, 0.0F).color(f, f1, f2, f3).endVertex();
      bufferbuilder.end();
   ...
   protected void fillGradient(int p_fillGradient_1_, int p_fillGradient_2_, int p_fillGradient_3_, int p_fillGradient_4_, int p_fillGradient_5_, int p_fillGradient_6_) {
      ...
      bufferbuilder.begin(7, DefaultVertexFormats.POSITION_COLOR);
      bufferbuilder.vertex((double)p_fillGradient_3_, (double)p_fillGradient_2_, (double)this.blitOffset).color(f1, f2, f3, f).endVertex();
      bufferbuilder.vertex((double)p_fillGradient_1_, (double)p_fillGradient_2_, (double)this.blitOffset).color(f1, f2, f3, f).endVertex();
      bufferbuilder.vertex((double)p_fillGradient_1_, (double)p_fillGradient_4_, (double)this.blitOffset).color(f5, f6, f7, f4).endVertex();
      bufferbuilder.vertex((double)p_fillGradient_3_, (double)p_fillGradient_4_, (double)this.blitOffset).color(f5, f6, f7, f4).endVertex();
      tessellator.end();
   ...
   public void drawCenteredString(FontRenderer p_drawCenteredString_1_, String p_drawCenteredString_2_, int p_drawCenteredString_3_, int p_drawCenteredString_4_, int p_drawCenteredString_5_) {
      p_drawCenteredString_1_.func_175063_a(p_drawCenteredString_2_, (float)(p_drawCenteredString_3_ - p_drawCenteredString_1_.width(p_drawCenteredString_2_) / 2), (float)p_drawCenteredString_4_, p_drawCenteredString_5_);
   }
   ...
   public void drawRightAlignedString(FontRenderer p_drawRightAlignedString_1_, String p_drawRightAlignedString_2_, int p_drawRightAlignedString_3_, int p_drawRightAlignedString_4_, int p_drawRightAlignedString_5_) {
      p_drawRightAlignedString_1_.func_175063_a(p_drawRightAlignedString_2_, (float)(p_drawRightAlignedString_3_ - p_drawRightAlignedString_1_.width(p_drawRightAlignedString_2_)), (float)p_drawRightAlignedString_4_, p_drawRightAlignedString_5_);
   }
   ...
   public void drawString(FontRenderer p_drawString_1_, String p_drawString_2_, int p_drawString_3_, int p_drawString_4_, int p_drawString_5_) {
      p_drawString_1_.func_175063_a(p_drawString_2_, (float)p_drawString_3_, (float)p_drawString_4_, p_drawString_5_);
   }
   ...
   public static void blit(int p_blit_0_, int p_blit_1_, int p_blit_2_, int p_blit_3_, int p_blit_4_, TextureAtlasSprite p_blit_5_) {
      innerBlit(p_blit_0_, p_blit_0_ + p_blit_3_, p_blit_1_, p_blit_1_ + p_blit_4_, p_blit_2_, p_blit_5_.getU0(), p_blit_5_.getU1(), p_blit_5_.getV0(), p_blit_5_.getV1());
   }
   ...
   protected static void innerBlit(int p_innerBlit_0_, int p_innerBlit_1_, int p_innerBlit_2_, int p_innerBlit_3_, int p_innerBlit_4_, float p_innerBlit_5_, float p_innerBlit_6_, float p_innerBlit_7_, float p_innerBlit_8_) {
      ...
      bufferbuilder.vertex((double)p_innerBlit_0_, (double)p_innerBlit_3_, (double)p_innerBlit_4_).uv(p_innerBlit_5_, p_innerBlit_8_).endVertex();
      bufferbuilder.vertex((double)p_innerBlit_1_, (double)p_innerBlit_3_, (double)p_innerBlit_4_).uv(p_innerBlit_6_, p_innerBlit_8_).endVertex();
      bufferbuilder.vertex((double)p_innerBlit_1_, (double)p_innerBlit_2_, (double)p_innerBlit_4_).uv(p_innerBlit_6_, p_innerBlit_7_).endVertex();
      bufferbuilder.vertex((double)p_innerBlit_0_, (double)p_innerBlit_2_, (double)p_innerBlit_4_).uv(p_innerBlit_5_, p_innerBlit_7_).endVertex();
      bufferbuilder.end();
      RenderSystem.enableAlphaTest();
      WorldVertexBufferUploader.end(bufferbuilder);
   }
