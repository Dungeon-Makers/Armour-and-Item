...
public class TrueTypeGlyphProvider implements IGlyphProvider {
   ...
   public TrueTypeGlyphProvider(ByteBuffer p_i230051_1_, STBTTFontinfo p_i230051_2_, float p_i230051_3_, float p_i230051_4_, float p_i230051_5_, float p_i230051_6_, String p_i230051_7_) {
      ...
      p_i230051_7_.chars().forEach((p_211614_1_) -> {
         this.skip.add((char)(p_211614_1_ & '\uffff'));
      });
   ...
   @Nullable
   public TrueTypeGlyphProvider.GlpyhInfo getGlyph(char p_212248_1_) {
         ...
         try (MemoryStack memorystack = MemoryStack.stackPush()) {
            ...
            if (i != 0) {
               ...
               if (k != 0 && j != 0) {
                  ...
                  TrueTypeGlyphProvider.GlpyhInfo truetypeglyphprovider$glpyhinfo = new TrueTypeGlyphProvider.GlpyhInfo(intbuffer.get(0), intbuffer2.get(0), -intbuffer1.get(0), -intbuffer3.get(0), (float)intbuffer5.get(0) * this.pointScale, (float)intbuffer4.get(0) * this.pointScale, i);
