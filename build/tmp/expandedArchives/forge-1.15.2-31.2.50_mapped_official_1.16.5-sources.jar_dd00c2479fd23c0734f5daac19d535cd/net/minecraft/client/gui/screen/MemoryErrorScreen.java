...
public class MemoryErrorScreen extends Screen {
   ...
   protected void init() {
      this.addButton(new Button(this.width / 2 - 155, this.height / 4 + 120 + 12, 150, 20, I18n.get("gui.toTitle"), (p_213048_1_) -> {
         this.minecraft.setScreen(new MainMenuScreen());
      }));
      this.addButton(new Button(this.width / 2 - 155 + 160, this.height / 4 + 120 + 12, 150, 20, I18n.get("menu.quit"), (p_213047_1_) -> {
         this.minecraft.stop();
      }));
   }
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      ...
      this.drawCenteredString(this.font, this.title.func_150254_d(), this.width / 2, this.height / 4 - 60 + 20, 16777215);
