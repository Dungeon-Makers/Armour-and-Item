...
public class UnicodeTextureGlyphProvider implements IGlyphProvider {
   ...
   private ResourceLocation func_211623_c(char p_211623_1_) {
      ResourceLocation resourcelocation = new ResourceLocation(String.format(this.texturePattern, String.format("%02x", p_211623_1_ / 256)));
   ...
   public IGlyphInfo getGlyph(char p_212248_1_) {
      ...
      if (b0 != 0) {
         NativeImage nativeimage = this.textures.computeIfAbsent(this.func_211623_c(p_212248_1_), this::loadTexture);
         if (nativeimage != null) {
            int i = getLeft(b0);
   ...
   public static class Factory implements IGlyphProviderFactory {
      ...
      public IGlyphProvider create(IResourceManager p_211246_1_) {
         try (IResource iresource = Minecraft.getInstance().getResourceManager().getResource(this.metadata)) {
            ...
            UnicodeTextureGlyphProvider unicodetextureglyphprovider = new UnicodeTextureGlyphProvider(p_211246_1_, abyte, this.texturePattern);
