...
public class EditMinecartCommandBlockScreen extends AbstractCommandBlockScreen {
   ...
   protected void populateAndSendPacket(CommandBlockLogic p_195235_1_) {
      if (p_195235_1_ instanceof MinecartCommandBlockEntity.MinecartCommandLogic) {
         ...
         this.minecraft.getConnection().send(new CUpdateMinecartCommandBlockPacket(minecartcommandblockentity$minecartcommandlogic.getMinecart().getId(), this.commandEdit.getValue(), p_195235_1_.isTrackOutput()));
      }
