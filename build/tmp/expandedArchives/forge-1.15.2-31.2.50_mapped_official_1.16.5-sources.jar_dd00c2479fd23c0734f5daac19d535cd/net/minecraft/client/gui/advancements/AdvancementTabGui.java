...
public class AdvancementTabGui extends AbstractGui {
   ...
   public AdvancementTabGui(Minecraft p_i47589_1_, AdvancementsScreen p_i47589_2_, AdvancementTabType p_i47589_3_, int p_i47589_4_, Advancement p_i47589_5_, DisplayInfo p_i47589_6_) {
      ...
      this.title = p_i47589_6_.getTitle().func_150254_d();
   ...
   public void func_191798_a(int p_191798_1_, int p_191798_2_, boolean p_191798_3_) {
      this.type.func_192651_a(this, p_191798_1_, p_191798_2_, p_191798_3_, this.index);
   }
   ...
   public void func_191799_a() {
      ...
      this.root.func_191819_a(i, j, true);
      this.root.func_191819_a(i, j, false);
      this.root.func_191817_b(i, j);
      RenderSystem.depthFunc(518);
      RenderSystem.translatef(0.0F, 0.0F, -950.0F);
      RenderSystem.colorMask(false, false, false, false);
      fill(4680, 2260, -4680, -2260, -16777216);
      ...
      if (p_192991_1_ > 0 && p_192991_1_ < 234 && p_192991_2_ > 0 && p_192991_2_ < 113) {
         for(AdvancementEntryGui advancemententrygui : this.widgets.values()) {
            if (advancemententrygui.isMouseOver(i, j, p_192991_1_, p_192991_2_)) {
               flag = true;
               advancemententrygui.func_191821_a(i, j, this.fade, p_192991_3_, p_192991_4_);
               break;
            }
         }
      }
