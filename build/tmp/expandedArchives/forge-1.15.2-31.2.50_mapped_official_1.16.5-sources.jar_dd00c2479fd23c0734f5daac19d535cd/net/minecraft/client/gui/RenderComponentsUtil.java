...
public class RenderComponentsUtil {
   public static String func_178909_a(String p_178909_0_, boolean p_178909_1_) {
      return !p_178909_1_ && !Minecraft.getInstance().options.chatColors ? TextFormatting.stripFormatting(p_178909_0_) : p_178909_0_;
   }
   ...
   public static List<ITextComponent> func_178908_a(ITextComponent p_178908_0_, int p_178908_1_, FontRenderer p_178908_2_, boolean p_178908_3_, boolean p_178908_4_) {
      ...
      for(int j = 0; j < list1.size(); ++j) {
         ...
         String s = itextcomponent1.getContents();
         boolean flag = false;
         if (s.contains("\n")) {
            int k = s.indexOf(10);
            String s1 = s.substring(k + 1);
            s = s.substring(0, k + 1);
            ITextComponent itextcomponent2 = (new StringTextComponent(s1)).func_150255_a(itextcomponent1.getStyle().func_150232_l());
            list1.add(j + 1, itextcomponent2);
            flag = true;
         }

         String s4 = func_178909_a(itextcomponent1.getStyle().func_150218_j() + s, p_178908_4_);
         String s5 = s4.endsWith("\n") ? s4.substring(0, s4.length() - 1) : s4;
         int i1 = p_178908_2_.width(s5);
         ITextComponent itextcomponent3 = (new StringTextComponent(s5)).func_150255_a(itextcomponent1.getStyle().func_150232_l());
         if (i + i1 > p_178908_1_) {
            ...
            if (s3 != null && !s3.isEmpty()) {
               ...
               ITextComponent itextcomponent4 = (new StringTextComponent(s3)).func_150255_a(itextcomponent1.getStyle().func_150232_l());
               list1.add(j + 1, itextcomponent4);
            }

            i1 = p_178908_2_.width(s2);
            itextcomponent3 = new StringTextComponent(s2);
            itextcomponent3.func_150255_a(itextcomponent1.getStyle().func_150232_l());
            flag = true;
         }

         if (i + i1 <= p_178908_1_) {
            i += i1;
            itextcomponent.func_150257_a(itextcomponent3);
         } else {
            flag = true;
         }
