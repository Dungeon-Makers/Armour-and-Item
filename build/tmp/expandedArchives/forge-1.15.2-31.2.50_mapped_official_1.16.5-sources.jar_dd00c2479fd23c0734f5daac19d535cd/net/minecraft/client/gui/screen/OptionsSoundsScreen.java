...
public class OptionsSoundsScreen extends SettingsScreen {
   ...
   protected void init() {
      ...
      ++i;
      this.addButton(new OptionButton(j, k + 24 * (i >> 1), 150, 20, AbstractOption.SHOW_SUBTITLES, AbstractOption.SHOW_SUBTITLES.func_216743_c(this.options), (p_213105_1_) -> {
         AbstractOption.SHOW_SUBTITLES.toggle(this.minecraft.options);
         p_213105_1_.setMessage(AbstractOption.SHOW_SUBTITLES.func_216743_c(this.minecraft.options));
         this.minecraft.options.save();
      }));
      this.addButton(new Button(this.width / 2 - 100, this.height / 6 + 168, 200, 20, I18n.get("gui.done"), (p_213104_1_) -> {
