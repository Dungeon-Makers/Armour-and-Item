         ...
         for(MapDecoration mapdecoration : this.data.decorations.values()) {
            if (!p_228089_3_ || mapdecoration.renderOnFrame()) {
               ...
               if (mapdecoration.getName() != null) {
                  ...
                  String s = mapdecoration.getName().func_150254_d();
                  float f6 = (float)fontrenderer.width(s);
                  ...
                  fontrenderer.drawInBatch(s, 0.0F, 0.0F, -1, false, p_228089_1_.last().pose(), p_228089_2_, false, Integer.MIN_VALUE, p_228089_4_);
                  p_228089_1_.popPose();
               }
