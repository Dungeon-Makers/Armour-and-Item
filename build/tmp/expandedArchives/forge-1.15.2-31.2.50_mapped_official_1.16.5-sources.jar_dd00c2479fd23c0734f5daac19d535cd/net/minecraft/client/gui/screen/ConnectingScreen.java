...
public class ConnectingScreen extends Screen {
         ...
         public void run() {
            ...
            try {
               ...
               ConnectingScreen.this.minecraft.execute(() -> {
                  ConnectingScreen.this.minecraft.setScreen(new DisconnectedScreen(ConnectingScreen.this.parent, "connect.failed", new TranslationTextComponent("disconnect.genericReason", "Unknown host")));
               });
               ...
               ConnectingScreen.this.minecraft.execute(() -> {
                  ConnectingScreen.this.minecraft.setScreen(new DisconnectedScreen(ConnectingScreen.this.parent, "connect.failed", new TranslationTextComponent("disconnect.genericReason", s)));
               });
            }
   ...
   protected void init() {
      this.addButton(new Button(this.width / 2 - 100, this.height / 4 + 120 + 12, 200, 20, I18n.get("gui.cancel"), (p_212999_1_) -> {
         this.aborted = true;
         if (this.connection != null) {
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      ...
      this.drawCenteredString(this.font, this.status.func_150254_d(), this.width / 2, this.height / 2 - 50, 16777215);
