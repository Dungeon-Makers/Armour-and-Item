...
public class DebugOverlayGui extends AbstractGui {
   ...
   public void render() {
      ...
      if (this.minecraft.options.renderFpsChart) {
         ...
         this.func_230023_a_(this.minecraft.getFrameTimer(), 0, i / 2, true);
   ...
   protected void drawGameInformation() {
      ...
      for(int i = 0; i < list.size(); ++i) {
         ...
         if (!Strings.isNullOrEmpty(s)) {
            ...
            this.font.func_211126_b(s, 2.0F, (float)i1, 14737632);
         }
      }
   ...
   protected void drawSystemInformation() {
      ...
      for(int i = 0; i < list.size(); ++i) {
         ...
         if (!Strings.isNullOrEmpty(s)) {
            ...
            this.font.func_211126_b(s, (float)l, (float)i1, 14737632);
         }
      }
   ...
   protected List<String> getGameInformation() {
      ...
      if (this.minecraft.showOnlyReducedInfo()) {
         ...
         list.add(DimensionType.func_212678_a(this.minecraft.level.dimension.func_186058_p()).toString() + " FC: " + Integer.toString(longset.size()));
         list.add("");
            ...
            if (this.minecraft.level.hasChunkAt(blockpos)) {
               ...
               if (chunk.isEmpty()) {
                  ...
                  if (blockpos.getY() >= 0 && blockpos.getY() < 256) {
                     list.add("Biome: " + Registry.field_212624_m.getKey(this.minecraft.level.getBiome(blockpos)));
                     long l = 0L;
                     float f2 = 0.0F;
                     if (chunk1 != null) {
         ...
         if (this.block.getType() == RayTraceResult.Type.BLOCK) {
            BlockPos blockpos1 = ((BlockRayTraceResult)this.block).getBlockPos();
         ...
         if (this.liquid.getType() == RayTraceResult.Type.BLOCK) {
            BlockPos blockpos2 = ((BlockRayTraceResult)this.liquid).getBlockPos();
   ...
   private String getServerChunkStats() {
      IntegratedServer integratedserver = this.minecraft.getSingleplayerServer();
      if (integratedserver != null) {
         ServerWorld serverworld = integratedserver.getLevel(this.minecraft.level.func_201675_m().func_186058_p());
         if (serverworld != null) {
            return serverworld.gatherChunkSourceStats();
         }
      }
   ...
   private World getLevel() {
      return DataFixUtils.orElse(Optional.ofNullable(this.minecraft.getSingleplayerServer()).map((p_212917_1_) -> {
         return p_212917_1_.getLevel(this.minecraft.level.dimension.func_186058_p());
   ...
   private Chunk getServerChunk() {
      if (this.serverChunk == null) {
         IntegratedServer integratedserver = this.minecraft.getSingleplayerServer();
         if (integratedserver != null) {
            ServerWorld serverworld = integratedserver.getLevel(this.minecraft.level.dimension.func_186058_p());
            if (serverworld != null) {
   ...
   protected List<String> getSystemInformation() {
      ...
      if (this.minecraft.showOnlyReducedInfo()) {
         ...
         if (this.liquid.getType() == RayTraceResult.Type.BLOCK) {
            ...
            IFluidState ifluidstate = this.minecraft.level.getFluidState(blockpos1);
            list.add("");
            list.add(TextFormatting.UNDERLINE + "Targeted Fluid");
            list.add(String.valueOf((Object)Registry.FLUID.getKey(ifluidstate.getType())));

            for(Entry<IProperty<?>, Comparable<?>> entry1 : ifluidstate.getValues().entrySet()) {
               list.add(this.getPropertyValueString(entry1));
            }

            for(ResourceLocation resourcelocation1 : ifluidstate.getType().getTags()) {
   ...
   private String getPropertyValueString(Entry<IProperty<?>, Comparable<?>> p_211534_1_) {
      IProperty<?> iproperty = p_211534_1_.getKey();
      Comparable<?> comparable = p_211534_1_.getValue();
      String s = Util.getPropertyName(iproperty, comparable);
   ...
   private void func_230023_a_(FrameTimer p_230023_1_, int p_230023_2_, int p_230023_3_, boolean p_230023_4_) {
      ...
      int i = p_230023_1_.getLogStart();
      int j = p_230023_1_.getLogEnd();
      long[] along = p_230023_1_.getLog();
      int l = p_230023_2_;
      int i1 = Math.max(0, along.length - p_230023_3_);
      int j1 = along.length - i1;
      int lvt_8_1_ = p_230023_1_.wrapIndex(i + i1);
      long k1 = 0L;
      int l1 = Integer.MAX_VALUE;
      int i2 = Integer.MIN_VALUE;

      for(int j2 = 0; j2 < j1; ++j2) {
         int k2 = (int)(along[p_230023_1_.wrapIndex(lvt_8_1_ + j2)] / 1000000L);
         l1 = Math.min(l1, k2);
         i2 = Math.max(i2, k2);
         k1 += (long)k2;
      }
      ...
      for(Matrix4f matrix4f = TransformationMatrix.identity().getMatrix(); lvt_8_1_ != j; lvt_8_1_ = p_230023_1_.wrapIndex(lvt_8_1_ + 1)) {
         int l2 = p_230023_1_.scaleSampleTo(along[lvt_8_1_], p_230023_4_ ? 30 : 60, p_230023_4_ ? 60 : 20);
      ...
      if (p_230023_4_) {
         ...
         this.font.func_211126_b("60 FPS", (float)(p_230023_2_ + 2), (float)(k4 - 30 + 2), 14737632);
         this.hLine(p_230023_2_, p_230023_2_ + j1 - 1, k4 - 30, -1);
         fill(p_230023_2_ + 1, k4 - 60 + 1, p_230023_2_ + 14, k4 - 60 + 10, -1873784752);
         this.font.func_211126_b("30 FPS", (float)(p_230023_2_ + 2), (float)(k4 - 60 + 2), 14737632);
         this.hLine(p_230023_2_, p_230023_2_ + j1 - 1, k4 - 60, -1);
      } else {
         fill(p_230023_2_ + 1, k4 - 60 + 1, p_230023_2_ + 14, k4 - 60 + 10, -1873784752);
         this.font.func_211126_b("20 TPS", (float)(p_230023_2_ + 2), (float)(k4 - 60 + 2), 14737632);
         this.hLine(p_230023_2_, p_230023_2_ + j1 - 1, k4 - 60, -1);
      }
      ...
      if (p_230023_4_ && this.minecraft.options.framerateLimit > 0 && this.minecraft.options.framerateLimit <= 250) {
         this.hLine(p_230023_2_, p_230023_2_ + j1 - 1, k4 - 1 - (int)(1800.0D / (double)this.minecraft.options.framerateLimit), -16711681);
      }

      String s = l1 + " ms min";
      String s1 = k1 / (long)j1 + " ms avg";
      String s2 = i2 + " ms max";
      this.font.func_175063_a(s, (float)(p_230023_2_ + 2), (float)(k4 - 60 - 9), 14737632);
      this.font.func_175063_a(s1, (float)(p_230023_2_ + j1 / 2 - this.font.width(s1) / 2), (float)(k4 - 60 - 9), 14737632);
      this.font.func_175063_a(s2, (float)(p_230023_2_ + j1 - this.font.width(s2)), (float)(k4 - 60 - 9), 14737632);
