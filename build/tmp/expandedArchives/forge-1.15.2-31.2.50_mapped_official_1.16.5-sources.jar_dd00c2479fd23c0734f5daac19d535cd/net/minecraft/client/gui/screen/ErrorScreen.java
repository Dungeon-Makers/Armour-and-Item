...
public class ErrorScreen extends Screen {
   ...
   protected void init() {
      super.init();
      this.addButton(new Button(this.width / 2 - 100, 140, 200, 20, I18n.get("gui.cancel"), (p_213034_1_) -> {
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      ...
      this.drawCenteredString(this.font, this.title.func_150254_d(), this.width / 2, 90, 16777215);
