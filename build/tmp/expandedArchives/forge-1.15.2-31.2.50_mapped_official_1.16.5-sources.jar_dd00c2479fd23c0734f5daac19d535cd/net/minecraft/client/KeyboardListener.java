...
public class KeyboardListener {
   ...
   private void debugFeedbackTranslated(String p_197964_1_, Object... p_197964_2_) {
      this.minecraft.gui.getChat().addMessage((new StringTextComponent("")).func_150257_a((new TranslationTextComponent("debug.prefix")).func_211709_a(new TextFormatting[]{TextFormatting.YELLOW, TextFormatting.BOLD})).func_150258_a(" ").func_150257_a(new TranslationTextComponent(p_197964_1_, p_197964_2_)));
   }

   private void debugWarningTranslated(String p_204869_1_, Object... p_204869_2_) {
      this.minecraft.gui.getChat().addMessage((new StringTextComponent("")).func_150257_a((new TranslationTextComponent("debug.prefix")).func_211709_a(new TextFormatting[]{TextFormatting.RED, TextFormatting.BOLD})).func_150258_a(" ").func_150257_a(new TranslationTextComponent(p_204869_1_, p_204869_2_)));
   }
   ...
   private boolean handleDebugKeys(int p_197962_1_) {
      if (this.debugCrashKeyTime > 0L && this.debugCrashKeyTime < Util.getMillis() - 100L) {
         ...
         case 67:
            ...
            this.setClipboard(String.format(Locale.ROOT, "/execute in %s run tp @s %.2f %.2f %.2f %.2f %.2f", DimensionType.func_212678_a(this.minecraft.player.level.dimension.func_186058_p()), this.minecraft.player.getX(), this.minecraft.player.getY(), this.minecraft.player.getZ(), this.minecraft.player.yRot, this.minecraft.player.xRot));
            return true;
         case 68:
   ...
   private void copyCreateEntityCommand(ResourceLocation p_211557_1_, Vec3d p_211557_2_, @Nullable CompoundNBT p_211557_3_) {
      String s;
      if (p_211557_3_ != null) {
         ...
         if (this.minecraft.screen == null || this.minecraft.screen.passEvents) {
            ...
            if (p_197961_5_ == 0) {
               ...
               if (this.minecraft.options.renderDebugCharts) {
                  ...
                  for(int i = 0; i < 9; ++i) {
                     if (p_197961_3_ == 49 + i) {
                        this.minecraft.debugFpsMeterKeyPress(i + 1);
                     }
                  }
               }
            }
