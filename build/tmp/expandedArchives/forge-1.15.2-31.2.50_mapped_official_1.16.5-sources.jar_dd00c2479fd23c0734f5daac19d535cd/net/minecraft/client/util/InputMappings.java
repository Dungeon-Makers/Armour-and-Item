...
public class InputMappings {
   ...
   public static void setupMouseCallbacks(long p_216503_0_, GLFWCursorPosCallbackI p_216503_2_, GLFWMouseButtonCallbackI p_216503_3_, GLFWScrollCallbackI p_216503_4_) {
   ...
   public static enum Type {
      ...
      private Type(String p_i48056_3_) {
         this.defaultPrefix = p_i48056_3_;
      }

      public InputMappings.Input getOrCreate(int p_197944_1_) {
         if (this.map.containsKey(p_197944_1_)) {
            return this.map.get(p_197944_1_);
         } else {
            String s;
            if (this == MOUSE) {
               if (p_197944_1_ <= 2) {
            ...
            InputMappings.Input inputmappings$input = new InputMappings.Input(this.defaultPrefix + s, this, p_197944_1_);
            this.map.put(p_197944_1_, inputmappings$input);
