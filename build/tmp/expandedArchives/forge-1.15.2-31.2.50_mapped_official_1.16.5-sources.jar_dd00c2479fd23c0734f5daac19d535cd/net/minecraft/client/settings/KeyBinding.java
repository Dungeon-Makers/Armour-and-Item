...
public class KeyBinding implements Comparable<KeyBinding>, net.minecraftforge.client.extensions.IForgeKeybinding {
   ...
   public boolean isDown() {
      return this.isDown && getKeyConflictContext().isActive() && getKeyModifier().isActive(getKeyConflictContext());
   }
   ...
   public static Supplier<String> createNameSupplier(String p_193626_0_) {
   ...
   public String func_197978_k() {
      return getKeyModifier().getLocalizedComboName(this.key, () -> {
      String s = this.key.getName();
      ...
      case SCANCODE:
         ...
         break;
      case MOUSE:
         String s2 = I18n.get(s);
         s1 = Objects.equals(s2, s) ? I18n.get(InputMappings.Type.MOUSE.func_216500_a(), i + 1) : s2;
      }

      return s1 == null ? I18n.get(s) : s1;
      });
   }
