...
public class ClientResourcePackInfo extends ResourcePackInfo {
   ...
   public ClientResourcePackInfo(String p_i48113_1_, boolean p_i48113_2_, Supplier<IResourcePack> p_i48113_3_, IResourcePack p_i48113_4_, PackMetadataSection p_i48113_5_, ResourcePackInfo.Priority p_i48113_6_, boolean hidden) {
      ...
      try (InputStream inputstream = p_i48113_4_.getRootResource("pack.png")) {
   ...
   public void func_195808_a(TextureManager p_195808_1_) {
      if (this.field_195810_b == null) {
         if (this.field_195809_a == null) {
            ...
            this.field_195810_b = p_195808_1_.register("texturepackicon", new DynamicTexture(this.field_195809_a));
         }
      }

      p_195808_1_.bind(this.field_195810_b);
   }
