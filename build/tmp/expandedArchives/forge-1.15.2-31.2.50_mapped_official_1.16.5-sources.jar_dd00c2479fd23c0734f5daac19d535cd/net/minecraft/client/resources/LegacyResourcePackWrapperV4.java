...
public class LegacyResourcePackWrapperV4 implements IResourcePack {
   ...
   public InputStream getRootResource(String p_195763_1_) throws IOException {
      return this.field_229283_h_.getRootResource(p_195763_1_);
   }
   ...
   public boolean hasResource(ResourcePackType p_195764_1_, ResourceLocation p_195764_2_) {
      if (!"minecraft".equals(p_195764_2_.getNamespace())) {
         return this.field_229283_h_.hasResource(p_195764_1_, p_195764_2_);
      } else {
         ...
         if ("textures/misc/enchanted_item_glint.png".equals(s)) {
            ...
            return this.field_229283_h_.hasResource(p_195764_1_, OLD_IRON_GOLEM_LOCATION);
            ...
            if (SHIELDS.contains(s)) {
               return this.field_229283_h_.hasResource(p_195764_1_, SHIELD_BASE) && this.field_229283_h_.hasResource(p_195764_1_, p_195764_2_);
            } else if (!BANNERS.contains(s)) {
               Pair<ChestType, ResourceLocation> pair = field_229279_d_.get(s);
               return pair != null && this.field_229283_h_.hasResource(p_195764_1_, pair.getSecond()) ? true : this.field_229283_h_.hasResource(p_195764_1_, p_195764_2_);
            } else {
               return this.field_229283_h_.hasResource(p_195764_1_, BANNER_BASE) && this.field_229283_h_.hasResource(p_195764_1_, p_195764_2_);
            }
         } else {
            return false;
         }
   ...
   public InputStream getResource(ResourcePackType p_195761_1_, ResourceLocation p_195761_2_) throws IOException {
      if (!"minecraft".equals(p_195761_2_.getNamespace())) {
         return this.field_229283_h_.getResource(p_195761_1_, p_195761_2_);
      } else {
         String s = p_195761_2_.getPath();
         if ("textures/entity/iron_golem/iron_golem.png".equals(s)) {
            return this.field_229283_h_.getResource(p_195761_1_, OLD_IRON_GOLEM_LOCATION);
         } else {
            if (SHIELDS.contains(s)) {
               InputStream inputstream2 = fixPattern(this.field_229283_h_.getResource(p_195761_1_, SHIELD_BASE), this.field_229283_h_.getResource(p_195761_1_, p_195761_2_), 64, 2, 2, 12, 22);
               if (inputstream2 != null) {
                  return inputstream2;
               }
            } else if (BANNERS.contains(s)) {
               InputStream inputstream1 = fixPattern(this.field_229283_h_.getResource(p_195761_1_, BANNER_BASE), this.field_229283_h_.getResource(p_195761_1_, p_195761_2_), 64, 0, 0, 42, 41);
               ...
               if ("textures/entity/enderdragon/dragon.png".equals(s) || "textures/entity/enderdragon/dragon_exploding.png".equals(s)) {
                  ...
                  try (NativeImage nativeimage = NativeImage.read(this.field_229283_h_.getResource(p_195761_1_, p_195761_2_))) {
               ...
               if ("textures/entity/conduit/closed_eye.png".equals(s) || "textures/entity/conduit/open_eye.png".equals(s)) {
                  return fixConduitEyeTexture(this.field_229283_h_.getResource(p_195761_1_, p_195761_2_));
               }

               Pair<ChestType, ResourceLocation> pair = field_229279_d_.get(s);
               if (pair != null) {
                  ChestType chesttype = pair.getFirst();
                  InputStream inputstream = this.field_229283_h_.getResource(p_195761_1_, pair.getSecond());
   ...
   public Collection<ResourceLocation> getResources(ResourcePackType p_225637_1_, String p_225637_2_, String p_225637_3_, int p_225637_4_, Predicate<String> p_225637_5_) {
      return this.field_229283_h_.getResources(p_225637_1_, p_225637_2_, p_225637_3_, p_225637_4_, p_225637_5_);
   }

   public Set<String> getNamespaces(ResourcePackType p_195759_1_) {
      return this.field_229283_h_.getNamespaces(p_195759_1_);
   }

   @Nullable
   public <T> T getMetadataSection(IMetadataSectionSerializer<T> p_195760_1_) throws IOException {
      return this.field_229283_h_.getMetadataSection(p_195760_1_);
   }
