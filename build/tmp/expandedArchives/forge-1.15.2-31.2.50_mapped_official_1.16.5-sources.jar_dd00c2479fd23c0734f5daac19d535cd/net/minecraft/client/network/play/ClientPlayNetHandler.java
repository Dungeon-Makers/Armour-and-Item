...
public class ClientPlayNetHandler implements IClientPlayNetHandler {
   ...
   private NetworkTagManager tags = new NetworkTagManager();
   ...
   public void handleLogin(SJoinGamePacket p_147282_1_) {
      ...
      this.level = new ClientWorld(this, new WorldSettings(p_147282_1_.getSeed(), p_147282_1_.getGameType(), false, p_147282_1_.isHardcore(), p_147282_1_.func_149196_i()), p_147282_1_.func_212642_e(), this.serverChunkRadius, this.minecraft.getProfiler(), this.minecraft.levelRenderer);
      this.minecraft.setLevel(this.level);
      if (this.minecraft.player == null) {
         this.minecraft.player = this.minecraft.gameMode.createPlayer(this.level, new StatisticsManager(), new ClientRecipeBook(this.level.getRecipeManager()));
      ...
      this.minecraft.player.field_71093_bK = p_147282_1_.func_212642_e();
   ...
   public void handleAddEntity(SSpawnObjectPacket p_147235_1_) {
      ...
      if (entitytype == EntityType.CHEST_MINECART) {
         ...
         entity = new MinecartCommandBlockEntity(this.level, d0, d1, d2);
   ...
   public void func_147292_a(SSpawnGlobalEntityPacket p_147292_1_) {
      PacketThreadUtil.ensureRunningOnSameThread(p_147292_1_, this, this.minecraft);
      ...
      if (p_147292_1_.func_149053_g() == 1) {
         LightningBoltEntity lightningboltentity = new LightningBoltEntity(this.level, d0, d1, d2, false);
         lightningboltentity.setPacketCoordinates(d0, d1, d2);
         lightningboltentity.yRot = 0.0F;
         lightningboltentity.xRot = 0.0F;
         lightningboltentity.setId(p_147292_1_.func_149052_c());
         this.level.func_217410_a(lightningboltentity);
      }
      ...
      if (entity != null) {
         ...
         if (!entity.isControlledByLocalInstance()) {
            ...
            if (!(Math.abs(entity.getX() - d0) >= 0.03125D) && !(Math.abs(entity.getY() - d1) >= 0.015625D) && !(Math.abs(entity.getZ() - d2) >= 0.03125D)) {
               entity.lerpTo(entity.getX(), entity.getY(), entity.getZ(), f, f1, 3, true);
            } else {
      ...
      if (entity != null) {
         if (!entity.isControlledByLocalInstance()) {
            if (p_147259_1_.hasPosition()) {
               entity.field_70118_ct += (long)p_147259_1_.getXa();
               entity.field_70117_cu += (long)p_147259_1_.getYa();
               entity.field_70116_cv += (long)p_147259_1_.getZa();
               Vec3d vec3d = SEntityPacket.packetToEntity(entity.field_70118_ct, entity.field_70117_cu, entity.field_70116_cv);
               ...
               entity.lerpTo(vec3d.x, vec3d.y, vec3d.z, f, f1, 3, false);
            ...
            entity.onGround = p_147259_1_.isOnGround();
         }
   ...
   public void handleMovePlayer(SPlayerPositionLookPacket p_184330_1_) {
      ...
      Vec3d vec3d = playerentity.getDeltaMovement();
   ...
   public void handleChunkBlocksUpdate(SMultiBlockChangePacket p_147287_1_) {
      ...
      for(SMultiBlockChangePacket.UpdateData smultiblockchangepacket$updatedata : p_147287_1_.func_179844_a()) {
         this.level.setKnownState(smultiblockchangepacket$updatedata.func_180090_a(), smultiblockchangepacket$updatedata.func_180088_c());
      }
   ...
   public void handleLevelChunk(SChunkDataPacket p_147263_1_) {
      ...
      Chunk chunk = this.level.getChunkSource().replaceWithPacketData(i, j, p_147263_1_.func_229739_i_(), p_147263_1_.getReadBuffer(), p_147263_1_.getHeightmaps(), p_147263_1_.getAvailableSections());
   ...
   public void onDisconnect(ITextComponent p_147231_1_) {
      ...
      if (this.callbackScreen != null) {
         if (this.callbackScreen instanceof RealmsScreenProxy) {
            this.minecraft.setScreen((new DisconnectedRealmsScreen(((RealmsScreenProxy)this.callbackScreen).getScreen(), "disconnect.lost", p_147231_1_)).getProxy());
         } else {
            this.minecraft.setScreen(new DisconnectedScreen(this.callbackScreen, "disconnect.lost", p_147231_1_));
         }
      } else {
         this.minecraft.setScreen(new DisconnectedScreen(new MultiplayerScreen(new MainMenuScreen()), "disconnect.lost", p_147231_1_));
      }
   ...
   public void handleChat(SChatPacket p_147251_1_) {
      ...
      net.minecraft.util.text.ITextComponent message = net.minecraftforge.event.ForgeEventFactory.onClientChat(p_147251_1_.getType(), p_147251_1_.getMessage());
      if (message == null) return;
      this.minecraft.gui.func_191742_a(p_147251_1_.getType(), message);
   }
   ...
   public void handleAddMob(SSpawnMobPacket p_147281_1_) {
      ...
      if (livingentity != null) {
         ...
         if (livingentity instanceof BeeEntity) {
            ...
            this.minecraft.getSoundManager().play(beesound);
         }
      } else {
   ...
   public void handleSetTime(SUpdateTimePacket p_147285_1_) {
      ...
      this.minecraft.level.func_82738_a(p_147285_1_.getGameTime());
      this.minecraft.level.setDayTime(p_147285_1_.getDayTime());
   }

   public void func_147271_a(SSpawnPositionPacket p_147271_1_) {
      PacketThreadUtil.ensureRunningOnSameThread(p_147271_1_, this, this.minecraft);
      this.minecraft.player.func_226560_a_(p_147271_1_.func_179800_a(), true, false);
      this.minecraft.level.getLevelData().setSpawn(p_147271_1_.func_179800_a());
   }
         ...
         for(int i : p_184328_1_.getPassengers()) {
            ...
            if (entity1 != null) {
               ...
               if (entity1 == this.minecraft.player && !flag) {
                  this.minecraft.gui.func_110326_a(I18n.get("mount.onboard", this.minecraft.options.keyShift.func_197978_k()), false);
               }
            }
         }
   ...
   public void handleRespawn(SRespawnPacket p_147280_1_) {
      ...
      if (dimensiontype != clientplayerentity.field_71093_bK) {
         this.started = false;
         Scoreboard scoreboard = this.level.getScoreboard();
         this.level = new ClientWorld(this, new WorldSettings(p_147280_1_.getSeed(), p_147280_1_.getPlayerGameType(), false, this.minecraft.level.getLevelData().isHardcore(), p_147280_1_.func_149080_f()), p_147280_1_.func_212643_b(), this.serverChunkRadius, this.minecraft.getProfiler(), this.minecraft.levelRenderer);
         this.level.setScoreboard(scoreboard);
         this.minecraft.setLevel(this.level);
         this.minecraft.setScreen(new DownloadTerrainScreen());
      }

      this.level.func_72974_f();
      this.level.removeAllPendingEntityRemovals();
      String s = clientplayerentity.getServerBrand();
      this.minecraft.cameraEntity = null;
      ClientPlayerEntity clientplayerentity1 = this.minecraft.gameMode.createPlayer(this.level, clientplayerentity.getStats(), clientplayerentity.getRecipeBook());
      clientplayerentity1.setId(i);
      clientplayerentity1.field_71093_bK = dimensiontype;
   ...
   public void handleBlockEntityData(SUpdateTileEntityPacket p_147273_1_) {
      ...
      if (this.minecraft.level.hasChunkAt(p_147273_1_.getPos())) {
         TileEntity tileentity = this.minecraft.level.getBlockEntity(p_147273_1_.getPos());
         ...
         if (i == 1 && tileentity instanceof MobSpawnerTileEntity || flag || i == 3 && tileentity instanceof BeaconTileEntity || i == 4 && tileentity instanceof SkullTileEntity || i == 6 && tileentity instanceof BannerTileEntity || i == 7 && tileentity instanceof StructureBlockTileEntity || i == 8 && tileentity instanceof EndGatewayTileEntity || i == 9 && tileentity instanceof SignTileEntity || i == 11 && tileentity instanceof BedTileEntity || i == 5 && tileentity instanceof ConduitTileEntity || i == 12 && tileentity instanceof JigsawTileEntity || i == 13 && tileentity instanceof CampfireTileEntity || i == 14 && tileentity instanceof BeehiveTileEntity) {
            tileentity.func_145839_a(p_147273_1_.getTag());
         } else {
            if(tileentity == null) {
   ...
   public void handleSetEquipment(SEntityEquipmentPacket p_147242_1_) {
      ...
      if (entity != null) {
         entity.setItemSlot(p_147242_1_.func_186969_c(), p_147242_1_.func_149390_c());
      }
   ...
   public void handleGameEvent(SChangeGameStatePacket p_147252_1_) {
      ...
      if (i >= 0 && i < SChangeGameStatePacket.field_149142_a.length && SChangeGameStatePacket.field_149142_a[i] != null) {
         playerentity.displayClientMessage(new TranslationTextComponent(SChangeGameStatePacket.field_149142_a[i]), false);
      }
      ...
      if (i == 1) {
         ...
         if (f == 0.0F) {
            ...
            this.minecraft.gui.getChat().addMessage(new TranslationTextComponent("demo.help.movement", gamesettings.keyUp.func_197978_k(), gamesettings.keyLeft.func_197978_k(), gamesettings.keyDown.func_197978_k(), gamesettings.keyRight.func_197978_k()));
         } else if (f == 102.0F) {
            this.minecraft.gui.getChat().addMessage(new TranslationTextComponent("demo.help.jump", gamesettings.keyJump.func_197978_k()));
         } else if (f == 103.0F) {
            this.minecraft.gui.getChat().addMessage(new TranslationTextComponent("demo.help.inventory", gamesettings.keyInventory.func_197978_k()));
         } else if (f == 104.0F) {
            this.minecraft.gui.getChat().addMessage(new TranslationTextComponent("demo.day.6", gamesettings.keyScreenshot.func_197978_k()));
         }
      } else if (i == 6) {
   ...
   public void handleLookAt(SPlayerLookPacket p_200232_1_) {
      ...
      Vec3d vec3d = p_200232_1_.getPosition(this.level);
      if (vec3d != null) {
         this.minecraft.player.lookAt(p_200232_1_.getFromAnchor(), vec3d);
      }
   ...
   public void handleAddOrRemoveRecipes(SRecipeBookPacket p_191980_1_) {
      ...
      ClientRecipeBook clientrecipebook = this.minecraft.player.getRecipeBook();
      clientrecipebook.func_192813_a(p_191980_1_.func_192593_c());
      clientrecipebook.func_192810_b(p_191980_1_.func_192594_d());
      clientrecipebook.func_202881_c(p_191980_1_.func_202492_e());
      clientrecipebook.func_202882_d(p_191980_1_.func_202493_f());
   ...
   public void handleUpdateTags(STagsListPacket p_199723_1_) {
      ...
      this.tags = p_199723_1_.getTags();
      if (!this.connection.isMemoryConnection()) {
         BlockTags.func_199895_a(this.tags.func_199717_a());
         ItemTags.func_199902_a(this.tags.func_199715_b());
         FluidTags.func_206953_a(this.tags.func_205704_c());
         EntityTypeTags.func_219759_a(this.tags.func_215297_d());
      }

      this.minecraft.getSearchTree(SearchTreeManager.CREATIVE_TAGS).refresh();
      net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(new net.minecraftforge.event.TagsUpdatedEvent(this.tags));
   }
   ...
   public void handleChangeDifficulty(SServerDifficultyPacket p_175101_1_) {
      ...
      this.minecraft.level.getLevelData().func_176144_a(p_175101_1_.getDifficulty());
      this.minecraft.level.getLevelData().func_180783_e(p_175101_1_.isLocked());
   }
   ...
   public void handleSetTitles(STitlePacket p_175099_1_) {
      ...
      String s = null;
      String s1 = null;
      String s2 = p_175099_1_.getText() != null ? p_175099_1_.getText().func_150254_d() : "";
      ...
      case SUBTITLE:
         ...
         break;
      case ACTIONBAR:
         this.minecraft.gui.func_110326_a(s2, false);
         return;
      case RESET:
         this.minecraft.gui.func_175178_a("", "", -1, -1, -1);
         this.minecraft.gui.resetTitleTimes();
         return;
      }

      this.minecraft.gui.func_175178_a(s, s1, p_175099_1_.getFadeInTime(), p_175099_1_.getStayTime(), p_175099_1_.getFadeOutTime());
   }

   public void handleTabListCustomisation(SPlayerListHeaderFooterPacket p_175096_1_) {
      this.minecraft.gui.getTabList().setHeader(p_175096_1_.getHeader().func_150254_d().isEmpty() ? null : p_175096_1_.getHeader());
      this.minecraft.gui.getTabList().setFooter(p_175096_1_.getFooter().func_150254_d().isEmpty() ? null : p_175096_1_.getFooter());
   }
   ...
   public void handleCustomSoundEvent(SPlaySoundPacket p_184329_1_) {
      ...
      this.minecraft.getSoundManager().play(new SimpleSound(p_184329_1_.getName(), p_184329_1_.getSource(), p_184329_1_.getVolume(), p_184329_1_.getPitch(), false, 0, ISound.AttenuationType.LINEAR, (float)p_184329_1_.getX(), (float)p_184329_1_.getY(), (float)p_184329_1_.getZ(), false));
   }
   ...
   public void handleCustomPayload(SCustomPayloadPlayPacket p_147240_1_) {
      ...
      try {
         ...
         if (SCustomPayloadPlayPacket.BRAND.equals(resourcelocation)) {
            ...
            ((NeighborsUpdateDebugRenderer)this.minecraft.debugRenderer.neighborsUpdateRenderer).addUpdate(l1, blockpos8);
            ...
            this.minecraft.debugRenderer.caveRenderer.addTunnel(blockpos1, list1, list);
         } else if (SCustomPayloadPlayPacket.DEBUG_STRUCTURES_PACKET.equals(resourcelocation)) {
            DimensionType dimensiontype = DimensionType.func_186069_a(packetbuffer.readInt());
            ...
            for(int l2 = 0; l2 < i2; ++l2) {
               this.minecraft.debugRenderer.field_217741_m.func_217701_a(packetbuffer.readSectionPos());
            }

            int i3 = packetbuffer.readInt();

            for(int j4 = 0; j4 < i3; ++j4) {
               this.minecraft.debugRenderer.field_217741_m.func_217700_b(packetbuffer.readSectionPos());
            }
            ...
            this.minecraft.debugRenderer.field_217741_m.addPoi(pointofinterestdebugrenderer$poiinfo);
            ...
            this.minecraft.debugRenderer.field_217741_m.removePoi(blockpos3);
            ...
            this.minecraft.debugRenderer.field_217741_m.setFreeTicketCount(blockpos4, j3);
            ...
            this.minecraft.debugRenderer.field_217741_m.addOrUpdateBrainDump(pointofinterestdebugrenderer$braininfo);
            ...
            for(int k8 = 0; k8 < l7; ++k8) {
               ...
               beedebugrenderer$bee.blacklistedHives.add(blockpos11);
            }
            ...
            BeeDebugRenderer.Hive beedebugrenderer$hive = new BeeDebugRenderer.Hive(blockpos6, s9, j5, k5, flag3, this.level.getGameTime());
            ...
            this.minecraft.debugRenderer.gameTestDebugRenderer.addMarker(blockpos7, l3, s10, l5);
         } else {
   ...
   public void handleUpdateAttributes(SEntityPropertiesPacket p_147290_1_) {
      ...
      if (entity != null) {
         if (!(entity instanceof LivingEntity)) {
            ...
            AbstractAttributeMap abstractattributemap = ((LivingEntity)entity).func_110140_aT();
            ...
            for(SEntityPropertiesPacket.Snapshot sentitypropertiespacket$snapshot : p_147290_1_.getValues()) {
               ...
               iattributeinstance.setBaseValue(sentitypropertiespacket$snapshot.getBase());
               iattributeinstance.removeModifiers();

               for(AttributeModifier attributemodifier : sentitypropertiespacket$snapshot.getModifiers()) {
                  iattributeinstance.addModifier(attributemodifier);
               }
            }
   ...
   public void handlePlaceRecipe(SPlaceGhostRecipePacket p_194307_1_) {
      ...
      if (container.containerId == p_194307_1_.getContainerId() && container.isSynched(this.minecraft.player)) {
         this.recipeManager.byKey(p_194307_1_.getRecipe()).ifPresent((p_217285_2_) -> {
            if (this.minecraft.screen instanceof IRecipeShownListener) {
               RecipeBookGui recipebookgui = ((IRecipeShownListener)this.minecraft.screen).getRecipeBookComponent();
               recipebookgui.setupGhostRecipe(p_217285_2_, container.slots);
            }
   ...
   public void handleLightUpdatePacked(SUpdateLightPacket p_217269_1_) {
      ...
      this.readSectionList(i, j, worldlightmanager, LightType.SKY, k, l, iterator);
      ...
      this.readSectionList(i, j, worldlightmanager, LightType.BLOCK, i1, j1, iterator1);
   }
   ...
   private void readSectionList(int p_217284_1_, int p_217284_2_, WorldLightManager p_217284_3_, LightType p_217284_4_, int p_217284_5_, int p_217284_6_, Iterator<byte[]> p_217284_7_) {
      for(int i = 0; i < 18; ++i) {
         int j = -1 + i;
         boolean flag = (p_217284_5_ & 1 << i) != 0;
         boolean flag1 = (p_217284_6_ & 1 << i) != 0;
         if (flag || flag1) {
            p_217284_3_.queueSectionData(p_217284_4_, SectionPos.of(p_217284_1_, j, p_217284_2_), flag ? new NibbleArray((byte[])p_217284_7_.next().clone()) : new NibbleArray());
