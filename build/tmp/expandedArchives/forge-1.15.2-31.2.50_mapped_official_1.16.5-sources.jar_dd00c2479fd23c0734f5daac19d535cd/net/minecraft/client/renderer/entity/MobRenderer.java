...
public abstract class MobRenderer<T extends MobEntity, M extends EntityModel<T>> extends LivingRenderer<T, M> {
   ...
   private <E extends Entity> void renderLeash(T p_229118_1_, float p_229118_2_, MatrixStack p_229118_3_, IRenderTypeBuffer p_229118_4_, E p_229118_5_) {
      ...
      double d0 = (double)(MathHelper.lerp(p_229118_2_ * 0.5F, p_229118_5_.yRot, p_229118_5_.yRotO) * ((float)Math.PI / 180F));
      double d1 = (double)(MathHelper.lerp(p_229118_2_ * 0.5F, p_229118_5_.xRot, p_229118_5_.xRotO) * ((float)Math.PI / 180F));
      ...
      double d6 = MathHelper.lerp((double)p_229118_2_, p_229118_5_.xo, p_229118_5_.getX()) - d2 * 0.7D - d3 * 0.5D * d5;
      double d7 = MathHelper.lerp((double)p_229118_2_, p_229118_5_.yo + (double)p_229118_5_.getEyeHeight() * 0.7D, p_229118_5_.getY() + (double)p_229118_5_.getEyeHeight() * 0.7D) - d4 * 0.5D - 0.25D;
      double d8 = MathHelper.lerp((double)p_229118_2_, p_229118_5_.zo, p_229118_5_.getZ()) - d3 * 0.7D + d2 * 0.5D * d5;
      double d9 = (double)(MathHelper.lerp(p_229118_2_, p_229118_1_.yBodyRot, p_229118_1_.yBodyRotO) * ((float)Math.PI / 180F)) + (Math.PI / 2D);
      d2 = Math.cos(d9) * (double)p_229118_1_.getBbWidth() * 0.4D;
      d3 = Math.sin(d9) * (double)p_229118_1_.getBbWidth() * 0.4D;
      double d10 = MathHelper.lerp((double)p_229118_2_, p_229118_1_.xo, p_229118_1_.getX()) + d2;
      double d11 = MathHelper.lerp((double)p_229118_2_, p_229118_1_.yo, p_229118_1_.getY());
      double d12 = MathHelper.lerp((double)p_229118_2_, p_229118_1_.zo, p_229118_1_.getZ()) + d3;
      p_229118_3_.translate(d2, -(1.6D - (double)p_229118_1_.getBbHeight()) * 0.5D, d3);
      ...
      float f5 = f2 * f4;
      float f6 = f * f4;
      int i = this.getBlockLightLevel(p_229118_1_, p_229118_2_);
      int j = this.entityRenderDispatcher.getRenderer(p_229118_5_).getBlockLightLevel(p_229118_5_, p_229118_2_);
      int k = p_229118_1_.level.getBrightness(LightType.SKY, new BlockPos(p_229118_1_.getEyePosition(p_229118_2_)));
      int l = p_229118_1_.level.getBrightness(LightType.SKY, new BlockPos(p_229118_5_.getEyePosition(p_229118_2_)));
