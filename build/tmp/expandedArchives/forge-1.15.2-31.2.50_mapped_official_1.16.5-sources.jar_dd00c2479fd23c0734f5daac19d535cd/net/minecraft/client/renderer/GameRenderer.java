...
public class GameRenderer implements AutoCloseable, IResourceManagerReloadListener {
      ...
      if (entity != null) {
         if (this.minecraft.level != null) {
            ...
            if (this.minecraft.hitResult != null) {
               d1 = this.minecraft.hitResult.getLocation().distanceToSqr(vec3d);
            }

            Vec3d vec3d1 = entity.getViewVector(1.0F);
            Vec3d vec3d2 = vec3d.add(vec3d1.x * d0, vec3d1.y * d0, vec3d1.z * d0);
            float f = 1.0F;
            AxisAlignedBB axisalignedbb = entity.getBoundingBox().expandTowards(vec3d1.scale(d0)).inflate(1.0D, 1.0D, 1.0D);
            EntityRayTraceResult entityraytraceresult = ProjectileHelper.getEntityHitResult(entity, vec3d, vec3d2, axisalignedbb, (p_215312_0_) -> {
               return !p_215312_0_.isSpectator() && p_215312_0_.isPickable();
            }, d1);
            if (entityraytraceresult != null) {
               Entity entity1 = entityraytraceresult.getEntity();
               Vec3d vec3d3 = entityraytraceresult.getLocation();
               double d2 = vec3d.distanceToSqr(vec3d3);
               if (flag && d2 > 9.0D) {
                  this.minecraft.hitResult = BlockRayTraceResult.miss(vec3d3, Direction.getNearest(vec3d1.x, vec3d1.y, vec3d1.z), new BlockPos(vec3d3));
   ...
   private double getFov(ActiveRenderInfo p_215311_1_, float p_215311_2_, boolean p_215311_3_) {
      if (this.panoramicMode) {
         ...
         if (p_215311_1_.getEntity() instanceof LivingEntity && ((LivingEntity)p_215311_1_.getEntity()).getHealth() <= 0.0F) {
         ...
         IFluidState ifluidstate = p_215311_1_.getFluidInCamera();
   ...
   private void renderItemInHand(MatrixStack p_228381_1_, ActiveRenderInfo p_228381_2_, float p_228381_3_) {
      if (!this.panoramicMode) {
         ...
         if (this.minecraft.options.field_74320_O == 0 && !flag && !this.minecraft.options.hideGui && this.minecraft.gameMode.getPlayerMode() != GameType.SPECTATOR) {
         ...
         p_228381_1_.popPose();
         if (this.minecraft.options.field_74320_O == 0 && !flag) {
   ...
   public void render(float p_195458_1_, long p_195458_2_, boolean p_195458_4_) {
      ...
      if (!this.minecraft.noRender) {
         ...
         if (p_195458_4_ && this.minecraft.level != null) {
            ...
            this.renderLevel(p_195458_1_, p_195458_2_, matrixstack);
         ...
         if (p_195458_4_ && this.minecraft.level != null) {
            ...
            if (!this.minecraft.options.hideGui || this.minecraft.screen != null) {
               ...
               this.minecraft.gui.func_175180_a(p_195458_1_);
               RenderSystem.clear(256, Minecraft.ON_OSX);
            }
         ...
         if (this.minecraft.overlay != null) {
            ...
            try {
               net.minecraftforge.client.ForgeHooksClient.drawScreen(this.minecraft.screen, i, j, this.minecraft.getDeltaFrameTime());
   ...
   public void renderLevel(float p_228378_1_, long p_228378_2_, MatrixStack p_228378_4_) {
      ...
      activerenderinfo.setup(this.minecraft.level, (Entity)(this.minecraft.getCameraEntity() == null ? this.minecraft.player : this.minecraft.getCameraEntity()), this.minecraft.options.field_74320_O > 0, this.minecraft.options.field_74320_O == 2, p_228378_1_);
