...
public class IronGolemModel<T extends IronGolemEntity> extends SegmentedModel<T> {
   ...
   public void setupAnim(T p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
      ...
      this.leg0.xRot = -1.5F * this.func_78172_a(p_225597_2_, 13.0F) * p_225597_3_;
      this.leg1.xRot = 1.5F * this.func_78172_a(p_225597_2_, 13.0F) * p_225597_3_;
      this.leg0.yRot = 0.0F;
      this.leg1.yRot = 0.0F;
   }
   ...
   public void prepareMobModel(T p_212843_1_, float p_212843_2_, float p_212843_3_, float p_212843_4_) {
      ...
      if (i > 0) {
         this.arm0.xRot = -2.0F + 1.5F * this.func_78172_a((float)i - p_212843_4_, 10.0F);
         this.arm1.xRot = -2.0F + 1.5F * this.func_78172_a((float)i - p_212843_4_, 10.0F);
      } else {
         int j = p_212843_1_.getOfferFlowerTick();
         if (j > 0) {
            this.arm0.xRot = -0.8F + 0.025F * this.func_78172_a((float)j, 70.0F);
            this.arm1.xRot = 0.0F;
         } else {
            this.arm0.xRot = (-0.2F + 1.5F * this.func_78172_a(p_212843_2_, 13.0F)) * p_212843_3_;
            this.arm1.xRot = (-0.2F - 1.5F * this.func_78172_a(p_212843_2_, 13.0F)) * p_212843_3_;
         }
      }
