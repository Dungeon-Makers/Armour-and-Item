...
public class ChestTileEntityRenderer<T extends TileEntity & IChestLid> extends TileEntityRenderer<T> {
   ...
   public void render(T p_225616_1_, float p_225616_2_, MatrixStack p_225616_3_, IRenderTypeBuffer p_225616_4_, int p_225616_5_, int p_225616_6_) {
      ...
      ChestType chesttype = blockstate.func_196959_b(ChestBlock.TYPE) ? blockstate.getValue(ChestBlock.TYPE) : ChestType.SINGLE;
      ...
      if (block instanceof AbstractChestBlock) {
         ...
         float f1 = icallbackwrapper.apply(ChestBlock.opennessCombiner((IChestLid)p_225616_1_)).get(p_225616_2_);
         f1 = 1.0F - f1;
         f1 = 1.0F - f1 * f1 * f1;
