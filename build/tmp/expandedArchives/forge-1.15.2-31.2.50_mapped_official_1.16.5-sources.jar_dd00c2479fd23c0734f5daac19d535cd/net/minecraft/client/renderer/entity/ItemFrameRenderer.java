...
public class ItemFrameRenderer extends EntityRenderer<ItemFrameEntity> {
   ...
   public void render(ItemFrameEntity p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
      ...
      p_225623_4_.translate(-vec3d.x(), -vec3d.y(), -vec3d.z());
      double d0 = 0.46875D;
   ...
   public Vec3d getRenderOffset(ItemFrameEntity p_225627_1_, float p_225627_2_) {
      return new Vec3d((double)((float)p_225627_1_.getDirection().getStepX() * 0.3F), -0.25D, (double)((float)p_225627_1_.getDirection().getStepZ() * 0.3F));
   }
   ...
   protected void renderNameTag(ItemFrameEntity p_225629_1_, String p_225629_2_, MatrixStack p_225629_3_, IRenderTypeBuffer p_225629_4_, int p_225629_5_) {
      super.renderNameTag(p_225629_1_, p_225629_1_.getItem().getHoverName().func_150254_d(), p_225629_3_, p_225629_4_, p_225629_5_);
   }
}
