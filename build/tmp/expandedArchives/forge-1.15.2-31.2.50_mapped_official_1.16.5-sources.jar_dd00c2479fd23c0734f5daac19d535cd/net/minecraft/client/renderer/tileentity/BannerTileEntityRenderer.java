...
public class BannerTileEntityRenderer extends TileEntityRenderer<BannerTileEntity> {
   ...
   public static void renderPatterns(MatrixStack p_230180_0_, IRenderTypeBuffer p_230180_1_, int p_230180_2_, int p_230180_3_, ModelRenderer p_230180_4_, Material p_230180_5_, boolean p_230180_6_, List<Pair<BannerPattern, DyeColor>> p_230180_7_) {
      p_230180_4_.render(p_230180_0_, p_230180_5_.buffer(p_230180_1_, RenderType::entitySolid), p_230180_2_, p_230180_3_);
      ...
      for(int i = 0; i < 17 && i < p_230180_7_.size(); ++i) {
         ...
         Material material = new Material(p_230180_6_ ? Atlases.BANNER_SHEET : Atlases.SHIELD_SHEET, pair.getFirst().location(p_230180_6_));
         p_230180_4_.render(p_230180_0_, material.buffer(p_230180_1_, RenderType::entityNoOutline), p_230180_2_, p_230180_3_, afloat[0], afloat[1], afloat[2], 1.0F);
      }
