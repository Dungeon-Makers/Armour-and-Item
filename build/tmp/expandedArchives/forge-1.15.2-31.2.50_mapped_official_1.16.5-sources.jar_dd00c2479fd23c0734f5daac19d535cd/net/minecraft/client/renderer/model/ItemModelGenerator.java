...
public class ItemModelGenerator {
   ...
   public BlockModel generateBlockModel(Function<Material, TextureAtlasSprite> p_209579_1_, BlockModel p_209579_2_) {
      ...
      for(int i = 0; i < LAYERS.size(); ++i) {
         ...
         Material material = p_209579_2_.getMaterial(s);
