...
public class BedTileEntityRenderer extends TileEntityRenderer<BedTileEntity> {
   ...
   public void render(BedTileEntity p_225616_1_, float p_225616_2_, MatrixStack p_225616_3_, IRenderTypeBuffer p_225616_4_, int p_225616_5_, int p_225616_6_) {
      Material material = Atlases.BED_TEXTURES[p_225616_1_.getColor().getId()];
      ...
      if (world != null) {
         ...
         this.renderPiece(p_225616_3_, p_225616_4_, blockstate.getValue(BedBlock.PART) == BedPart.HEAD, blockstate.getValue(BedBlock.FACING), material, i, p_225616_6_, false);
      } else {
         this.renderPiece(p_225616_3_, p_225616_4_, true, Direction.SOUTH, material, p_225616_5_, p_225616_6_, false);
         this.renderPiece(p_225616_3_, p_225616_4_, false, Direction.SOUTH, material, p_225616_5_, p_225616_6_, true);
      }

   }

   private void renderPiece(MatrixStack p_228847_1_, IRenderTypeBuffer p_228847_2_, boolean p_228847_3_, Direction p_228847_4_, Material p_228847_5_, int p_228847_6_, int p_228847_7_, boolean p_228847_8_) {
