...
public class Atlases {
   ...
   private static final RenderType field_228740_C_ = RenderType.entityTranslucent(AtlasTexture.LOCATION_BLOCKS);
   ...
   public static final List<Material> SHULKER_TEXTURE_LOCATION = Stream.of("white", "orange", "magenta", "light_blue", "yellow", "lime", "pink", "gray", "light_gray", "cyan", "purple", "blue", "brown", "green", "red", "black").map((p_228777_0_) -> {
      return new Material(SHULKER_SHEET, new ResourceLocation("entity/shulker/shulker_" + p_228777_0_));
   }).collect(ImmutableList.toImmutableList());
   public static final Map<WoodType, Material> SIGN_MATERIALS = WoodType.values().collect(Collectors.toMap(Function.identity(), Atlases::signTexture));
   public static final Material[] BED_TEXTURES = Arrays.stream(DyeColor.values()).sorted(Comparator.comparingInt(DyeColor::getId)).map((p_228770_0_) -> {
      return new Material(BED_SHEET, new ResourceLocation("entity/bed/" + p_228770_0_.getName()));
   }).toArray((p_228769_0_) -> {
   ...
   public static void getAllMaterials(Consumer<Material> p_228775_0_) {
      p_228775_0_.accept(DEFAULT_SHULKER_TEXTURE_LOCATION);
      SHULKER_TEXTURE_LOCATION.forEach(p_228775_0_);

      for(BannerPattern bannerpattern : BannerPattern.values()) {
         p_228775_0_.accept(new Material(BANNER_SHEET, bannerpattern.location(true)));
         p_228775_0_.accept(new Material(SHIELD_SHEET, bannerpattern.location(false)));
      }
   ...
   public static Material signTexture(WoodType p_228773_0_) {
      return new Material(SIGN_SHEET, new ResourceLocation("entity/signs/" + p_228773_0_.name()));
   }

   private static Material chestMaterial(String p_228774_0_) {
      return new Material(CHEST_SHEET, new ResourceLocation("entity/chest/" + p_228774_0_));
   }

   public static Material chooseMaterial(TileEntity p_228771_0_, ChestType p_228771_1_, boolean p_228771_2_) {
      if (p_228771_2_) {
   ...
   private static Material chooseMaterial(ChestType p_228772_0_, Material p_228772_1_, Material p_228772_2_, Material p_228772_3_) {
      switch(p_228772_0_) {
      case LEFT:
         return p_228772_2_;
      case RIGHT:
