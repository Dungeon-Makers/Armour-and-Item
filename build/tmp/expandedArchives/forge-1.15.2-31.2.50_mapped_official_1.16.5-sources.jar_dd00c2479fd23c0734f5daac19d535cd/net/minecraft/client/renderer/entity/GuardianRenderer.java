...
public class GuardianRenderer extends MobRenderer<GuardianEntity, GuardianModel> {
   ...
   public boolean shouldRender(GuardianEntity p_225626_1_, ClippingHelperImpl p_225626_2_, double p_225626_3_, double p_225626_5_, double p_225626_7_) {
      if (super.shouldRender(p_225626_1_, p_225626_2_, p_225626_3_, p_225626_5_, p_225626_7_)) {
         ...
         if (p_225626_1_.hasActiveAttackTarget()) {
            ...
            if (livingentity != null) {
               Vec3d vec3d = this.getPosition(livingentity, (double)livingentity.getBbHeight() * 0.5D, 1.0F);
               Vec3d vec3d1 = this.getPosition(p_225626_1_, (double)p_225626_1_.getEyeHeight(), 1.0F);
               return p_225626_2_.isVisible(new AxisAlignedBB(vec3d1.x, vec3d1.y, vec3d1.z, vec3d.x, vec3d.y, vec3d.z));
            }
         }
   ...
   public void render(GuardianEntity p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
      ...
      if (livingentity != null) {
         ...
         Vec3d vec3d = this.getPosition(livingentity, (double)livingentity.getBbHeight() * 0.5D, p_225623_3_);
