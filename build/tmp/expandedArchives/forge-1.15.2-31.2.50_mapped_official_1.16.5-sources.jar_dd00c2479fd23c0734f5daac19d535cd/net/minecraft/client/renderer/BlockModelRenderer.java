...
public class BlockModelRenderer {
   ...
   public boolean tesselateBlock(ILightReader p_228802_1_, IBakedModel p_228802_2_, BlockState p_228802_3_, BlockPos p_228802_4_, MatrixStack p_228802_5_, IVertexBuilder p_228802_6_, boolean p_228802_7_, Random p_228802_8_, long p_228802_9_, int p_228802_11_) {
   ...
   public boolean renderModel(ILightReader p_228802_1_, IBakedModel p_228802_2_, BlockState p_228802_3_, BlockPos p_228802_4_, MatrixStack p_228802_5_, IVertexBuilder p_228802_6_, boolean p_228802_7_, Random p_228802_8_, long p_228802_9_, int p_228802_11_, net.minecraftforge.client.model.data.IModelData modelData) {
      boolean flag = Minecraft.useAmbientOcclusion() && p_228802_3_.getLightValue(p_228802_1_, p_228802_4_) == 0 && p_228802_2_.useAmbientOcclusion();
      Vec3d vec3d = p_228802_3_.getOffset(p_228802_1_, p_228802_4_);
      p_228802_5_.translate(vec3d.x, vec3d.y, vec3d.z);
   ...
   @Deprecated //Forge: Model data argument
   public boolean tesselateWithAO(ILightReader p_228805_1_, IBakedModel p_228805_2_, BlockState p_228805_3_, BlockPos p_228805_4_, MatrixStack p_228805_5_, IVertexBuilder p_228805_6_, boolean p_228805_7_, Random p_228805_8_, long p_228805_9_, int p_228805_11_) {
   ...
   @Deprecated //Forge: Model data argument
   public boolean tesselateWithoutAO(ILightReader p_228806_1_, IBakedModel p_228806_2_, BlockState p_228806_3_, BlockPos p_228806_4_, MatrixStack p_228806_5_, IVertexBuilder p_228806_6_, boolean p_228806_7_, Random p_228806_8_, long p_228806_9_, int p_228806_11_) {
   ...
   private void renderModelFaceAO(ILightReader p_228799_1_, BlockState p_228799_2_, BlockPos p_228799_3_, MatrixStack p_228799_4_, IVertexBuilder p_228799_5_, List<BakedQuad> p_228799_6_, float[] p_228799_7_, BitSet p_228799_8_, BlockModelRenderer.AmbientOcclusionFace p_228799_9_, int p_228799_10_) {
      for(BakedQuad bakedquad : p_228799_6_) {
         ...
         p_228799_9_.func_228807_a_(p_228799_1_, p_228799_2_, p_228799_3_, bakedquad.getDirection(), p_228799_7_, p_228799_8_);
   ...
   private void putQuadData(ILightReader p_228800_1_, BlockState p_228800_2_, BlockPos p_228800_3_, IVertexBuilder p_228800_4_, MatrixStack.Entry p_228800_5_, BakedQuad p_228800_6_, float p_228800_7_, float p_228800_8_, float p_228800_9_, float p_228800_10_, int p_228800_11_, int p_228800_12_, int p_228800_13_, int p_228800_14_, int p_228800_15_) {
      ...
      if (p_228800_6_.shouldApplyDiffuseLighting()) {
         ...
         float l = net.minecraftforge.client.model.pipeline.LightUtil.diffuseLight(p_228800_6_.getDirection());
         f *= l;
         f1 *= l;
         f2 *= l;
      }
   ...
   private void calculateShape(ILightReader p_228801_1_, BlockState p_228801_2_, BlockPos p_228801_3_, int[] p_228801_4_, Direction p_228801_5_, @Nullable float[] p_228801_6_, BitSet p_228801_7_) {
      float f = 32.0F;
      float f1 = 32.0F;
      float f2 = 32.0F;
      float f3 = -32.0F;
   ...
   private void renderModelFaceFlat(ILightReader p_228798_1_, BlockState p_228798_2_, BlockPos p_228798_3_, int p_228798_4_, int p_228798_5_, boolean p_228798_6_, MatrixStack p_228798_7_, IVertexBuilder p_228798_8_, List<BakedQuad> p_228798_9_, BitSet p_228798_10_) {
      for(BakedQuad bakedquad : p_228798_9_) {
         ...
         this.putQuadData(p_228798_1_, p_228798_2_, p_228798_3_, p_228798_8_, p_228798_7_.last(), bakedquad, 1.0F, 1.0F, 1.0F, 1.0F, p_228798_4_, p_228798_4_, p_228798_4_, p_228798_4_, p_228798_5_);
      }
   ...
   class AmbientOcclusionFace {
      ...
      public void func_228807_a_(ILightReader p_228807_1_, BlockState p_228807_2_, BlockPos p_228807_3_, Direction p_228807_4_, float[] p_228807_5_, BitSet p_228807_6_) {
         BlockPos blockpos = p_228807_6_.get(0) ? p_228807_3_.relative(p_228807_4_) : p_228807_3_;
         BlockModelRenderer.NeighborInfo blockmodelrenderer$neighborinfo = BlockModelRenderer.NeighborInfo.fromFacing(p_228807_4_);
         BlockPos.Mutable blockpos$mutable = new BlockPos.Mutable();
         BlockModelRenderer.Cache blockmodelrenderer$cache = BlockModelRenderer.CACHE.get();
         blockpos$mutable.set(blockpos).move(blockmodelrenderer$neighborinfo.corners[0]);
         BlockState blockstate = p_228807_1_.getBlockState(blockpos$mutable);
         int i = blockmodelrenderer$cache.getLightColor(blockstate, p_228807_1_, blockpos$mutable);
         float f = blockmodelrenderer$cache.getShadeBrightness(blockstate, p_228807_1_, blockpos$mutable);
         blockpos$mutable.set(blockpos).move(blockmodelrenderer$neighborinfo.corners[1]);
         BlockState blockstate1 = p_228807_1_.getBlockState(blockpos$mutable);
         int j = blockmodelrenderer$cache.getLightColor(blockstate1, p_228807_1_, blockpos$mutable);
         float f1 = blockmodelrenderer$cache.getShadeBrightness(blockstate1, p_228807_1_, blockpos$mutable);
         blockpos$mutable.set(blockpos).move(blockmodelrenderer$neighborinfo.corners[2]);
         BlockState blockstate2 = p_228807_1_.getBlockState(blockpos$mutable);
         int k = blockmodelrenderer$cache.getLightColor(blockstate2, p_228807_1_, blockpos$mutable);
         float f2 = blockmodelrenderer$cache.getShadeBrightness(blockstate2, p_228807_1_, blockpos$mutable);
         blockpos$mutable.set(blockpos).move(blockmodelrenderer$neighborinfo.corners[3]);
         BlockState blockstate3 = p_228807_1_.getBlockState(blockpos$mutable);
         int l = blockmodelrenderer$cache.getLightColor(blockstate3, p_228807_1_, blockpos$mutable);
         float f3 = blockmodelrenderer$cache.getShadeBrightness(blockstate3, p_228807_1_, blockpos$mutable);
         blockpos$mutable.set(blockpos).move(blockmodelrenderer$neighborinfo.corners[0]).move(p_228807_4_);
         boolean flag = p_228807_1_.getBlockState(blockpos$mutable).getLightBlock(p_228807_1_, blockpos$mutable) == 0;
         blockpos$mutable.set(blockpos).move(blockmodelrenderer$neighborinfo.corners[1]).move(p_228807_4_);
         boolean flag1 = p_228807_1_.getBlockState(blockpos$mutable).getLightBlock(p_228807_1_, blockpos$mutable) == 0;
         blockpos$mutable.set(blockpos).move(blockmodelrenderer$neighborinfo.corners[2]).move(p_228807_4_);
         boolean flag2 = p_228807_1_.getBlockState(blockpos$mutable).getLightBlock(p_228807_1_, blockpos$mutable) == 0;
         blockpos$mutable.set(blockpos).move(blockmodelrenderer$neighborinfo.corners[3]).move(p_228807_4_);
         boolean flag3 = p_228807_1_.getBlockState(blockpos$mutable).getLightBlock(p_228807_1_, blockpos$mutable) == 0;
         float f4;
         int i1;
         if (!flag2 && !flag) {
            f4 = f;
            ...
            blockpos$mutable.set(blockpos).move(blockmodelrenderer$neighborinfo.corners[0]).move(blockmodelrenderer$neighborinfo.corners[2]);
            BlockState blockstate4 = p_228807_1_.getBlockState(blockpos$mutable);
            f4 = blockmodelrenderer$cache.getShadeBrightness(blockstate4, p_228807_1_, blockpos$mutable);
            i1 = blockmodelrenderer$cache.getLightColor(blockstate4, p_228807_1_, blockpos$mutable);
         }
         ...
         if (!flag3 && !flag) {
            ...
            blockpos$mutable.set(blockpos).move(blockmodelrenderer$neighborinfo.corners[0]).move(blockmodelrenderer$neighborinfo.corners[3]);
            BlockState blockstate6 = p_228807_1_.getBlockState(blockpos$mutable);
            f5 = blockmodelrenderer$cache.getShadeBrightness(blockstate6, p_228807_1_, blockpos$mutable);
            j1 = blockmodelrenderer$cache.getLightColor(blockstate6, p_228807_1_, blockpos$mutable);
         }
         ...
         if (!flag2 && !flag1) {
            ...
            blockpos$mutable.set(blockpos).move(blockmodelrenderer$neighborinfo.corners[1]).move(blockmodelrenderer$neighborinfo.corners[2]);
            BlockState blockstate7 = p_228807_1_.getBlockState(blockpos$mutable);
            f6 = blockmodelrenderer$cache.getShadeBrightness(blockstate7, p_228807_1_, blockpos$mutable);
            k1 = blockmodelrenderer$cache.getLightColor(blockstate7, p_228807_1_, blockpos$mutable);
         }
         ...
         if (!flag3 && !flag1) {
            ...
            blockpos$mutable.set(blockpos).move(blockmodelrenderer$neighborinfo.corners[1]).move(blockmodelrenderer$neighborinfo.corners[3]);
            BlockState blockstate8 = p_228807_1_.getBlockState(blockpos$mutable);
            f7 = blockmodelrenderer$cache.getShadeBrightness(blockstate8, p_228807_1_, blockpos$mutable);
            l1 = blockmodelrenderer$cache.getLightColor(blockstate8, p_228807_1_, blockpos$mutable);
         }

         int i3 = blockmodelrenderer$cache.getLightColor(p_228807_2_, p_228807_1_, p_228807_3_);
         blockpos$mutable.set(p_228807_3_).move(p_228807_4_);
         BlockState blockstate5 = p_228807_1_.getBlockState(blockpos$mutable);
         if (p_228807_6_.get(0) || !blockstate5.isSolidRender(p_228807_1_, blockpos$mutable)) {
            i3 = blockmodelrenderer$cache.getLightColor(blockstate5, p_228807_1_, blockpos$mutable);
         }

         float f8 = p_228807_6_.get(0) ? blockmodelrenderer$cache.getShadeBrightness(p_228807_1_.getBlockState(blockpos), p_228807_1_, blockpos) : blockmodelrenderer$cache.getShadeBrightness(p_228807_1_.getBlockState(p_228807_3_), p_228807_1_, p_228807_3_);
         BlockModelRenderer.VertexTranslations blockmodelrenderer$vertextranslations = BlockModelRenderer.VertexTranslations.fromFacing(p_228807_4_);
         if (p_228807_6_.get(1) && blockmodelrenderer$neighborinfo.doNonCubicWeight) {
            ...
            this.brightness[blockmodelrenderer$vertextranslations.vert0] = f29 * f13 + f30 * f14 + f31 * f15 + f32 * f16;
            this.brightness[blockmodelrenderer$vertextranslations.vert1] = f29 * f17 + f30 * f18 + f31 * f19 + f32 * f20;
            this.brightness[blockmodelrenderer$vertextranslations.vert2] = f29 * f21 + f30 * f22 + f31 * f23 + f32 * f24;
            this.brightness[blockmodelrenderer$vertextranslations.vert3] = f29 * f25 + f30 * f26 + f31 * f27 + f32 * f28;
   ...
   static class Cache {
      ...
      public int getLightColor(BlockState p_228810_1_, ILightReader p_228810_2_, BlockPos p_228810_3_) {
      ...
      public float getShadeBrightness(BlockState p_228811_1_, ILightReader p_228811_2_, BlockPos p_228811_3_) {
