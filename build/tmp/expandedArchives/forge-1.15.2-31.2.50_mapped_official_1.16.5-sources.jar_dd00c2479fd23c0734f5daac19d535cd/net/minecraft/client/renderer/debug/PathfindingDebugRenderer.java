      ...
      if (p_229034_3_) {
         for(int j = 0; j < p_229034_0_.getNodeCount(); ++j) {
            ...
            if (distanceToCamera(pathpoint1.asBlockPos(), p_229034_4_, p_229034_6_, p_229034_8_) <= 80.0F) {
               DebugRenderer.renderFloatingText(String.format("%s", pathpoint1.type), (double)pathpoint1.x + 0.5D, (double)pathpoint1.y + 0.75D, (double)pathpoint1.z + 0.5D, -1);
               DebugRenderer.renderFloatingText(String.format(Locale.ROOT, "%.2f", pathpoint1.costMalus), (double)pathpoint1.x + 0.5D, (double)pathpoint1.y + 0.25D, (double)pathpoint1.z + 0.5D, -1);
            }
         }
      }
