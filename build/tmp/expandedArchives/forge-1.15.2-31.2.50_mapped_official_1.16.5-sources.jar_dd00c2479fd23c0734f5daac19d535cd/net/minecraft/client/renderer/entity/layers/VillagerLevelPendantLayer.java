...
public class VillagerLevelPendantLayer<T extends LivingEntity & IVillagerDataHolder, M extends EntityModel<T> & IHeadToggle> extends LayerRenderer<T, M> implements IResourceManagerReloadListener {
   ...
   private final Object2ObjectMap<IVillagerType, VillagerMetadataSection.HatType> typeHatCache = new Object2ObjectOpenHashMap<>();
   ...
   public void render(MatrixStack p_225628_1_, IRenderTypeBuffer p_225628_2_, int p_225628_3_, T p_225628_4_, float p_225628_5_, float p_225628_6_, float p_225628_7_, float p_225628_8_, float p_225628_9_, float p_225628_10_) {
      if (!p_225628_4_.isInvisible()) {
         ...
         VillagerMetadataSection.HatType villagermetadatasection$hattype = this.getHatData(this.typeHatCache, "type", Registry.VILLAGER_TYPE, ivillagertype);
         ...
         ((IHeadToggle)m).hatVisible(villagermetadatasection$hattype1 == VillagerMetadataSection.HatType.NONE || villagermetadatasection$hattype1 == VillagerMetadataSection.HatType.PARTIAL && villagermetadatasection$hattype != VillagerMetadataSection.HatType.FULL);
         ResourceLocation resourcelocation = this.getResourceLocation("type", Registry.VILLAGER_TYPE.getKey(ivillagertype));
         renderColoredCutoutModel(m, resourcelocation, p_225628_1_, p_225628_2_, p_225628_3_, p_225628_4_, 1.0F, 1.0F, 1.0F);
         ((IHeadToggle)m).hatVisible(true);
      ...
      return p_215350_1_.computeIfAbsent(p_215350_4_, (p_215349_4_) -> {
         try (IResource iresource = this.resourceManager.getResource(this.getResourceLocation(p_215350_2_, p_215350_3_.getKey(p_215350_4_)))) {
            ...
            if (villagermetadatasection != null) {
               VillagerMetadataSection.HatType villagermetadatasection$hattype = villagermetadatasection.getHat();
