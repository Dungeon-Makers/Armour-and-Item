...
public class IllagerModel<T extends AbstractIllagerEntity> extends SegmentedModel<T> implements IHasArm, IHasHead {
   ...
   public void setupAnim(T p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
      ...
      if (abstractillagerentity$armpose == AbstractIllagerEntity.ArmPose.ATTACKING) {
         ...
         if (p_225597_1_.getMainArm() == HandSide.RIGHT) {
            this.rightArm.xRot = -1.8849558F + MathHelper.cos(p_225597_4_ * 0.09F) * 0.15F;
            this.leftArm.xRot = -0.0F + MathHelper.cos(p_225597_4_ * 0.19F) * 0.5F;
            this.rightArm.xRot += f * 2.2F - f1 * 0.4F;
            this.leftArm.xRot += f * 1.2F - f1 * 0.4F;
         } else {
            this.rightArm.xRot = -0.0F + MathHelper.cos(p_225597_4_ * 0.19F) * 0.5F;
            this.leftArm.xRot = -1.8849558F + MathHelper.cos(p_225597_4_ * 0.09F) * 0.15F;
         ...
         this.leftArm.yRot = MathHelper.lerp(f2 / 25.0F, 0.4F, 0.85F);
         this.leftArm.xRot = MathHelper.lerp(f2 / 25.0F, this.leftArm.xRot, (-(float)Math.PI / 2F));
   ...
   public void prepareMobModel(T p_212843_1_, float p_212843_2_, float p_212843_3_, float p_212843_4_) {
      this.field_217145_m = (float)p_212843_1_.getTicksUsingItem();
