...
public class WaterDebugRenderer implements DebugRenderer.IDebugRenderer {
   ...
   public void render(MatrixStack p_225619_1_, IRenderTypeBuffer p_225619_2_, double p_225619_3_, double p_225619_5_, double p_225619_7_) {
      BlockPos blockpos = this.minecraft.player.func_180425_c();
      ...
      for(BlockPos blockpos1 : BlockPos.betweenClosed(blockpos.offset(-10, -10, -10), blockpos.offset(10, 10, 10))) {
         ...
         if (ifluidstate.is(FluidTags.WATER)) {
            double d0 = (double)((float)blockpos1.getY() + ifluidstate.getHeight(iworldreader, blockpos1));
      ...
      for(BlockPos blockpos2 : BlockPos.betweenClosed(blockpos.offset(-10, -10, -10), blockpos.offset(10, 10, 10))) {
         ...
         if (ifluidstate1.is(FluidTags.WATER)) {
            DebugRenderer.renderFloatingText(String.valueOf(ifluidstate1.getAmount()), (double)blockpos2.getX() + 0.5D, (double)((float)blockpos2.getY() + ifluidstate1.getHeight(iworldreader, blockpos2)), (double)blockpos2.getZ() + 0.5D, -16777216);
         }
      }
