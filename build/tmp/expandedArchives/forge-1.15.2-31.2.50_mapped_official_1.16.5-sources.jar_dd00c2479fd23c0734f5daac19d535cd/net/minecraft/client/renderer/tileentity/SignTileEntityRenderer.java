...
public class SignTileEntityRenderer extends TileEntityRenderer<SignTileEntity> {
   ...
   public void render(SignTileEntity p_225616_1_, float p_225616_2_, MatrixStack p_225616_3_, IRenderTypeBuffer p_225616_4_, int p_225616_5_, int p_225616_6_) {
      ...
      IVertexBuilder ivertexbuilder = material.buffer(p_225616_4_, this.signModel::renderType);
      ...
      for(int j1 = 0; j1 < 4; ++j1) {
         String s = p_225616_1_.func_212364_a(j1, (p_212491_1_) -> {
            List<ITextComponent> list = RenderComponentsUtil.func_178908_a(p_212491_1_, 90, fontrenderer, false, true);
            return list.isEmpty() ? "" : list.get(0).func_150254_d();
         });
         if (s != null) {
            float f3 = (float)(-fontrenderer.width(s) / 2);
            fontrenderer.drawInBatch(s, f3, (float)(j1 * 10 - p_225616_1_.messages.length * 5), i1, false, p_225616_3_.last().pose(), p_225616_4_, false, 0, p_225616_5_);
         }
      }
   ...
   public static Material getMaterial(Block p_228877_0_) {
      WoodType woodtype;
