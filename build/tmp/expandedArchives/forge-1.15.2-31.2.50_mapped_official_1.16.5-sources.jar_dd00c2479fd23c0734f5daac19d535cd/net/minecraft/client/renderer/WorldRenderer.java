...
public class WorldRenderer implements AutoCloseable, IResourceManagerReloadListener {
   ...
   private void renderSnowAndRain(LightTexture p_228438_1_, float p_228438_2_, double p_228438_3_, double p_228438_5_, double p_228438_7_) {
      net.minecraftforge.client.IRenderHandler renderer = this.minecraft.level.func_201675_m().getWeatherRenderer();
      if (renderer != null) {
      ...
      if (!(f <= 0.0F)) {
         ...
         int l = 5;
         if (this.minecraft.options.field_74347_j) {
            l = 10;
         }
   ...
   public void allChanged() {
      if (this.level != null) {
         ...
         RenderTypeLookup.setFancy(this.minecraft.options.field_74347_j);
   ...
   private void setupRender(ActiveRenderInfo p_228437_1_, ClippingHelperImpl p_228437_2_, boolean p_228437_3_, int p_228437_4_, boolean p_228437_5_) {
      ...
      if (!p_228437_3_ && this.needsUpdate) {
         ...
         if (chunkrenderdispatcher$chunkrender != null) {
            ...
            Set<Direction> set1 = this.func_174978_c(blockpos);
            if (set1.size() == 1) {
         ...
         while(!queue.isEmpty()) {
            ...
            for(Direction direction2 : DIRECTIONS) {
               ...
               if ((!flag || !worldrenderer$localrenderinformationcontainer1.hasDirection(direction2.getOpposite())) && (!flag || direction == null || chunkrenderdispatcher$chunkrender3.getCompiledChunk().facesCanSeeEachother(direction.getOpposite(), direction2)) && chunkrenderdispatcher$chunkrender2 != null && chunkrenderdispatcher$chunkrender2.hasAllNeighbors() && chunkrenderdispatcher$chunkrender2.setFrame(p_228437_4_) && p_228437_2_.isVisible(chunkrenderdispatcher$chunkrender2.bb)) {
                  WorldRenderer.LocalRenderInformationContainer worldrenderer$localrenderinformationcontainer = new WorldRenderer.LocalRenderInformationContainer(chunkrenderdispatcher$chunkrender2, direction2, worldrenderer$localrenderinformationcontainer1.step + 1);
   ...
   private Set<Direction> func_174978_c(BlockPos p_174978_1_) {
   ...
   public void renderLevel(MatrixStack p_228426_1_, float p_228426_2_, long p_228426_3_, boolean p_228426_5_, ActiveRenderInfo p_228426_6_, GameRenderer p_228426_7_, LightTexture p_228426_8_, Matrix4f p_228426_9_) {
      ...
      if (flag) {
         ...
         clippinghelperimpl.prepare(d0, d1, d2);
      }
      ...
      boolean flag1 = this.minecraft.level.dimension.func_76568_b(MathHelper.floor(d0), MathHelper.floor(d1)) || this.minecraft.gui.getBossOverlay().shouldCreateWorldFog();
      ...
      for(Entity entity : this.level.entitiesForRendering()) {
         if ((this.entityRenderDispatcher.shouldRender(entity, clippinghelperimpl, d0, d1, d2) || entity.hasIndirectPassenger(this.minecraft.player)) && (entity != p_228426_6_.getEntity() || p_228426_6_.isDetached() || p_228426_6_.getEntity() instanceof LivingEntity && ((LivingEntity)p_228426_6_.getEntity()).isSleeping()) && (!(entity instanceof ClientPlayerEntity) || p_228426_6_.getEntity() == entity)) {
         ...
         if (!list.isEmpty()) {
            for(TileEntity tileentity1 : list) {
               ...
               if (sortedset != null && !sortedset.isEmpty()) {
                  ...
                  if (k3 >= 0) {
                     IVertexBuilder ivertexbuilder = new MatrixApplyingVertexBuilder(this.renderBuffers.crumblingBufferSource().getBuffer(ModelBakery.DESTROY_TYPES.get(k3)), p_228426_1_.last());
      ...
      for(Entry<SortedSet<DestroyBlockProgress>> entry : this.destructionProgress.long2ObjectEntrySet()) {
         ...
         if (!(d3 * d3 + d4 * d4 + d5 * d5 > 1024.0D)) {
            ...
            if (sortedset1 != null && !sortedset1.isEmpty()) {
               ...
               IVertexBuilder ivertexbuilder1 = new MatrixApplyingVertexBuilder(this.renderBuffers.crumblingBufferSource().getBuffer(ModelBakery.DESTROY_TYPES.get(j3)), p_228426_1_.last());
      ...
      if (p_228426_5_ && raytraceresult != null && raytraceresult.getType() == RayTraceResult.Type.BLOCK) {
         ...
         if (!net.minecraftforge.client.ForgeHooksClient.onDrawBlockHighlight(this, p_228426_6_, minecraft.hitResult, p_228426_2_, p_228426_1_, irendertypebuffer$impl))
      ...
      irendertypebuffer$impl.endBatch(Atlases.func_228784_i_());
   ...
   public void renderSky(MatrixStack p_228424_1_, float p_228424_2_) {
      net.minecraftforge.client.IRenderHandler renderer = this.level.func_201675_m().getSkyRenderer();
      if (renderer != null) {
         if (renderer instanceof net.minecraftforge.client.SkyRenderHandler) {
            ((net.minecraftforge.client.SkyRenderHandler) renderer).render(this.ticks, p_228424_2_, p_228424_1_, this.level, this.minecraft);
         } else {
            renderer.render(this.ticks, p_228424_2_, this.level, this.minecraft);
         }
         return;
      }
      if (this.minecraft.level.dimension.func_186058_p() == DimensionType.field_223229_c_) {
         this.renderEndSky(p_228424_1_);
      } else if (this.minecraft.level.dimension.func_76569_d()) {
         RenderSystem.disableTexture();
         ...
         RenderSystem.enableBlend();
         RenderSystem.defaultBlendFunc();
         float[] afloat = this.level.dimension.func_76560_a(this.level.func_72826_c(p_228424_2_), p_228424_2_);
         if (afloat != null) {
            RenderSystem.disableTexture();
         ...
         p_228424_1_.mulPose(Vector3f.XP.rotationDegrees(this.level.func_72826_c(p_228424_2_) * 360.0F));
         ...
         double d0 = this.minecraft.player.getEyePosition(p_228424_2_).y - this.level.func_228331_m_();
         if (d0 < 0.0D) {
            p_228424_1_.pushPose();
         ...
         if (this.level.dimension.func_76561_g()) {
   ...
   public void renderClouds(MatrixStack p_228425_1_, float p_228425_2_, double p_228425_3_, double p_228425_5_, double p_228425_7_) {
      net.minecraftforge.client.IRenderHandler renderer = this.level.func_201675_m().getCloudRenderer();
      if (renderer != null) {
         if (renderer instanceof net.minecraftforge.client.CloudRenderHandler) {
            ((net.minecraftforge.client.CloudRenderHandler) renderer).render(this.ticks, p_228425_2_, p_228425_1_, this.level, this.minecraft);
         } else {
            renderer.render(this.ticks, p_228425_2_, this.level, this.minecraft);
         }
         return;
      }
      if (this.minecraft.level.dimension.func_76569_d()) {
         RenderSystem.disableCull();
         RenderSystem.enableBlend();
         RenderSystem.enableAlphaTest();
         ...
         double d3 = (double)(this.level.dimension.func_76571_f() - (float)p_228425_5_ + 0.33F);
   ...
   public static void renderLineBox(IVertexBuilder p_228432_0_, double p_228432_1_, double p_228432_3_, double p_228432_5_, double p_228432_7_, double p_228432_9_, double p_228432_11_, float p_228432_13_, float p_228432_14_, float p_228432_15_, float p_228432_16_) {
      renderLineBox(new MatrixStack(), p_228432_0_, p_228432_1_, p_228432_3_, p_228432_5_, p_228432_7_, p_228432_9_, p_228432_11_, p_228432_13_, p_228432_14_, p_228432_15_, p_228432_16_, p_228432_13_, p_228432_14_, p_228432_15_);
   }
   ...
   public void playRecord(@Nullable SoundEvent p_184377_1_, BlockPos p_184377_2_, @Nullable MusicDiscItem musicDiscItem) {
      ...
      if (p_184377_1_ != null) {
         ...
         if (musicdiscitem != null) {
            this.minecraft.gui.func_73833_a(musicdiscitem.func_200299_h().func_150254_d());
         }
