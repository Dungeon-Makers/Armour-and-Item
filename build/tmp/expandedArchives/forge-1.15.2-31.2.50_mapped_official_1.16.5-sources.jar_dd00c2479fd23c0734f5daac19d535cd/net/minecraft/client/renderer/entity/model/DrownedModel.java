...
public class DrownedModel<T extends ZombieEntity> extends ZombieModel<T> {
   ...
   public void setupAnim(T p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
      ...
      if (this.swimAmount > 0.0F) {
         this.rightArm.xRot = this.rotlerpRad(this.rightArm.xRot, -2.5132742F, this.swimAmount) + this.swimAmount * 0.35F * MathHelper.sin(0.1F * p_225597_4_);
         this.leftArm.xRot = this.rotlerpRad(this.leftArm.xRot, -2.5132742F, this.swimAmount) - this.swimAmount * 0.35F * MathHelper.sin(0.1F * p_225597_4_);
