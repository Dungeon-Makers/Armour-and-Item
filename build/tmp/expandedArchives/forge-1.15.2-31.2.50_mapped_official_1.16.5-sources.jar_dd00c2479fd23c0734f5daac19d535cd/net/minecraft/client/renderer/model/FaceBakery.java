...
public class FaceBakery {
   ...
   public BakedQuad bakeQuad(Vector3f p_228824_1_, Vector3f p_228824_2_, BlockPartFace p_228824_3_, TextureAtlasSprite p_228824_4_, Direction p_228824_5_, IModelTransform p_228824_6_, @Nullable BlockPartRotation p_228824_7_, boolean p_228824_8_, ResourceLocation p_228824_9_) {
      ...
      int[] aint = this.makeVertices(blockfaceuv, p_228824_4_, p_228824_5_, this.setupShape(p_228824_1_, p_228824_2_), p_228824_6_.getRotation(), p_228824_7_, false);
   ...
   private int func_178413_a(Direction p_178413_1_) {
      float f = this.func_178412_b(p_178413_1_);
      int i = MathHelper.clamp((int)(f * 255.0F), 0, 255);
      return -16777216 | i << 16 | i << 8 | i;
   }

   private float func_178412_b(Direction p_178412_1_) {
      switch(p_178412_1_) {
      case DOWN:
         return 0.5F;
      case UP:
   ...
   private void bakeVertex(int[] p_228827_1_, int p_228827_2_, Direction p_228827_3_, BlockFaceUV p_228827_4_, float[] p_228827_5_, TextureAtlasSprite p_228827_6_, TransformationMatrix p_228827_7_, @Nullable BlockPartRotation p_228827_8_, boolean p_228827_9_) {
      Direction direction = Direction.rotate(p_228827_7_.getMatrix(), p_228827_3_);
      int i = p_228827_9_ ? this.func_178413_a(direction) : -1;
   ...
   private void func_228826_a_(int[] p_228826_1_, int p_228826_2_, Vector3f p_228826_3_, int p_228826_4_, TextureAtlasSprite p_228826_5_, BlockFaceUV p_228826_6_) {
      int i = p_228826_2_ * 8;
      p_228826_1_[i] = Float.floatToRawIntBits(p_228826_3_.x());
      p_228826_1_[i + 1] = Float.floatToRawIntBits(p_228826_3_.y());
      p_228826_1_[i + 2] = Float.floatToRawIntBits(p_228826_3_.z());
      p_228826_1_[i + 3] = p_228826_4_;
      p_228826_1_[i + 4] = Float.floatToRawIntBits(p_228826_5_.getU((double)p_228826_6_.getU(p_228826_2_)  * .999 + p_228826_6_.getU((p_228826_2_ + 2) % 4) * .001));
      p_228826_1_[i + 4 + 1] = Float.floatToRawIntBits(p_228826_5_.getV((double)p_228826_6_.getV(p_228826_2_) * .999 + p_228826_6_.getV((p_228826_2_ + 2) % 4) * .001));
   }
