...
public abstract class EntityRenderer<T extends Entity> {
   ...
   public final int getPackedLightCoords(T p_229100_1_, float p_229100_2_) {
      return LightTexture.pack(this.getBlockLightLevel(p_229100_1_, p_229100_2_), p_229100_1_.level.getBrightness(LightType.SKY, new BlockPos(p_229100_1_.getEyePosition(p_229100_2_))));
   }

   protected int getBlockLightLevel(T p_225624_1_, float p_225624_2_) {
      return p_225624_1_.isOnFire() ? 15 : p_225624_1_.level.getBrightness(LightType.BLOCK, new BlockPos(p_225624_1_.getEyePosition(p_225624_2_)));
   }
   ...
   public Vec3d getRenderOffset(T p_225627_1_, float p_225627_2_) {
      return Vec3d.ZERO;
   }
   ...
   public void render(T p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
      net.minecraftforge.client.event.RenderNameplateEvent renderNameplateEvent = new net.minecraftforge.client.event.RenderNameplateEvent(p_225623_1_, p_225623_1_.getDisplayName().func_150254_d(), this, p_225623_4_, p_225623_5_, p_225623_6_);
   ...
   protected void renderNameTag(T p_225629_1_, String p_225629_2_, MatrixStack p_225629_3_, IRenderTypeBuffer p_225629_4_, int p_225629_5_) {
