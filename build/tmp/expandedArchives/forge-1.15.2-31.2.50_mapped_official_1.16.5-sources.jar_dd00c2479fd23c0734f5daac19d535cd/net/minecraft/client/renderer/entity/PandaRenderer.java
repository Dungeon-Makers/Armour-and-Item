...
public class PandaRenderer extends MobRenderer<PandaEntity, PandaModel<PandaEntity>> {
   private static final Map<PandaEntity.Type, ResourceLocation> TEXTURES = Util.make(Maps.newEnumMap(PandaEntity.Type.class), (p_217776_0_) -> {
   ...
   public ResourceLocation getTextureLocation(PandaEntity p_110775_1_) {
      return TEXTURES.getOrDefault(p_110775_1_.getVariant(), TEXTURES.get(PandaEntity.Type.NORMAL));
   }
