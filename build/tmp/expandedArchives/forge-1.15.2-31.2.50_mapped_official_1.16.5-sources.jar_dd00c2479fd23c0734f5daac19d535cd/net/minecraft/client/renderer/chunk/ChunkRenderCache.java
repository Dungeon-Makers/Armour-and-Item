...
public class ChunkRenderCache implements ILightReader {
   ...
   public static ChunkRenderCache createIfNotEmpty(World p_212397_0_, BlockPos p_212397_1_, BlockPos p_212397_2_, int p_212397_3_) {
      ...
      for(int l1 = p_212397_1_.getX() >> 4; l1 <= p_212397_2_.getX() >> 4; ++l1) {
         for(int k1 = p_212397_1_.getZ() >> 4; k1 <= p_212397_2_.getZ() >> 4; ++k1) {
            ...
            if (!chunk.isYSpaceEmpty(p_212397_1_.getY(), p_212397_2_.getY())) {
               flag = false;
            }
         }
      }
      ...
      if (flag) {
         ...
         int i2 = 1;
         BlockPos blockpos = p_212397_1_.offset(-1, -1, -1);
         BlockPos blockpos1 = p_212397_2_.offset(1, 1, 1);
         return new ChunkRenderCache(p_212397_0_, i, j, achunk, blockpos, blockpos1);
      }
   }
   ...
   public ChunkRenderCache(World p_i49840_1_, int p_i49840_2_, int p_i49840_3_, Chunk[][] p_i49840_4_, BlockPos p_i49840_5_, BlockPos p_i49840_6_) {
      ...
      this.fluidStates = new IFluidState[this.xLength * this.yLength * this.zLength];
