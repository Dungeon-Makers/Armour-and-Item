...
public final class NativeImage implements AutoCloseable {
   ...
   public void func_195718_b(int p_195718_1_, int p_195718_2_, int p_195718_3_) {
      if (this.format != NativeImage.PixelFormat.RGBA) {
         throw new UnsupportedOperationException("Can only call blendPixel with RGBA format");
      } else {
         int i = this.getPixelRGBA(p_195718_1_, p_195718_2_);
         float f = (float)getA(p_195718_3_) / 255.0F;
         float f1 = (float)getB(p_195718_3_) / 255.0F;
         float f2 = (float)getG(p_195718_3_) / 255.0F;
         float f3 = (float)getR(p_195718_3_) / 255.0F;
         ...
         this.setPixelRGBA(p_195718_1_, p_195718_2_, combine(j, k, l, i1));
      }
   }
