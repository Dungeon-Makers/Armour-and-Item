...
public class BlockColors {
   ...
   private final Map<Block, Set<IProperty<?>>> coloringStates = Maps.newHashMap();

   public static BlockColors createDefault() {
      BlockColors blockcolors = new BlockColors();
      blockcolors.register((p_228065_0_, p_228065_1_, p_228065_2_, p_228065_3_) -> {
         return p_228065_1_ != null && p_228065_2_ != null ? BiomeColors.getAverageGrassColor(p_228065_1_, p_228065_0_.getValue(ShearableDoublePlantBlock.field_208063_b) == DoubleBlockHalf.UPPER ? p_228065_2_.below() : p_228065_2_) : -1;
      }, Blocks.LARGE_FERN, Blocks.TALL_GRASS);
      blockcolors.addColoringState(ShearableDoublePlantBlock.field_208063_b, Blocks.LARGE_FERN, Blocks.TALL_GRASS);
      ...
      blockcolors.register((p_228059_0_, p_228059_1_, p_228059_2_, p_228059_3_) -> {
         return RedstoneWireBlock.func_176337_b(p_228059_0_.getValue(RedstoneWireBlock.POWER));
   ...
   public int getColor(BlockState p_228054_1_, @Nullable ILightReader p_228054_2_, @Nullable BlockPos p_228054_3_, int p_228054_4_) {
   ...
   private void addColoringStates(Set<IProperty<?>> p_225309_1_, Block... p_225309_2_) {
   ...
   private void addColoringState(IProperty<?> p_225308_1_, Block... p_225308_2_) {
      this.addColoringStates(ImmutableSet.of(p_225308_1_), p_225308_2_);
   }

   public Set<IProperty<?>> getColoringProperties(Block p_225310_1_) {
