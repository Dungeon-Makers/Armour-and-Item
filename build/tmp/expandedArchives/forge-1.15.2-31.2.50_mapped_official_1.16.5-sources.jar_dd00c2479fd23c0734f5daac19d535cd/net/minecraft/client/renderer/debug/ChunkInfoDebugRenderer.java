...
public class ChunkInfoDebugRenderer implements DebugRenderer.IDebugRenderer {
   ...
   final class Entry {
      ...
      private Entry(IntegratedServer p_i226030_2_, double p_i226030_3_, double p_i226030_5_) {
         ...
         DimensionType dimensiontype = ChunkInfoDebugRenderer.this.minecraft.level.dimension.func_186058_p();
         ServerWorld serverworld;
         if (p_i226030_2_.getLevel(dimensiontype) != null) {
            serverworld = p_i226030_2_.getLevel(dimensiontype);
         } else {
            serverworld = null;
         }
