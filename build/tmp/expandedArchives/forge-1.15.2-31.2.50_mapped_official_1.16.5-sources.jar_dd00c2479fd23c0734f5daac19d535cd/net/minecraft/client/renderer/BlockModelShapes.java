...
public class BlockModelShapes {
   ...
   public static String statePropertiesToString(Map<IProperty<?>, Comparable<?>> p_209552_0_) {
      ...
      for(Entry<IProperty<?>, Comparable<?>> entry : p_209552_0_.entrySet()) {
         ...
         stringbuilder.append('=');
         stringbuilder.append(getValue(iproperty, entry.getValue()));
      }

      return stringbuilder.toString();
   }

   private static <T extends Comparable<T>> String getValue(IProperty<T> p_209555_0_, Comparable<?> p_209555_1_) {
