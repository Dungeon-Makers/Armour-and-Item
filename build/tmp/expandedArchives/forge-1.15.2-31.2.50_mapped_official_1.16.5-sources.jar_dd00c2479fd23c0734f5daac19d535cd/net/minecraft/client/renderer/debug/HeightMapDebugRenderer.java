...
public class HeightMapDebugRenderer implements DebugRenderer.IDebugRenderer {
   ...
   public void render(MatrixStack p_225619_1_, IRenderTypeBuffer p_225619_2_, double p_225619_3_, double p_225619_5_, double p_225619_7_) {
      ...
      for(BlockPos blockpos1 : BlockPos.betweenClosed(blockpos.offset(-40, 0, -40), blockpos.offset(40, 0, 40))) {
         int i = iworld.getHeight(Heightmap.Type.WORLD_SURFACE_WG, blockpos1.getX(), blockpos1.getZ());
         if (iworld.getBlockState(blockpos1.offset(0, i, 0).below()).isAir()) {
