...
public class PufferFishBigModel<T extends Entity> extends SegmentedModel<T> {
   ...
   public Iterable<ModelRenderer> parts() {
      return ImmutableList.of(this.cube, this.blueFin0, this.blueFin1, this.topFrontFin, this.topMidFin, this.topBackFin, this.sideFrontFin0, this.sideBackFin1, this.bottomFrontFin, this.bottomMidFin, this.bottomBackFin, this.sideBackFin0, this.sideBackFin1);
   }
