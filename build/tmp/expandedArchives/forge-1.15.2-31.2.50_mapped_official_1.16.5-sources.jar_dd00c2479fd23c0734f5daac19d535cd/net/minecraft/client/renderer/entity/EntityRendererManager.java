...
public class EntityRendererManager {
   ...
   private void registerRenderers(net.minecraft.client.renderer.ItemRenderer p_229097_1_, IReloadableResourceManager p_229097_2_) {
      ...
      this.register(EntityType.field_200785_Y, new PigZombieRenderer(this));
   ...
   public <E extends Entity> boolean shouldRender(E p_229086_1_, ClippingHelperImpl p_229086_2_, double p_229086_3_, double p_229086_5_, double p_229086_7_) {
   ...
   public <E extends Entity> void render(E p_229084_1_, double p_229084_2_, double p_229084_4_, double p_229084_6_, float p_229084_8_, float p_229084_9_, MatrixStack p_229084_10_, IRenderTypeBuffer p_229084_11_, int p_229084_12_) {
      ...
      try {
         Vec3d vec3d = entityrenderer.getRenderOffset(p_229084_1_, p_229084_9_);
         double d2 = p_229084_2_ + vec3d.x();
         double d3 = p_229084_4_ + vec3d.y();
         double d0 = p_229084_6_ + vec3d.z();
         ...
         p_229084_10_.translate(-vec3d.x(), -vec3d.y(), -vec3d.z());
   ...
   private void renderHitbox(MatrixStack p_229093_1_, IVertexBuilder p_229093_2_, Entity p_229093_3_, float p_229093_4_) {
      ...
      if (p_229093_3_ instanceof EnderDragonEntity) {
         double d0 = p_229093_3_.getX() - MathHelper.lerp((double)p_229093_4_, p_229093_3_.xOld, p_229093_3_.getX());
         double d1 = p_229093_3_.getY() - MathHelper.lerp((double)p_229093_4_, p_229093_3_.yOld, p_229093_3_.getY());
         double d2 = p_229093_3_.getZ() - MathHelper.lerp((double)p_229093_4_, p_229093_3_.zOld, p_229093_3_.getZ());
      ...
      Vec3d vec3d = p_229093_3_.getViewVector(p_229093_4_);
      ...
      p_229093_2_.vertex(matrix4f, (float)(vec3d.x * 2.0D), (float)((double)p_229093_3_.getEyeHeight() + vec3d.y * 2.0D), (float)(vec3d.z * 2.0D)).color(0, 0, 255, 255).endVertex();
   }
