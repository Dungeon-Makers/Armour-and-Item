      ...
      if (this.postMainBoxes.containsKey(dimensiontype)) {
         for(MutableBoundingBox mutableboundingbox : this.postMainBoxes.get(dimensiontype).values()) {
            if (blockpos.closerThan(mutableboundingbox.getCenter(), 500.0D)) {
               WorldRenderer.renderLineBox(ivertexbuilder, (double)mutableboundingbox.x0 - p_225619_3_, (double)mutableboundingbox.y0 - p_225619_5_, (double)mutableboundingbox.z0 - p_225619_7_, (double)(mutableboundingbox.x1 + 1) - p_225619_3_, (double)(mutableboundingbox.y1 + 1) - p_225619_5_, (double)(mutableboundingbox.z1 + 1) - p_225619_7_, 1.0F, 1.0F, 1.0F, 1.0F);
            }
         }
      }
      ...
      if (this.postPiecesBoxes.containsKey(dimensiontype)) {
         for(Entry<String, MutableBoundingBox> entry : this.postPiecesBoxes.get(dimensiontype).entrySet()) {
            ...
            if (blockpos.closerThan(mutableboundingbox1.getCenter(), 500.0D)) {
               if (obool) {
                  WorldRenderer.renderLineBox(ivertexbuilder, (double)mutableboundingbox1.x0 - p_225619_3_, (double)mutableboundingbox1.y0 - p_225619_5_, (double)mutableboundingbox1.z0 - p_225619_7_, (double)(mutableboundingbox1.x1 + 1) - p_225619_3_, (double)(mutableboundingbox1.y1 + 1) - p_225619_5_, (double)(mutableboundingbox1.z1 + 1) - p_225619_7_, 0.0F, 1.0F, 0.0F, 1.0F);
               } else {
                  WorldRenderer.renderLineBox(ivertexbuilder, (double)mutableboundingbox1.x0 - p_225619_3_, (double)mutableboundingbox1.y0 - p_225619_5_, (double)mutableboundingbox1.z0 - p_225619_7_, (double)(mutableboundingbox1.x1 + 1) - p_225619_3_, (double)(mutableboundingbox1.y1 + 1) - p_225619_5_, (double)(mutableboundingbox1.z1 + 1) - p_225619_7_, 0.0F, 0.0F, 1.0F, 1.0F);
               }
            }
