         ...
         if (k > 200L) {
            ...
            for(Entry<BlockPos, Integer> entry1 : map1.entrySet()) {
               ...
               if (set.add(blockpos)) {
                  ...
                  WorldRenderer.renderLineBox(ivertexbuilder, axisalignedbb.minX, axisalignedbb.minY, axisalignedbb.minZ, axisalignedbb.maxX, axisalignedbb.maxY, axisalignedbb.maxZ, 1.0F, 1.0F, 1.0F, 1.0F);
