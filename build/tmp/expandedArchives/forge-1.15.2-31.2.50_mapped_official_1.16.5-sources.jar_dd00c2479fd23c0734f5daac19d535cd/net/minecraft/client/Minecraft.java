...
public class Minecraft extends RecursiveEventLoop<Runnable> implements ISnooperInfo, IWindowEventListener {
   ...
   private final DebugProfiler profiler = new DebugProfiler(() -> {
      return this.timer.field_74280_b;
   });
   ...
   public Minecraft(GameConfiguration p_i45547_1_) {
      ...
      this.resourcePackRepository = new ResourcePackList<>(Minecraft::createClientPackAdapter);
      this.resourcePackRepository.func_198982_a(this.clientPackSource);
      this.resourcePackRepository.func_198982_a(new FolderPackFinder(this.resourcePackDirectory));
      ...
      String s;
      int i;
      if (p_i45547_1_.server.hostname != null) {
      ...
      Bootstrap.validate();
      KeybindTextComponent.keyResolver = KeyBinding::createNameSupplier;
      ...
      this.resourceManager = new SimpleReloadableResourceManager(ResourcePackType.CLIENT_RESOURCES, this.gameThread);
      ...
      this.fontManager = new FontResourceManager(this.textureManager, this.isEnforceUnicode());
      this.resourceManager.registerReloadListener(this.fontManager.getReloadListener());
      FontRenderer fontrenderer = this.fontManager.func_211504_a(DEFAULT_FONT);
      if (fontrenderer == null) {
         ...
         List<IResourcePack> list = this.resourcePackRepository.getSelectedPacks().stream().map(ResourcePackInfo::open).collect(Collectors.toList());
         this.setOverlay(new ResourceLoadProgressGui(this, this.resourceManager.createFullReload(Util.backgroundExecutor(), this, RESOURCE_RELOAD_INITIAL_TASK, list), (p_229990_2_) -> {
            Util.ifElse(p_229990_2_, this::rollbackResourcePacks, () -> {
               this.languageManager.func_135043_a(list);
               ...
               if (autoServerName != null) {
                  this.setScreen(new ConnectingScreen(new MainMenuScreen(), this, autoServerName, autoServerPort));
               } else {
   ...
   public CompletableFuture<Void> reloadResourcePacks() {
      if (this.pendingReload != null) {
         ...
         if (this.overlay instanceof ResourceLoadProgressGui) {
            ...
            this.resourcePackRepository.reload();
            List<IResourcePack> list = this.resourcePackRepository.getSelectedPacks().stream().map(ResourcePackInfo::open).collect(Collectors.toList());
            this.setOverlay(new ResourceLoadProgressGui(this, this.resourceManager.createFullReload(Util.backgroundExecutor(), this, RESOURCE_RELOAD_INITIAL_TASK, list), (p_229992_3_) -> {
               Util.ifElse(p_229992_3_, this::rollbackResourcePacks, () -> {
                  this.languageManager.func_135043_a(list);
   ...
   private void runTick(boolean p_195542_1_) {
      ...
      if (p_195542_1_) {
         this.timer.func_74275_a(Util.getMillis());
      ...
      if (p_195542_1_) {
         for(int j = 0; j < Math.min(10, this.timer.field_74280_b); ++j) {
            this.tick();
         }
      }
      ...
      this.profiler.pop();
      if (!this.noRender) {
         net.minecraftforge.fml.hooks.BasicEventHooks.onRenderTickStart(this.timer.partialTick);
         this.profiler.popPush("gameRenderer");
         this.gameRenderer.render(this.pause ? this.pausePartialTick : this.timer.partialTick, i, p_195542_1_);
         this.profiler.popPush("toasts");
         this.toast.func_195625_a();
         this.profiler.pop();
         net.minecraftforge.fml.hooks.BasicEventHooks.onRenderTickEnd(this.timer.partialTick);
      }
   ...
   public void resizeDisplay() {
      ...
      if (this.gameRenderer!=null) this.gameRenderer.resize(this.window.getWidth(), this.window.getHeight());
   ...
   void debugFpsMeterKeyPress(int p_71383_1_) {
      ...
      List<DataPoint> list = iprofileresult.getTimes(this.debugPath);
      if (!list.isEmpty()) {
   ...
   private void func_203410_as() {
      if (this.profiler.func_219899_d().func_219936_a()) {
         ...
         int k2 = 16777215;
         this.font.func_175063_a(s1, (float)(j - 160), (float)(k - 80 - 16), 16777215);
         s1 = decimalformat.format(datapoint.globalPercentage) + "%";
         this.font.func_175063_a(s1, (float)(j + 160 - this.font.width(s1)), (float)(k - 80 - 16), 16777215);
         ...
         for(int j2 = 0; j2 < list.size(); ++j2) {
            ...
            this.font.func_175063_a(s2, (float)(j - 160), (float)(k + 80 + j2 * 8 + 20), datapoint2.getColor());
            s2 = decimalformat.format(datapoint2.percentage) + "%";
            this.font.func_175063_a(s2, (float)(j + 160 - 50 - this.font.width(s2)), (float)(k + 80 + j2 * 8 + 20), datapoint2.getColor());
            s2 = decimalformat.format(datapoint2.globalPercentage) + "%";
            this.font.func_175063_a(s2, (float)(j + 160 - this.font.width(s2)), (float)(k + 80 + j2 * 8 + 20), datapoint2.getColor());
         }
   ...
   private void handleKeybinds() {
      for(; this.options.keyTogglePerspective.consumeClick(); this.levelRenderer.needsUpdate()) {
         ++this.options.field_74320_O;
         if (this.options.field_74320_O > 2) {
            this.options.field_74320_O = 0;
         }

         if (this.options.field_74320_O == 0) {
            this.gameRenderer.checkEntityPostEffect(this.getCameraEntity());
         } else if (this.options.field_74320_O == 1) {
      ...
      while(this.options.keySwapOffhand.consumeClick()) {
         if (!this.player.isSpectator()) {
            this.getConnection().send(new CPlayerDiggingPacket(CPlayerDiggingPacket.Action.SWAP_HELD_ITEMS, BlockPos.ZERO, Direction.DOWN));
         }
      }
   ...
   public void func_71371_a(String p_71371_1_, String p_71371_2_, @Nullable WorldSettings p_71371_3_) {
      this.clearLevel();
      SaveHandler savehandler = this.levelSource.func_197715_a(p_71371_1_, (MinecraftServer)null);
      ...
      try {
         ...
         this.singleplayerServer = new IntegratedServer(this, p_71371_1_, p_71371_2_, p_71371_3_, yggdrasilauthenticationservice, minecraftsessionservice, gameprofilerepository, playerprofilecache, (p_229999_1_) -> {
         ...
         this.singleplayerServer.func_71256_s();
         ...
         crashreportcategory.setDetail("Level ID", p_71371_1_);
         crashreportcategory.setDetail("Level Name", p_71371_2_);
         throw new ReportedException(crashreport);
      }
      ...
      while(!this.singleplayerServer.isReady()) {
         if (!net.minecraftforge.fml.StartupQuery.check() || this.singleplayerServer.isStopped()) {
            this.setScreen(null);
            return;
         } else if (this.screen == null) // if we're showing nothing, put the working screen back again
           this.setScreen(worldloadprogressscreen);
   ...
   public static boolean useFancyGraphics() {
      return instance.options.field_74347_j;
   }
   ...
   public void populateSnooper(Snooper p_70000_1_) {
      ...
      for(ClientResourcePackInfo clientresourcepackinfo : this.resourcePackRepository.getSelectedPacks()) {
         if (!clientresourcepackinfo.isRequired() && !clientresourcepackinfo.isFixedPosition()) {
            p_70000_1_.setDynamicData("resource_pack[" + i++ + "]", clientresourcepackinfo.getId());
         }
      }
   ...
   public ResourcePackList<ClientResourcePackInfo> getResourcePackRepository() {
   ...
   public MusicTicker.MusicType func_147109_W() {
      MusicTicker.MusicType type = this.level == null || this.level.dimension == null ? null : this.level.dimension.getMusicType();
      ...
      } else if (this.player.level.dimension instanceof EndDimension) {
         return this.gui.getBossOverlay().shouldPlayMusic() ? MusicTicker.MusicType.END_BOSS : MusicTicker.MusicType.END;
      } else {
         Biome.Category biome$category = this.player.level.getBiome(new BlockPos(this.player)).getBiomeCategory();
         if (!this.musicManager.func_209100_b(MusicTicker.MusicType.UNDER_WATER) && (!this.player.isUnderWater() || this.musicManager.func_209100_b(MusicTicker.MusicType.GAME) || biome$category != Biome.Category.OCEAN && biome$category != Biome.Category.RIVER)) {
            return this.player.abilities.instabuild && this.player.abilities.mayfly ? MusicTicker.MusicType.CREATIVE : MusicTicker.MusicType.GAME;
         } else {
   ...
   private static ClientResourcePackInfo createClientPackAdapter(String p_228011_0_, boolean p_228011_1_, Supplier<IResourcePack> p_228011_2_, IResourcePack p_228011_3_, PackMetadataSection p_228011_4_, ResourcePackInfo.Priority p_228011_5_) {
