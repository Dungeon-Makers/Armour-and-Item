         ...
         if (jsonarray != null) {
            ...
            for(JsonElement jsonelement : jsonarray) {
               try {
                  ...
                  String s4 = JSONUtils.getAsString(jsonobject1, "name");
                  String s3 = JSONUtils.getAsString(jsonobject1, "id");
                  Framebuffer framebuffer2 = this.getRenderTarget(s3);
                  if (framebuffer2 == null) {
                     ResourceLocation rl = ResourceLocation.tryParse(s3);
                     ...
                     int lvt_21_1_ = JSONUtils.getAsInt(jsonobject1, "width");
                     int lvt_22_1_ = JSONUtils.getAsInt(jsonobject1, "height");
                     boolean lvt_23_1_ = JSONUtils.getAsBoolean(jsonobject1, "bilinear");
                     if (lvt_23_1_) {
                     ...
                     shader.addAuxAsset(s4, lvt_20_2_.getId(), lvt_21_1_, lvt_22_1_);
                  } else {
                     shader.addAuxAsset(s4, framebuffer2, framebuffer2.width, framebuffer2.height);
                  }
               } catch (Exception exception1) {
