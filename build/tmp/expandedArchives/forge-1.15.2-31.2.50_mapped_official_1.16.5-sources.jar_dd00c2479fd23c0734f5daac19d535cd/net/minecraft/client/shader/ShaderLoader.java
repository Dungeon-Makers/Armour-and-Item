...
public class ShaderLoader {
   ...
   public static ShaderLoader compileShader(ShaderLoader.ShaderType p_216534_0_, String p_216534_1_, InputStream p_216534_2_) throws IOException {
      RenderSystem.assertThread(RenderSystem::isOnRenderThread);
      ...
      if (s == null) {
         ...
         if (GlStateManager.glGetShaderi(i, 35713) == 0) {
            ...
            throw new IOException("Couldn't compile " + p_216534_0_.getName() + " program: " + s1);
         } else {
