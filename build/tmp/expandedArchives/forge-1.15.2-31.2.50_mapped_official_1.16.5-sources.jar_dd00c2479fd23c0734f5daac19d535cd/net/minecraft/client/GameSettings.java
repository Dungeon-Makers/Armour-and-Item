...
public class GameSettings {
   ...
   public final KeyBinding keySwapOffhand = new KeyBinding("key.swapHands", 70, "key.categories.inventory");
         ...
         for(String s : compoundnbt1.getAllKeys()) {
            ...
            try {
               ...
               if ("fancyGraphics".equals(s)) {
                  this.field_74347_j = "true".equals(s1);
               }
               ...
               if ("resourcePacks".equals(s)) {
                  this.resourcePacks = JSONUtils.func_193840_a(GSON, s1, RESOURCE_PACK_TYPE);
               ...
               if ("incompatibleResourcePacks".equals(s)) {
                  this.incompatibleResourcePacks = JSONUtils.func_193840_a(GSON, s1, RESOURCE_PACK_TYPE);
   ...
   public void loadSelectedResourcePacks(ResourcePackList<ClientResourcePackInfo> p_198017_1_) {
      p_198017_1_.reload();
      ...
      while(iterator.hasNext()) {
         ...
         ClientResourcePackInfo clientresourcepackinfo = p_198017_1_.getPack(s);
         if (clientresourcepackinfo == null && !s.startsWith("file/")) {
            clientresourcepackinfo = p_198017_1_.getPack("file/" + s);
         }
   ...
   private void setForgeKeybindProperties() {
      ...
      keySwapOffhand.setKeyConflictContext(inGame);
   }
}
