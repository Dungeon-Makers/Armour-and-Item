...
public class WrittenBookItem extends Item {
   ...
   public void appendHoverText(ItemStack p_77624_1_, @Nullable World p_77624_2_, List<ITextComponent> p_77624_3_, ITooltipFlag p_77624_4_) {
      if (p_77624_1_.hasTag()) {
         ...
         if (!StringUtils.isNullOrEmpty(s)) {
            p_77624_3_.add((new TranslationTextComponent("book.byAuthor", s)).func_211708_a(TextFormatting.GRAY));
         }

         p_77624_3_.add((new TranslationTextComponent("book.generation." + compoundnbt.getInt("generation"))).func_211708_a(TextFormatting.GRAY));
      }
   ...
   public ActionResultType useOn(ItemUseContext p_195939_1_) {
      ...
      if (blockstate.getBlock() == Blocks.LECTERN) {
         return LecternBlock.tryPlaceBook(world, blockpos, blockstate, p_195939_1_.getItemInHand()) ? ActionResultType.SUCCESS : ActionResultType.PASS;
      } else {
         ...
         if (!makeSureTagIsValid(compoundnbt)) {
            ...
            for(int i = 0; i < listnbt.size(); ++i) {
               ...
               try {
                  ...
                  itextcomponent = TextComponentUtils.func_197680_a(p_220050_1_, itextcomponent, p_220050_2_, 0);
