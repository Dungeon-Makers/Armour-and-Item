...
public class SpawnEggItem extends Item {
   ...
   public ActionResultType useOn(ItemUseContext p_195939_1_) {
      ...
      if (world.isClientSide) {
         ...
         if (entitytype.spawn(world, itemstack, p_195939_1_.getPlayer(), blockpos1, SpawnReason.SPAWN_EGG, true, !Objects.equals(blockpos, blockpos1) && direction == Direction.UP) != null) {
            itemstack.shrink(1);
         }
   ...
   public ActionResult<ItemStack> use(World p_77659_1_, PlayerEntity p_77659_2_, Hand p_77659_3_) {
      ...
      if (raytraceresult.getType() != RayTraceResult.Type.BLOCK) {
         ...
         if (!(p_77659_1_.getBlockState(blockpos).getBlock() instanceof FlowingFluidBlock)) {
            ...
            EntityType<?> entitytype = this.getType(itemstack.getTag());
            if (entitytype.spawn(p_77659_1_, itemstack, p_77659_2_, blockpos, SpawnReason.SPAWN_EGG, false, false) == null) {
               return ActionResult.pass(itemstack);
            } else {
