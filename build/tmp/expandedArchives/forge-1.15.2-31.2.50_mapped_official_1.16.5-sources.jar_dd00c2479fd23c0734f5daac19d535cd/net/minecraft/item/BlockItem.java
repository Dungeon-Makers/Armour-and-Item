...
public class BlockItem extends Item {
   ...
   public ActionResultType useOn(ItemUseContext p_195939_1_) {
      ...
      return actionresulttype != ActionResultType.SUCCESS && this.isEdible() ? this.use(p_195939_1_.level, p_195939_1_.player, p_195939_1_.hand).getResult() : actionresulttype;
   }
   ...
   private static <T extends Comparable<T>> BlockState updateState(BlockState p_219988_0_, IProperty<T> p_219988_1_, String p_219988_2_) {
