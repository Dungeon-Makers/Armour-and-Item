...
public class TridentItem extends Item {
   public TridentItem(Item.Properties p_i48788_1_) {
      ...
      this.func_185043_a(new ResourceLocation("throwing"), (p_210315_0_, p_210315_1_, p_210315_2_) -> {
         return p_210315_2_ != null && p_210315_2_.isUsingItem() && p_210315_2_.getUseItem() == p_210315_0_ ? 1.0F : 0.0F;
      });
   }
            ...
            if (j <= 0 || playerentity.isInWaterOrRain()) {
               if (!p_77615_2_.isClientSide) {
                  ...
                  if (j == 0) {
                     ...
                     tridententity.func_184547_a(playerentity, playerentity.xRot, playerentity.yRot, 0.0F, 2.5F + (float)j * 0.5F, 1.0F);
   ...
   public Multimap<String, AttributeModifier> getDefaultAttributeModifiers(EquipmentSlotType p_111205_1_) {
      ...
      if (p_111205_1_ == EquipmentSlotType.MAINHAND) {
         multimap.put(SharedMonsterAttributes.field_111264_e.func_111108_a(), new AttributeModifier(BASE_ATTACK_DAMAGE_UUID, "Tool modifier", 8.0D, AttributeModifier.Operation.ADDITION));
         multimap.put(SharedMonsterAttributes.field_188790_f.func_111108_a(), new AttributeModifier(BASE_ATTACK_SPEED_UUID, "Tool modifier", (double)-2.9F, AttributeModifier.Operation.ADDITION));
      }
