...
public class FishBucketItem extends BucketItem {
   ...
   public void checkExtraContent(World p_203792_1_, ItemStack p_203792_2_, BlockPos p_203792_3_) {
      if (!p_203792_1_.isClientSide) {
         this.spawn(p_203792_1_, p_203792_2_, p_203792_3_);
      }
   ...
   private void spawn(World p_205357_1_, ItemStack p_205357_2_, BlockPos p_205357_3_) {
         ...
         if (compoundnbt != null && compoundnbt.contains("BucketVariantTag", 3)) {
            ...
            for(int j = 0; j < TropicalFishEntity.COMMON_VARIANTS.length; ++j) {
               if (i == TropicalFishEntity.COMMON_VARIANTS[j]) {
                  p_77624_3_.add((new TranslationTextComponent(TropicalFishEntity.getPredefinedName(j))).func_211709_a(atextformatting));
                  return;
               }
            }

            p_77624_3_.add((new TranslationTextComponent(TropicalFishEntity.getFishTypeName(i))).func_211709_a(atextformatting));
            ITextComponent itextcomponent = new TranslationTextComponent(s);
            if (!s.equals(s1)) {
               itextcomponent.func_150258_a(", ").func_150257_a(new TranslationTextComponent(s1));
            }

            itextcomponent.func_211709_a(atextformatting);
