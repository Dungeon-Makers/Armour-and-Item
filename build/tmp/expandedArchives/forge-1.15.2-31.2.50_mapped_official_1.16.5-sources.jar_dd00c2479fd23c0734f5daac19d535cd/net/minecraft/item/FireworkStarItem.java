...
public class FireworkStarItem extends Item {
   ...
   public static void appendHoverText(CompoundNBT p_195967_0_, List<ITextComponent> p_195967_1_) {
      ...
      p_195967_1_.add((new TranslationTextComponent("item.minecraft.firework_star.shape." + fireworkrocketitem$shape.getName())).func_211708_a(TextFormatting.GRAY));
      int[] aint = p_195967_0_.getIntArray("Colors");
      if (aint.length > 0) {
         p_195967_1_.add(func_200298_a((new StringTextComponent("")).func_211708_a(TextFormatting.GRAY), aint));
      }

      int[] aint1 = p_195967_0_.getIntArray("FadeColors");
      if (aint1.length > 0) {
         p_195967_1_.add(func_200298_a((new TranslationTextComponent("item.minecraft.firework_star.fade_to")).func_150258_a(" ").func_211708_a(TextFormatting.GRAY), aint1));
      }

      if (p_195967_0_.getBoolean("Trail")) {
         p_195967_1_.add((new TranslationTextComponent("item.minecraft.firework_star.trail")).func_211708_a(TextFormatting.GRAY));
      }

      if (p_195967_0_.getBoolean("Flicker")) {
         p_195967_1_.add((new TranslationTextComponent("item.minecraft.firework_star.flicker")).func_211708_a(TextFormatting.GRAY));
      }
   ...
   private static ITextComponent func_200298_a(ITextComponent p_200298_0_, int[] p_200298_1_) {
      for(int i = 0; i < p_200298_1_.length; ++i) {
         if (i > 0) {
            p_200298_0_.func_150258_a(", ");
         }

         p_200298_0_.func_150257_a(getColorName(p_200298_1_[i]));
      }
