...
public class Items {
   ...
   public static final Item COMPOSTER = registerBlock(Blocks.COMPOSTER, ItemGroup.TAB_MISC);
   ...
   public static final Item WOODEN_HOE = registerItem("wooden_hoe", new HoeItem(ItemTier.WOOD, -3.0F, (new Item.Properties()).tab(ItemGroup.TAB_TOOLS)));
   public static final Item STONE_HOE = registerItem("stone_hoe", new HoeItem(ItemTier.STONE, -2.0F, (new Item.Properties()).tab(ItemGroup.TAB_TOOLS)));
   public static final Item IRON_HOE = registerItem("iron_hoe", new HoeItem(ItemTier.IRON, -1.0F, (new Item.Properties()).tab(ItemGroup.TAB_TOOLS)));
   public static final Item DIAMOND_HOE = registerItem("diamond_hoe", new HoeItem(ItemTier.DIAMOND, 0.0F, (new Item.Properties()).tab(ItemGroup.TAB_TOOLS)));
   public static final Item GOLDEN_HOE = registerItem("golden_hoe", new HoeItem(ItemTier.GOLD, -3.0F, (new Item.Properties()).tab(ItemGroup.TAB_TOOLS)));
   ...
   public static final Item SUGAR_CANE = registerBlock(Blocks.SUGAR_CANE, ItemGroup.TAB_MISC);
   public static final Item KELP = registerBlock(Blocks.KELP, ItemGroup.TAB_MISC);
   public static final Item DRIED_KELP_BLOCK = registerBlock(Blocks.DRIED_KELP_BLOCK, ItemGroup.TAB_BUILDING_BLOCKS);
   public static final Item BAMBOO = registerBlock(Blocks.BAMBOO, ItemGroup.TAB_MATERIALS);
   ...
   public static final Item CLOCK = registerItem("clock", new ClockItem((new Item.Properties()).tab(ItemGroup.TAB_TOOLS)));
   ...
   public static final Item field_196179_dh = registerItem("zombie_pigman_spawn_egg", new SpawnEggItem(EntityType.field_200785_Y, 15373203, 5009705, (new Item.Properties()).tab(ItemGroup.TAB_MISC)));
   ...
   public static final Item CARROT_ON_A_STICK = registerItem("carrot_on_a_stick", new CarrotOnAStickItem((new Item.Properties()).durability(25).tab(ItemGroup.TAB_TRANSPORTATION)));
