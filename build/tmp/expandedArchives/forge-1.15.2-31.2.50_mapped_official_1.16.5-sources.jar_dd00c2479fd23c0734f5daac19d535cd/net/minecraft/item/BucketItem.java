...
public class BucketItem extends Item {
            ...
            if (this.content == Fluids.EMPTY) {
               ...
               if (blockstate1.getBlock() instanceof IBucketPickupHandler) {
                  ...
                  if (fluid != Fluids.EMPTY) {
                     ...
                     ItemStack itemstack1 = this.func_150910_a(itemstack, p_77659_2_, fluid.getBucket());
               ...
               if (this.emptyBucket(p_77659_2_, p_77659_1_, blockpos2, blockraytraceresult)) {
                  ...
                  p_77659_2_.awardStat(Stats.ITEM_USED.get(this));
                  return ActionResult.success(this.getEmptySuccessItem(itemstack, p_77659_2_));
               } else {
                  return ActionResult.fail(itemstack);
               }
            }
   ...
   private ItemStack func_150910_a(ItemStack p_150910_1_, PlayerEntity p_150910_2_, Item p_150910_3_) {
      if (p_150910_2_.abilities.instabuild) {
         return p_150910_1_;
      } else {
         ...
         if (p_150910_1_.isEmpty()) {
            ...
            if (!p_150910_2_.inventory.add(new ItemStack(p_150910_3_))) {
               p_150910_2_.drop(new ItemStack(p_150910_3_), false);
            }
   ...
   public boolean emptyBucket(@Nullable PlayerEntity p_180616_1_, World p_180616_2_, BlockPos p_180616_3_, @Nullable BlockRayTraceResult p_180616_4_) {
      if (!(this.content instanceof FlowingFluid)) {
         ...
         if (blockstate.isAir() || flag || canContainFluid) {
            if (p_180616_2_.dimension.func_177500_n() && this.content.is(FluidTags.WATER)) {
               ...
               if (((ILiquidContainer)blockstate.getBlock()).placeLiquid(p_180616_2_, p_180616_3_, blockstate, ((FlowingFluid)this.content).getSource(false))) {
               ...
               this.playEmptySound(p_180616_1_, p_180616_2_, p_180616_3_);
               p_180616_2_.setBlock(p_180616_3_, this.content.defaultFluidState().createLegacyBlock(), 11);
            }

            return true;
         } else {
            return p_180616_4_ == null ? false : this.emptyBucket(p_180616_1_, p_180616_2_, p_180616_4_.getBlockPos().relative(p_180616_4_.getDirection()), (BlockRayTraceResult)null);
         }
      }
   }
