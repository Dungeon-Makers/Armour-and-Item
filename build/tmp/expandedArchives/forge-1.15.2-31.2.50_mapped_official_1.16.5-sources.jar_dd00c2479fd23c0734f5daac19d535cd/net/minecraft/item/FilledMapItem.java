...
public class FilledMapItem extends AbstractMapItem {
   ...
   public static ItemStack create(World p_195952_0_, int p_195952_1_, int p_195952_2_, byte p_195952_3_, boolean p_195952_4_, boolean p_195952_5_) {
      ...
      createAndStoreSavedData(itemstack, p_195952_0_, p_195952_1_, p_195952_2_, p_195952_3_, p_195952_4_, p_195952_5_, p_195952_0_.dimension.func_186058_p());
      return itemstack;
   }
   ...
   protected MapData getCustomMapData(ItemStack p_195950_0_, World p_195950_1_) {
      ...
      if (mapdata == null && !p_195950_1_.isClientSide) {
         mapdata = createAndStoreSavedData(p_195950_0_, p_195950_1_, p_195950_1_.getLevelData().getXSpawn(), p_195950_1_.getLevelData().getZSpawn(), 3, false, false, p_195950_1_.dimension.func_186058_p());
      }
   ...
   private static MapData createAndStoreSavedData(ItemStack p_195951_0_, World p_195951_1_, int p_195951_2_, int p_195951_3_, int p_195951_4_, boolean p_195951_5_, boolean p_195951_6_, DimensionType p_195951_7_) {
   ...
   public void update(World p_77872_1_, Entity p_77872_2_, MapData p_77872_3_) {
      if (p_77872_1_.dimension.func_186058_p() == p_77872_3_.dimension && p_77872_2_ instanceof PlayerEntity) {
         ...
         int j1 = 128 / i;
         if (p_77872_1_.dimension.func_177495_o()) {
            j1 /= 2;
         }
                              ...
                              for(int j4 = 0; j4 < i; ++j4) {
                                 ...
                                 if (k4 <= 1) {
                                    ...
                                    while(true) {
                                       ...
                                       if (blockstate.getMapColor(p_77872_1_, blockpos$mutable1) != MaterialColor.NONE || k4 <= 0) {
                                          break;
                                       }
                                    }
   ...
   private BlockState getCorrectStateForFluidBlock(World p_211698_1_, BlockState p_211698_2_, BlockPos p_211698_3_) {
      ...
      return !ifluidstate.isEmpty() && !p_211698_2_.isFaceSturdy(p_211698_1_, p_211698_3_, Direction.UP) ? ifluidstate.createLegacyBlock() : p_211698_2_;
   }
   ...
   public static void renderBiomePreviewMap(ServerWorld p_226642_0_, ItemStack p_226642_1_) {
      ...
      if (mapdata != null) {
         if (p_226642_0_.dimension.func_186058_p() == mapdata.dimension) {
   ...
   @Nullable
   public static ItemStack lockMap(World p_219992_0_, ItemStack p_219992_1_) {
      MapData mapdata = getOrCreateSavedData(p_219992_1_, p_219992_0_);
      if (mapdata != null) {
         ItemStack itemstack = p_219992_1_.copy();
         MapData mapdata1 = createAndStoreSavedData(itemstack, p_219992_0_, 0, 0, mapdata.scale, mapdata.trackingPosition, mapdata.unlimitedTracking, mapdata.dimension);
   ...
   public void appendHoverText(ItemStack p_77624_1_, @Nullable World p_77624_2_, List<ITextComponent> p_77624_3_, ITooltipFlag p_77624_4_) {
      ...
      if (mapdata != null && mapdata.locked) {
         p_77624_3_.add((new TranslationTextComponent("filled_map.locked", getMapId(p_77624_1_))).func_211708_a(TextFormatting.GRAY));
      }

      if (p_77624_4_.isAdvanced()) {
         if (mapdata != null) {
            p_77624_3_.add((new TranslationTextComponent("filled_map.id", getMapId(p_77624_1_))).func_211708_a(TextFormatting.GRAY));
            p_77624_3_.add((new TranslationTextComponent("filled_map.scale", 1 << mapdata.scale)).func_211708_a(TextFormatting.GRAY));
            p_77624_3_.add((new TranslationTextComponent("filled_map.level", mapdata.scale, 4)).func_211708_a(TextFormatting.GRAY));
         } else {
            p_77624_3_.add((new TranslationTextComponent("filled_map.unknown")).func_211708_a(TextFormatting.GRAY));
         }
      }
   ...
   public ActionResultType useOn(ItemUseContext p_195939_1_) {
      ...
      if (blockstate.is(BlockTags.BANNERS)) {
         if (!p_195939_1_.level.isClientSide) {
