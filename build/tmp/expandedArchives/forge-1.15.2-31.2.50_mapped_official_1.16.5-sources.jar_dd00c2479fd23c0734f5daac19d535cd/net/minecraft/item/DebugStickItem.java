...
public class DebugStickItem extends Item {
      ...
      if (p_195958_1_.canUseGameMasterBlocks()) {
         ...
         if (collection.isEmpty()) {
            ...
            if (p_195958_5_) {
               ...
               BlockState blockstate = cycleState(p_195958_2_, iproperty, p_195958_1_.isSecondaryUseActive());
               p_195958_3_.setBlock(p_195958_4_, blockstate, 18);
               message(p_195958_1_, new TranslationTextComponent(this.getDescriptionId() + ".update", iproperty.getName(), getNameHelper(blockstate, iproperty)));
            } else {
               iproperty = getRelative(collection, iproperty, p_195958_1_.isSecondaryUseActive());
               String s2 = iproperty.getName();
               compoundnbt.putString(s, s2);
               message(p_195958_1_, new TranslationTextComponent(this.getDescriptionId() + ".select", s2, getNameHelper(p_195958_2_, iproperty)));
            }
   ...
   private static <T extends Comparable<T>> BlockState cycleState(BlockState p_195960_0_, IProperty<T> p_195960_1_, boolean p_195960_2_) {
      return p_195960_0_.setValue(p_195960_1_, (T)(getRelative(p_195960_1_.getPossibleValues(), p_195960_0_.getValue(p_195960_1_), p_195960_2_)));
   }
   ...
   private static void message(PlayerEntity p_195956_0_, ITextComponent p_195956_1_) {
      ((ServerPlayerEntity)p_195956_0_).func_195395_a(p_195956_1_, ChatType.GAME_INFO);
   }

   private static <T extends Comparable<T>> String getNameHelper(BlockState p_195957_0_, IProperty<T> p_195957_1_) {
