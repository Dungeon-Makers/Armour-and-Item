...
public class Item extends net.minecraftforge.registries.ForgeRegistryEntry<Item> implements IItemProvider, net.minecraftforge.common.extensions.IForgeItem {
   ...
   private static final IItemPropertyGetter field_185047_c = (p_210307_0_, p_210307_1_, p_210307_2_) -> {
      return MathHelper.clamp((float)p_210307_0_.getDamageValue() / (float)p_210307_0_.getMaxDamage(), 0.0F, 1.0F);
   };
   private static final IItemPropertyGetter field_185048_d = (p_210305_0_, p_210305_1_, p_210305_2_) -> {
      return p_210305_2_ != null && p_210305_2_.getMainArm() != HandSide.RIGHT ? 1.0F : 0.0F;
   };
   private static final IItemPropertyGetter field_185049_e = (p_210308_0_, p_210308_1_, p_210308_2_) -> {
      return p_210308_2_ instanceof PlayerEntity ? ((PlayerEntity)p_210308_2_).getCooldowns().getCooldownPercent(p_210308_0_.getItem(), 0.0F) : 0.0F;
   };
   ...
   public IItemPropertyGetter func_185045_a(ResourceLocation p_185045_1_) {
      return this.field_185051_m.get(p_185045_1_);
   }
   ...
   public final void func_185043_a(ResourceLocation p_185043_1_, IItemPropertyGetter p_185043_2_) {
      this.field_185051_m.put(p_185043_1_, p_185043_2_);
   }
   ...
   public boolean isEnchantable(ItemStack p_77616_1_) {
      return this.getItemStackLimit(p_77616_1_) == 1 && this.canBeDepleted();
   }

   protected static RayTraceResult getPlayerPOVHitResult(World p_219968_0_, PlayerEntity p_219968_1_, RayTraceContext.FluidMode p_219968_2_) {
      ...
      return p_219968_0_.clip(new RayTraceContext(vec3d, vec3d1, RayTraceContext.BlockMode.OUTLINE, p_219968_2_, p_219968_1_));
   }
   ...
   private final net.minecraftforge.common.util.ReverseTagWrapper<Item> reverseTags = new net.minecraftforge.common.util.ReverseTagWrapper<>(this, net.minecraft.tags.ItemTags::getGeneration, net.minecraft.tags.ItemTags::getAllTags);
   protected final boolean canRepair;

   @Override
   public boolean isRepairable(ItemStack stack) {
     return canRepair && canBeDepleted();
   }
   ...
   public boolean is(Tag<Item> p_206844_1_) {
      return p_206844_1_.func_199685_a_(this);
   }
