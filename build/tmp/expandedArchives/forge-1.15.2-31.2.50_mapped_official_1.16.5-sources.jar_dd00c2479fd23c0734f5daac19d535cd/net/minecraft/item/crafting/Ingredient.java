...
public class Ingredient implements Predicate<ItemStack> {
   ...
   private static final Predicate<? super Ingredient.IItemList> field_209362_b = (p_209361_0_) -> {
      return !p_209361_0_.getItems().stream().allMatch(ItemStack::isEmpty);
   };
   ...
   protected Ingredient(Stream<? extends Ingredient.IItemList> p_i49381_1_) {
      this.values = p_i49381_1_.filter(field_209362_b).toArray((p_209360_0_) -> {
         return new Ingredient.IItemList[p_209360_0_];
      });
      this.isSimple = !Arrays.stream(values).anyMatch(list -> list.getItems().stream().anyMatch(stack -> stack.getItem().canBeDepleted()));
   ...
   public static Ingredient of(IItemProvider... p_199804_0_) {
      return fromValues(Arrays.stream(p_199804_0_).map((p_209353_0_) -> {
         return new Ingredient.SingleItemList(new ItemStack(p_209353_0_));
      }));
   }

   public static Ingredient of(ItemStack... p_193369_0_) {
      return fromValues(Arrays.stream(p_193369_0_).map((p_209356_0_) -> {
         return new Ingredient.SingleItemList(p_209356_0_);
      }));
   }

   public static Ingredient of(Tag<Item> p_199805_0_) {
   ...
   public static Ingredient.IItemList valueFromJson(JsonObject p_199803_0_) {
      if (p_199803_0_.has("item") && p_199803_0_.has("tag")) {
         ...
         Item item = Registry.ITEM.func_218349_b(resourcelocation1).orElseThrow(() -> {
   ...
   public static class TagList implements Ingredient.IItemList {
      ...
      public Collection<ItemStack> getItems() {
         ...
         if (list.size() == 0 && !net.minecraftforge.common.ForgeConfig.SERVER.treatEmptyTagsAsAir.get()) {
            list.add(new ItemStack(net.minecraft.block.Blocks.BARRIER).setHoverName(new net.minecraft.util.text.StringTextComponent("Empty Tag: " + tag.func_199886_b().toString())));
         }
         return list;
      }
