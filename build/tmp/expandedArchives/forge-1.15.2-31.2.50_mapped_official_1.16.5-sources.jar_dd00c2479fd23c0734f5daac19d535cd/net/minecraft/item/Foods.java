...
public class Foods {
   ...
   public static final Food PUFFERFISH = (new Food.Builder()).nutrition(1).saturationMod(0.1F).effect(new EffectInstance(Effects.POISON, 1200, 3), 1.0F).effect(new EffectInstance(Effects.HUNGER, 300, 2), 1.0F).effect(new EffectInstance(Effects.CONFUSION, 300, 1), 1.0F).build();
