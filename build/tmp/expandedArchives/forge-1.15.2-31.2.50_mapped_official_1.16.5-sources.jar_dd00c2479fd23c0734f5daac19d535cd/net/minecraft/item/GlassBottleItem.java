...
public class GlassBottleItem extends Item {
   ...
   public ActionResult<ItemStack> use(World p_77659_1_, PlayerEntity p_77659_2_, Hand p_77659_3_) {
      ...
      if (!list.isEmpty()) {
         ...
         return ActionResult.success(this.turnBottleIntoItem(itemstack, p_77659_2_, new ItemStack(Items.DRAGON_BREATH)));
      } else {
         ...
         if (raytraceresult.getType() == RayTraceResult.Type.MISS) {
            ...
            if (raytraceresult.getType() == RayTraceResult.Type.BLOCK) {
               ...
               if (p_77659_1_.getFluidState(blockpos).is(FluidTags.WATER)) {
                  ...
                  return ActionResult.success(this.turnBottleIntoItem(itemstack, p_77659_2_, PotionUtils.setPotion(new ItemStack(Items.POTION), Potions.WATER)));
               }
            }
   ...
   protected ItemStack turnBottleIntoItem(ItemStack p_185061_1_, PlayerEntity p_185061_2_, ItemStack p_185061_3_) {
      ...
      if (p_185061_1_.isEmpty()) {
         ...
         if (!p_185061_2_.inventory.add(p_185061_3_)) {
            p_185061_2_.drop(p_185061_3_, false);
         }
