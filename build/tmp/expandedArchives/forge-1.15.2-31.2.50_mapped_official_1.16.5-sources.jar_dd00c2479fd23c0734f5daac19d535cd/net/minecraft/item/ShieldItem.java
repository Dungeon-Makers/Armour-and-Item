...
public class ShieldItem extends Item {
   public ShieldItem(Item.Properties p_i48470_1_) {
      ...
      this.func_185043_a(new ResourceLocation("blocking"), (p_210314_0_, p_210314_1_, p_210314_2_) -> {
         return p_210314_2_ != null && p_210314_2_.isUsingItem() && p_210314_2_.getUseItem() == p_210314_0_ ? 1.0F : 0.0F;
      });
   ...
   public boolean isValidRepairItem(ItemStack p_82789_1_, ItemStack p_82789_2_) {
      return ItemTags.PLANKS.func_199685_a_(p_82789_2_.getItem()) || super.isValidRepairItem(p_82789_1_, p_82789_2_);
   }
