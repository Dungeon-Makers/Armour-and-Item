...
public class CrossbowItem extends ShootableItem {
   ...
   public CrossbowItem(Item.Properties p_i50052_1_) {
      ...
      this.func_185043_a(new ResourceLocation("pull"), (p_220022_1_, p_220022_2_, p_220022_3_) -> {
         if (p_220022_3_ != null && p_220022_1_.getItem() == this) {
            return isCharged(p_220022_1_) ? 0.0F : (float)(p_220022_1_.getUseDuration() - p_220022_3_.getUseItemRemainingTicks()) / (float)getChargeDuration(p_220022_1_);
         } else {
            return 0.0F;
         }
      });
      this.func_185043_a(new ResourceLocation("pulling"), (p_220033_0_, p_220033_1_, p_220033_2_) -> {
         return p_220033_2_ != null && p_220033_2_.isUsingItem() && p_220033_2_.getUseItem() == p_220033_0_ && !isCharged(p_220033_0_) ? 1.0F : 0.0F;
      });
      this.func_185043_a(new ResourceLocation("charged"), (p_220030_0_, p_220030_1_, p_220030_2_) -> {
         return p_220030_2_ != null && isCharged(p_220030_0_) ? 1.0F : 0.0F;
      });
      this.func_185043_a(new ResourceLocation("firework"), (p_220020_0_, p_220020_1_, p_220020_2_) -> {
         return p_220020_2_ != null && isCharged(p_220020_0_) && containsChargedProjectile(p_220020_0_, Items.FIREWORK_ROCKET) ? 1.0F : 0.0F;
      });
   }
   ...
   private static boolean containsChargedProjectile(ItemStack p_220019_0_, Item p_220019_1_) {
   ...
   private static void shootProjectile(World p_220016_0_, LivingEntity p_220016_1_, Hand p_220016_2_, ItemStack p_220016_3_, ItemStack p_220016_4_, float p_220016_5_, boolean p_220016_6_, float p_220016_7_, float p_220016_8_, float p_220016_9_) {
      if (!p_220016_0_.isClientSide) {
         ...
         if (flag) {
            iprojectile = new FireworkRocketEntity(p_220016_0_, p_220016_4_, p_220016_1_.getX(), p_220016_1_.getEyeY() - (double)0.15F, p_220016_1_.getZ(), true);
         } else {
            iprojectile = getArrow(p_220016_0_, p_220016_1_, p_220016_3_, p_220016_4_);
         ...
         if (p_220016_1_ instanceof ICrossbowUser) {
            ...
            icrossbowuser.func_213670_a(icrossbowuser.getTarget(), p_220016_3_, iprojectile, p_220016_9_);
         } else {
            Vec3d vec3d1 = p_220016_1_.getUpVector(1.0F);
            Quaternion quaternion = new Quaternion(new Vector3f(vec3d1), p_220016_9_, true);
            Vec3d vec3d = p_220016_1_.getViewVector(1.0F);
         ...
         p_220016_0_.addFreshEntity((Entity)iprojectile);
   ...
   public void appendHoverText(ItemStack p_77624_1_, @Nullable World p_77624_2_, List<ITextComponent> p_77624_3_, ITooltipFlag p_77624_4_) {
      ...
      if (isCharged(p_77624_1_) && !list.isEmpty()) {
         ...
         p_77624_3_.add((new TranslationTextComponent("item.minecraft.crossbow.projectile")).func_150258_a(" ").func_150257_a(itemstack.getDisplayName()));
         if (p_77624_4_.isAdvanced() && itemstack.getItem() == Items.FIREWORK_ROCKET) {
            ...
            if (!list1.isEmpty()) {
               for(int i = 0; i < list1.size(); ++i) {
                  list1.set(i, (new StringTextComponent("  ")).func_150257_a(list1.get(i)).func_211708_a(TextFormatting.GRAY));
               }
