...
public class BoatItem extends Item {
   ...
   public ActionResult<ItemStack> use(World p_77659_1_, PlayerEntity p_77659_2_, Hand p_77659_3_) {
      ...
      if (raytraceresult.getType() == RayTraceResult.Type.MISS) {
         ...
         Vec3d vec3d = p_77659_2_.getViewVector(1.0F);
         double d0 = 5.0D;
         List<Entity> list = p_77659_1_.getEntities(p_77659_2_, p_77659_2_.getBoundingBox().expandTowards(vec3d.scale(5.0D)).inflate(1.0D), ENTITY_PREDICATE);
         if (!list.isEmpty()) {
            Vec3d vec3d1 = p_77659_2_.getEyePosition(1.0F);
