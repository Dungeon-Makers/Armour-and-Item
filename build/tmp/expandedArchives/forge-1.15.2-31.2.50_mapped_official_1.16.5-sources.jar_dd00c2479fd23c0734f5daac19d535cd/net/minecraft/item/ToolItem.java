...
public class ToolItem extends TieredItem {
   ...
   protected final float field_185065_c;
   ...
   protected ToolItem(float p_i48512_1_, float p_i48512_2_, IItemTier p_i48512_3_, Set<Block> p_i48512_4_, Item.Properties p_i48512_5_) {
      ...
      this.field_185065_c = p_i48512_2_;
   }
   ...
   public Multimap<String, AttributeModifier> getDefaultAttributeModifiers(EquipmentSlotType p_111205_1_) {
      ...
      if (p_111205_1_ == EquipmentSlotType.MAINHAND) {
         multimap.put(SharedMonsterAttributes.field_111264_e.func_111108_a(), new AttributeModifier(BASE_ATTACK_DAMAGE_UUID, "Tool modifier", (double)this.attackDamageBaseline, AttributeModifier.Operation.ADDITION));
         multimap.put(SharedMonsterAttributes.field_188790_f.func_111108_a(), new AttributeModifier(BASE_ATTACK_SPEED_UUID, "Tool modifier", (double)this.field_185065_c, AttributeModifier.Operation.ADDITION));
      }
