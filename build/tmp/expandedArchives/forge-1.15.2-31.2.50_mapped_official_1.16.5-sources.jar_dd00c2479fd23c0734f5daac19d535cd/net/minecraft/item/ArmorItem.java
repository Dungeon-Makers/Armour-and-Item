...
public class ArmorItem extends Item {
   ...
   public Multimap<String, AttributeModifier> getDefaultAttributeModifiers(EquipmentSlotType p_111205_1_) {
      ...
      if (p_111205_1_ == this.slot) {
         multimap.put(SharedMonsterAttributes.field_188791_g.func_111108_a(), new AttributeModifier(ARMOR_MODIFIER_UUID_PER_SLOT[p_111205_1_.getIndex()], "Armor modifier", (double)this.defense, AttributeModifier.Operation.ADDITION));
         multimap.put(SharedMonsterAttributes.field_189429_h.func_111108_a(), new AttributeModifier(ARMOR_MODIFIER_UUID_PER_SLOT[p_111205_1_.getIndex()], "Armor toughness", (double)this.toughness, AttributeModifier.Operation.ADDITION));
      }
