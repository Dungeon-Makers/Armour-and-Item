...
public class EnderEyeItem extends Item {
   ...
   public ActionResult<ItemStack> use(World p_77659_1_, PlayerEntity p_77659_2_, Hand p_77659_3_) {
      ...
      if (raytraceresult.getType() == RayTraceResult.Type.BLOCK && p_77659_1_.getBlockState(((BlockRayTraceResult)raytraceresult).getBlockPos()).getBlock() == Blocks.END_PORTAL_FRAME) {
         return ActionResult.pass(itemstack);
      } else {
         p_77659_2_.startUsingItem(p_77659_3_);
         if (p_77659_1_ instanceof ServerWorld) {
            BlockPos blockpos = ((ServerWorld)p_77659_1_).getChunkSource().getGenerator().func_211403_a(p_77659_1_, "Stronghold", new BlockPos(p_77659_2_), 100, false);
            if (blockpos != null) {
               ...
               p_77659_1_.levelEvent((PlayerEntity)null, 1003, new BlockPos(p_77659_2_), 0);
