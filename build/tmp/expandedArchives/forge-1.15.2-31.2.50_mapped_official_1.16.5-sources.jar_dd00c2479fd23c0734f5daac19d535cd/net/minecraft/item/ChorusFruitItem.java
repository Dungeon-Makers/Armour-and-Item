   ...
   public ItemStack finishUsingItem(ItemStack p_77654_1_, World p_77654_2_, LivingEntity p_77654_3_) {
      ...
      if (!p_77654_2_.isClientSide) {
         ...
         for(int i = 0; i < 16; ++i) {
            ...
            double d4 = MathHelper.clamp(p_77654_3_.getY() + (double)(p_77654_3_.getRandom().nextInt(16) - 8), 0.0D, (double)(p_77654_2_.func_72940_L() - 1));
            ...
            if (p_77654_3_.randomTeleport(d3, d4, d5, true)) {
               p_77654_2_.playSound((PlayerEntity)null, d0, d1, d2, SoundEvents.CHORUS_FRUIT_TELEPORT, SoundCategory.PLAYERS, 1.0F, 1.0F);
               p_77654_3_.playSound(SoundEvents.CHORUS_FRUIT_TELEPORT, 1.0F, 1.0F);
               break;
            }
         }
