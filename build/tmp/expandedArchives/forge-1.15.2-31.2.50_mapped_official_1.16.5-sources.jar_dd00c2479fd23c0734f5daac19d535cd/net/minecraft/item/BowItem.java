   ...
   public BowItem(Item.Properties p_i48522_1_) {
      ...
      this.func_185043_a(new ResourceLocation("pull"), (p_210310_0_, p_210310_1_, p_210310_2_) -> {
         if (p_210310_2_ == null) {
            ...
            return !(p_210310_2_.getUseItem().getItem() instanceof BowItem) ? 0.0F : (float)(p_210310_0_.getUseDuration() - p_210310_2_.getUseItemRemainingTicks()) / 20.0F;
         }
      });
         ...
         if (!itemstack.isEmpty() || flag) {
            ...
            if (!((double)f < 0.1D)) {
               ...
               if (!p_77615_2_.isClientSide) {
                  ...
                  abstractarrowentity.func_184547_a(playerentity, playerentity.xRot, playerentity.yRot, 0.0F, f * 3.0F, 1.0F);
                  if (f == 1.0F) {
