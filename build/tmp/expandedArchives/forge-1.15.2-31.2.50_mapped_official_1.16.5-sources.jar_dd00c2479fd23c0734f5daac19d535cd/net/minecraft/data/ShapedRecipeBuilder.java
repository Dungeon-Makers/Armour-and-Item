...
public class ShapedRecipeBuilder {
   ...
   public ShapedRecipeBuilder define(Character p_200469_1_, Tag<Item> p_200469_2_) {
   ...
   public void save(Consumer<IFinishedRecipe> p_200467_1_, ResourceLocation p_200467_2_) {
      ...
      this.advancement.parent(new ResourceLocation("recipes/root")).addCriterion("has_the_recipe", new RecipeUnlockedTrigger.Instance(p_200467_2_)).rewards(AdvancementRewards.Builder.recipe(p_200467_2_)).requirements(IRequirementsStrategy.OR);
