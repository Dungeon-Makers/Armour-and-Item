      ...
      for(Block block : Registry.BLOCK) {
         ...
         if (!statecontainer.getProperties().isEmpty()) {
            ...
            for(IProperty<?> iproperty : statecontainer.getProperties()) {
               ...
               for(Comparable<?> comparable : iproperty.getPossibleValues()) {
                  jsonarray.add(Util.getPropertyName(iproperty, comparable));
               }
         ...
         for(BlockState blockstate : statecontainer.getPossibleStates()) {
            ...
            for(IProperty<?> iproperty1 : statecontainer.getProperties()) {
               jsonobject4.addProperty(iproperty1.getName(), Util.getPropertyName(iproperty1, blockstate.getValue(iproperty1)));
            }
