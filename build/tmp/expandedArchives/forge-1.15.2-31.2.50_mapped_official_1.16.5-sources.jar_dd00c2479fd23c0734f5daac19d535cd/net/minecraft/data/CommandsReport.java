...
public class CommandsReport implements IDataProvider {
   ...
   public void run(DirectoryCache p_200398_1_) throws IOException {
      ...
      MinecraftServer minecraftserver = new DedicatedServer(file1, serverpropertiesprovider, DataFixesManager.getDataFixer(), yggdrasilauthenticationservice, minecraftsessionservice, gameprofilerepository, playerprofilecache, LoggingChunkStatusListener::new, serverpropertiesprovider.getProperties().levelName);
      Path path = this.generator.getOutputFolder().resolve("reports/commands.json");
      CommandDispatcher<CommandSource> commanddispatcher = minecraftserver.getCommands().getDispatcher();
