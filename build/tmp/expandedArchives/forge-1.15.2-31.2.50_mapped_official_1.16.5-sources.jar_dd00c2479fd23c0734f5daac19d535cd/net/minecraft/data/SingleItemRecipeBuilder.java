...
public class SingleItemRecipeBuilder {
   ...
   public void save(Consumer<IFinishedRecipe> p_218647_1_, ResourceLocation p_218647_2_) {
      ...
      this.advancement.parent(new ResourceLocation("recipes/root")).addCriterion("has_the_recipe", new RecipeUnlockedTrigger.Instance(p_218647_2_)).rewards(AdvancementRewards.Builder.recipe(p_218647_2_)).requirements(IRequirementsStrategy.OR);
