...
public class BlockLootTables implements Consumer<BiConsumer<ResourceLocation, LootTable.Builder>> {
   ...
   protected static LootTable.Builder createSelfDropDispatchTable(Block p_218494_0_, ILootCondition.IBuilder p_218494_1_, LootEntry.Builder<?> p_218494_2_) {
      return LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantRange.exactly(1)).add(((StandaloneLootEntry.Builder)ItemLootEntry.lootTableItem(p_218494_0_).when(p_218494_1_)).otherwise(p_218494_2_)));
   }
   ...
   protected static <T extends Comparable<T> & IStringSerializable> LootTable.Builder createSinglePropConditionTable(Block p_218562_0_, IProperty<T> p_218562_1_, T p_218562_2_) {
   ...
   protected static LootTable.Builder createCropDrops(Block p_218541_0_, Item p_218541_1_, Item p_218541_2_, ILootCondition.IBuilder p_218541_3_) {
      return applyExplosionDecay(p_218541_0_, LootTable.lootTable().withPool(LootPool.lootPool().add(((StandaloneLootEntry.Builder)ItemLootEntry.lootTableItem(p_218541_1_).when(p_218541_3_)).otherwise(ItemLootEntry.lootTableItem(p_218541_2_)))).withPool(LootPool.lootPool().when(p_218541_3_).add(ItemLootEntry.lootTableItem(p_218541_2_).apply(ApplyBonus.addBonusBinomialDistributionCount(Enchantments.BLOCK_FORTUNE, 0.5714286F, 3)))));
   }
   ...
   protected void addTables() {
      ...
      this.add(Blocks.ACACIA_DOOR, (p_218483_0_) -> {
         return createSinglePropConditionTable(p_218483_0_, DoorBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.add(Blocks.BIRCH_DOOR, (p_218528_0_) -> {
         return createSinglePropConditionTable(p_218528_0_, DoorBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.add(Blocks.DARK_OAK_DOOR, (p_218468_0_) -> {
         return createSinglePropConditionTable(p_218468_0_, DoorBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.add(Blocks.IRON_DOOR, (p_218510_0_) -> {
         return createSinglePropConditionTable(p_218510_0_, DoorBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.add(Blocks.JUNGLE_DOOR, (p_218498_0_) -> {
         return createSinglePropConditionTable(p_218498_0_, DoorBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.add(Blocks.OAK_DOOR, (p_218480_0_) -> {
         return createSinglePropConditionTable(p_218480_0_, DoorBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.add(Blocks.SPRUCE_DOOR, (p_218527_0_) -> {
         return createSinglePropConditionTable(p_218527_0_, DoorBlock.HALF, DoubleBlockHalf.LOWER);
      });
      ...
      this.add(Blocks.PLAYER_HEAD, (p_218565_0_) -> {
         return LootTable.lootTable().withPool(applyExplosionCondition(p_218565_0_, LootPool.lootPool().setRolls(ConstantRange.exactly(1)).add(ItemLootEntry.lootTableItem(p_218565_0_).apply(CopyNbt.copyData(CopyNbt.Source.BLOCK_ENTITY).copy("Owner", "SkullOwner")))));
      });
      ...
      this.add(Blocks.DARK_OAK_LEAVES, (p_218471_0_) -> {
         return createOakLeavesDrops(p_218471_0_, Blocks.DARK_OAK_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES);
      });
      ...
      this.add(Blocks.COAL_ORE, (p_229432_0_) -> {
         return createOreDrop(p_229432_0_, Items.COAL);
      });
      ...
      this.add(Blocks.LARGE_FERN, (p_218572_0_) -> {
         return createShearsDispatchTable(Blocks.FERN, ((StandaloneLootEntry.Builder)applyExplosionCondition(p_218572_0_, ItemLootEntry.lootTableItem(Items.WHEAT_SEEDS)).when(BlockStateProperty.hasBlockStateProperties(p_218572_0_).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(DoublePlantBlock.HALF, DoubleBlockHalf.LOWER)))).when(RandomChance.randomChance(0.125F)));
      });
      this.add(Blocks.TALL_GRASS, createShearsDispatchTable(Blocks.GRASS, ((StandaloneLootEntry.Builder)applyExplosionCondition(Blocks.TALL_GRASS, ItemLootEntry.lootTableItem(Items.WHEAT_SEEDS)).when(BlockStateProperty.hasBlockStateProperties(Blocks.TALL_GRASS).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(DoublePlantBlock.HALF, DoubleBlockHalf.LOWER)))).when(RandomChance.randomChance(0.125F))));
      ...
      this.add(Blocks.SNOW, (p_218485_0_) -> {
         return LootTable.lootTable().withPool(LootPool.lootPool().when(EntityHasProperty.entityPresent(LootContext.EntityTarget.THIS)).add(AlternativesLootEntry.alternatives(AlternativesLootEntry.alternatives(ItemLootEntry.lootTableItem(Items.SNOWBALL).when(BlockStateProperty.hasBlockStateProperties(p_218485_0_).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(SnowBlock.LAYERS, 1))), ((StandaloneLootEntry.Builder)ItemLootEntry.lootTableItem(Items.SNOWBALL).when(BlockStateProperty.hasBlockStateProperties(p_218485_0_).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(SnowBlock.LAYERS, 2)))).apply(SetCount.setCount(ConstantRange.exactly(2))), ((StandaloneLootEntry.Builder)ItemLootEntry.lootTableItem(Items.SNOWBALL).when(BlockStateProperty.hasBlockStateProperties(p_218485_0_).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(SnowBlock.LAYERS, 3)))).apply(SetCount.setCount(ConstantRange.exactly(3))), ((StandaloneLootEntry.Builder)ItemLootEntry.lootTableItem(Items.SNOWBALL).when(BlockStateProperty.hasBlockStateProperties(p_218485_0_).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(SnowBlock.LAYERS, 4)))).apply(SetCount.setCount(ConstantRange.exactly(4))), ((StandaloneLootEntry.Builder)ItemLootEntry.lootTableItem(Items.SNOWBALL).when(BlockStateProperty.hasBlockStateProperties(p_218485_0_).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(SnowBlock.LAYERS, 5)))).apply(SetCount.setCount(ConstantRange.exactly(5))), ((StandaloneLootEntry.Builder)ItemLootEntry.lootTableItem(Items.SNOWBALL).when(BlockStateProperty.hasBlockStateProperties(p_218485_0_).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(SnowBlock.LAYERS, 6)))).apply(SetCount.setCount(ConstantRange.exactly(6))), ((StandaloneLootEntry.Builder)ItemLootEntry.lootTableItem(Items.SNOWBALL).when(BlockStateProperty.hasBlockStateProperties(p_218485_0_).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(SnowBlock.LAYERS, 7)))).apply(SetCount.setCount(ConstantRange.exactly(7))), ItemLootEntry.lootTableItem(Items.SNOWBALL).apply(SetCount.setCount(ConstantRange.exactly(8)))).when(HAS_NO_SILK_TOUCH), AlternativesLootEntry.alternatives(ItemLootEntry.lootTableItem(Blocks.SNOW).when(BlockStateProperty.hasBlockStateProperties(p_218485_0_).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(SnowBlock.LAYERS, 1))), ItemLootEntry.lootTableItem(Blocks.SNOW).apply(SetCount.setCount(ConstantRange.exactly(2))).when(BlockStateProperty.hasBlockStateProperties(p_218485_0_).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(SnowBlock.LAYERS, 2))), ItemLootEntry.lootTableItem(Blocks.SNOW).apply(SetCount.setCount(ConstantRange.exactly(3))).when(BlockStateProperty.hasBlockStateProperties(p_218485_0_).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(SnowBlock.LAYERS, 3))), ItemLootEntry.lootTableItem(Blocks.SNOW).apply(SetCount.setCount(ConstantRange.exactly(4))).when(BlockStateProperty.hasBlockStateProperties(p_218485_0_).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(SnowBlock.LAYERS, 4))), ItemLootEntry.lootTableItem(Blocks.SNOW).apply(SetCount.setCount(ConstantRange.exactly(5))).when(BlockStateProperty.hasBlockStateProperties(p_218485_0_).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(SnowBlock.LAYERS, 5))), ItemLootEntry.lootTableItem(Blocks.SNOW).apply(SetCount.setCount(ConstantRange.exactly(6))).when(BlockStateProperty.hasBlockStateProperties(p_218485_0_).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(SnowBlock.LAYERS, 6))), ItemLootEntry.lootTableItem(Blocks.SNOW).apply(SetCount.setCount(ConstantRange.exactly(7))).when(BlockStateProperty.hasBlockStateProperties(p_218485_0_).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(SnowBlock.LAYERS, 7))), ItemLootEntry.lootTableItem(Blocks.SNOW_BLOCK)))));
      });
      this.add(Blocks.GRAVEL, (p_218533_0_) -> {
         return createSilkTouchDispatchTable(p_218533_0_, applyExplosionCondition(p_218533_0_, ((StandaloneLootEntry.Builder)ItemLootEntry.lootTableItem(Items.FLINT).when(TableBonus.bonusLevelFlatChance(Enchantments.BLOCK_FORTUNE, 0.1F, 0.14285715F, 0.25F, 1.0F))).otherwise(ItemLootEntry.lootTableItem(p_218533_0_))));
      });
   ...
   public void dropPottedContents(Block p_218547_1_) {
      this.add(p_218547_1_, (p_229438_0_) -> {
         return createPotFlowerItemTable(((FlowerPotBlock)p_229438_0_).getContent());
      });
   }
