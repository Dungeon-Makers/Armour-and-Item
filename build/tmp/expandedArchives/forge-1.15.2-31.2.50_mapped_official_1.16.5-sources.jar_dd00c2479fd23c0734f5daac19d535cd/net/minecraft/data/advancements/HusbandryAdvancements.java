...
public class HusbandryAdvancements implements Consumer<Consumer<Advancement>> {
   ...
   public void accept(Consumer<Advancement> p_accept_1_) {
      ...
      Advancement advancement3 = this.addFood(Advancement.Builder.advancement()).parent(advancement1).display(Items.APPLE, new TranslationTextComponent("advancements.husbandry.balanced_diet.title"), new TranslationTextComponent("advancements.husbandry.balanced_diet.description"), (ResourceLocation)null, FrameType.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(100)).save(p_accept_1_, "husbandry/balanced_diet");
      Advancement advancement4 = Advancement.Builder.advancement().parent(advancement1).display(Items.DIAMOND_HOE, new TranslationTextComponent("advancements.husbandry.break_diamond_hoe.title"), new TranslationTextComponent("advancements.husbandry.break_diamond_hoe.description"), (ResourceLocation)null, FrameType.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(100)).addCriterion("broke_hoe", ItemDurabilityTrigger.Instance.changedDurability(ItemPredicate.Builder.item().of(Items.DIAMOND_HOE).build(), MinMaxBounds.IntBound.exactly(0))).save(p_accept_1_, "husbandry/break_diamond_hoe");
      Advancement advancement5 = Advancement.Builder.advancement().parent(advancement).display(Items.LEAD, new TranslationTextComponent("advancements.husbandry.tame_an_animal.title"), new TranslationTextComponent("advancements.husbandry.tame_an_animal.description"), (ResourceLocation)null, FrameType.TASK, true, true, false).addCriterion("tamed_animal", TameAnimalTrigger.Instance.tamedAnimal()).save(p_accept_1_, "husbandry/tame_an_animal");
      Advancement advancement6 = this.addBreedable(Advancement.Builder.advancement()).parent(advancement2).display(Items.GOLDEN_CARROT, new TranslationTextComponent("advancements.husbandry.breed_all_animals.title"), new TranslationTextComponent("advancements.husbandry.breed_all_animals.description"), (ResourceLocation)null, FrameType.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(100)).save(p_accept_1_, "husbandry/bred_all_animals");
      Advancement advancement7 = this.addFish(Advancement.Builder.advancement()).parent(advancement).requirements(IRequirementsStrategy.OR).display(Items.FISHING_ROD, new TranslationTextComponent("advancements.husbandry.fishy_business.title"), new TranslationTextComponent("advancements.husbandry.fishy_business.description"), (ResourceLocation)null, FrameType.TASK, true, true, false).save(p_accept_1_, "husbandry/fishy_business");
      Advancement advancement8 = this.addFishBuckets(Advancement.Builder.advancement()).parent(advancement7).requirements(IRequirementsStrategy.OR).display(Items.PUFFERFISH_BUCKET, new TranslationTextComponent("advancements.husbandry.tactical_fishing.title"), new TranslationTextComponent("advancements.husbandry.tactical_fishing.description"), (ResourceLocation)null, FrameType.TASK, true, true, false).save(p_accept_1_, "husbandry/tactical_fishing");
      Advancement advancement9 = this.addCatVariants(Advancement.Builder.advancement()).parent(advancement5).display(Items.COD, new TranslationTextComponent("advancements.husbandry.complete_catalogue.title"), new TranslationTextComponent("advancements.husbandry.complete_catalogue.description"), (ResourceLocation)null, FrameType.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(50)).save(p_accept_1_, "husbandry/complete_catalogue");
      Advancement advancement10 = Advancement.Builder.advancement().parent(advancement).addCriterion("safely_harvest_honey", RightClickBlockWithItemTrigger.Instance.func_226699_a_(BlockPredicate.Builder.block().of(BlockTags.BEEHIVES), ItemPredicate.Builder.item().of(Items.GLASS_BOTTLE))).display(Items.HONEY_BOTTLE, new TranslationTextComponent("advancements.husbandry.safely_harvest_honey.title"), new TranslationTextComponent("advancements.husbandry.safely_harvest_honey.description"), (ResourceLocation)null, FrameType.TASK, true, true, false).save(p_accept_1_, "husbandry/safely_harvest_honey");
      Advancement advancement11 = Advancement.Builder.advancement().parent(advancement).addCriterion("silk_touch_nest", BeeNestDestroyedTrigger.Instance.destroyedBeeNest(Blocks.BEE_NEST, ItemPredicate.Builder.item().hasEnchantment(new EnchantmentPredicate(Enchantments.SILK_TOUCH, MinMaxBounds.IntBound.atLeast(1))), MinMaxBounds.IntBound.exactly(3))).display(Blocks.BEE_NEST, new TranslationTextComponent("advancements.husbandry.silk_touch_nest.title"), new TranslationTextComponent("advancements.husbandry.silk_touch_nest.description"), (ResourceLocation)null, FrameType.TASK, true, true, false).save(p_accept_1_, "husbandry/silk_touch_nest");
   }
