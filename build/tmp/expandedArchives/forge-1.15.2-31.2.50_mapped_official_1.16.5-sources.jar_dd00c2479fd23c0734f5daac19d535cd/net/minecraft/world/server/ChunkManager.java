...
public class ChunkManager extends ChunkLoader implements ChunkHolder.IPlayerProvider {
   ...
   public ChunkManager(ServerWorld p_i51538_1_, File p_i51538_2_, DataFixer p_i51538_3_, TemplateManager p_i51538_4_, Executor p_i51538_5_, ThreadTaskExecutor<Runnable> p_i51538_6_, IChunkLightProvider p_i51538_7_, ChunkGenerator<?> p_i51538_8_, IChunkStatusListener p_i51538_9_, Supplier<DimensionSavedDataManager> p_i51538_10_, int p_i51538_11_) {
      ...
      this.structureManager = p_i51538_4_;
      this.storageFolder = p_i51538_1_.func_201675_m().func_186058_p().func_212679_a(p_i51538_2_);
      this.level = p_i51538_1_;
      this.generator = p_i51538_8_;
      this.mainThreadExecutor = p_i51538_6_;
      DelegatedTaskExecutor<Runnable> delegatedtaskexecutor = DelegatedTaskExecutor.create(p_i51538_5_, "worldgen");
      ITaskExecutor<Runnable> itaskexecutor = ITaskExecutor.of("main", p_i51538_6_::tell);
      this.progressListener = p_i51538_9_;
      DelegatedTaskExecutor<Runnable> delegatedtaskexecutor1 = DelegatedTaskExecutor.create(p_i51538_5_, "light");
      this.queueSorter = new ChunkTaskPriorityQueueSorter(ImmutableList.of(delegatedtaskexecutor, itaskexecutor, delegatedtaskexecutor1), p_i51538_5_, Integer.MAX_VALUE);
      ...
      this.lightEngine = new ServerWorldLightManager(p_i51538_7_, this, this.level.func_201675_m().func_191066_m(), delegatedtaskexecutor1, this.queueSorter.getProcessor(delegatedtaskexecutor1, false));
      this.distanceManager = new ChunkManager.ProxyTicketManager(p_i51538_5_, p_i51538_6_);
      this.overworldDataStorage = p_i51538_10_;
      this.poiManager = new PointOfInterestManager(new File(this.storageFolder, "poi"), p_i51538_3_);
         ...
         while(true) {
            ...
            list.stream().map((p_222974_1_) -> {
               ...
               while(true) {
                  ...
                  if (completablefuture == p_222974_1_.getChunkToSave()) {
                     break;
                  }
               }
   ...
   protected void tick(BooleanSupplier p_219204_1_) {
      ...
      if (!this.level.noSave()) {
         ...
         if (this.updatingChunkMap.isEmpty()) net.minecraftforge.common.DimensionManager.unloadWorld(this.level);
      }
      ...
      if (!p_219229_1_.isUnsaved()) {
         ...
         try {
            ...
            if (chunkstatus.getChunkType() != ChunkStatus.Type.LEVELCHUNK) {
               ...
               if (compoundnbt != null && ChunkSerializer.getChunkTypeFromTag(compoundnbt) == ChunkStatus.Type.LEVELCHUNK) {
                  return false;
               }
            ...
            CompoundNBT compoundnbt1 = ChunkSerializer.write(this.level, p_219229_1_);
            net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(new net.minecraftforge.event.world.ChunkDataEvent.Save(p_219229_1_, p_219229_1_.getWorldForge() != null ? p_219229_1_.getWorldForge() : this.level, compoundnbt1));
            this.write(chunkpos, compoundnbt1);
            return true;
         } catch (Exception exception) {
   ...
   private CompoundNBT readChunk(ChunkPos p_219178_1_) throws IOException {
      ...
      return compoundnbt == null ? null : this.func_219166_a(this.level.func_201675_m().func_186058_p(), this.overworldDataStorage, compoundnbt);
   }
   ...
   private void playerLoadedChunk(ServerPlayerEntity p_219180_1_, IPacket<?>[] p_219180_2_, Chunk p_219180_3_) {
      if (p_219180_2_[0] == null) {
         ...
         p_219180_2_[1] = new SUpdateLightPacket(p_219180_3_.getPos(), this.lightEngine);
      }
   ...
   class EntityTracker {
      ...
      public void updatePlayer(ServerPlayerEntity p_219400_1_) {
         if (p_219400_1_ != this.entity) {
            Vec3d vec3d = p_219400_1_.position().subtract(this.serverEntity.sentPos());
            int i = Math.min(this.getEffectiveRange(), (ChunkManager.this.viewDistance - 1) * 16);
            boolean flag = vec3d.x >= (double)(-i) && vec3d.x <= (double)i && vec3d.z >= (double)(-i) && vec3d.z <= (double)i && this.entity.broadcastToPlayer(p_219400_1_);
            if (flag) {
      ...
      private int getEffectiveRange() {
         ...
         for(Entity entity : collection) {
            int j = entity.getType().func_220345_k() * 16;
            if (j > i) {
               i = j;
            }
         }
