...
public class ServerTickList<T> implements ITickList<T> {
   ...
   public ServerTickList(ServerWorld p_i48979_1_, Predicate<T> p_i48979_2_, Function<T, ResourceLocation> p_i48979_3_, Function<ResourceLocation, T> p_i48979_4_, Consumer<NextTickListEntry<T>> p_i48979_5_) {
      this.ignore = p_i48979_2_;
      this.toId = p_i48979_3_;
      this.field_205373_c = p_i48979_4_;
      this.level = p_i48979_1_;
      this.ticker = p_i48979_5_;
   }
   ...
   public void tick() {
      ...
      if (i != this.tickNextTickSet.size()) {
         ...
         while(i > 0 && iterator.hasNext()) {
            ...
            if (nextticklistentry.field_77180_e > this.level.getGameTime()) {
               break;
            }
   ...
   public void func_219497_a(Stream<NextTickListEntry<T>> p_219497_1_) {
      p_219497_1_.forEach(this::addTickData);
   }
   ...
   public void copy(MutableBoundingBox p_205368_1_, BlockPos p_205368_2_) {
      for(NextTickListEntry<T> nextticklistentry : this.fetchTicksInArea(p_205368_1_, false, false)) {
         if (p_205368_1_.isInside(nextticklistentry.pos)) {
            ...
            this.addTickData(new NextTickListEntry<>(blockpos, t, nextticklistentry.field_77180_e, nextticklistentry.priority));
         }
      }
   ...
   public static <T> ListNBT saveTickList(Function<T, ResourceLocation> p_219502_0_, Iterable<NextTickListEntry<T>> p_219502_1_, long p_219502_2_) {
      ...
      for(NextTickListEntry<T> nextticklistentry : p_219502_1_) {
         ...
         compoundnbt.putInt("t", (int)(nextticklistentry.field_77180_e - p_219502_2_));
