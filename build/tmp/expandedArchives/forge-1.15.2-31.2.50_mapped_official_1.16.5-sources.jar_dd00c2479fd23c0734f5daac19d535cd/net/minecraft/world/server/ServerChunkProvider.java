...
public class ServerChunkProvider extends AbstractChunkProvider {
   ...
   public ServerChunkProvider(ServerWorld p_i51537_1_, File p_i51537_2_, DataFixer p_i51537_3_, TemplateManager p_i51537_4_, Executor p_i51537_5_, ChunkGenerator<?> p_i51537_6_, int p_i51537_7_, IChunkStatusListener p_i51537_8_, Supplier<DimensionSavedDataManager> p_i51537_9_) {
      this.level = p_i51537_1_;
      this.mainThreadProcessor = new ServerChunkProvider.ChunkExecutor(p_i51537_1_);
      this.generator = p_i51537_6_;
      this.mainThread = Thread.currentThread();
      File file1 = p_i51537_1_.func_201675_m().func_186058_p().func_212679_a(p_i51537_2_);
      File file2 = new File(file1, "data");
      file2.mkdirs();
      this.dataStorage = new DimensionSavedDataManager(file2, p_i51537_3_);
      this.chunkMap = new ChunkManager(p_i51537_1_, p_i51537_2_, p_i51537_3_, p_i51537_4_, p_i51537_5_, this.mainThreadProcessor, this, this.getGenerator(), p_i51537_8_, p_i51537_9_, p_i51537_7_);
   ...
   public boolean func_223435_b(Entity p_223435_1_) {
      long i = ChunkPos.asLong(MathHelper.floor(p_223435_1_.getX()) >> 4, MathHelper.floor(p_223435_1_.getZ()) >> 4);
      return this.checkChunkFuture(i, ChunkHolder::getFullChunkFuture);
   }
   ...
   private void tickChunks() {
      ...
      WorldInfo worldinfo = this.level.getLevelData();
      ...
      if (!flag) {
         ...
         BlockPos blockpos = this.level.func_175694_M();
         ...
         Object2IntMap<EntityClassification> object2intmap = this.level.func_217450_l();
         this.level.getProfiler().pop();
         this.chunkMap.getChunks().forEach((p_223434_10_) -> {
            Optional<Chunk> optional = p_223434_10_.getEntityTickingChunkFuture().getNow(ChunkHolder.UNLOADED_LEVEL_CHUNK).left();
            if (optional.isPresent()) {
               Chunk chunk = optional.get();
               this.level.getProfiler().push("broadcast");
               p_223434_10_.broadcastChanges(chunk);
               this.level.getProfiler().pop();
               ChunkPos chunkpos = p_223434_10_.getPos();
               if (!this.chunkMap.noPlayersCloseForSpawning(chunkpos)) {
                  ...
                  if (flag1 && (this.spawnEnemies || this.spawnFriendlies) && this.level.getWorldBorder().isWithinBounds(chunk.getPos())) {
                     ...
                     for(EntityClassification entityclassification : aentityclassification) {
                        if (entityclassification != EntityClassification.MISC && (!entityclassification.isFriendly() || this.spawnFriendlies) && (entityclassification.isFriendly() || this.spawnEnemies) && (!entityclassification.isPersistent() || flag2)) {
                           int i1 = entityclassification.getMaxInstancesPerChunk() * l / field_217238_b;
                           if (object2intmap.getInt(entityclassification) <= i1) {
                              WorldEntitySpawner.func_226701_a_(entityclassification, this.level, chunk, blockpos);
                           }
                        }
                     }
         ...
         if (flag1) {
            this.generator.func_203222_a(this.level, this.spawnEnemies, this.spawnFriendlies);
         }
   ...
   final class ChunkExecutor extends ThreadTaskExecutor<Runnable> {
      private ChunkExecutor(World p_i50985_2_) {
         super("Chunk source main thread executor for " + Registry.field_212622_k.getKey(p_i50985_2_.func_201675_m().func_186058_p()));
      }
