...
public class ServerWorldLightManager extends WorldLightManager implements AutoCloseable {
   ...
   protected void updateChunkStatus(ChunkPos p_215581_1_) {
      this.addTask(p_215581_1_.x, p_215581_1_.z, () -> {
         ...
         for(int i = -1; i < 17; ++i) {
            super.queueSectionData(LightType.BLOCK, SectionPos.of(p_215581_1_, i), (NibbleArray)null);
            super.queueSectionData(LightType.SKY, SectionPos.of(p_215581_1_, i), (NibbleArray)null);
         }
   ...
   public void queueSectionData(LightType p_215574_1_, SectionPos p_215574_2_, @Nullable NibbleArray p_215574_3_) {
      this.addTask(p_215574_2_.x(), p_215574_2_.z(), () -> {
         return 0;
      }, ServerWorldLightManager.Phase.PRE_UPDATE, Util.name(() -> {
         super.queueSectionData(p_215574_1_, p_215574_2_, p_215574_3_);
      }, () -> {
