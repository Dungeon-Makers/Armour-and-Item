...
public class MineshaftPieces {
   ...
   public static class Corridor extends MineshaftPieces.Piece {
      ...
      protected boolean createChest(IWorld p_186167_1_, MutableBoundingBox p_186167_2_, Random p_186167_3_, int p_186167_4_, int p_186167_5_, int p_186167_6_, ResourceLocation p_186167_7_) {
         ...
         if (p_186167_2_.isInside(blockpos) && p_186167_1_.getBlockState(blockpos).isAir(p_186167_1_, blockpos) && !p_186167_1_.getBlockState(blockpos.below()).isAir(p_186167_1_, blockpos.below())) {
            ...
            ChestMinecartEntity chestminecartentity = new ChestMinecartEntity(p_186167_1_.getLevel(), (double)((float)blockpos.getX() + 0.5F), (double)((float)blockpos.getY() + 0.5F), (double)((float)blockpos.getZ() + 0.5F));
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         if (this.edgesLiquid(p_225577_1_, p_225577_4_)) {
            return false;
         } else {
            int i = 0;
            int j = 2;
            ...
            this.generateBox(p_225577_1_, p_225577_4_, 0, 0, 0, 2, 1, i1, CAVE_AIR, CAVE_AIR, false);
            this.generateMaybeBox(p_225577_1_, p_225577_4_, p_225577_3_, 0.8F, 0, 2, 0, 2, 2, i1, CAVE_AIR, CAVE_AIR, false, false);
            if (this.spiderCorridor) {
               this.generateMaybeBox(p_225577_1_, p_225577_4_, p_225577_3_, 0.6F, 0, 0, 0, 2, 1, i1, Blocks.COBWEB.defaultBlockState(), CAVE_AIR, false, true);
            }
            ...
            for(int j1 = 0; j1 < this.numSections; ++j1) {
               ...
               if (p_225577_3_.nextInt(100) == 0) {
                  this.createChest(p_225577_1_, p_225577_4_, p_225577_3_, 2, 0, k1 - 1, LootTables.ABANDONED_MINESHAFT);
               }

               if (p_225577_3_.nextInt(100) == 0) {
                  this.createChest(p_225577_1_, p_225577_4_, p_225577_3_, 0, 0, k1 + 1, LootTables.ABANDONED_MINESHAFT);
               }
               ...
               if (this.spiderCorridor && !this.hasPlacedSpider) {
                  ...
                  if (p_225577_4_.isInside(blockpos) && this.isInterior(p_225577_1_, 1, 0, i2, p_225577_4_)) {
            ...
            for(int l2 = 0; l2 <= 2; ++l2) {
               for(int i3 = 0; i3 <= i1; ++i3) {
                  int k3 = -1;
                  BlockState blockstate3 = this.getBlock(p_225577_1_, l2, -1, i3, p_225577_4_);
                  if (blockstate3.isAir() && this.isInterior(p_225577_1_, l2, -1, i3, p_225577_4_)) {
                     int l3 = -1;
                     this.placeBlock(p_225577_1_, blockstate, l2, -1, i3, p_225577_4_);
                  }
               }
            }
            ...
            if (this.hasRails) {
               ...
               for(int j3 = 0; j3 <= i1; ++j3) {
                  BlockState blockstate2 = this.getBlock(p_225577_1_, 1, -1, j3, p_225577_4_);
                  if (!blockstate2.isAir() && blockstate2.isSolidRender(p_225577_1_, new BlockPos(this.getWorldX(1, j3), this.getWorldY(-1), this.getWorldZ(1, j3)))) {
                     float f = this.isInterior(p_225577_1_, 1, 0, j3, p_225577_4_) ? 0.7F : 0.9F;
                     this.maybeGenerateBlock(p_225577_1_, p_225577_4_, p_225577_3_, f, 1, 0, j3, blockstate1);
                  }
               }
            }
   ...
   public static class Cross extends MineshaftPieces.Piece {
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         if (this.edgesLiquid(p_225577_1_, p_225577_4_)) {
            ...
            BlockState blockstate = this.getPlanksBlock();
            if (this.isTwoFloored) {
               this.generateBox(p_225577_1_, p_225577_4_, this.boundingBox.x0 + 1, this.boundingBox.y0, this.boundingBox.z0, this.boundingBox.x1 - 1, this.boundingBox.y0 + 3 - 1, this.boundingBox.z1, CAVE_AIR, CAVE_AIR, false);
               this.generateBox(p_225577_1_, p_225577_4_, this.boundingBox.x0, this.boundingBox.y0, this.boundingBox.z0 + 1, this.boundingBox.x1, this.boundingBox.y0 + 3 - 1, this.boundingBox.z1 - 1, CAVE_AIR, CAVE_AIR, false);
               this.generateBox(p_225577_1_, p_225577_4_, this.boundingBox.x0 + 1, this.boundingBox.y1 - 2, this.boundingBox.z0, this.boundingBox.x1 - 1, this.boundingBox.y1, this.boundingBox.z1, CAVE_AIR, CAVE_AIR, false);
               this.generateBox(p_225577_1_, p_225577_4_, this.boundingBox.x0, this.boundingBox.y1 - 2, this.boundingBox.z0 + 1, this.boundingBox.x1, this.boundingBox.y1, this.boundingBox.z1 - 1, CAVE_AIR, CAVE_AIR, false);
               this.generateBox(p_225577_1_, p_225577_4_, this.boundingBox.x0 + 1, this.boundingBox.y0 + 3, this.boundingBox.z0 + 1, this.boundingBox.x1 - 1, this.boundingBox.y0 + 3, this.boundingBox.z1 - 1, CAVE_AIR, CAVE_AIR, false);
            } else {
               this.generateBox(p_225577_1_, p_225577_4_, this.boundingBox.x0 + 1, this.boundingBox.y0, this.boundingBox.z0, this.boundingBox.x1 - 1, this.boundingBox.y1, this.boundingBox.z1, CAVE_AIR, CAVE_AIR, false);
               this.generateBox(p_225577_1_, p_225577_4_, this.boundingBox.x0, this.boundingBox.y0, this.boundingBox.z0 + 1, this.boundingBox.x1, this.boundingBox.y1, this.boundingBox.z1 - 1, CAVE_AIR, CAVE_AIR, false);
            }

            this.placeSupportPillar(p_225577_1_, p_225577_4_, this.boundingBox.x0 + 1, this.boundingBox.y0, this.boundingBox.z0 + 1, this.boundingBox.y1);
            this.placeSupportPillar(p_225577_1_, p_225577_4_, this.boundingBox.x0 + 1, this.boundingBox.y0, this.boundingBox.z1 - 1, this.boundingBox.y1);
            this.placeSupportPillar(p_225577_1_, p_225577_4_, this.boundingBox.x1 - 1, this.boundingBox.y0, this.boundingBox.z0 + 1, this.boundingBox.y1);
            this.placeSupportPillar(p_225577_1_, p_225577_4_, this.boundingBox.x1 - 1, this.boundingBox.y0, this.boundingBox.z1 - 1, this.boundingBox.y1);

            for(int i = this.boundingBox.x0; i <= this.boundingBox.x1; ++i) {
               for(int j = this.boundingBox.z0; j <= this.boundingBox.z1; ++j) {
                  if (this.getBlock(p_225577_1_, i, this.boundingBox.y0 - 1, j, p_225577_4_).isAir() && this.isInterior(p_225577_1_, i, this.boundingBox.y0 - 1, j, p_225577_4_)) {
                     this.placeBlock(p_225577_1_, blockstate, i, this.boundingBox.y0 - 1, j, p_225577_4_);
                  }
               }
            }
   ...
   public static class Room extends MineshaftPieces.Piece {
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         if (this.edgesLiquid(p_225577_1_, p_225577_4_)) {
            ...
            this.generateBox(p_225577_1_, p_225577_4_, this.boundingBox.x0, this.boundingBox.y0, this.boundingBox.z0, this.boundingBox.x1, this.boundingBox.y0, this.boundingBox.z1, Blocks.DIRT.defaultBlockState(), CAVE_AIR, true);
            this.generateBox(p_225577_1_, p_225577_4_, this.boundingBox.x0, this.boundingBox.y0 + 1, this.boundingBox.z0, this.boundingBox.x1, Math.min(this.boundingBox.y0 + 3, this.boundingBox.y1), this.boundingBox.z1, CAVE_AIR, CAVE_AIR, false);

            for(MutableBoundingBox mutableboundingbox : this.childEntranceBoxes) {
               this.generateBox(p_225577_1_, p_225577_4_, mutableboundingbox.x0, mutableboundingbox.y1 - 2, mutableboundingbox.z0, mutableboundingbox.x1, mutableboundingbox.y1, mutableboundingbox.z1, CAVE_AIR, CAVE_AIR, false);
            }

            this.generateUpperHalfSphere(p_225577_1_, p_225577_4_, this.boundingBox.x0, this.boundingBox.y0 + 4, this.boundingBox.z0, this.boundingBox.x1, this.boundingBox.y1, this.boundingBox.z1, CAVE_AIR, false);
            return true;
         }
      }
   ...
   public static class Stairs extends MineshaftPieces.Piece {
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         if (this.edgesLiquid(p_225577_1_, p_225577_4_)) {
            ...
            this.generateBox(p_225577_1_, p_225577_4_, 0, 5, 0, 2, 7, 1, CAVE_AIR, CAVE_AIR, false);
            this.generateBox(p_225577_1_, p_225577_4_, 0, 0, 7, 2, 2, 8, CAVE_AIR, CAVE_AIR, false);

            for(int i = 0; i < 5; ++i) {
               this.generateBox(p_225577_1_, p_225577_4_, 0, 5 - i - (i < 4 ? 1 : 0), 2 + i, 2, 7 - i, 2 + i, CAVE_AIR, CAVE_AIR, false);
            }
