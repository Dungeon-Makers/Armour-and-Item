...
public class IglooPieces {
   ...
   public static void func_207617_a(TemplateManager p_207617_0_, BlockPos p_207617_1_, Rotation p_207617_2_, List<StructurePiece> p_207617_3_, Random p_207617_4_, NoFeatureConfig p_207617_5_) {
      if (p_207617_4_.nextDouble() < 0.5D) {
         ...
         p_207617_3_.add(new IglooPieces.Piece(p_207617_0_, STRUCTURE_LOCATION_LABORATORY, p_207617_1_, p_207617_2_, i * 3));

         for(int j = 0; j < i - 1; ++j) {
            p_207617_3_.add(new IglooPieces.Piece(p_207617_0_, STRUCTURE_LOCATION_LADDER, p_207617_1_, p_207617_2_, j * 3));
         }
      }

      p_207617_3_.add(new IglooPieces.Piece(p_207617_0_, STRUCTURE_LOCATION_IGLOO, p_207617_1_, p_207617_2_, 0));
   }
   ...
   public static class Piece extends TemplateStructurePiece {
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         ...
         if (this.templateLocation.equals(IglooPieces.STRUCTURE_LOCATION_IGLOO)) {
            ...
            BlockState blockstate = p_225577_1_.getBlockState(blockpos3.below());
            if (!blockstate.isAir() && blockstate.getBlock() != Blocks.LADDER) {
               p_225577_1_.setBlock(blockpos3, Blocks.SNOW_BLOCK.defaultBlockState(), 3);
            }
         }
