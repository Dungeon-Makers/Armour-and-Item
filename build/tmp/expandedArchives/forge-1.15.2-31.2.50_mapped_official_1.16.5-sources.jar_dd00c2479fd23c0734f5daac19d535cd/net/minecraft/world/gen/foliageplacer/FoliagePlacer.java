...
public abstract class FoliagePlacer implements IDynamicSerializable {
      ...
      for(int i = -p_227384_7_; i <= p_227384_7_; ++i) {
         for(int j = -p_227384_7_; j <= p_227384_7_; ++j) {
            if (!this.func_225572_a_(p_227384_2_, p_227384_4_, i, p_227384_6_, j, p_227384_7_)) {
               blockpos$mutable.set(i + p_227384_5_.getX(), p_227384_6_ + p_227384_5_.getY(), j + p_227384_5_.getZ());
   ...
   protected void func_227385_a_(IWorldGenerationReader p_227385_1_, Random p_227385_2_, BlockPos p_227385_3_, TreeFeatureConfig p_227385_4_, Set<BlockPos> p_227385_5_) {
      if (AbstractTreeFeature.func_214572_g(p_227385_1_, p_227385_3_) || AbstractTreeFeature.func_214576_j(p_227385_1_, p_227385_3_) || AbstractTreeFeature.func_214571_e(p_227385_1_, p_227385_3_)) {
         p_227385_1_.setBlock(p_227385_3_, p_227385_4_.leavesProvider.getState(p_227385_2_, p_227385_3_), 19);
         p_227385_5_.add(p_227385_3_.immutable());
      }
   ...
   public <T> T func_218175_a(DynamicOps<T> p_218175_1_) {
      ...
      builder.put(p_218175_1_.createString("type"), p_218175_1_.createString(Registry.FOLIAGE_PLACER_TYPES.getKey(this.field_227383_c_).toString())).put(p_218175_1_.createString("radius"), p_218175_1_.createInt(this.radius)).put(p_218175_1_.createString("radius_random"), p_218175_1_.createInt(this.field_227382_b_));
