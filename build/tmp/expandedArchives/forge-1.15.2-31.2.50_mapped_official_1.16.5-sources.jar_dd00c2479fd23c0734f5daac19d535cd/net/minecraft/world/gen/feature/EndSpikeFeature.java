...
public class EndSpikeFeature extends Feature<EndSpikeFeatureConfig> {
   ...
   public boolean func_212245_a(IWorld p_212245_1_, ChunkGenerator<? extends GenerationSettings> p_212245_2_, Random p_212245_3_, BlockPos p_212245_4_, EndSpikeFeatureConfig p_212245_5_) {
      List<EndSpikeFeature.EndSpike> list = p_212245_5_.getSpikes();
      if (list.isEmpty()) {
         list = func_214554_a(p_212245_1_);
      }

      for(EndSpikeFeature.EndSpike endspikefeature$endspike : list) {
         if (endspikefeature$endspike.isCenterWithinChunk(p_212245_4_)) {
            this.placeSpike(p_212245_1_, p_212245_3_, p_212245_5_, endspikefeature$endspike);
         }
      }
   ...
   private void placeSpike(IWorld p_214553_1_, Random p_214553_2_, EndSpikeFeatureConfig p_214553_3_, EndSpikeFeature.EndSpike p_214553_4_) {
      ...
      for(BlockPos blockpos : BlockPos.betweenClosed(new BlockPos(p_214553_4_.getCenterX() - i, 0, p_214553_4_.getCenterZ() - i), new BlockPos(p_214553_4_.getCenterX() + i, p_214553_4_.getHeight() + 10, p_214553_4_.getCenterZ() + i))) {
         if (blockpos.distSqr((double)p_214553_4_.getCenterX(), (double)blockpos.getY(), (double)p_214553_4_.getCenterZ(), false) <= (double)(i * i + 1) && blockpos.getY() < p_214553_4_.getHeight()) {
            this.func_202278_a(p_214553_1_, blockpos, Blocks.OBSIDIAN.defaultBlockState());
         } else if (blockpos.getY() > 65) {
            this.func_202278_a(p_214553_1_, blockpos, Blocks.AIR.defaultBlockState());
         }
      }
            ...
            for(int l = -2; l <= 2; ++l) {
               for(int i1 = 0; i1 <= 3; ++i1) {
                  ...
                  if (flag || flag1 || flag2) {
                     ...
                     this.func_202278_a(p_214553_1_, blockpos$mutable.set(p_214553_4_.getCenterX() + k, p_214553_4_.getHeight() + i1, p_214553_4_.getCenterZ() + l), blockstate);
                  }
               }
            }
         }
      ...
      endercrystalentity.moveTo((double)((float)p_214553_4_.getCenterX() + 0.5F), (double)(p_214553_4_.getHeight() + 1), (double)((float)p_214553_4_.getCenterZ() + 0.5F), p_214553_2_.nextFloat() * 360.0F, 0.0F);
      p_214553_1_.addFreshEntity(endercrystalentity);
      this.func_202278_a(p_214553_1_, new BlockPos(p_214553_4_.getCenterX(), p_214553_4_.getHeight(), p_214553_4_.getCenterZ()), Blocks.BEDROCK.defaultBlockState());
   }
