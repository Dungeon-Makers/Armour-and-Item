...
public class HugeTreeFeatureConfig extends BaseTreeFeatureConfig {
   ...
   public static <T> HugeTreeFeatureConfig func_227277_a_(Dynamic<T> p_227277_0_) {
      ...
      return new HugeTreeFeatureConfig(basetreefeatureconfig.trunkProvider, basetreefeatureconfig.leavesProvider, basetreefeatureconfig.decorators, basetreefeatureconfig.field_227371_p_, p_227277_0_.get("height_interval").asInt(0), p_227277_0_.get("crown_height").asInt(0));
   }
