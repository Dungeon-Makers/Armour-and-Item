...
public interface IStructurePieceType {
   ...
   IStructurePieceType field_214784_e = setPieceId(PillagerOutpostPieces.PillageOutpost::new, "PCP");
   IStructurePieceType field_214785_f = setPieceId(VillagePieces.Village::new, "NVi");
