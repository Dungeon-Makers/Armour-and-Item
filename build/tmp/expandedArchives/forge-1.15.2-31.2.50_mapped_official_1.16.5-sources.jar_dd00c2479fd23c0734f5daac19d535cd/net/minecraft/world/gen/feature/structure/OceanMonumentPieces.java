...
public class OceanMonumentPieces {
   public static class DoubleXRoom extends OceanMonumentPieces.Piece {
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         ...
         if (this.roomDefinition.index / 25 > 0) {
            this.generateDefaultFloor(p_225577_1_, p_225577_4_, 8, 0, oceanmonumentpieces$roomdefinition.hasOpening[Direction.DOWN.get3DDataValue()]);
            this.generateDefaultFloor(p_225577_1_, p_225577_4_, 0, 0, oceanmonumentpieces$roomdefinition1.hasOpening[Direction.DOWN.get3DDataValue()]);
         }

         if (oceanmonumentpieces$roomdefinition1.connections[Direction.UP.get3DDataValue()] == null) {
            this.generateBoxOnFillOnly(p_225577_1_, p_225577_4_, 1, 4, 1, 7, 4, 6, BASE_GRAY);
         }

         if (oceanmonumentpieces$roomdefinition.connections[Direction.UP.get3DDataValue()] == null) {
            this.generateBoxOnFillOnly(p_225577_1_, p_225577_4_, 8, 4, 1, 14, 4, 6, BASE_GRAY);
         }

         this.generateBox(p_225577_1_, p_225577_4_, 0, 3, 0, 0, 3, 7, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 15, 3, 0, 15, 3, 7, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 1, 3, 0, 15, 3, 0, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 1, 3, 7, 14, 3, 7, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 0, 2, 0, 0, 2, 7, BASE_GRAY, BASE_GRAY, false);
         this.generateBox(p_225577_1_, p_225577_4_, 15, 2, 0, 15, 2, 7, BASE_GRAY, BASE_GRAY, false);
         this.generateBox(p_225577_1_, p_225577_4_, 1, 2, 0, 15, 2, 0, BASE_GRAY, BASE_GRAY, false);
         this.generateBox(p_225577_1_, p_225577_4_, 1, 2, 7, 14, 2, 7, BASE_GRAY, BASE_GRAY, false);
         this.generateBox(p_225577_1_, p_225577_4_, 0, 1, 0, 0, 1, 7, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 15, 1, 0, 15, 1, 7, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 1, 1, 0, 15, 1, 0, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 1, 1, 7, 14, 1, 7, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 5, 1, 0, 10, 1, 4, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 6, 2, 0, 9, 2, 3, BASE_GRAY, BASE_GRAY, false);
         this.generateBox(p_225577_1_, p_225577_4_, 5, 3, 0, 10, 3, 4, BASE_LIGHT, BASE_LIGHT, false);
         this.placeBlock(p_225577_1_, LAMP_BLOCK, 6, 2, 3, p_225577_4_);
         this.placeBlock(p_225577_1_, LAMP_BLOCK, 9, 2, 3, p_225577_4_);
         if (oceanmonumentpieces$roomdefinition1.hasOpening[Direction.SOUTH.get3DDataValue()]) {
            this.generateWaterBox(p_225577_1_, p_225577_4_, 3, 1, 0, 4, 2, 0);
         }

         if (oceanmonumentpieces$roomdefinition1.hasOpening[Direction.NORTH.get3DDataValue()]) {
            this.generateWaterBox(p_225577_1_, p_225577_4_, 3, 1, 7, 4, 2, 7);
         }

         if (oceanmonumentpieces$roomdefinition1.hasOpening[Direction.WEST.get3DDataValue()]) {
            this.generateWaterBox(p_225577_1_, p_225577_4_, 0, 1, 3, 0, 2, 4);
         }

         if (oceanmonumentpieces$roomdefinition.hasOpening[Direction.SOUTH.get3DDataValue()]) {
            this.generateWaterBox(p_225577_1_, p_225577_4_, 11, 1, 0, 12, 2, 0);
         }

         if (oceanmonumentpieces$roomdefinition.hasOpening[Direction.NORTH.get3DDataValue()]) {
            this.generateWaterBox(p_225577_1_, p_225577_4_, 11, 1, 7, 12, 2, 7);
         }

         if (oceanmonumentpieces$roomdefinition.hasOpening[Direction.EAST.get3DDataValue()]) {
            this.generateWaterBox(p_225577_1_, p_225577_4_, 15, 1, 3, 15, 2, 4);
         }
   ...
   public static class DoubleXYRoom extends OceanMonumentPieces.Piece {
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         ...
         if (oceanmonumentpieces$roomdefinition2.connections[Direction.UP.get3DDataValue()] == null) {
            this.generateBoxOnFillOnly(p_225577_1_, p_225577_4_, 1, 8, 1, 7, 8, 6, BASE_GRAY);
         }

         if (oceanmonumentpieces$roomdefinition3.connections[Direction.UP.get3DDataValue()] == null) {
            this.generateBoxOnFillOnly(p_225577_1_, p_225577_4_, 8, 8, 1, 14, 8, 6, BASE_GRAY);
         }
         ...
         for(int i = 1; i <= 7; ++i) {
            ...
            this.generateBox(p_225577_1_, p_225577_4_, 0, i, 0, 0, i, 7, blockstate, blockstate, false);
            this.generateBox(p_225577_1_, p_225577_4_, 15, i, 0, 15, i, 7, blockstate, blockstate, false);
            this.generateBox(p_225577_1_, p_225577_4_, 1, i, 0, 15, i, 0, blockstate, blockstate, false);
            this.generateBox(p_225577_1_, p_225577_4_, 1, i, 7, 14, i, 7, blockstate, blockstate, false);
         }

         this.generateBox(p_225577_1_, p_225577_4_, 2, 1, 3, 2, 7, 4, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 3, 1, 2, 4, 7, 2, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 3, 1, 5, 4, 7, 5, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 13, 1, 3, 13, 7, 4, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 11, 1, 2, 12, 7, 2, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 11, 1, 5, 12, 7, 5, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 5, 1, 3, 5, 3, 4, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 10, 1, 3, 10, 3, 4, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 5, 7, 2, 10, 7, 5, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 5, 5, 2, 5, 7, 2, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 10, 5, 2, 10, 7, 2, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 5, 5, 5, 5, 7, 5, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 10, 5, 5, 10, 7, 5, BASE_LIGHT, BASE_LIGHT, false);
         this.placeBlock(p_225577_1_, BASE_LIGHT, 6, 6, 2, p_225577_4_);
         this.placeBlock(p_225577_1_, BASE_LIGHT, 9, 6, 2, p_225577_4_);
         this.placeBlock(p_225577_1_, BASE_LIGHT, 6, 6, 5, p_225577_4_);
         this.placeBlock(p_225577_1_, BASE_LIGHT, 9, 6, 5, p_225577_4_);
         this.generateBox(p_225577_1_, p_225577_4_, 5, 4, 3, 6, 4, 4, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 9, 4, 3, 10, 4, 4, BASE_LIGHT, BASE_LIGHT, false);
         this.placeBlock(p_225577_1_, LAMP_BLOCK, 5, 4, 2, p_225577_4_);
         this.placeBlock(p_225577_1_, LAMP_BLOCK, 5, 4, 5, p_225577_4_);
         this.placeBlock(p_225577_1_, LAMP_BLOCK, 10, 4, 2, p_225577_4_);
         this.placeBlock(p_225577_1_, LAMP_BLOCK, 10, 4, 5, p_225577_4_);
         if (oceanmonumentpieces$roomdefinition1.hasOpening[Direction.SOUTH.get3DDataValue()]) {
            this.generateWaterBox(p_225577_1_, p_225577_4_, 3, 1, 0, 4, 2, 0);
         }
   ...
   public static class DoubleYRoom extends OceanMonumentPieces.Piece {
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         if (this.roomDefinition.index / 25 > 0) {
            this.generateDefaultFloor(p_225577_1_, p_225577_4_, 0, 0, this.roomDefinition.hasOpening[Direction.DOWN.get3DDataValue()]);
         }
         ...
         if (oceanmonumentpieces$roomdefinition.connections[Direction.UP.get3DDataValue()] == null) {
            this.generateBoxOnFillOnly(p_225577_1_, p_225577_4_, 1, 8, 1, 6, 8, 6, BASE_GRAY);
         }

         this.generateBox(p_225577_1_, p_225577_4_, 0, 4, 0, 0, 4, 7, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 7, 4, 0, 7, 4, 7, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 1, 4, 0, 6, 4, 0, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 1, 4, 7, 6, 4, 7, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 2, 4, 1, 2, 4, 2, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 1, 4, 2, 1, 4, 2, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 5, 4, 1, 5, 4, 2, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 6, 4, 2, 6, 4, 2, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 2, 4, 5, 2, 4, 6, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 1, 4, 5, 1, 4, 5, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 5, 4, 5, 5, 4, 6, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 6, 4, 5, 6, 4, 5, BASE_LIGHT, BASE_LIGHT, false);
         OceanMonumentPieces.RoomDefinition oceanmonumentpieces$roomdefinition1 = this.roomDefinition;

         for(int i = 1; i <= 5; i += 4) {
            int j = 0;
            if (oceanmonumentpieces$roomdefinition1.hasOpening[Direction.SOUTH.get3DDataValue()]) {
               this.generateBox(p_225577_1_, p_225577_4_, 2, i, j, 2, i + 2, j, BASE_LIGHT, BASE_LIGHT, false);
               this.generateBox(p_225577_1_, p_225577_4_, 5, i, j, 5, i + 2, j, BASE_LIGHT, BASE_LIGHT, false);
               this.generateBox(p_225577_1_, p_225577_4_, 3, i + 2, j, 4, i + 2, j, BASE_LIGHT, BASE_LIGHT, false);
            } else {
               this.generateBox(p_225577_1_, p_225577_4_, 0, i, j, 7, i + 2, j, BASE_LIGHT, BASE_LIGHT, false);
               this.generateBox(p_225577_1_, p_225577_4_, 0, i + 1, j, 7, i + 1, j, BASE_GRAY, BASE_GRAY, false);
            }
            ...
            int k = 0;
            if (oceanmonumentpieces$roomdefinition1.hasOpening[Direction.WEST.get3DDataValue()]) {
               this.generateBox(p_225577_1_, p_225577_4_, k, i, 2, k, i + 2, 2, BASE_LIGHT, BASE_LIGHT, false);
               this.generateBox(p_225577_1_, p_225577_4_, k, i, 5, k, i + 2, 5, BASE_LIGHT, BASE_LIGHT, false);
               this.generateBox(p_225577_1_, p_225577_4_, k, i + 2, 3, k, i + 2, 4, BASE_LIGHT, BASE_LIGHT, false);
            } else {
               this.generateBox(p_225577_1_, p_225577_4_, k, i, 0, k, i + 2, 7, BASE_LIGHT, BASE_LIGHT, false);
               this.generateBox(p_225577_1_, p_225577_4_, k, i + 1, 0, k, i + 1, 7, BASE_GRAY, BASE_GRAY, false);
            }
   ...
   public static class DoubleYZRoom extends OceanMonumentPieces.Piece {
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         ...
         if (this.roomDefinition.index / 25 > 0) {
            this.generateDefaultFloor(p_225577_1_, p_225577_4_, 0, 8, oceanmonumentpieces$roomdefinition.hasOpening[Direction.DOWN.get3DDataValue()]);
            this.generateDefaultFloor(p_225577_1_, p_225577_4_, 0, 0, oceanmonumentpieces$roomdefinition1.hasOpening[Direction.DOWN.get3DDataValue()]);
         }

         if (oceanmonumentpieces$roomdefinition3.connections[Direction.UP.get3DDataValue()] == null) {
            this.generateBoxOnFillOnly(p_225577_1_, p_225577_4_, 1, 8, 1, 6, 8, 7, BASE_GRAY);
         }

         if (oceanmonumentpieces$roomdefinition2.connections[Direction.UP.get3DDataValue()] == null) {
            this.generateBoxOnFillOnly(p_225577_1_, p_225577_4_, 1, 8, 8, 6, 8, 14, BASE_GRAY);
         }
         ...
         for(int i = 1; i <= 7; ++i) {
            ...
            this.generateBox(p_225577_1_, p_225577_4_, 0, i, 0, 0, i, 15, blockstate, blockstate, false);
            this.generateBox(p_225577_1_, p_225577_4_, 7, i, 0, 7, i, 15, blockstate, blockstate, false);
            this.generateBox(p_225577_1_, p_225577_4_, 1, i, 0, 6, i, 0, blockstate, blockstate, false);
            this.generateBox(p_225577_1_, p_225577_4_, 1, i, 15, 6, i, 15, blockstate, blockstate, false);
         }
         ...
         for(int j = 1; j <= 7; ++j) {
            ...
            this.generateBox(p_225577_1_, p_225577_4_, 3, j, 7, 4, j, 8, blockstate1, blockstate1, false);
         }
         ...
         if (oceanmonumentpieces$roomdefinition1.hasOpening[Direction.EAST.get3DDataValue()]) {
            this.generateWaterBox(p_225577_1_, p_225577_4_, 7, 1, 3, 7, 2, 4);
         }
         ...
         if (oceanmonumentpieces$roomdefinition.hasOpening[Direction.NORTH.get3DDataValue()]) {
            this.generateWaterBox(p_225577_1_, p_225577_4_, 3, 1, 15, 4, 2, 15);
         }

         if (oceanmonumentpieces$roomdefinition.hasOpening[Direction.WEST.get3DDataValue()]) {
            this.generateWaterBox(p_225577_1_, p_225577_4_, 0, 1, 11, 0, 2, 12);
         }

         if (oceanmonumentpieces$roomdefinition.hasOpening[Direction.EAST.get3DDataValue()]) {
            this.generateWaterBox(p_225577_1_, p_225577_4_, 7, 1, 11, 7, 2, 12);
         }
         ...
         if (oceanmonumentpieces$roomdefinition3.hasOpening[Direction.EAST.get3DDataValue()]) {
            this.generateWaterBox(p_225577_1_, p_225577_4_, 7, 5, 3, 7, 6, 4);
            this.generateBox(p_225577_1_, p_225577_4_, 5, 4, 2, 6, 4, 5, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 6, 1, 2, 6, 3, 2, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 6, 1, 5, 6, 3, 5, BASE_LIGHT, BASE_LIGHT, false);
         }

         if (oceanmonumentpieces$roomdefinition3.hasOpening[Direction.WEST.get3DDataValue()]) {
            this.generateWaterBox(p_225577_1_, p_225577_4_, 0, 5, 3, 0, 6, 4);
            this.generateBox(p_225577_1_, p_225577_4_, 1, 4, 2, 2, 4, 5, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 1, 1, 2, 1, 3, 2, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 1, 1, 5, 1, 3, 5, BASE_LIGHT, BASE_LIGHT, false);
         }

         if (oceanmonumentpieces$roomdefinition2.hasOpening[Direction.NORTH.get3DDataValue()]) {
            this.generateWaterBox(p_225577_1_, p_225577_4_, 3, 5, 15, 4, 6, 15);
         }

         if (oceanmonumentpieces$roomdefinition2.hasOpening[Direction.WEST.get3DDataValue()]) {
            this.generateWaterBox(p_225577_1_, p_225577_4_, 0, 5, 11, 0, 6, 12);
            this.generateBox(p_225577_1_, p_225577_4_, 1, 4, 10, 2, 4, 13, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 1, 1, 10, 1, 3, 10, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 1, 1, 13, 1, 3, 13, BASE_LIGHT, BASE_LIGHT, false);
         }

         if (oceanmonumentpieces$roomdefinition2.hasOpening[Direction.EAST.get3DDataValue()]) {
            this.generateWaterBox(p_225577_1_, p_225577_4_, 7, 5, 11, 7, 6, 12);
            this.generateBox(p_225577_1_, p_225577_4_, 5, 4, 10, 6, 4, 13, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 6, 1, 10, 6, 3, 10, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 6, 1, 13, 6, 3, 13, BASE_LIGHT, BASE_LIGHT, false);
         }
   ...
   public static class DoubleZRoom extends OceanMonumentPieces.Piece {
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         ...
         if (oceanmonumentpieces$roomdefinition1.connections[Direction.UP.get3DDataValue()] == null) {
            this.generateBoxOnFillOnly(p_225577_1_, p_225577_4_, 1, 4, 1, 6, 4, 7, BASE_GRAY);
         }

         if (oceanmonumentpieces$roomdefinition.connections[Direction.UP.get3DDataValue()] == null) {
            this.generateBoxOnFillOnly(p_225577_1_, p_225577_4_, 1, 4, 8, 6, 4, 14, BASE_GRAY);
         }

         this.generateBox(p_225577_1_, p_225577_4_, 0, 3, 0, 0, 3, 15, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 7, 3, 0, 7, 3, 15, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 1, 3, 0, 7, 3, 0, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 1, 3, 15, 6, 3, 15, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 0, 2, 0, 0, 2, 15, BASE_GRAY, BASE_GRAY, false);
         this.generateBox(p_225577_1_, p_225577_4_, 7, 2, 0, 7, 2, 15, BASE_GRAY, BASE_GRAY, false);
         this.generateBox(p_225577_1_, p_225577_4_, 1, 2, 0, 7, 2, 0, BASE_GRAY, BASE_GRAY, false);
         this.generateBox(p_225577_1_, p_225577_4_, 1, 2, 15, 6, 2, 15, BASE_GRAY, BASE_GRAY, false);
         this.generateBox(p_225577_1_, p_225577_4_, 0, 1, 0, 0, 1, 15, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 7, 1, 0, 7, 1, 15, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 1, 1, 0, 7, 1, 0, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 1, 1, 15, 6, 1, 15, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 1, 1, 1, 1, 1, 2, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 6, 1, 1, 6, 1, 2, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 1, 3, 1, 1, 3, 2, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 6, 3, 1, 6, 3, 2, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 1, 1, 13, 1, 1, 14, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 6, 1, 13, 6, 1, 14, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 1, 3, 13, 1, 3, 14, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 6, 3, 13, 6, 3, 14, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 2, 1, 6, 2, 3, 6, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 5, 1, 6, 5, 3, 6, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 2, 1, 9, 2, 3, 9, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 5, 1, 9, 5, 3, 9, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 3, 2, 6, 4, 2, 6, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 3, 2, 9, 4, 2, 9, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 2, 2, 7, 2, 2, 8, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 5, 2, 7, 5, 2, 8, BASE_LIGHT, BASE_LIGHT, false);
         this.placeBlock(p_225577_1_, LAMP_BLOCK, 2, 2, 5, p_225577_4_);
         this.placeBlock(p_225577_1_, LAMP_BLOCK, 5, 2, 5, p_225577_4_);
         this.placeBlock(p_225577_1_, LAMP_BLOCK, 2, 2, 10, p_225577_4_);
         this.placeBlock(p_225577_1_, LAMP_BLOCK, 5, 2, 10, p_225577_4_);
         this.placeBlock(p_225577_1_, BASE_LIGHT, 2, 3, 5, p_225577_4_);
         this.placeBlock(p_225577_1_, BASE_LIGHT, 5, 3, 5, p_225577_4_);
         this.placeBlock(p_225577_1_, BASE_LIGHT, 2, 3, 10, p_225577_4_);
         this.placeBlock(p_225577_1_, BASE_LIGHT, 5, 3, 10, p_225577_4_);
         if (oceanmonumentpieces$roomdefinition1.hasOpening[Direction.SOUTH.get3DDataValue()]) {
            this.generateWaterBox(p_225577_1_, p_225577_4_, 3, 1, 0, 4, 2, 0);
         }
   ...
   public static class EntryRoom extends OceanMonumentPieces.Piece {
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         this.generateBox(p_225577_1_, p_225577_4_, 0, 3, 0, 2, 3, 7, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 5, 3, 0, 7, 3, 7, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 0, 2, 0, 1, 2, 7, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 6, 2, 0, 7, 2, 7, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 0, 1, 0, 0, 1, 7, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 7, 1, 0, 7, 1, 7, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 0, 1, 7, 7, 3, 7, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 1, 1, 0, 2, 3, 0, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 5, 1, 0, 6, 3, 0, BASE_LIGHT, BASE_LIGHT, false);
         ...
         if (this.roomDefinition.hasOpening[Direction.WEST.get3DDataValue()]) {
            this.generateWaterBox(p_225577_1_, p_225577_4_, 0, 1, 3, 1, 2, 4);
         }

         if (this.roomDefinition.hasOpening[Direction.EAST.get3DDataValue()]) {
            this.generateWaterBox(p_225577_1_, p_225577_4_, 6, 1, 3, 7, 2, 4);
         }
   ...
   public static class MonumentBuilding extends OceanMonumentPieces.Piece {
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         int i = Math.max(p_225577_1_.getSeaLevel(), 64) - this.boundingBox.y0;
         this.generateWaterBox(p_225577_1_, p_225577_4_, 0, 0, 0, 58, i, 58);
            ...
            while(k < 7) {
               ...
               for(int j1 = 0; j1 < 4; ++j1) {
                  for(int k1 = 0; k1 < 4; ++k1) {
                     this.placeBlock(p_225577_1_, BASE_LIGHT, l + j1, 0, i1 + k1, p_225577_4_);
                     this.fillColumnDown(p_225577_1_, BASE_LIGHT, l + j1, -1, i1 + k1, p_225577_4_);
                  }
               }
         ...
         for(int l1 = 0; l1 < 5; ++l1) {
            this.generateWaterBox(p_225577_1_, p_225577_4_, -1 - l1, 0 + l1 * 2, -1 - l1, -1 - l1, 23, 58 + l1);
            this.generateWaterBox(p_225577_1_, p_225577_4_, 58 + l1, 0 + l1 * 2, -1 - l1, 58 + l1, 23, 58 + l1);
            this.generateWaterBox(p_225577_1_, p_225577_4_, 0 - l1, 0 + l1 * 2, -1 - l1, 57 + l1, 23, -1 - l1);
            this.generateWaterBox(p_225577_1_, p_225577_4_, 0 - l1, 0 + l1 * 2, 58 + l1, 57 + l1, 23, 58 + l1);
         }

         for(OceanMonumentPieces.Piece oceanmonumentpieces$piece : this.childPieces) {
            if (oceanmonumentpieces$piece.getBoundingBox().intersects(p_225577_4_)) {
   ...
   public static class MonumentCoreRoom extends OceanMonumentPieces.Piece {
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         this.generateBoxOnFillOnly(p_225577_1_, p_225577_4_, 1, 8, 0, 14, 8, 14, BASE_GRAY);
         int i = 7;
         BlockState blockstate = BASE_LIGHT;
         this.generateBox(p_225577_1_, p_225577_4_, 0, 7, 0, 0, 7, 15, blockstate, blockstate, false);
         this.generateBox(p_225577_1_, p_225577_4_, 15, 7, 0, 15, 7, 15, blockstate, blockstate, false);
         this.generateBox(p_225577_1_, p_225577_4_, 1, 7, 0, 15, 7, 0, blockstate, blockstate, false);
         this.generateBox(p_225577_1_, p_225577_4_, 1, 7, 15, 14, 7, 15, blockstate, blockstate, false);
         ...
         for(int k = 1; k <= 6; ++k) {
            ...
            for(int j = 0; j <= 15; j += 15) {
               this.generateBox(p_225577_1_, p_225577_4_, j, k, 0, j, k, 1, blockstate, blockstate, false);
               this.generateBox(p_225577_1_, p_225577_4_, j, k, 6, j, k, 9, blockstate, blockstate, false);
               this.generateBox(p_225577_1_, p_225577_4_, j, k, 14, j, k, 15, blockstate, blockstate, false);
            }

            this.generateBox(p_225577_1_, p_225577_4_, 1, k, 0, 1, k, 0, blockstate, blockstate, false);
            this.generateBox(p_225577_1_, p_225577_4_, 6, k, 0, 9, k, 0, blockstate, blockstate, false);
            this.generateBox(p_225577_1_, p_225577_4_, 14, k, 0, 14, k, 0, blockstate, blockstate, false);
            this.generateBox(p_225577_1_, p_225577_4_, 1, k, 15, 14, k, 15, blockstate, blockstate, false);
         }

         this.generateBox(p_225577_1_, p_225577_4_, 6, 3, 6, 9, 6, 9, BASE_BLACK, BASE_BLACK, false);
         this.generateBox(p_225577_1_, p_225577_4_, 7, 4, 7, 8, 5, 8, Blocks.GOLD_BLOCK.defaultBlockState(), Blocks.GOLD_BLOCK.defaultBlockState(), false);

         for(int l = 3; l <= 6; l += 3) {
            for(int i1 = 6; i1 <= 9; i1 += 3) {
               this.placeBlock(p_225577_1_, LAMP_BLOCK, i1, l, 6, p_225577_4_);
               this.placeBlock(p_225577_1_, LAMP_BLOCK, i1, l, 9, p_225577_4_);
            }
         }

         this.generateBox(p_225577_1_, p_225577_4_, 5, 1, 6, 5, 2, 6, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 5, 1, 9, 5, 2, 9, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 10, 1, 6, 10, 2, 6, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 10, 1, 9, 10, 2, 9, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 6, 1, 5, 6, 2, 5, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 9, 1, 5, 9, 2, 5, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 6, 1, 10, 6, 2, 10, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 9, 1, 10, 9, 2, 10, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 5, 2, 5, 5, 6, 5, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 5, 2, 10, 5, 6, 10, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 10, 2, 5, 10, 6, 5, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 10, 2, 10, 10, 6, 10, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 5, 7, 1, 5, 7, 6, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 10, 7, 1, 10, 7, 6, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 5, 7, 9, 5, 7, 14, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 10, 7, 9, 10, 7, 14, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 1, 7, 5, 6, 7, 5, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 1, 7, 10, 6, 7, 10, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 9, 7, 5, 14, 7, 5, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 9, 7, 10, 14, 7, 10, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 2, 1, 2, 2, 1, 3, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 3, 1, 2, 3, 1, 2, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 13, 1, 2, 13, 1, 3, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 12, 1, 2, 12, 1, 2, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 2, 1, 12, 2, 1, 13, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 3, 1, 13, 3, 1, 13, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 13, 1, 12, 13, 1, 13, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 12, 1, 13, 12, 1, 13, BASE_LIGHT, BASE_LIGHT, false);
         return true;
      }
   }
   ...
   public static class Penthouse extends OceanMonumentPieces.Piece {
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         this.generateBox(p_225577_1_, p_225577_4_, 2, -1, 2, 11, -1, 11, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 0, -1, 0, 1, -1, 11, BASE_GRAY, BASE_GRAY, false);
         this.generateBox(p_225577_1_, p_225577_4_, 12, -1, 0, 13, -1, 11, BASE_GRAY, BASE_GRAY, false);
         this.generateBox(p_225577_1_, p_225577_4_, 2, -1, 0, 11, -1, 1, BASE_GRAY, BASE_GRAY, false);
         this.generateBox(p_225577_1_, p_225577_4_, 2, -1, 12, 11, -1, 13, BASE_GRAY, BASE_GRAY, false);
         this.generateBox(p_225577_1_, p_225577_4_, 0, 0, 0, 0, 0, 13, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 13, 0, 0, 13, 0, 13, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 1, 0, 0, 12, 0, 0, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 1, 0, 13, 12, 0, 13, BASE_LIGHT, BASE_LIGHT, false);

         for(int i = 2; i <= 11; i += 3) {
            this.placeBlock(p_225577_1_, LAMP_BLOCK, 0, 0, i, p_225577_4_);
            this.placeBlock(p_225577_1_, LAMP_BLOCK, 13, 0, i, p_225577_4_);
            this.placeBlock(p_225577_1_, LAMP_BLOCK, i, 0, 0, p_225577_4_);
         }

         this.generateBox(p_225577_1_, p_225577_4_, 2, 0, 3, 4, 0, 9, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 9, 0, 3, 11, 0, 9, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 4, 0, 9, 9, 0, 11, BASE_LIGHT, BASE_LIGHT, false);
         this.placeBlock(p_225577_1_, BASE_LIGHT, 5, 0, 8, p_225577_4_);
         this.placeBlock(p_225577_1_, BASE_LIGHT, 8, 0, 8, p_225577_4_);
         this.placeBlock(p_225577_1_, BASE_LIGHT, 10, 0, 10, p_225577_4_);
         this.placeBlock(p_225577_1_, BASE_LIGHT, 3, 0, 10, p_225577_4_);
         this.generateBox(p_225577_1_, p_225577_4_, 3, 0, 3, 3, 0, 7, BASE_BLACK, BASE_BLACK, false);
         this.generateBox(p_225577_1_, p_225577_4_, 10, 0, 3, 10, 0, 7, BASE_BLACK, BASE_BLACK, false);
         this.generateBox(p_225577_1_, p_225577_4_, 6, 0, 10, 7, 0, 10, BASE_BLACK, BASE_BLACK, false);
         int l = 3;

         for(int j = 0; j < 2; ++j) {
            for(int k = 2; k <= 8; k += 3) {
               this.generateBox(p_225577_1_, p_225577_4_, l, 0, k, l, 2, k, BASE_LIGHT, BASE_LIGHT, false);
            }

            l = 10;
         }

         this.generateBox(p_225577_1_, p_225577_4_, 5, 0, 10, 5, 2, 10, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 8, 0, 10, 8, 2, 10, BASE_LIGHT, BASE_LIGHT, false);
         this.generateBox(p_225577_1_, p_225577_4_, 6, -1, 7, 7, -1, 8, BASE_BLACK, BASE_BLACK, false);
         this.generateWaterBox(p_225577_1_, p_225577_4_, 6, -1, 3, 7, -1, 4);
   ...
   public abstract static class Piece extends StructurePiece {
      ...
      protected void generateWaterBox(IWorld p_209179_1_, MutableBoundingBox p_209179_2_, int p_209179_3_, int p_209179_4_, int p_209179_5_, int p_209179_6_, int p_209179_7_, int p_209179_8_) {
      ...
      protected boolean spawnElder(IWorld p_175817_1_, MutableBoundingBox p_175817_2_, int p_175817_3_, int p_175817_4_, int p_175817_5_) {
         ...
         if (p_175817_2_.isInside(new BlockPos(i, j, k))) {
            ...
            elderguardianentity.finalizeSpawn(p_175817_1_, p_175817_1_.getCurrentDifficultyAt(new BlockPos(elderguardianentity)), SpawnReason.STRUCTURE, (ILivingEntityData)null, (CompoundNBT)null);
            p_175817_1_.addFreshEntity(elderguardianentity);
            return true;
         } else {
            return false;
         }
   ...
   public static class SimpleRoom extends OceanMonumentPieces.Piece {
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         ...
         if (this.roomDefinition.connections[Direction.UP.get3DDataValue()] == null) {
            this.generateBoxOnFillOnly(p_225577_1_, p_225577_4_, 1, 4, 1, 6, 4, 6, BASE_GRAY);
         }

         boolean flag = this.mainDesign != 0 && p_225577_3_.nextBoolean() && !this.roomDefinition.hasOpening[Direction.DOWN.get3DDataValue()] && !this.roomDefinition.hasOpening[Direction.UP.get3DDataValue()] && this.roomDefinition.countOpenings() > 1;
         if (this.mainDesign == 0) {
            this.generateBox(p_225577_1_, p_225577_4_, 0, 1, 0, 2, 1, 2, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 0, 3, 0, 2, 3, 2, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 0, 2, 0, 0, 2, 2, BASE_GRAY, BASE_GRAY, false);
            this.generateBox(p_225577_1_, p_225577_4_, 1, 2, 0, 2, 2, 0, BASE_GRAY, BASE_GRAY, false);
            this.placeBlock(p_225577_1_, LAMP_BLOCK, 1, 2, 1, p_225577_4_);
            this.generateBox(p_225577_1_, p_225577_4_, 5, 1, 0, 7, 1, 2, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 5, 3, 0, 7, 3, 2, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 7, 2, 0, 7, 2, 2, BASE_GRAY, BASE_GRAY, false);
            this.generateBox(p_225577_1_, p_225577_4_, 5, 2, 0, 6, 2, 0, BASE_GRAY, BASE_GRAY, false);
            this.placeBlock(p_225577_1_, LAMP_BLOCK, 6, 2, 1, p_225577_4_);
            this.generateBox(p_225577_1_, p_225577_4_, 0, 1, 5, 2, 1, 7, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 0, 3, 5, 2, 3, 7, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 0, 2, 5, 0, 2, 7, BASE_GRAY, BASE_GRAY, false);
            this.generateBox(p_225577_1_, p_225577_4_, 1, 2, 7, 2, 2, 7, BASE_GRAY, BASE_GRAY, false);
            this.placeBlock(p_225577_1_, LAMP_BLOCK, 1, 2, 6, p_225577_4_);
            this.generateBox(p_225577_1_, p_225577_4_, 5, 1, 5, 7, 1, 7, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 5, 3, 5, 7, 3, 7, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 7, 2, 5, 7, 2, 7, BASE_GRAY, BASE_GRAY, false);
            this.generateBox(p_225577_1_, p_225577_4_, 5, 2, 7, 6, 2, 7, BASE_GRAY, BASE_GRAY, false);
            this.placeBlock(p_225577_1_, LAMP_BLOCK, 6, 2, 6, p_225577_4_);
            if (this.roomDefinition.hasOpening[Direction.SOUTH.get3DDataValue()]) {
               this.generateBox(p_225577_1_, p_225577_4_, 3, 3, 0, 4, 3, 0, BASE_LIGHT, BASE_LIGHT, false);
            } else {
               this.generateBox(p_225577_1_, p_225577_4_, 3, 3, 0, 4, 3, 1, BASE_LIGHT, BASE_LIGHT, false);
               this.generateBox(p_225577_1_, p_225577_4_, 3, 2, 0, 4, 2, 0, BASE_GRAY, BASE_GRAY, false);
               this.generateBox(p_225577_1_, p_225577_4_, 3, 1, 0, 4, 1, 1, BASE_LIGHT, BASE_LIGHT, false);
            }

            if (this.roomDefinition.hasOpening[Direction.NORTH.get3DDataValue()]) {
               this.generateBox(p_225577_1_, p_225577_4_, 3, 3, 7, 4, 3, 7, BASE_LIGHT, BASE_LIGHT, false);
            } else {
               this.generateBox(p_225577_1_, p_225577_4_, 3, 3, 6, 4, 3, 7, BASE_LIGHT, BASE_LIGHT, false);
               this.generateBox(p_225577_1_, p_225577_4_, 3, 2, 7, 4, 2, 7, BASE_GRAY, BASE_GRAY, false);
               this.generateBox(p_225577_1_, p_225577_4_, 3, 1, 6, 4, 1, 7, BASE_LIGHT, BASE_LIGHT, false);
            }

            if (this.roomDefinition.hasOpening[Direction.WEST.get3DDataValue()]) {
               this.generateBox(p_225577_1_, p_225577_4_, 0, 3, 3, 0, 3, 4, BASE_LIGHT, BASE_LIGHT, false);
            } else {
               this.generateBox(p_225577_1_, p_225577_4_, 0, 3, 3, 1, 3, 4, BASE_LIGHT, BASE_LIGHT, false);
               this.generateBox(p_225577_1_, p_225577_4_, 0, 2, 3, 0, 2, 4, BASE_GRAY, BASE_GRAY, false);
               this.generateBox(p_225577_1_, p_225577_4_, 0, 1, 3, 1, 1, 4, BASE_LIGHT, BASE_LIGHT, false);
            }

            if (this.roomDefinition.hasOpening[Direction.EAST.get3DDataValue()]) {
               this.generateBox(p_225577_1_, p_225577_4_, 7, 3, 3, 7, 3, 4, BASE_LIGHT, BASE_LIGHT, false);
            } else {
               this.generateBox(p_225577_1_, p_225577_4_, 6, 3, 3, 7, 3, 4, BASE_LIGHT, BASE_LIGHT, false);
               this.generateBox(p_225577_1_, p_225577_4_, 7, 2, 3, 7, 2, 4, BASE_GRAY, BASE_GRAY, false);
               this.generateBox(p_225577_1_, p_225577_4_, 6, 1, 3, 7, 1, 4, BASE_LIGHT, BASE_LIGHT, false);
            }
         } else if (this.mainDesign == 1) {
            this.generateBox(p_225577_1_, p_225577_4_, 2, 1, 2, 2, 3, 2, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 2, 1, 5, 2, 3, 5, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 5, 1, 5, 5, 3, 5, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 5, 1, 2, 5, 3, 2, BASE_LIGHT, BASE_LIGHT, false);
            this.placeBlock(p_225577_1_, LAMP_BLOCK, 2, 2, 2, p_225577_4_);
            this.placeBlock(p_225577_1_, LAMP_BLOCK, 2, 2, 5, p_225577_4_);
            this.placeBlock(p_225577_1_, LAMP_BLOCK, 5, 2, 5, p_225577_4_);
            this.placeBlock(p_225577_1_, LAMP_BLOCK, 5, 2, 2, p_225577_4_);
            this.generateBox(p_225577_1_, p_225577_4_, 0, 1, 0, 1, 3, 0, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 0, 1, 1, 0, 3, 1, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 0, 1, 7, 1, 3, 7, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 0, 1, 6, 0, 3, 6, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 6, 1, 7, 7, 3, 7, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 7, 1, 6, 7, 3, 6, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 6, 1, 0, 7, 3, 0, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 7, 1, 1, 7, 3, 1, BASE_LIGHT, BASE_LIGHT, false);
            this.placeBlock(p_225577_1_, BASE_GRAY, 1, 2, 0, p_225577_4_);
            this.placeBlock(p_225577_1_, BASE_GRAY, 0, 2, 1, p_225577_4_);
            this.placeBlock(p_225577_1_, BASE_GRAY, 1, 2, 7, p_225577_4_);
            this.placeBlock(p_225577_1_, BASE_GRAY, 0, 2, 6, p_225577_4_);
            this.placeBlock(p_225577_1_, BASE_GRAY, 6, 2, 7, p_225577_4_);
            this.placeBlock(p_225577_1_, BASE_GRAY, 7, 2, 6, p_225577_4_);
            this.placeBlock(p_225577_1_, BASE_GRAY, 6, 2, 0, p_225577_4_);
            this.placeBlock(p_225577_1_, BASE_GRAY, 7, 2, 1, p_225577_4_);
            if (!this.roomDefinition.hasOpening[Direction.SOUTH.get3DDataValue()]) {
               this.generateBox(p_225577_1_, p_225577_4_, 1, 3, 0, 6, 3, 0, BASE_LIGHT, BASE_LIGHT, false);
               this.generateBox(p_225577_1_, p_225577_4_, 1, 2, 0, 6, 2, 0, BASE_GRAY, BASE_GRAY, false);
               this.generateBox(p_225577_1_, p_225577_4_, 1, 1, 0, 6, 1, 0, BASE_LIGHT, BASE_LIGHT, false);
            }

            if (!this.roomDefinition.hasOpening[Direction.NORTH.get3DDataValue()]) {
               this.generateBox(p_225577_1_, p_225577_4_, 1, 3, 7, 6, 3, 7, BASE_LIGHT, BASE_LIGHT, false);
               this.generateBox(p_225577_1_, p_225577_4_, 1, 2, 7, 6, 2, 7, BASE_GRAY, BASE_GRAY, false);
               this.generateBox(p_225577_1_, p_225577_4_, 1, 1, 7, 6, 1, 7, BASE_LIGHT, BASE_LIGHT, false);
            }

            if (!this.roomDefinition.hasOpening[Direction.WEST.get3DDataValue()]) {
               this.generateBox(p_225577_1_, p_225577_4_, 0, 3, 1, 0, 3, 6, BASE_LIGHT, BASE_LIGHT, false);
               this.generateBox(p_225577_1_, p_225577_4_, 0, 2, 1, 0, 2, 6, BASE_GRAY, BASE_GRAY, false);
               this.generateBox(p_225577_1_, p_225577_4_, 0, 1, 1, 0, 1, 6, BASE_LIGHT, BASE_LIGHT, false);
            }

            if (!this.roomDefinition.hasOpening[Direction.EAST.get3DDataValue()]) {
               this.generateBox(p_225577_1_, p_225577_4_, 7, 3, 1, 7, 3, 6, BASE_LIGHT, BASE_LIGHT, false);
               this.generateBox(p_225577_1_, p_225577_4_, 7, 2, 1, 7, 2, 6, BASE_GRAY, BASE_GRAY, false);
               this.generateBox(p_225577_1_, p_225577_4_, 7, 1, 1, 7, 1, 6, BASE_LIGHT, BASE_LIGHT, false);
            }
            ...
            this.generateBox(p_225577_1_, p_225577_4_, 1, 1, 0, 6, 1, 0, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 1, 1, 7, 6, 1, 7, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 0, 2, 0, 0, 2, 7, BASE_BLACK, BASE_BLACK, false);
            this.generateBox(p_225577_1_, p_225577_4_, 7, 2, 0, 7, 2, 7, BASE_BLACK, BASE_BLACK, false);
            this.generateBox(p_225577_1_, p_225577_4_, 1, 2, 0, 6, 2, 0, BASE_BLACK, BASE_BLACK, false);
            this.generateBox(p_225577_1_, p_225577_4_, 1, 2, 7, 6, 2, 7, BASE_BLACK, BASE_BLACK, false);
            this.generateBox(p_225577_1_, p_225577_4_, 0, 3, 0, 0, 3, 7, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 7, 3, 0, 7, 3, 7, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 1, 3, 0, 6, 3, 0, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 1, 3, 7, 6, 3, 7, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 0, 1, 3, 0, 2, 4, BASE_BLACK, BASE_BLACK, false);
            this.generateBox(p_225577_1_, p_225577_4_, 7, 1, 3, 7, 2, 4, BASE_BLACK, BASE_BLACK, false);
            this.generateBox(p_225577_1_, p_225577_4_, 3, 1, 0, 4, 2, 0, BASE_BLACK, BASE_BLACK, false);
            this.generateBox(p_225577_1_, p_225577_4_, 3, 1, 7, 4, 2, 7, BASE_BLACK, BASE_BLACK, false);
            if (this.roomDefinition.hasOpening[Direction.SOUTH.get3DDataValue()]) {
               this.generateWaterBox(p_225577_1_, p_225577_4_, 3, 1, 0, 4, 2, 0);
            }
         ...
         if (flag) {
            this.generateBox(p_225577_1_, p_225577_4_, 3, 1, 3, 4, 1, 4, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 3, 2, 3, 4, 2, 4, BASE_GRAY, BASE_GRAY, false);
            this.generateBox(p_225577_1_, p_225577_4_, 3, 3, 3, 4, 3, 4, BASE_LIGHT, BASE_LIGHT, false);
         }
         ...
         for(int i = 1; i <= 6; ++i) {
            for(int j = 1; j <= 6; ++j) {
               if (p_225577_3_.nextInt(3) != 0) {
                  ...
                  this.generateBox(p_225577_1_, p_225577_4_, i, k, j, i, 3, j, blockstate, blockstate, false);
               }
            }
         }
   ...
   public static class WingRoom extends OceanMonumentPieces.Piece {
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         if (this.mainDesign == 0) {
            for(int i = 0; i < 4; ++i) {
               this.generateBox(p_225577_1_, p_225577_4_, 10 - i, 3 - i, 20 - i, 12 + i, 3 - i, 20, BASE_LIGHT, BASE_LIGHT, false);
            }

            this.generateBox(p_225577_1_, p_225577_4_, 7, 0, 6, 15, 0, 16, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 6, 0, 6, 6, 3, 20, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 16, 0, 6, 16, 3, 20, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 7, 1, 7, 7, 1, 20, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 15, 1, 7, 15, 1, 20, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 7, 1, 6, 9, 3, 6, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 13, 1, 6, 15, 3, 6, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 8, 1, 7, 9, 1, 7, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 13, 1, 7, 14, 1, 7, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 9, 0, 5, 13, 0, 5, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 10, 0, 7, 12, 0, 7, BASE_BLACK, BASE_BLACK, false);
            this.generateBox(p_225577_1_, p_225577_4_, 8, 0, 10, 8, 0, 12, BASE_BLACK, BASE_BLACK, false);
            this.generateBox(p_225577_1_, p_225577_4_, 14, 0, 10, 14, 0, 12, BASE_BLACK, BASE_BLACK, false);

            for(int i1 = 18; i1 >= 7; i1 -= 3) {
               this.placeBlock(p_225577_1_, LAMP_BLOCK, 6, 3, i1, p_225577_4_);
               this.placeBlock(p_225577_1_, LAMP_BLOCK, 16, 3, i1, p_225577_4_);
            }

            this.placeBlock(p_225577_1_, LAMP_BLOCK, 10, 0, 10, p_225577_4_);
            this.placeBlock(p_225577_1_, LAMP_BLOCK, 12, 0, 10, p_225577_4_);
            this.placeBlock(p_225577_1_, LAMP_BLOCK, 10, 0, 12, p_225577_4_);
            this.placeBlock(p_225577_1_, LAMP_BLOCK, 12, 0, 12, p_225577_4_);
            this.placeBlock(p_225577_1_, LAMP_BLOCK, 8, 3, 6, p_225577_4_);
            this.placeBlock(p_225577_1_, LAMP_BLOCK, 14, 3, 6, p_225577_4_);
            this.placeBlock(p_225577_1_, BASE_LIGHT, 4, 2, 4, p_225577_4_);
            this.placeBlock(p_225577_1_, LAMP_BLOCK, 4, 1, 4, p_225577_4_);
            this.placeBlock(p_225577_1_, BASE_LIGHT, 4, 0, 4, p_225577_4_);
            this.placeBlock(p_225577_1_, BASE_LIGHT, 18, 2, 4, p_225577_4_);
            this.placeBlock(p_225577_1_, LAMP_BLOCK, 18, 1, 4, p_225577_4_);
            this.placeBlock(p_225577_1_, BASE_LIGHT, 18, 0, 4, p_225577_4_);
            this.placeBlock(p_225577_1_, BASE_LIGHT, 4, 2, 18, p_225577_4_);
            this.placeBlock(p_225577_1_, LAMP_BLOCK, 4, 1, 18, p_225577_4_);
            this.placeBlock(p_225577_1_, BASE_LIGHT, 4, 0, 18, p_225577_4_);
            this.placeBlock(p_225577_1_, BASE_LIGHT, 18, 2, 18, p_225577_4_);
            this.placeBlock(p_225577_1_, LAMP_BLOCK, 18, 1, 18, p_225577_4_);
            this.placeBlock(p_225577_1_, BASE_LIGHT, 18, 0, 18, p_225577_4_);
            this.placeBlock(p_225577_1_, BASE_LIGHT, 9, 7, 20, p_225577_4_);
            this.placeBlock(p_225577_1_, BASE_LIGHT, 13, 7, 20, p_225577_4_);
            this.generateBox(p_225577_1_, p_225577_4_, 6, 0, 21, 7, 4, 21, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 15, 0, 21, 16, 4, 21, BASE_LIGHT, BASE_LIGHT, false);
            this.spawnElder(p_225577_1_, p_225577_4_, 11, 2, 16);
         } else if (this.mainDesign == 1) {
            this.generateBox(p_225577_1_, p_225577_4_, 9, 3, 18, 13, 3, 20, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 9, 0, 18, 9, 2, 18, BASE_LIGHT, BASE_LIGHT, false);
            this.generateBox(p_225577_1_, p_225577_4_, 13, 0, 18, 13, 2, 18, BASE_LIGHT, BASE_LIGHT, false);
            int j1 = 9;
            int j = 20;
            int k = 5;

            for(int l = 0; l < 2; ++l) {
               this.placeBlock(p_225577_1_, BASE_LIGHT, j1, 6, 20, p_225577_4_);
               this.placeBlock(p_225577_1_, LAMP_BLOCK, j1, 5, 20, p_225577_4_);
               this.placeBlock(p_225577_1_, BASE_LIGHT, j1, 4, 20, p_225577_4_);
               j1 = 13;
            }

            this.generateBox(p_225577_1_, p_225577_4_, 7, 3, 7, 15, 3, 14, BASE_LIGHT, BASE_LIGHT, false);
            j1 = 10;

            for(int k1 = 0; k1 < 2; ++k1) {
               this.generateBox(p_225577_1_, p_225577_4_, j1, 0, 10, j1, 6, 10, BASE_LIGHT, BASE_LIGHT, false);
               this.generateBox(p_225577_1_, p_225577_4_, j1, 0, 12, j1, 6, 12, BASE_LIGHT, BASE_LIGHT, false);
               this.placeBlock(p_225577_1_, LAMP_BLOCK, j1, 0, 10, p_225577_4_);
               this.placeBlock(p_225577_1_, LAMP_BLOCK, j1, 0, 12, p_225577_4_);
               this.placeBlock(p_225577_1_, LAMP_BLOCK, j1, 4, 10, p_225577_4_);
               this.placeBlock(p_225577_1_, LAMP_BLOCK, j1, 4, 12, p_225577_4_);
               j1 = 12;
            }
            ...
            for(int l1 = 0; l1 < 2; ++l1) {
               this.generateBox(p_225577_1_, p_225577_4_, j1, 0, 7, j1, 2, 7, BASE_LIGHT, BASE_LIGHT, false);
               this.generateBox(p_225577_1_, p_225577_4_, j1, 0, 14, j1, 2, 14, BASE_LIGHT, BASE_LIGHT, false);
               j1 = 14;
            }

            this.generateBox(p_225577_1_, p_225577_4_, 8, 3, 8, 8, 3, 13, BASE_BLACK, BASE_BLACK, false);
            this.generateBox(p_225577_1_, p_225577_4_, 14, 3, 8, 14, 3, 13, BASE_BLACK, BASE_BLACK, false);
