...
public abstract class AbstractBigMushroomFeature extends Feature<BigMushroomFeatureConfig> {
   ...
   protected void placeTrunk(IWorld p_227210_1_, Random p_227210_2_, BlockPos p_227210_3_, BigMushroomFeatureConfig p_227210_4_, int p_227210_5_, BlockPos.Mutable p_227210_6_) {
      for(int i = 0; i < p_227210_5_; ++i) {
         ...
         if (p_227210_1_.getBlockState(p_227210_6_).canBeReplacedByLogs(p_227210_1_, p_227210_6_)) {
            this.func_202278_a(p_227210_1_, p_227210_6_, p_227210_4_.stemProvider.getState(p_227210_2_, p_227210_3_));
         }
      }
   ...
   public boolean func_212245_a(IWorld p_212245_1_, ChunkGenerator<? extends GenerationSettings> p_212245_2_, Random p_212245_3_, BlockPos p_212245_4_, BigMushroomFeatureConfig p_212245_5_) {
      int i = this.getTreeHeight(p_212245_3_);
      BlockPos.Mutable blockpos$mutable = new BlockPos.Mutable();
      if (!this.isValidPosition(p_212245_1_, p_212245_4_, i, blockpos$mutable, p_212245_5_)) {
         return false;
      } else {
         this.makeCap(p_212245_1_, p_212245_3_, p_212245_4_, i, blockpos$mutable, p_212245_5_);
         this.placeTrunk(p_212245_1_, p_212245_3_, p_212245_4_, p_212245_5_, i, blockpos$mutable);
         return true;
      }
   }
