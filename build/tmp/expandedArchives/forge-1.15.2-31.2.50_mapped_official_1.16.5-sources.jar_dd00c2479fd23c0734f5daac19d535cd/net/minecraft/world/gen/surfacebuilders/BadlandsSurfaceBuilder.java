...
public class BadlandsSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig> {
   ...
   public void initNoise(long p_205548_1_) {
      ...
      if (this.seed != p_205548_1_ || this.pillarNoise == null || this.pillarRoofNoise == null) {
         ...
         this.pillarNoise = new PerlinNoiseGenerator(sharedseedrandom, 3, 0);
         this.pillarRoofNoise = new PerlinNoiseGenerator(sharedseedrandom, 0, 0);
      }
   ...
   protected void generateBands(long p_215430_1_) {
      ...
      this.clayBandsOffsetNoise = new PerlinNoiseGenerator(sharedseedrandom, 0, 0);
