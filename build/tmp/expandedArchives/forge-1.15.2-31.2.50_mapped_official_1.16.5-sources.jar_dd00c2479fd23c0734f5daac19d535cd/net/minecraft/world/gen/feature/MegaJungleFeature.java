...
public class MegaJungleFeature extends HugeTreesFeature<HugeTreeFeatureConfig> {
   ...
   public boolean doPlace(IWorldGenerationReader p_225557_1_, Random p_225557_2_, BlockPos p_225557_3_, Set<BlockPos> p_225557_4_, Set<BlockPos> p_225557_5_, MutableBoundingBox p_225557_6_, HugeTreeFeatureConfig p_225557_7_) {
      int i = this.func_227256_a_(p_225557_2_, p_225557_7_);
      if (!this.hasRoom(p_225557_1_, p_225557_3_, i, p_225557_7_)) {
         return false;
      } else {
         this.func_227252_c_(p_225557_1_, p_225557_2_, p_225557_3_.above(i), 2, p_225557_5_, p_225557_6_, p_225557_7_);
   ...
   private void func_227252_c_(IWorldGenerationReader p_227252_1_, Random p_227252_2_, BlockPos p_227252_3_, int p_227252_4_, Set<BlockPos> p_227252_5_, MutableBoundingBox p_227252_6_, BaseTreeFeatureConfig p_227252_7_) {
      ...
      for(int j = -2; j <= 0; ++j) {
         this.func_227255_a_(p_227252_1_, p_227252_2_, p_227252_3_.above(j), p_227252_4_ + 1 - j, p_227252_5_, p_227252_6_, p_227252_7_);
      }
