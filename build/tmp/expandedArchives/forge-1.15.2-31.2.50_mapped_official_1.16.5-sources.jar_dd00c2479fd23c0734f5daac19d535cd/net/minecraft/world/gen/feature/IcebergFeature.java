...
public class IcebergFeature extends Feature<BlockStateFeatureConfig> {
   ...
   public boolean func_212245_a(IWorld p_212245_1_, ChunkGenerator<? extends GenerationSettings> p_212245_2_, Random p_212245_3_, BlockPos p_212245_4_, BlockStateFeatureConfig p_212245_5_) {
      ...
      BlockState blockstate = p_212245_5_.state;
      ...
      for(int l1 = -k1; l1 < k1; ++l1) {
         for(int i2 = -k1; i2 < k1; ++i2) {
            for(int j2 = 0; j2 < l; ++j2) {
               int k2 = flag1 ? this.heightDependentRadiusEllipse(j2, l, j1) : this.heightDependentRadiusRound(p_212245_3_, j2, l, j1);
               if (flag1 || l1 < k2) {
                  this.generateIcebergBlock(p_212245_1_, p_212245_3_, p_212245_4_, l, l1, j2, i2, k2, k1, flag1, j, d0, flag, blockstate);
               }
            }
         }
      }

      this.smooth(p_212245_1_, p_212245_4_, j1, l, flag1, i);
      ...
      for(int i3 = -k1; i3 < k1; ++i3) {
         for(int j3 = -k1; j3 < k1; ++j3) {
            for(int k3 = -1; k3 > -i1; --k3) {
               ...
               int l2 = this.heightDependentRadiusSteep(p_212245_3_, -k3, i1, j1);
               if (i3 < l2) {
                  this.generateIcebergBlock(p_212245_1_, p_212245_3_, p_212245_4_, i1, i3, k3, j3, l2, l3, flag1, j, d0, flag, blockstate);
               }
            }
         }
      }
      ...
      if (flag2) {
         this.generateCutOut(p_212245_3_, p_212245_1_, j1, l, p_212245_4_, flag1, i, d0, j);
      }
         ...
         for(int l = -i; l < i; ++l) {
            ...
            if (d0 < 0.0D) {
               ...
               if (this.isIcebergBlock(block) || block == Blocks.SNOW_BLOCK) {
                  if (p_205174_5_) {
                     this.func_202278_a(p_205174_4_, blockpos, Blocks.WATER.defaultBlockState());
                  } else {
                     this.func_202278_a(p_205174_4_, blockpos, Blocks.AIR.defaultBlockState());
   ...
   private void removeFloatingSnowLayer(IWorld p_205185_1_, BlockPos p_205185_2_) {
      if (p_205185_1_.getBlockState(p_205185_2_.above()).getBlock() == Blocks.SNOW) {
         this.func_202278_a(p_205185_1_, p_205185_2_.above(), Blocks.AIR.defaultBlockState());
      }
   ...
   private void setIcebergBlock(BlockPos p_205175_1_, IWorld p_205175_2_, Random p_205175_3_, int p_205175_4_, int p_205175_5_, boolean p_205175_6_, boolean p_205175_7_, BlockState p_205175_8_) {
      ...
      if (blockstate.getMaterial() == Material.AIR || block == Blocks.SNOW_BLOCK || block == Blocks.ICE || block == Blocks.WATER) {
         ...
         if (p_205175_7_ && block != Blocks.WATER && (double)p_205175_4_ <= (double)p_205175_3_.nextInt(Math.max(1, p_205175_5_ / i)) + (double)p_205175_5_ * 0.6D && flag) {
            this.func_202278_a(p_205175_2_, p_205175_1_, Blocks.SNOW_BLOCK.defaultBlockState());
         } else {
            this.func_202278_a(p_205175_2_, p_205175_1_, p_205175_8_);
         }
      }
            ...
            for(int l = 0; l <= p_205186_4_; ++l) {
               ...
               if (this.isIcebergBlock(block) || block == Blocks.SNOW) {
                  if (this.belowIsAir(p_205186_1_, blockpos)) {
                     this.func_202278_a(p_205186_1_, blockpos, Blocks.AIR.defaultBlockState());
                     this.func_202278_a(p_205186_1_, blockpos.above(), Blocks.AIR.defaultBlockState());
