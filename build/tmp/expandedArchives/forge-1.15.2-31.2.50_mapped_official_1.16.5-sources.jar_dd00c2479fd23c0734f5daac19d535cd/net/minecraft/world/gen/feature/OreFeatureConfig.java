...
public class OreFeatureConfig implements IFeatureConfig {
   ...
   public <T> Dynamic<T> func_214634_a(DynamicOps<T> p_214634_1_) {
      return new Dynamic<>(p_214634_1_, p_214634_1_.createMap(ImmutableMap.of(p_214634_1_.createString("size"), p_214634_1_.createInt(this.size), p_214634_1_.createString("target"), p_214634_1_.createString(this.target.func_214737_a()), p_214634_1_.createString("state"), BlockState.func_215689_a(p_214634_1_, this.state).getValue())));
   }

   public static OreFeatureConfig func_214641_a(Dynamic<?> p_214641_0_) {
      ...
      BlockState blockstate = p_214641_0_.get("state").map(BlockState::func_215698_a).orElse(Blocks.AIR.defaultBlockState());
