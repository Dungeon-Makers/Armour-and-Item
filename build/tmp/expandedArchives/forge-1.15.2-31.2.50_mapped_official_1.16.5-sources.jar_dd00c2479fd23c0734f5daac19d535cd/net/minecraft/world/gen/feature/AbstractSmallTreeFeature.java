...
public abstract class AbstractSmallTreeFeature<T extends TreeFeatureConfig> extends AbstractTreeFeature<T> {
   ...
   protected void func_227213_a_(IWorldGenerationReader p_227213_1_, Random p_227213_2_, int p_227213_3_, BlockPos p_227213_4_, int p_227213_5_, Set<BlockPos> p_227213_6_, MutableBoundingBox p_227213_7_, TreeFeatureConfig p_227213_8_) {
      for(int i = 0; i < p_227213_3_ - p_227213_5_; ++i) {
         this.func_227216_a_(p_227213_1_, p_227213_2_, p_227213_4_.above(i), p_227213_6_, p_227213_7_, p_227213_8_);
      }
   ...
   public Optional<BlockPos> func_227212_a_(IWorldGenerationReader p_227212_1_, int p_227212_2_, int p_227212_3_, int p_227212_4_, BlockPos p_227212_5_, TreeFeatureConfig p_227212_6_) {
      BlockPos blockpos;
      if (!p_227212_6_.fromSapling) {
         int i = p_227212_1_.getHeightmapPos(Heightmap.Type.OCEAN_FLOOR, p_227212_5_).getY();
         int j = p_227212_1_.getHeightmapPos(Heightmap.Type.WORLD_SURFACE, p_227212_5_).getY();
      ...
      if (blockpos.getY() >= 1 && blockpos.getY() + p_227212_2_ + 1 <= p_227212_1_.getMaxHeight()) {
         ...
         return isSoilOrFarm(p_227212_1_, blockpos.below(), p_227212_6_.getSapling()) && blockpos.getY() < p_227212_1_.getMaxHeight() - p_227212_2_ - 1 ? Optional.of(blockpos) : Optional.empty();
      } else {
         return Optional.empty();
      }
   }
