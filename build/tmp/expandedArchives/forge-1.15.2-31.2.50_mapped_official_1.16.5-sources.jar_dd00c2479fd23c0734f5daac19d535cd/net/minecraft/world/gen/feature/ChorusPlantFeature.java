...
public class ChorusPlantFeature extends Feature<NoFeatureConfig> {
   ...
   public boolean func_212245_a(IWorld p_212245_1_, ChunkGenerator<? extends GenerationSettings> p_212245_2_, Random p_212245_3_, BlockPos p_212245_4_, NoFeatureConfig p_212245_5_) {
      if (p_212245_1_.isEmptyBlock(p_212245_4_.above()) && p_212245_1_.getBlockState(p_212245_4_).getBlock() == Blocks.END_STONE) {
         ChorusFlowerBlock.generatePlant(p_212245_1_, p_212245_4_.above(), p_212245_3_, 8);
         return true;
      } else {
         return false;
      }
