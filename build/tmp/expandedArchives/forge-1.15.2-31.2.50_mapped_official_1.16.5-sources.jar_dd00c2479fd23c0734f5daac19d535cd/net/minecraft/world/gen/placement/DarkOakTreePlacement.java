...
public class DarkOakTreePlacement extends Placement<NoPlacementConfig> {
   ...
   public Stream<BlockPos> func_212848_a_(IWorld p_212848_1_, ChunkGenerator<? extends GenerationSettings> p_212848_2_, Random p_212848_3_, NoPlacementConfig p_212848_4_, BlockPos p_212848_5_) {
      return IntStream.range(0, 16).mapToObj((p_227445_3_) -> {
         int i = p_227445_3_ / 4;
         int j = p_227445_3_ % 4;
         int k = i * 4 + 1 + p_212848_3_.nextInt(3) + p_212848_5_.getX();
         int l = j * 4 + 1 + p_212848_3_.nextInt(3) + p_212848_5_.getZ();
         int i1 = p_212848_1_.getHeight(Heightmap.Type.MOTION_BLOCKING, k, l);
