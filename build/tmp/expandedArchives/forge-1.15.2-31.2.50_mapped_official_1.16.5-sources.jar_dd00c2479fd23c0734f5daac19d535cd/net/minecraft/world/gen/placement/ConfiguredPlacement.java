...
public class ConfiguredPlacement<DC extends IPlacementConfig> {
   ...
   public ConfiguredPlacement(Placement<DC> p_i51389_1_, Dynamic<?> p_i51389_2_) {
      this(p_i51389_1_, p_i51389_1_.func_215001_a(p_i51389_2_));
   }
   ...
   public <FC extends IFeatureConfig, F extends Feature<FC>> boolean func_215093_a(IWorld p_215093_1_, ChunkGenerator<? extends GenerationSettings> p_215093_2_, Random p_215093_3_, BlockPos p_215093_4_, ConfiguredFeature<FC, F> p_215093_5_) {
      return this.decorator.func_214998_a(p_215093_1_, p_215093_2_, p_215093_3_, p_215093_4_, this.config, p_215093_5_);
   }

   public <T> Dynamic<T> func_215094_a(DynamicOps<T> p_215094_1_) {
      return new Dynamic<>(p_215094_1_, p_215094_1_.createMap(ImmutableMap.of(p_215094_1_.createString("name"), p_215094_1_.createString(Registry.DECORATOR.getKey(this.decorator).toString()), p_215094_1_.createString("config"), this.config.func_214719_a(p_215094_1_).getValue())));
   }

   public static <T> ConfiguredPlacement<?> func_215095_a(Dynamic<T> p_215095_0_) {
      Placement<? extends IPlacementConfig> placement = Registry.DECORATOR.get(new ResourceLocation(p_215095_0_.get("name").asString("")));
