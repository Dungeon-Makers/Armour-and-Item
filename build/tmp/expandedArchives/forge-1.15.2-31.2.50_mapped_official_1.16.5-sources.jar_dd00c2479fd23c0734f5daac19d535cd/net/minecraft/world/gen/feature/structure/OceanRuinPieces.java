...
public class OceanRuinPieces {
   ...
   private static ResourceLocation getSmallWarmRuin(Random p_204042_0_) {
      return WARM_RUINS[p_204042_0_.nextInt(WARM_RUINS.length)];
   }

   private static ResourceLocation getBigWarmRuin(Random p_204043_0_) {
      return BIG_WARM_RUINS[p_204043_0_.nextInt(BIG_WARM_RUINS.length)];
   }
   ...
   public static class Piece extends TemplateStructurePiece {
      ...
      protected void handleDataMarker(String p_186175_1_, BlockPos p_186175_2_, IWorld p_186175_3_, Random p_186175_4_, MutableBoundingBox p_186175_5_) {
         if ("chest".equals(p_186175_1_)) {
            ...
            p_186175_3_.addFreshEntity(drownedentity);
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         ...
         this.templatePosition = new BlockPos(this.templatePosition.getX(), this.getHeight(this.templatePosition, p_225577_1_, blockpos), this.templatePosition.getZ());
      ...
      private int getHeight(BlockPos p_204035_1_, IBlockReader p_204035_2_, BlockPos p_204035_3_) {
         ...
         for(BlockPos blockpos : BlockPos.betweenClosed(p_204035_1_, p_204035_3_)) {
            ...
            for(IFluidState ifluidstate = p_204035_2_.getFluidState(blockpos$mutable); (blockstate.isAir() || ifluidstate.is(FluidTags.WATER) || blockstate.getBlock().is(BlockTags.ICE)) && k1 > 1; ifluidstate = p_204035_2_.getFluidState(blockpos$mutable)) {
               --k1;
