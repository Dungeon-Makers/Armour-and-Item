...
public class OreFeature extends Feature<OreFeatureConfig> {
   ...
   public boolean func_212245_a(IWorld p_212245_1_, ChunkGenerator<? extends GenerationSettings> p_212245_2_, Random p_212245_3_, BlockPos p_212245_4_, OreFeatureConfig p_212245_5_) {
      ...
      for(int l1 = k; l1 <= k + j1; ++l1) {
         for(int i2 = i1; i2 <= i1 + j1; ++i2) {
            if (l <= p_212245_1_.getHeight(Heightmap.Type.OCEAN_FLOOR_WG, l1, i2)) {
               return this.doPlace(p_212245_1_, p_212245_3_, p_212245_5_, d0, d1, d2, d3, d4, d5, k, l, i1, j1, k1);
            }
         }
      }
                        ...
                        for(int j2 = l; j2 <= k1; ++j2) {
                           ...
                           if (d8 * d8 + d9 * d9 + d10 * d10 < 1.0D) {
                              ...
                              if (!bitset.get(k2)) {
                                 ...
                                 if (p_207803_3_.target.func_214738_b().test(p_207803_1_.getBlockState(blockpos$mutable))) {
