...
public class NetherGlowstone extends SimplePlacement<FrequencyConfig> {
   ...
   public Stream<BlockPos> place(Random p_212852_1_, FrequencyConfig p_212852_2_, BlockPos p_212852_3_) {
      return IntStream.range(0, p_212852_1_.nextInt(p_212852_1_.nextInt(p_212852_2_.field_202476_a) + 1)).mapToObj((p_215062_2_) -> {
