...
public class BeehiveTreeDecorator extends TreeDecorator {
   ...
   public void place(IWorld p_225576_1_, Random p_225576_2_, List<BlockPos> p_225576_3_, List<BlockPos> p_225576_4_, Set<BlockPos> p_225576_5_, MutableBoundingBox p_225576_6_) {
      if (!(p_225576_2_.nextFloat() >= this.probability)) {
         Direction direction = BeehiveBlock.SPAWN_DIRECTIONS[p_225576_2_.nextInt(BeehiveBlock.SPAWN_DIRECTIONS.length)];
         ...
         if (!list.isEmpty()) {
            ...
            if (AbstractTreeFeature.func_214574_b(p_225576_1_, blockpos1) && AbstractTreeFeature.func_214574_b(p_225576_1_, blockpos1.relative(Direction.SOUTH))) {
