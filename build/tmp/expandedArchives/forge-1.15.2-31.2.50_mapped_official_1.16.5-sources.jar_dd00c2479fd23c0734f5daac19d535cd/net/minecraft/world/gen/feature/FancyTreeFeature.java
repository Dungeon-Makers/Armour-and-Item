...
public class FancyTreeFeature extends AbstractTreeFeature<TreeFeatureConfig> {
      ...
      for(int j = -i; j <= i; ++j) {
         for(int k = -i; k <= i; ++k) {
            if (Math.pow((double)Math.abs(j) + 0.5D, 2.0D) + Math.pow((double)Math.abs(k) + 0.5D, 2.0D) <= (double)(p_227233_4_ * p_227233_4_)) {
               this.func_227219_b_(p_227233_1_, p_227233_2_, p_227233_3_.offset(j, 0, k), p_227233_5_, p_227233_6_, p_227233_7_);
            }
         }
      }
   ...
   private void func_227236_a_(IWorldGenerationReader p_227236_1_, Random p_227236_2_, BlockPos p_227236_3_, Set<BlockPos> p_227236_4_, MutableBoundingBox p_227236_5_, TreeFeatureConfig p_227236_6_) {
      for(int i = 0; i < 5; ++i) {
         this.func_227233_a_(p_227236_1_, p_227236_2_, p_227236_3_.above(i), this.func_227230_a_(i), p_227236_4_, p_227236_5_, p_227236_6_);
      }
   ...
   private int func_227235_a_(IWorldGenerationReader p_227235_1_, Random p_227235_2_, BlockPos p_227235_3_, BlockPos p_227235_4_, boolean p_227235_5_, Set<BlockPos> p_227235_6_, MutableBoundingBox p_227235_7_, TreeFeatureConfig p_227235_8_) {
      if (!p_227235_5_ && Objects.equals(p_227235_3_, p_227235_4_)) {
         ...
         BlockPos blockpos = p_227235_4_.offset(-p_227235_3_.getX(), -p_227235_3_.getY(), -p_227235_3_.getZ());
         ...
         for(int j = 0; j <= i; ++j) {
            BlockPos blockpos1 = p_227235_3_.offset((double)(0.5F + (float)j * f), (double)(0.5F + (float)j * f1), (double)(0.5F + (float)j * f2));
            if (p_227235_5_) {
               this.func_227217_a_(p_227235_1_, blockpos1, p_227235_8_.trunkProvider.getState(p_227235_2_, blockpos1).setValue(LogBlock.AXIS, this.func_227238_a_(p_227235_3_, blockpos1)), p_227235_7_);
   ...
   private void func_227234_a_(IWorldGenerationReader p_227234_1_, Random p_227234_2_, BlockPos p_227234_3_, int p_227234_4_, Set<BlockPos> p_227234_5_, MutableBoundingBox p_227234_6_, TreeFeatureConfig p_227234_7_) {
      this.func_227235_a_(p_227234_1_, p_227234_2_, p_227234_3_, p_227234_3_.above(p_227234_4_), true, p_227234_5_, p_227234_6_, p_227234_7_);
   }
   ...
   public boolean doPlace(IWorldGenerationReader p_225557_1_, Random p_225557_2_, BlockPos p_225557_3_, Set<BlockPos> p_225557_4_, Set<BlockPos> p_225557_5_, MutableBoundingBox p_225557_6_, TreeFeatureConfig p_225557_7_) {
      ...
      if (i == -1) {
         ...
         this.func_214584_a(p_225557_1_, p_225557_3_.below());
         ...
         list.add(new FancyTreeFeature.ExtendedPos(p_225557_3_.above(i1), l));
         ...
         for(; i1 >= 0; --i1) {
            ...
            if (!(f < 0.0F)) {
               for(int j1 = 0; j1 < k; ++j1) {
                  ...
                  BlockPos blockpos = p_225557_3_.offset(d4, (double)(i1 - 1), d5);
   ...
   private int func_227241_b_(IWorldGenerationReader p_227241_1_, Random p_227241_2_, BlockPos p_227241_3_, int p_227241_4_, Set<BlockPos> p_227241_5_, MutableBoundingBox p_227241_6_, TreeFeatureConfig p_227241_7_) {
      if (!func_214585_i(p_227241_1_, p_227241_3_.below())) {
         return -1;
      } else {
         int i = this.func_227235_a_(p_227241_1_, p_227241_2_, p_227241_3_, p_227241_3_.above(p_227241_4_ - 1), false, p_227241_5_, p_227241_6_, p_227241_7_);
         if (i == -1) {
            return p_227241_4_;
         } else {
            return i < 6 ? -1 : i;
