...
public enum DragonSpawnState {
   ...
   SUMMONING_PILLARS {
      public void tick(ServerWorld p_186079_1_, DragonFightManager p_186079_2_, List<EnderCrystalEntity> p_186079_3_, int p_186079_4_, BlockPos p_186079_5_) {
         ...
         if (flag || flag1) {
            List<EndSpikeFeature.EndSpike> list = EndSpikeFeature.func_214554_a(p_186079_1_);
            ...
            if (j < list.size()) {
               ...
               if (flag) {
                  ...
                  Feature.END_SPIKE.configured(endspikefeatureconfig).func_222734_a(p_186079_1_, p_186079_1_.getChunkSource().getGenerator(), new Random(), new BlockPos(endspikefeature$endspike.getCenterX(), 45, endspikefeature$endspike.getCenterZ()));
               }
            } else if (flag) {
