...
public abstract class LightEngine<M extends LightDataMap<M>, S extends SectionLightStorage<M>> extends LevelBasedGraph implements IWorldLightListener {
   ...
   public static int getLightBlockInto(IBlockReader p_215613_0_, BlockState p_215613_1_, BlockPos p_215613_2_, BlockState p_215613_3_, BlockPos p_215613_4_, Direction p_215613_5_, int p_215613_6_) {
      ...
      if (!flag && !flag1) {
         ...
         VoxelShape voxelshape = flag ? p_215613_1_.getBlockSupportShape(p_215613_0_, p_215613_2_) : VoxelShapes.empty();
         VoxelShape voxelshape1 = flag1 ? p_215613_3_.getBlockSupportShape(p_215613_0_, p_215613_4_) : VoxelShapes.empty();
   ...
   protected void queueSectionData(long p_215621_1_, @Nullable NibbleArray p_215621_3_) {
      this.storage.queueSectionData(p_215621_1_, p_215621_3_);
   }
