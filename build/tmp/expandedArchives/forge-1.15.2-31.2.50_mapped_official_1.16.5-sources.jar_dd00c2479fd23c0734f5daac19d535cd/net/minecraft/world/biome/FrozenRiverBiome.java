...
public final class FrozenRiverBiome extends Biome {
   public FrozenRiverBiome() {
      super((new Biome.Builder()).func_222351_a(SurfaceBuilder.DEFAULT, SurfaceBuilder.CONFIG_GRASS).precipitation(Biome.RainType.SNOW).biomeCategory(Biome.Category.RIVER).depth(-0.5F).scale(0.0F).temperature(0.0F).downfall(0.5F).func_205412_a(3750089).func_205413_b(329011).func_205418_a((String)null));
      ...
      this.func_201866_a(EntityClassification.MONSTER, new Biome.SpawnListEntry(EntityType.DROWNED, 1, 1, 1));
