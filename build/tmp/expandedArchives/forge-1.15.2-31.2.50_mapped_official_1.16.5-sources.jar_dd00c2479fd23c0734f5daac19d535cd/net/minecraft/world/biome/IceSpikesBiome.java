...
public final class IceSpikesBiome extends Biome {
   public IceSpikesBiome() {
      super((new Biome.Builder()).func_222351_a(SurfaceBuilder.DEFAULT, new SurfaceBuilderConfig(Blocks.SNOW_BLOCK.defaultBlockState(), Blocks.DIRT.defaultBlockState(), Blocks.GRAVEL.defaultBlockState())).precipitation(Biome.RainType.SNOW).biomeCategory(Biome.Category.ICY).depth(0.425F).scale(0.45000002F).temperature(0.0F).downfall(0.5F).func_205412_a(4159204).func_205413_b(329011).func_205418_a("snowy_tundra"));
      ...
      this.func_203611_a(GenerationStage.Decoration.SURFACE_STRUCTURES, Feature.ICE_SPIKE.configured(IFeatureConfig.NONE).decorated(Placement.field_215015_a.configured(new FrequencyConfig(3))));
      this.func_203611_a(GenerationStage.Decoration.SURFACE_STRUCTURES, Feature.ICE_PATCH.configured(new FeatureRadiusConfig(2)).decorated(Placement.field_215015_a.configured(new FrequencyConfig(2))));
