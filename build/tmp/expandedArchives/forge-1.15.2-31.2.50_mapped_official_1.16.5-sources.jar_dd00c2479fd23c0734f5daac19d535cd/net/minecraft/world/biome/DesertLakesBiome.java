...
public final class DesertLakesBiome extends Biome {
   public DesertLakesBiome() {
      super((new Biome.Builder()).func_222351_a(SurfaceBuilder.DEFAULT, SurfaceBuilder.CONFIG_DESERT).precipitation(Biome.RainType.NONE).biomeCategory(Biome.Category.DESERT).depth(0.225F).scale(0.25F).temperature(2.0F).downfall(0.0F).func_205412_a(4159204).func_205413_b(329011).func_205418_a("desert"));
