...
public final class TaigaMountainsBiome extends Biome {
   public TaigaMountainsBiome() {
      super((new Biome.Builder()).func_222351_a(SurfaceBuilder.DEFAULT, SurfaceBuilder.CONFIG_GRASS).precipitation(Biome.RainType.RAIN).biomeCategory(Biome.Category.TAIGA).depth(0.3F).scale(0.4F).temperature(0.25F).downfall(0.8F).func_205412_a(4159204).func_205413_b(329011).func_205418_a("taiga"));
