...
public final class ShatteredSavannaBiome extends Biome {
   public ShatteredSavannaBiome() {
      super((new Biome.Builder()).func_222351_a(SurfaceBuilder.SHATTERED_SAVANNA, SurfaceBuilder.CONFIG_GRASS).precipitation(Biome.RainType.NONE).biomeCategory(Biome.Category.SAVANNA).depth(0.3625F).scale(1.225F).temperature(1.1F).downfall(0.0F).func_205412_a(4159204).func_205413_b(329011).func_205418_a("savanna"));
