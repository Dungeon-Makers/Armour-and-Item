...
public class DeepFrozenOceanBiome extends Biome {
   ...
   public DeepFrozenOceanBiome() {
      super((new Biome.Builder()).func_222351_a(SurfaceBuilder.FROZEN_OCEAN, SurfaceBuilder.CONFIG_GRASS).precipitation(Biome.RainType.RAIN).biomeCategory(Biome.Category.OCEAN).depth(-1.8F).scale(0.1F).temperature(0.5F).downfall(0.5F).func_205412_a(3750089).func_205413_b(329011).func_205418_a((String)null));
   ...
   public float func_180626_a(BlockPos p_180626_1_) {
      ...
      double d0 = field_206856_bb.getValue((double)p_180626_1_.getX() * 0.05D, (double)p_180626_1_.getZ() * 0.05D, false) * 7.0D;
