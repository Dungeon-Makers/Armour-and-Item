...
public final class SnowyTaigaHillsBiome extends Biome {
   public SnowyTaigaHillsBiome() {
      super((new Biome.Builder()).func_222351_a(SurfaceBuilder.DEFAULT, SurfaceBuilder.CONFIG_GRASS).precipitation(Biome.RainType.SNOW).biomeCategory(Biome.Category.TAIGA).depth(0.45F).scale(0.3F).temperature(-0.5F).downfall(0.4F).func_205412_a(4020182).func_205413_b(329011).func_205418_a((String)null));
