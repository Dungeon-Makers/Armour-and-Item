...
public final class ShatteredSavannaPlateauBiome extends Biome {
   public ShatteredSavannaPlateauBiome() {
      super((new Biome.Builder()).func_222351_a(SurfaceBuilder.SHATTERED_SAVANNA, SurfaceBuilder.CONFIG_GRASS).precipitation(Biome.RainType.NONE).biomeCategory(Biome.Category.SAVANNA).depth(1.05F).scale(1.2125001F).temperature(1.0F).downfall(0.0F).func_205412_a(4159204).func_205413_b(329011).func_205418_a("savanna_plateau"));
