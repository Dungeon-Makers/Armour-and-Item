...
public final class SnowyBeachBiome extends Biome {
   public SnowyBeachBiome() {
      super((new Biome.Builder()).func_222351_a(SurfaceBuilder.DEFAULT, SurfaceBuilder.CONFIG_DESERT).precipitation(Biome.RainType.SNOW).biomeCategory(Biome.Category.BEACH).depth(0.0F).scale(0.025F).temperature(0.05F).downfall(0.3F).func_205412_a(4020182).func_205413_b(329011).func_205418_a((String)null));
