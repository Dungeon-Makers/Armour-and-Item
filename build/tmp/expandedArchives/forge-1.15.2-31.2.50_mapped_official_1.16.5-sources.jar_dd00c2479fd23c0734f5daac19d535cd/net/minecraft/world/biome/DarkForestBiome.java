...
public final class DarkForestBiome extends Biome {
   public DarkForestBiome() {
      super((new Biome.Builder()).func_222351_a(SurfaceBuilder.DEFAULT, SurfaceBuilder.CONFIG_GRASS).precipitation(Biome.RainType.RAIN).biomeCategory(Biome.Category.FOREST).depth(0.1F).scale(0.2F).temperature(0.7F).downfall(0.8F).func_205412_a(4159204).func_205413_b(329011).func_205418_a((String)null));
      ...
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.RANDOM_SELECTOR.configured(new MultipleRandomFeatureConfig(ImmutableList.of(Feature.HUGE_BROWN_MUSHROOM.configured(DefaultBiomeFeatures.field_226768_ac_).weighted(0.025F), Feature.HUGE_RED_MUSHROOM.configured(DefaultBiomeFeatures.field_226767_ab_).weighted(0.05F), Feature.field_214551_w.configured(DefaultBiomeFeatures.field_226822_q_).weighted(0.6666667F), Feature.field_202301_A.configured(DefaultBiomeFeatures.field_226812_g_).weighted(0.2F), Feature.field_202339_q.configured(DefaultBiomeFeatures.field_226815_j_).weighted(0.1F)), Feature.field_202301_A.configured(DefaultBiomeFeatures.field_226739_a_))).decorated(Placement.DARK_OAK_TREE.configured(IPlacementConfig.NONE)));
