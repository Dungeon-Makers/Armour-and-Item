...
public final class MushroomFieldsBiome extends Biome {
   public MushroomFieldsBiome() {
      super((new Biome.Builder()).func_222351_a(SurfaceBuilder.DEFAULT, SurfaceBuilder.CONFIG_MYCELIUM).precipitation(Biome.RainType.RAIN).biomeCategory(Biome.Category.MUSHROOM).depth(0.2F).scale(0.3F).temperature(0.9F).downfall(1.0F).func_205412_a(4159204).func_205413_b(329011).func_205418_a((String)null));
