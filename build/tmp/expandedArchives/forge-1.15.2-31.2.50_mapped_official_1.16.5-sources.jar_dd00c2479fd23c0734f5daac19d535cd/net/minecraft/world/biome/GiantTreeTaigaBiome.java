...
public final class GiantTreeTaigaBiome extends Biome {
   public GiantTreeTaigaBiome() {
      super((new Biome.Builder()).func_222351_a(SurfaceBuilder.GIANT_TREE_TAIGA, SurfaceBuilder.CONFIG_GRASS).precipitation(Biome.RainType.RAIN).biomeCategory(Biome.Category.TAIGA).depth(0.2F).scale(0.2F).temperature(0.3F).downfall(0.8F).func_205412_a(4159204).func_205413_b(329011).func_205418_a((String)null));
