...
public class EndBiomeProvider extends BiomeProvider {
   ...
   public EndBiomeProvider(EndBiomeProviderSettings p_i48970_1_) {
      ...
      this.field_201547_b = new SharedSeedRandom(p_i48970_1_.func_205445_a());
      this.field_201547_b.consumeCount(17292);
      this.islandNoise = new SimplexNoiseGenerator(this.field_201547_b);
   }
   ...
   public float func_222365_c(int p_222365_1_, int p_222365_2_) {
      ...
      for(int i1 = -12; i1 <= 12; ++i1) {
         for(int j1 = -12; j1 <= 12; ++j1) {
            long k1 = (long)(i + i1);
            long l1 = (long)(j + j1);
            if (k1 * k1 + l1 * l1 > 4096L && this.islandNoise.getValue((double)k1, (double)l1) < (double)-0.9F) {
