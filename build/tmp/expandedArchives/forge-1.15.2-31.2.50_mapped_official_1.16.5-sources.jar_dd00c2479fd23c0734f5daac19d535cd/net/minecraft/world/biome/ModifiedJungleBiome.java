...
public final class ModifiedJungleBiome extends Biome {
   public ModifiedJungleBiome() {
      super((new Biome.Builder()).func_222351_a(SurfaceBuilder.DEFAULT, SurfaceBuilder.CONFIG_GRASS).precipitation(Biome.RainType.RAIN).biomeCategory(Biome.Category.JUNGLE).depth(0.2F).scale(0.4F).temperature(0.95F).downfall(0.9F).func_205412_a(4159204).func_205413_b(329011).func_205418_a("jungle"));
