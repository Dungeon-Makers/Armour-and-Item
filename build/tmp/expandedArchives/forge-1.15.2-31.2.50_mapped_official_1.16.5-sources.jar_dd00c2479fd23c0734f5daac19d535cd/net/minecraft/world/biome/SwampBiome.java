...
public final class SwampBiome extends Biome {
   protected SwampBiome() {
      super((new Biome.Builder()).func_222351_a(SurfaceBuilder.SWAMP, SurfaceBuilder.CONFIG_GRASS).precipitation(Biome.RainType.RAIN).biomeCategory(Biome.Category.SWAMP).depth(-0.2F).scale(0.1F).temperature(0.8F).downfall(0.9F).func_205412_a(6388580).func_205413_b(2302743).func_205418_a((String)null));
      this.func_226711_a_(Feature.field_202334_l.configured(IFeatureConfig.NONE));
      ...
      this.func_203611_a(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.SEAGRASS.configured(new SeaGrassConfig(64, 0.6D)).decorated(Placement.TOP_SOLID_HEIGHTMAP.configured(IPlacementConfig.NONE)));
