...
public final class TallBirchHillsBiome extends Biome {
   public TallBirchHillsBiome() {
      super((new Biome.Builder()).func_222351_a(SurfaceBuilder.DEFAULT, SurfaceBuilder.CONFIG_GRASS).precipitation(Biome.RainType.RAIN).biomeCategory(Biome.Category.FOREST).depth(0.55F).scale(0.5F).temperature(0.6F).downfall(0.6F).func_205412_a(4159204).func_205413_b(329011).func_205418_a("birch_forest_hills"));
