...
public interface IBlockReader {
   ...
   default BlockRayTraceResult clip(RayTraceContext p_217299_1_) {
      return traverseBlocks(p_217299_1_, (p_217297_1_, p_217297_2_) -> {
         ...
         Vec3d vec3d = p_217297_1_.getFrom();
         Vec3d vec3d1 = p_217297_1_.getTo();
         VoxelShape voxelshape = p_217297_1_.getBlockShape(blockstate, this, p_217297_2_);
         BlockRayTraceResult blockraytraceresult = this.clipWithInteractionOverride(vec3d, vec3d1, p_217297_2_, voxelshape, blockstate);
         VoxelShape voxelshape1 = p_217297_1_.getFluidShape(ifluidstate, this, p_217297_2_);
         BlockRayTraceResult blockraytraceresult1 = voxelshape1.clip(vec3d, vec3d1, p_217297_2_);
         ...
         Vec3d vec3d = p_217302_0_.getFrom().subtract(p_217302_0_.getTo());
         return BlockRayTraceResult.miss(p_217302_0_.getTo(), Direction.getNearest(vec3d.x, vec3d.y, vec3d.z), new BlockPos(p_217302_0_.getTo()));
      });
   }

   @Nullable
   default BlockRayTraceResult clipWithInteractionOverride(Vec3d p_217296_1_, Vec3d p_217296_2_, BlockPos p_217296_3_, VoxelShape p_217296_4_, BlockState p_217296_5_) {
      BlockRayTraceResult blockraytraceresult = p_217296_4_.clip(p_217296_1_, p_217296_2_, p_217296_3_);
      if (blockraytraceresult != null) {
         BlockRayTraceResult blockraytraceresult1 = p_217296_5_.getVisualShape(this, p_217296_3_).clip(p_217296_1_, p_217296_2_, p_217296_3_);
   ...
   static <T> T traverseBlocks(RayTraceContext p_217300_0_, BiFunction<RayTraceContext, BlockPos, T> p_217300_1_, Function<RayTraceContext, T> p_217300_2_) {
      Vec3d vec3d = p_217300_0_.getFrom();
      Vec3d vec3d1 = p_217300_0_.getTo();
