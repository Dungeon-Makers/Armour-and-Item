...
public class Chunk extends net.minecraftforge.common.capabilities.CapabilityProvider<Chunk> implements IChunk, net.minecraftforge.common.extensions.IForgeChunk {
   ...
   public BlockState getBlockState(BlockPos p_180495_1_) {
      ...
      if (this.level.func_175624_G() == WorldType.field_180272_g) {
   ...
   public LongSet func_201578_b(String p_201578_1_) {
      return this.structuresRefences.computeIfAbsent(p_201578_1_, (p_201603_0_) -> {
         return new LongOpenHashSet();
      });
   }

   public void func_201583_a(String p_201583_1_, long p_201583_2_) {
      this.structuresRefences.computeIfAbsent(p_201583_1_, (p_201598_0_) -> {
         return new LongOpenHashSet();
      }).add(p_201583_2_);
   }
   ...
   public void unpackTicks() {
      if (this.blockTicks instanceof ChunkPrimerTickList) {
         ...
         this.level.getBlockTicks().func_219497_a(((SerializableTickList)this.blockTicks).func_219499_a());
         this.blockTicks = EmptyTickList.empty();
      }
      ...
      if (this.liquidTicks instanceof ChunkPrimerTickList) {
         ...
         this.level.getLiquidTicks().func_219497_a(((SerializableTickList)this.liquidTicks).func_219499_a());
         this.liquidTicks = EmptyTickList.empty();
      }
   ...
   public void packTicks(ServerWorld p_222880_1_) {
      if (this.blockTicks == EmptyTickList.<Block>empty()) {
         this.blockTicks = new SerializableTickList<>(Registry.BLOCK::getKey, p_222880_1_.getBlockTicks().fetchTicksInChunk(this.chunkPos, true, false));
         this.setUnsaved(true);
      }

      if (this.liquidTicks == EmptyTickList.<Fluid>empty()) {
         this.liquidTicks = new SerializableTickList<>(Registry.FLUID::getKey, p_222880_1_.getLiquidTicks().fetchTicksInChunk(this.chunkPos, true, false));
         this.setUnsaved(true);
      }
