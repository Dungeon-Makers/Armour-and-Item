...
public class TrackedEntity {
   ...
   public TrackedEntity(ServerWorld p_i50704_1_, Entity p_i50704_2_, int p_i50704_3_, boolean p_i50704_4_, Consumer<IPacket<?>> p_i50704_5_) {
      ...
      this.wasOnGround = p_i50704_2_.onGround;
   }
   ...
   public void sendChanges() {
      ...
      if (this.tickCount % this.updateInterval == 0 || this.entity.hasImpulse || this.entity.getEntityData().isDirty()) {
         if (this.entity.isPassenger()) {
            ...
            if (flag2) {
               this.broadcast.accept(new SEntityPacket.LookPacket(this.entity.getId(), (byte)i1, (byte)l1, this.entity.onGround));
               this.yRotp = i1;
               this.xRotp = l1;
            }
            ...
            Vec3d vec3d = this.entity.position().subtract(SEntityPacket.packetToEntity(this.xp, this.yp, this.zp));
            boolean flag3 = vec3d.lengthSqr() >= (double)7.6293945E-6F;
            ...
            if (this.tickCount > 0 || this.entity instanceof AbstractArrowEntity) {
               long i = SEntityPacket.entityToPacket(vec3d.x);
               long j = SEntityPacket.entityToPacket(vec3d.y);
               long k = SEntityPacket.entityToPacket(vec3d.z);
               ...
               if (!flag1 && this.teleportDelay <= 400 && !this.wasRiding && this.wasOnGround == this.entity.onGround) {
                  if ((!flag4 || !flag) && !(this.entity instanceof AbstractArrowEntity)) {
                     if (flag4) {
                        ipacket1 = new SEntityPacket.RelativeMovePacket(this.entity.getId(), (short)((int)i), (short)((int)j), (short)((int)k), this.entity.onGround);
                     } else if (flag) {
                        ipacket1 = new SEntityPacket.LookPacket(this.entity.getId(), (byte)l, (byte)k1, this.entity.onGround);
                     }
                  } else {
                     ipacket1 = new SEntityPacket.MovePacket(this.entity.getId(), (short)((int)i), (short)((int)j), (short)((int)k), (byte)l, (byte)k1, this.entity.onGround);
                  }
               } else {
   ...
   public void sendPairingData(Consumer<IPacket<?>> p_219452_1_) {
      ...
      if (this.entity instanceof LivingEntity) {
         AttributeMap attributemap = (AttributeMap)((LivingEntity)this.entity).func_110140_aT();
      ...
      if (this.entity instanceof LivingEntity) {
         for(EquipmentSlotType equipmentslottype : EquipmentSlotType.values()) {
            ...
            if (!itemstack.isEmpty()) {
               p_219452_1_.accept(new SEntityEquipmentPacket(this.entity.getId(), equipmentslottype, itemstack));
            }
         }
      }
