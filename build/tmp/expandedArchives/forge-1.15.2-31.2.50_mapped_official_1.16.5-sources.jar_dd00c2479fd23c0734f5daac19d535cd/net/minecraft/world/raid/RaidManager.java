...
public class RaidManager extends WorldSavedData {
   ...
   public static boolean canJoinRaid(AbstractRaiderEntity p_215165_0_, Raid p_215165_1_) {
      if (p_215165_0_ != null && p_215165_1_ != null && p_215165_1_.getLevel() != null) {
         return p_215165_0_.isAlive() && p_215165_0_.canJoinRaid() && p_215165_0_.getNoActionTime() <= 2400 && p_215165_0_.level.func_201675_m().func_186058_p() == p_215165_1_.getLevel().func_201675_m().func_186058_p();
      } else {
         return false;
      }
   }
   ...
   public Raid createOrExtendRaid(ServerPlayerEntity p_215170_1_) {
      if (p_215170_1_.isSpectator()) {
         ...
         DimensionType dimensiontype = p_215170_1_.level.func_201675_m().func_186058_p();
   ...
   public static String func_215172_a(Dimension p_215172_0_) {
      return "raids" + p_215172_0_.func_186058_p().getFileSuffix();
   }
