...
public class PlayerInteractionManager {
   ...
   public void setGameModeForPlayer(GameType p_73076_1_) {
      this.gameModeForPlayer = p_73076_1_;
      p_73076_1_.updatePlayerAbilities(this.player.abilities);
   ...
   public void handleBlockBreakAction(BlockPos p_225416_1_, CPlayerDiggingPacket.Action p_225416_2_, Direction p_225416_3_, int p_225416_4_) {
      ...
      if (d3 > dist) {
         ...
         if (p_225416_2_ == CPlayerDiggingPacket.Action.START_DESTROY_BLOCK) {
            ...
            if (this.isCreative()) {
               if (!this.level.func_175719_a((PlayerEntity)null, p_225416_1_, p_225416_3_)) {
                  this.destroyAndAck(p_225416_1_, p_225416_2_, "creative destroy");
               } else {
                  this.player.connection.send(new SPlayerDiggingPacket(p_225416_1_, this.level.getBlockState(p_225416_1_), p_225416_2_, true, "fire put out"));
               }
            ...
            this.level.func_175719_a((PlayerEntity)null, p_225416_1_, p_225416_3_);
      ...
      if (exp == -1) {
         ...
         if ((block instanceof CommandBlockBlock || block instanceof StructureBlock || block instanceof JigsawBlock) && !this.player.canUseGameMasterBlocks()) {
            ...
            if (this.isCreative()) {
               ...
               boolean flag1 = blockstate.canHarvestBlock(this.level, p_180237_1_, this.player);
   ...
   public ActionResultType useItem(PlayerEntity p_187250_1_, World p_187250_2_, ItemStack p_187250_3_, Hand p_187250_4_) {
      if (this.gameModeForPlayer == GameType.SPECTATOR) {
         ...
         if (itemstack == p_187250_3_ && itemstack.getCount() == i && itemstack.getUseDuration() <= 0 && itemstack.getDamageValue() == j) {
            ...
            if (!p_187250_1_.isUsingItem()) {
               ((ServerPlayerEntity)p_187250_1_).refreshContainer(p_187250_1_.inventoryMenu);
            }
   ...
   public ActionResultType useItemOn(PlayerEntity p_219441_1_, World p_219441_2_, ItemStack p_219441_3_, Hand p_219441_4_, BlockRayTraceResult p_219441_5_) {
      BlockPos blockpos = p_219441_5_.getBlockPos();
      BlockState blockstate = p_219441_2_.getBlockState(blockpos);
      net.minecraftforge.event.entity.player.PlayerInteractEvent.RightClickBlock event = net.minecraftforge.common.ForgeHooks.onRightClickBlock(p_219441_1_, p_219441_4_, blockpos, p_219441_5_.getDirection());
      ...
      if (this.gameModeForPlayer == GameType.SPECTATOR) {
         ...
         if (!p_219441_3_.isEmpty() && !p_219441_1_.getCooldowns().isOnCooldown(p_219441_3_.getItem())) {
            ...
            if (this.isCreative()) {
               ...
               ActionResultType actionresulttype1 = p_219441_3_.useOn(itemusecontext);
               p_219441_3_.setCount(i);
               return actionresulttype1;
            } else {
               return p_219441_3_.useOn(itemusecontext);
            }
         } else {
            return ActionResultType.PASS;
         }
