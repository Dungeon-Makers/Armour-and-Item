...
public class CustomServerBossInfo extends ServerBossInfo {
   ...
   public final ITextComponent getDisplayName() {
      return TextComponentUtils.func_197676_a(this.getName()).func_211710_a((p_211569_1_) -> {
         p_211569_1_.func_150238_a(this.getColor().getFormatting()).func_150209_a(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new StringTextComponent(this.getTextId().toString()))).func_179989_a(this.getTextId().toString());
      });
   }
   ...
   public static CustomServerBossInfo load(CompoundNBT p_201371_0_, ResourceLocation p_201371_1_) {
      CustomServerBossInfo customserverbossinfo = new CustomServerBossInfo(p_201371_1_, ITextComponent.Serializer.func_150699_a(p_201371_0_.getString("Name")));
      ...
      ListNBT listnbt = p_201371_0_.getList("Players", 10);

      for(int i = 0; i < listnbt.size(); ++i) {
         customserverbossinfo.addOfflinePlayer(NBTUtil.loadUUID(listnbt.getCompound(i)));
      }
