...
public class DoorBlock extends Block {
   ...
   public BlockState updateShape(BlockState p_196271_1_, Direction p_196271_2_, BlockState p_196271_3_, IWorld p_196271_4_, BlockPos p_196271_5_, BlockPos p_196271_6_) {
      ...
      if (p_196271_2_.getAxis() == Direction.Axis.Y && doubleblockhalf == DoubleBlockHalf.LOWER == (p_196271_2_ == Direction.UP)) {
         return p_196271_3_.getBlock() == this && p_196271_3_.getValue(HALF) != doubleblockhalf ? p_196271_1_.setValue(FACING, p_196271_3_.getValue(FACING)).setValue(OPEN, p_196271_3_.getValue(OPEN)).setValue(HINGE, p_196271_3_.getValue(HINGE)).setValue(POWERED, p_196271_3_.getValue(POWERED)) : Blocks.AIR.defaultBlockState();
      } else {
   ...
   public void playerWillDestroy(World p_176208_1_, BlockPos p_176208_2_, BlockState p_176208_3_, PlayerEntity p_176208_4_) {
      DoubleBlockHalf doubleblockhalf = p_176208_3_.getValue(HALF);
      BlockPos blockpos = doubleblockhalf == DoubleBlockHalf.LOWER ? p_176208_2_.above() : p_176208_2_.below();
      ...
      if (blockstate.getBlock() == this && blockstate.getValue(HALF) != doubleblockhalf) {
         ...
         if (!p_176208_1_.isClientSide && !p_176208_4_.isCreative() && p_176208_4_.func_184823_b(blockstate)) {
            Block.dropResources(p_176208_3_, p_176208_1_, p_176208_2_, (TileEntity)null, p_176208_4_, itemstack);
            Block.dropResources(blockstate, p_176208_1_, blockpos, (TileEntity)null, p_176208_4_, itemstack);
         }
      }
   ...
   public ActionResultType use(BlockState p_225533_1_, World p_225533_2_, BlockPos p_225533_3_, PlayerEntity p_225533_4_, Hand p_225533_5_, BlockRayTraceResult p_225533_6_) {
      if (this.material == Material.METAL) {
         ...
         p_225533_1_ = p_225533_1_.func_177231_a(OPEN);
   ...
   public void func_176512_a(World p_176512_1_, BlockPos p_176512_2_, boolean p_176512_3_) {
      BlockState blockstate = p_176512_1_.getBlockState(p_176512_2_);
      if (blockstate.getBlock() == this && blockstate.getValue(OPEN) != p_176512_3_) {
         p_176512_1_.setBlock(p_176512_2_, blockstate.setValue(OPEN, Boolean.valueOf(p_176512_3_)), 10);
   ...
   public boolean canSurvive(BlockState p_196260_1_, IWorldReader p_196260_2_, BlockPos p_196260_3_) {
      ...
      if (p_196260_1_.getValue(HALF) == DoubleBlockHalf.LOWER) {
   ...
   public BlockState mirror(BlockState p_185471_1_, Mirror p_185471_2_) {
      return p_185471_2_ == Mirror.NONE ? p_185471_1_ : p_185471_1_.rotate(p_185471_2_.getRotation(p_185471_1_.getValue(FACING))).func_177231_a(HINGE);
   }
