...
public class AnvilBlock extends FallingBlock {
   ...
   private static final TranslationTextComponent CONTAINER_TITLE = new TranslationTextComponent("container.repair");
   ...
   public static BlockState damage(BlockState p_196433_0_) {
      ...
      if (block == Blocks.ANVIL) {
         ...
         return block == Blocks.CHIPPED_ANVIL ? Blocks.DAMAGED_ANVIL.defaultBlockState().setValue(FACING, p_196433_0_.getValue(FACING)) : null;
      }
   }
