      ...
      if (!list.isEmpty()) {
         ...
         for(BeeEntity beeentity : list) {
            if (beeentity.getTarget() == null) {
               beeentity.func_226391_a_(list1.get(p_226881_1_.random.nextInt(i)));
            }
         }
      }
      ...
      if (flag) {
         if (!CampfireBlock.func_226914_b_(p_225533_2_, p_225533_3_, 5)) {
            ...
            if (p_225533_4_ instanceof ServerPlayerEntity) {
               CriteriaTriggers.field_229863_J_.trigger((ServerPlayerEntity)p_225533_4_, p_225533_3_, itemstack1);
            }
         }
