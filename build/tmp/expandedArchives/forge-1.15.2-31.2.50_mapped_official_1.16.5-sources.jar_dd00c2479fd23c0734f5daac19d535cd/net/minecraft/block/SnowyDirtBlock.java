...
public class SnowyDirtBlock extends Block {
   ...
   public BlockState updateShape(BlockState p_196271_1_, Direction p_196271_2_, BlockState p_196271_3_, IWorld p_196271_4_, BlockPos p_196271_5_, BlockPos p_196271_6_) {
      if (p_196271_2_ != Direction.UP) {
         ...
         return p_196271_1_.setValue(SNOWY, Boolean.valueOf(block == Blocks.SNOW_BLOCK || block == Blocks.SNOW));
      }
   }

   public BlockState getStateForPlacement(BlockItemUseContext p_196258_1_) {
      Block block = p_196258_1_.getLevel().getBlockState(p_196258_1_.getClickedPos().above()).getBlock();
