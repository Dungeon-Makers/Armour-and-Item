...
public class StairsBlock extends Block implements IWaterLoggable {
   ...
   public int getTickDelay(IWorldReader p_149738_1_) {
      return this.base.getTickDelay(p_149738_1_);
   }
   ...
   public BlockState getStateForPlacement(BlockItemUseContext p_196258_1_) {
      ...
      IFluidState ifluidstate = p_196258_1_.getLevel().getFluidState(blockpos);
      BlockState blockstate = this.defaultBlockState().setValue(FACING, p_196258_1_.getHorizontalDirection()).setValue(HALF, direction != Direction.DOWN && (direction == Direction.UP || !(p_196258_1_.getClickLocation().y - (double)blockpos.getY() > 0.5D)) ? Half.BOTTOM : Half.TOP).setValue(WATERLOGGED, Boolean.valueOf(ifluidstate.getType() == Fluids.WATER));
