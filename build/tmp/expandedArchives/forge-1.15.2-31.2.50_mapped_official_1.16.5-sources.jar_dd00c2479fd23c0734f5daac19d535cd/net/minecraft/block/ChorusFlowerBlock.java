...
public class ChorusFlowerBlock extends Block {
   ...
   public void tick(BlockState p_225534_1_, ServerWorld p_225534_2_, BlockPos p_225534_3_, Random p_225534_4_) {
      if (!p_225534_1_.canSurvive(p_225534_2_, p_225534_3_)) {
         ...
         if (p_225534_2_.isEmptyBlock(blockpos) && blockpos.getY() < p_225534_2_.func_201675_m().getHeight()) {
            ...
            if (i < 5 && net.minecraftforge.common.ForgeHooks.onCropsGrowPre(p_225534_2_, blockpos, p_225534_1_, true)) {
               ...
               if (block == Blocks.END_STONE) {
                  ...
                  for(int k = 0; k < 4; ++k) {
                     Block block1 = p_225534_2_.getBlockState(p_225534_3_.below(j + 1)).getBlock();
               ...
               } else if (blockstate.isAir(p_225534_2_, p_225534_3_.below())) {
                  flag = true;
               }

               if (flag && allNeighborsEmpty(p_225534_2_, blockpos, (Direction)null) && p_225534_2_.isEmptyBlock(p_225534_3_.above(2))) {
                  p_225534_2_.setBlock(p_225534_3_, this.plant.getStateForPlacement(p_225534_2_, p_225534_3_), 2);
                  ...
                  for(int i1 = 0; i1 < l; ++i1) {
                     ...
                     BlockPos blockpos1 = p_225534_3_.relative(direction);
                     if (p_225534_2_.isEmptyBlock(blockpos1) && p_225534_2_.isEmptyBlock(blockpos1.below()) && allNeighborsEmpty(p_225534_2_, blockpos1, direction.getOpposite())) {
      ...
      if (block != this.plant && block != Blocks.END_STONE) {
         if (!blockstate.isAir(p_196260_2_, p_196260_3_.below())) {
            ...
            for(Direction direction : Direction.Plane.HORIZONTAL) {
               ...
               if (blockstate1.getBlock() == this.plant) {
                  if (flag) {
                     return false;
                  }
