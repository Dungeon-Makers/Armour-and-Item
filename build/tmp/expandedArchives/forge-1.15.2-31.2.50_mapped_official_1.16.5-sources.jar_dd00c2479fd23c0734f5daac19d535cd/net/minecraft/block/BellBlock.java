...
public class BellBlock extends ContainerBlock {
   ...
   public void onProjectileHit(World p_220066_1_, BlockState p_220066_2_, BlockRayTraceResult p_220066_3_, Entity p_220066_4_) {
      if (p_220066_4_ instanceof AbstractArrowEntity) {
         Entity entity = ((AbstractArrowEntity)p_220066_4_).func_212360_k();
   ...
   public ActionResultType use(BlockState p_225533_1_, World p_225533_2_, BlockPos p_225533_3_, PlayerEntity p_225533_4_, Hand p_225533_5_, BlockRayTraceResult p_225533_6_) {
      return this.onHit(p_225533_2_, p_225533_1_, p_225533_6_, p_225533_4_, true) ? ActionResultType.SUCCESS : ActionResultType.PASS;
   }
   ...
   public boolean canSurvive(BlockState p_196260_1_, IWorldReader p_196260_2_, BlockPos p_196260_3_) {
      return HorizontalFaceBlock.canAttach(p_196260_2_, p_196260_3_, getConnectedDirection(p_196260_1_).getOpposite());
   }
