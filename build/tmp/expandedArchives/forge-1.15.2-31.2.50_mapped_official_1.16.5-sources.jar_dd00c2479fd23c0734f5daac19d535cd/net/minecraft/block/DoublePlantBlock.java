...
public class DoublePlantBlock extends BushBlock {
   ...
   public BlockState updateShape(BlockState p_196271_1_, Direction p_196271_2_, BlockState p_196271_3_, IWorld p_196271_4_, BlockPos p_196271_5_, BlockPos p_196271_6_) {
      ...
      if (p_196271_2_.getAxis() != Direction.Axis.Y || doubleblockhalf == DoubleBlockHalf.LOWER != (p_196271_2_ == Direction.UP) || p_196271_3_.getBlock() == this && p_196271_3_.getValue(HALF) != doubleblockhalf) {
   ...
   public BlockState getStateForPlacement(BlockItemUseContext p_196258_1_) {
      ...
      return blockpos.getY() < p_196258_1_.getLevel().func_201675_m().getHeight() - 1 && p_196258_1_.getLevel().getBlockState(blockpos.above()).canBeReplaced(p_196258_1_) ? super.getStateForPlacement(p_196258_1_) : null;
   }
   ...
   public void playerWillDestroy(World p_176208_1_, BlockPos p_176208_2_, BlockState p_176208_3_, PlayerEntity p_176208_4_) {
      ...
      if (blockstate.getBlock() == this && blockstate.getValue(HALF) != doubleblockhalf) {
         ...
         if (!p_176208_1_.isClientSide && !p_176208_4_.isCreative()) {
            ...
            dropResources(blockstate, p_176208_1_, blockpos, (TileEntity)null, p_176208_4_, p_176208_4_.getMainHandItem());
         }
      }
