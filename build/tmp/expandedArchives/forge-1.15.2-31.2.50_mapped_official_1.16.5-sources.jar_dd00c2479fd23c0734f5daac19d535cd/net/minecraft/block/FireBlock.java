...
public class FireBlock extends Block {
   ...
   public BlockState updateShape(BlockState p_196271_1_, Direction p_196271_2_, BlockState p_196271_3_, IWorld p_196271_4_, BlockPos p_196271_5_, BlockPos p_196271_6_) {
      return this.canSurvive(p_196271_1_, p_196271_4_, p_196271_5_) ? this.getStateForPlacement(p_196271_4_, p_196271_5_).setValue(AGE, p_196271_1_.getValue(AGE)) : Blocks.AIR.defaultBlockState();
   }
   ...
   public void tick(BlockState p_225534_1_, ServerWorld p_225534_2_, BlockPos p_225534_3_, Random p_225534_4_) {
      if (p_225534_2_.getGameRules().getBoolean(GameRules.RULE_DOFIRETICK)) {
         ...
         Block block = p_225534_2_.getBlockState(p_225534_3_.below()).getBlock();
         BlockState other = p_225534_2_.getBlockState(p_225534_3_.below());
         boolean flag = other.isFireSource(p_225534_2_, p_225534_3_.below(), Direction.UP);
         ...
         if (!flag && p_225534_2_.isRaining() && this.isNearRain(p_225534_2_, p_225534_3_) && p_225534_4_.nextFloat() < 0.2F + (float)i * 0.03F) {
            ...
            if (!flag) {
               p_225534_2_.getBlockTicks().scheduleTick(p_225534_3_, this, this.getTickDelay(p_225534_2_) + p_225534_4_.nextInt(10));
               ...
               for(int i1 = -1; i1 <= 1; ++i1) {
                  for(int j1 = -1; j1 <= 4; ++j1) {
                     if (l != 0 || j1 != 0 || i1 != 0) {
                        ...
                        blockpos$mutable.set(p_225534_3_).move(l, j1, i1);
                        ...
                        if (l1 > 0) {
                           ...
                           if (i2 > 0 && p_225534_4_.nextInt(k1) <= i2 && (!p_225534_2_.isRaining() || !this.isNearRain(p_225534_2_, blockpos$mutable))) {
                              ...
                              p_225534_2_.setBlock(blockpos$mutable, this.getStateForPlacement(p_225534_2_, blockpos$mutable).setValue(AGE, Integer.valueOf(j2)), 3);
                           }
                        }
                     }
                  }
   ...
   public int getBurnOdd(BlockState p_220274_1_) {
      return p_220274_1_.func_196959_b(BlockStateProperties.WATERLOGGED) && p_220274_1_.getValue(BlockStateProperties.WATERLOGGED) ? 0 : this.burnOdds.getInt(p_220274_1_.getBlock());
   }

   @Deprecated //Forge: Use IForgeBlockState.getFireSpreadSpeed
   public int getFlameOdds(BlockState p_220275_1_) {
      return p_220275_1_.func_196959_b(BlockStateProperties.WATERLOGGED) && p_220275_1_.getValue(BlockStateProperties.WATERLOGGED) ? 0 : this.flameOdds.getInt(p_220275_1_.getBlock());
   }
   ...
   private void tryCatchFire(World p_176536_1_, BlockPos p_176536_2_, int p_176536_3_, Random p_176536_4_, int p_176536_5_, Direction face) {
      ...
      if (p_176536_4_.nextInt(p_176536_3_) < i) {
         ...
         if (p_176536_4_.nextInt(p_176536_5_ + 10) < 5 && !p_176536_1_.isRainingAt(p_176536_2_)) {
            ...
            p_176536_1_.setBlock(p_176536_2_, this.getStateForPlacement(p_176536_1_, p_176536_2_).setValue(AGE, Integer.valueOf(j)), 3);
         } else {
   ...
   public void onPlace(BlockState p_220082_1_, World p_220082_2_, BlockPos p_220082_3_, BlockState p_220082_4_, boolean p_220082_5_) {
      if (p_220082_4_.getBlock() != p_220082_1_.getBlock()) {
         if (p_220082_2_.dimension.func_186058_p() != DimensionType.field_223227_a_ && p_220082_2_.dimension.func_186058_p() != DimensionType.field_223228_b_ || !((NetherPortalBlock)Blocks.NETHER_PORTAL).func_176548_d(p_220082_2_, p_220082_3_)) {
            if (!p_220082_1_.canSurvive(p_220082_2_, p_220082_3_)) {
               p_220082_2_.removeBlock(p_220082_3_, false);
            } else {
               p_220082_2_.getBlockTicks().scheduleTick(p_220082_3_, this, this.getTickDelay(p_220082_2_) + p_220082_2_.random.nextInt(10));
            }
         }
      }
   }
   ...
   public void animateTick(BlockState p_180655_1_, World p_180655_2_, BlockPos p_180655_3_, Random p_180655_4_) {
      if (p_180655_4_.nextInt(24) == 0) {
         p_180655_2_.playLocalSound((double)((float)p_180655_3_.getX() + 0.5F), (double)((float)p_180655_3_.getY() + 0.5F), (double)((float)p_180655_3_.getZ() + 0.5F), SoundEvents.FIRE_AMBIENT, SoundCategory.BLOCKS, 1.0F + p_180655_4_.nextFloat(), p_180655_4_.nextFloat() * 0.7F + 0.3F, false);
      }
      ...
      if (!this.canCatchFire(p_180655_2_, blockpos, Direction.UP) && !Block.func_220056_d(blockstate, p_180655_2_, blockpos, Direction.UP)) {
         ...
         if (this.canCatchFire(p_180655_2_, p_180655_3_.above(), Direction.DOWN)) {
   ...
   public void setFlammable(Block p_180686_1_, int p_180686_2_, int p_180686_3_) {
