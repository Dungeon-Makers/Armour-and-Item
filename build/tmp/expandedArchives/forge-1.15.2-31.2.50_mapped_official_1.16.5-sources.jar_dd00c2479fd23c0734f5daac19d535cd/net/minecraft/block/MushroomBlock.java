...
public class MushroomBlock extends BushBlock implements IGrowable {
   ...
   public void tick(BlockState p_225534_1_, ServerWorld p_225534_2_, BlockPos p_225534_3_, Random p_225534_4_) {
      if (p_225534_4_.nextInt(25) == 0) {
         ...
         for(BlockPos blockpos : BlockPos.betweenClosed(p_225534_3_.offset(-4, -1, -4), p_225534_3_.offset(4, 1, 4))) {
         ...
         BlockPos blockpos1 = p_225534_3_.offset(p_225534_4_.nextInt(3) - 1, p_225534_4_.nextInt(2) - p_225534_4_.nextInt(2), p_225534_4_.nextInt(3) - 1);

         for(int k = 0; k < 4; ++k) {
            if (p_225534_2_.isEmptyBlock(blockpos1) && p_225534_1_.canSurvive(p_225534_2_, blockpos1)) {
               p_225534_3_ = blockpos1;
            }

            blockpos1 = p_225534_3_.offset(p_225534_4_.nextInt(3) - 1, p_225534_4_.nextInt(2) - p_225534_4_.nextInt(2), p_225534_4_.nextInt(3) - 1);
         }

         if (p_225534_2_.isEmptyBlock(blockpos1) && p_225534_1_.canSurvive(p_225534_2_, blockpos1)) {
            p_225534_2_.setBlock(blockpos1, p_225534_1_, 2);
         }
      }
   ...
   public boolean growMushroom(ServerWorld p_226940_1_, BlockPos p_226940_2_, BlockState p_226940_3_, Random p_226940_4_) {
      ...
      if (this == Blocks.BROWN_MUSHROOM) {
         configuredfeature = Feature.HUGE_BROWN_MUSHROOM.configured(DefaultBiomeFeatures.field_226768_ac_);
      } else {
         ...
         configuredfeature = Feature.HUGE_RED_MUSHROOM.configured(DefaultBiomeFeatures.field_226767_ab_);
      }

      if (configuredfeature.func_222734_a(p_226940_1_, p_226940_1_.getChunkSource().getGenerator(), p_226940_4_, p_226940_2_)) {
         return true;
      } else {
         p_226940_1_.setBlock(p_226940_2_, p_226940_3_, 3);
         return false;
