...
public class ComposterBlock extends Block implements ISidedInventoryProvider {
   ...
   public static final VoxelShape OUTER_SHAPE = VoxelShapes.block();
   ...
   public ActionResultType use(BlockState p_225533_1_, World p_225533_2_, BlockPos p_225533_3_, PlayerEntity p_225533_4_, Hand p_225533_5_, BlockRayTraceResult p_225533_6_) {
      ...
      if (i < 8 && COMPOSTABLES.containsKey(itemstack.getItem())) {
         if (i < 7 && !p_225533_2_.isClientSide) {
            boolean flag = func_220293_b(p_225533_1_, p_225533_2_, p_225533_3_, itemstack);
            p_225533_2_.levelEvent(1500, p_225533_3_, flag ? 1 : 0);
         ...
         if (!p_225533_2_.isClientSide) {
            float f = 0.7F;
            double d0 = (double)(p_225533_2_.random.nextFloat() * 0.7F) + (double)0.15F;
            double d1 = (double)(p_225533_2_.random.nextFloat() * 0.7F) + (double)0.060000002F + 0.6D;
            double d2 = (double)(p_225533_2_.random.nextFloat() * 0.7F) + (double)0.15F;
         ...
         func_220294_d(p_225533_1_, p_225533_2_, p_225533_3_);
         p_225533_2_.playSound((PlayerEntity)null, p_225533_3_, SoundEvents.COMPOSTER_EMPTY, SoundCategory.BLOCKS, 1.0F, 1.0F);
         return ActionResultType.SUCCESS;
      } else {
   ...
   private static void func_220294_d(BlockState p_220294_0_, IWorld p_220294_1_, BlockPos p_220294_2_) {
      p_220294_1_.setBlock(p_220294_2_, p_220294_0_.setValue(LEVEL, Integer.valueOf(0)), 3);
   }
   ...
   private static boolean func_220293_b(BlockState p_220293_0_, IWorld p_220293_1_, BlockPos p_220293_2_, ItemStack p_220293_3_) {
      int i = p_220293_0_.getValue(LEVEL);
      float f = COMPOSTABLES.getFloat(p_220293_3_.getItem());
      if ((i != 0 || !(f > 0.0F)) && !(p_220293_1_.getRandom().nextDouble() < (double)f)) {
         return false;
      } else {
         int j = i + 1;
         p_220293_1_.setBlock(p_220293_2_, p_220293_0_.setValue(LEVEL, Integer.valueOf(j)), 3);
         if (j == 7) {
            p_220293_1_.getBlockTicks().scheduleTick(p_220293_2_, p_220293_0_.getBlock(), 20);
         }
   ...
   public void tick(BlockState p_225534_1_, ServerWorld p_225534_2_, BlockPos p_225534_3_, Random p_225534_4_) {
      if (p_225534_1_.getValue(LEVEL) == 7) {
         p_225534_2_.setBlock(p_225534_3_, p_225534_1_.func_177231_a(LEVEL), 3);
   ...
   static class FullInventory extends Inventory implements ISidedInventory {
      ...
      public void setChanged() {
         ComposterBlock.func_220294_d(this.state, this.level, this.pos);
         this.changed = true;
      }
   }
   ...
   static class PartialInventory extends Inventory implements ISidedInventory {
      ...
      public void setChanged() {
         ...
         if (!itemstack.isEmpty()) {
            this.changed = true;
            ComposterBlock.func_220293_b(this.state, this.level, this.pos, itemstack);
