...
public class SaplingBlock extends BushBlock implements IGrowable {
   ...
   public void tick(BlockState p_225534_1_, ServerWorld p_225534_2_, BlockPos p_225534_3_, Random p_225534_4_) {
      ...
      if (p_225534_2_.getMaxLocalRawBrightness(p_225534_3_.above()) >= 9 && p_225534_4_.nextInt(7) == 0) {
         this.advanceTree(p_225534_2_, p_225534_3_, p_225534_1_, p_225534_4_);
      }
   ...
   public void advanceTree(ServerWorld p_226942_1_, BlockPos p_226942_2_, BlockState p_226942_3_, Random p_226942_4_) {
      if (p_226942_3_.getValue(STAGE) == 0) {
         ...
         this.treeGrower.func_225545_a_(p_226942_1_, p_226942_1_.getChunkSource().getGenerator(), p_226942_2_, p_226942_3_, p_226942_4_);
      }
