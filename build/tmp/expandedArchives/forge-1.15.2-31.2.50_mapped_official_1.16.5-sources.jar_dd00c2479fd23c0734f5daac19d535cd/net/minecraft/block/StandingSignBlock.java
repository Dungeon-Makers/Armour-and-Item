...
public class StandingSignBlock extends AbstractSignBlock {
   ...
   public BlockState getStateForPlacement(BlockItemUseContext p_196258_1_) {
      ...
      return this.defaultBlockState().setValue(ROTATION, Integer.valueOf(MathHelper.floor((double)((180.0F + p_196258_1_.getRotation()) * 16.0F / 360.0F) + 0.5D) & 15)).setValue(WATERLOGGED, Boolean.valueOf(ifluidstate.getType() == Fluids.WATER));
   }
