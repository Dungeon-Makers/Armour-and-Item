...
public class SilverfishBlock extends Block {
   ...
   public void spawnAfterBreak(BlockState p_220062_1_, World p_220062_2_, BlockPos p_220062_3_, ItemStack p_220062_4_) {
      ...
      if (!p_220062_2_.isClientSide && p_220062_2_.getGameRules().getBoolean(GameRules.RULE_DOBLOCKDROPS) && EnchantmentHelper.getItemEnchantmentLevel(Enchantments.SILK_TOUCH, p_220062_4_) == 0) {
         SilverfishEntity silverfishentity = EntityType.SILVERFISH.create(p_220062_2_);
         silverfishentity.moveTo((double)p_220062_3_.getX() + 0.5D, (double)p_220062_3_.getY(), (double)p_220062_3_.getZ() + 0.5D, 0.0F, 0.0F);
         p_220062_2_.addFreshEntity(silverfishentity);
