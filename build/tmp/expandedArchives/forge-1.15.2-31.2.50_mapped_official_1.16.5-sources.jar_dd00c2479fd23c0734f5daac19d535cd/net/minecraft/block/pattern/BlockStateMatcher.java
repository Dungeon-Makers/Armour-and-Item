...
public class BlockStateMatcher implements Predicate<BlockState> {
   ...
   private final Map<IProperty<?>, Predicate<Object>> properties = Maps.newHashMap();
   ...
   public boolean test(@Nullable BlockState p_test_1_) {
      if (p_test_1_ != null && p_test_1_.getBlock().equals(this.definition.getOwner())) {
         if (this.properties.isEmpty()) {
            ...
            for(Entry<IProperty<?>, Predicate<Object>> entry : this.properties.entrySet()) {
   ...
   protected <T extends Comparable<T>> boolean applies(BlockState p_185927_1_, IProperty<T> p_185927_2_, Predicate<Object> p_185927_3_) {
