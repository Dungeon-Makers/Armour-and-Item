...
public class CactusBlock extends Block implements net.minecraftforge.common.IPlantable {
      ...
      if (!p_225534_1_.canSurvive(p_225534_2_, p_225534_3_)) {
         ...
         if (p_225534_2_.isEmptyBlock(blockpos)) {
            ...
            if (i < 3) {
               ...
               if (j == 15) {
                  p_225534_2_.setBlockAndUpdate(blockpos, this.defaultBlockState());
                  BlockState blockstate = p_225534_1_.setValue(AGE, Integer.valueOf(0));
                  p_225534_2_.setBlock(p_225534_3_, blockstate, 4);
   ...
   public boolean canSurvive(BlockState p_196260_1_, IWorldReader p_196260_2_, BlockPos p_196260_3_) {
      ...
      return soil.canSustainPlant(p_196260_2_, p_196260_3_.below(), Direction.UP, this) && !p_196260_2_.getBlockState(p_196260_3_.above()).getMaterial().isLiquid();
   }
