...
public class NoteBlock extends Block {
   ...
   public ActionResultType use(BlockState p_225533_1_, World p_225533_2_, BlockPos p_225533_3_, PlayerEntity p_225533_4_, Hand p_225533_5_, BlockRayTraceResult p_225533_6_) {
      if (p_225533_2_.isClientSide) {
         ...
         int _new = net.minecraftforge.common.ForgeHooks.onNoteChange(p_225533_2_, p_225533_3_, p_225533_1_, p_225533_1_.getValue(NOTE), p_225533_1_.func_177231_a(NOTE).getValue(NOTE));
         if (_new == -1) return ActionResultType.FAIL;
         p_225533_1_ = (BlockState)p_225533_1_.setValue(NOTE, _new);
