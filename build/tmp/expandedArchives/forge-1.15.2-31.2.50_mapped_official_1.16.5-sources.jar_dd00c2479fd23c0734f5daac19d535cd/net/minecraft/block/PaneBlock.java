...
public class PaneBlock extends FourWayBlock {
   ...
   public final boolean attachsTo(BlockState p_220112_1_, boolean p_220112_2_) {
      ...
      return !isExceptionForConnection(block) && p_220112_2_ || block instanceof PaneBlock;
   }
