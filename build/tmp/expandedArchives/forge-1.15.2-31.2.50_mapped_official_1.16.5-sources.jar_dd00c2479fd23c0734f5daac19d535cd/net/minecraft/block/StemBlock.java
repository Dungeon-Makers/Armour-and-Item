...
public class StemBlock extends BushBlock implements IGrowable {
   ...
   public void tick(BlockState p_225534_1_, ServerWorld p_225534_2_, BlockPos p_225534_3_, Random p_225534_4_) {
      ...
      if (p_225534_2_.getRawBrightness(p_225534_3_, 0) >= 9) {
         float f = CropsBlock.getGrowthSpeed(this, p_225534_2_, p_225534_3_);
         if (net.minecraftforge.common.ForgeHooks.onCropsGrowPre(p_225534_2_, p_225534_3_, p_225534_1_, p_225534_4_.nextInt((int)(25.0F / f) + 1) == 0)) {
            ...
            if (i < 7) {
               ...
               Direction direction = Direction.Plane.HORIZONTAL.getRandomDirection(p_225534_4_);
               BlockPos blockpos = p_225534_3_.relative(direction);
               BlockState soil = p_225534_2_.getBlockState(blockpos.below());
               Block block = soil.getBlock();
               if (p_225534_2_.isEmptyBlock(blockpos) && (soil.canSustainPlant(p_225534_2_, blockpos.below(), Direction.UP, this) || block == Blocks.FARMLAND || block == Blocks.DIRT || block == Blocks.COARSE_DIRT || block == Blocks.PODZOL || block == Blocks.GRASS_BLOCK)) {
                  p_225534_2_.setBlockAndUpdate(blockpos, this.fruit.defaultBlockState());
                  p_225534_2_.setBlockAndUpdate(p_225534_3_, this.fruit.getAttachedStem().defaultBlockState().setValue(HorizontalBlock.FACING, direction));
               }
            }
   ...
   public void performBonemeal(ServerWorld p_225535_1_, Random p_225535_2_, BlockPos p_225535_3_, BlockState p_225535_4_) {
      ...
      if (i == 7) {
         blockstate.tick(p_225535_1_, p_225535_3_, p_225535_1_.random);
      }
