...
public class BubbleColumnBlock extends Block implements IBucketPickupHandler {
   ...
   public void entityInside(BlockState p_196262_1_, World p_196262_2_, BlockPos p_196262_3_, Entity p_196262_4_) {
      ...
      if (blockstate.isAir()) {
         ...
         if (!p_196262_2_.isClientSide) {
            ...
            for(int i = 0; i < 2; ++i) {
               serverworld.sendParticles(ParticleTypes.SPLASH, (double)((float)p_196262_3_.getX() + p_196262_2_.random.nextFloat()), (double)(p_196262_3_.getY() + 1), (double)((float)p_196262_3_.getZ() + p_196262_2_.random.nextFloat()), 1, 0.0D, 0.0D, 0.0D, 1.0D);
               serverworld.sendParticles(ParticleTypes.BUBBLE, (double)((float)p_196262_3_.getX() + p_196262_2_.random.nextFloat()), (double)(p_196262_3_.getY() + 1), (double)((float)p_196262_3_.getZ() + p_196262_2_.random.nextFloat()), 1, 0.0D, 0.01D, 0.0D, 0.2D);
            }
         }
      } else {
   ...
   public static boolean canExistIn(IWorld p_208072_0_, BlockPos p_208072_1_) {
      ...
      return p_208072_0_.getBlockState(p_208072_1_).getBlock() == Blocks.WATER && ifluidstate.getAmount() >= 8 && ifluidstate.isSource();
   }
   ...
   public BlockState updateShape(BlockState p_196271_1_, Direction p_196271_2_, BlockState p_196271_3_, IWorld p_196271_4_, BlockPos p_196271_5_, BlockPos p_196271_6_) {
      if (!p_196271_1_.canSurvive(p_196271_4_, p_196271_5_)) {
         ...
         } else if (p_196271_2_ == Direction.UP && p_196271_3_.getBlock() != Blocks.BUBBLE_COLUMN && canExistIn(p_196271_4_, p_196271_6_)) {
            p_196271_4_.getBlockTicks().scheduleTick(p_196271_5_, this, this.getTickDelay(p_196271_4_));
         }
