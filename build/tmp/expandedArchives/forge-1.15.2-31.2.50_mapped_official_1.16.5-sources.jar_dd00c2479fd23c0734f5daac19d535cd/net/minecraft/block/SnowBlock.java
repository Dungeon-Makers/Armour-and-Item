...
public class SnowBlock extends Block {
   ...
   public boolean canSurvive(BlockState p_196260_1_, IWorldReader p_196260_2_, BlockPos p_196260_3_) {
      ...
      if (block != Blocks.ICE && block != Blocks.PACKED_ICE && block != Blocks.BARRIER) {
         if (block != Blocks.HONEY_BLOCK && block != Blocks.SOUL_SAND) {
            return Block.isFaceFull(blockstate.getCollisionShape(p_196260_2_, p_196260_3_.below()), Direction.UP) || block == this && blockstate.getValue(LAYERS) == 8;
         } else {
            return true;
         }
      } else {
   ...
   public void tick(BlockState p_225534_1_, ServerWorld p_225534_2_, BlockPos p_225534_3_, Random p_225534_4_) {
      if (p_225534_2_.getBrightness(LightType.BLOCK, p_225534_3_) > 11) {
