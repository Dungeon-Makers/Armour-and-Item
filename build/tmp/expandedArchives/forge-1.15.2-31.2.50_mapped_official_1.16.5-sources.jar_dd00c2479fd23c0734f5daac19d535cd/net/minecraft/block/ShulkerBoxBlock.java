      ...
      if (p_225533_2_.isClientSide) {
         ...
         if (tileentity instanceof ShulkerBoxTileEntity) {
            ...
            if (shulkerboxtileentity.getAnimationStatus() == ShulkerBoxTileEntity.AnimationStatus.CLOSED) {
               ...
               flag = p_225533_2_.noCollision(axisalignedbb.move(p_225533_3_.relative(direction)));
            } else {
               flag = true;
            }
         ...
         if (compoundnbt.contains("Items", 9)) {
            ...
            for(ItemStack itemstack : nonnulllist) {
               if (!itemstack.isEmpty()) {
                  ...
                  if (i <= 4) {
                     ++i;
                     ITextComponent itextcomponent = itemstack.getHoverName().func_212638_h();
                     itextcomponent.func_150258_a(" x").func_150258_a(String.valueOf(itemstack.getCount()));
            ...
            if (j - i > 0) {
               p_190948_3_.add((new TranslationTextComponent("container.shulkerBox.more", j - i)).func_211708_a(TextFormatting.ITALIC));
            }
         }
      }
