...
public class RedstoneTorchBlock extends TorchBlock {
   ...
   public void tick(BlockState p_225534_1_, ServerWorld p_225534_2_, BlockPos p_225534_3_, Random p_225534_4_) {
      func_196527_a(p_225534_1_, p_225534_2_, p_225534_3_, p_225534_4_, this.hasNeighborSignal(p_225534_2_, p_225534_3_, p_225534_1_));
   }

   public static void func_196527_a(BlockState p_196527_0_, World p_196527_1_, BlockPos p_196527_2_, Random p_196527_3_, boolean p_196527_4_) {
      List<RedstoneTorchBlock.Toggle> list = RECENT_TOGGLES.get(p_196527_1_);

      while(list != null && !list.isEmpty() && p_196527_1_.getGameTime() - (list.get(0)).when > 60L) {
         list.remove(0);
      }

      if (p_196527_0_.getValue(LIT)) {
         if (p_196527_4_) {
            p_196527_1_.setBlock(p_196527_2_, p_196527_0_.setValue(LIT, Boolean.valueOf(false)), 3);
            if (isToggledTooFrequently(p_196527_1_, p_196527_2_, true)) {
               p_196527_1_.levelEvent(1502, p_196527_2_, 0);
               p_196527_1_.getBlockTicks().scheduleTick(p_196527_2_, p_196527_1_.getBlockState(p_196527_2_).getBlock(), 160);
            }
         }
      } else if (!p_196527_4_ && !isToggledTooFrequently(p_196527_1_, p_196527_2_, false)) {
         p_196527_1_.setBlock(p_196527_2_, p_196527_0_.setValue(LIT, Boolean.valueOf(true)), 3);
      }
   ...
   public void neighborChanged(BlockState p_220069_1_, World p_220069_2_, BlockPos p_220069_3_, Block p_220069_4_, BlockPos p_220069_5_, boolean p_220069_6_) {
      if (p_220069_1_.getValue(LIT) == this.hasNeighborSignal(p_220069_2_, p_220069_3_, p_220069_1_) && !p_220069_2_.getBlockTicks().willTickThisTick(p_220069_3_, this)) {
         p_220069_2_.getBlockTicks().scheduleTick(p_220069_3_, this, this.getTickDelay(p_220069_2_));
      }
   ...
   public void animateTick(BlockState p_180655_1_, World p_180655_2_, BlockPos p_180655_3_, Random p_180655_4_) {
      if (p_180655_1_.getValue(LIT)) {
         ...
         p_180655_2_.addParticle(RedstoneParticleData.REDSTONE, d0, d1, d2, 0.0D, 0.0D, 0.0D);
      }
   }
