...
public class SeaPickleBlock extends BushBlock implements IGrowable, IWaterLoggable {
   ...
   public int func_149750_m(BlockState p_149750_1_) {
      return this.isDead(p_149750_1_) ? 0 : super.func_149750_m(p_149750_1_) + 3 * p_149750_1_.getValue(PICKLES);
   }
   ...
   private boolean isDead(BlockState p_204901_1_) {
      return !p_204901_1_.getValue(WATERLOGGED);
   }

   protected boolean mayPlaceOn(BlockState p_200014_1_, IBlockReader p_200014_2_, BlockPos p_200014_3_) {
      return !p_200014_1_.getCollisionShape(p_200014_2_, p_200014_3_).getFaceShape(Direction.UP).isEmpty();
   }
   ...
   public void performBonemeal(ServerWorld p_225535_1_, Random p_225535_2_, BlockPos p_225535_3_, BlockState p_225535_4_) {
      if (!this.isDead(p_225535_4_) && p_225535_1_.getBlockState(p_225535_3_.below()).is(BlockTags.CORAL_BLOCKS)) {
         int i = 5;
         int j = 1;
         int k = 2;
         int l = 0;
