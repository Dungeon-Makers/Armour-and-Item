...
public class DetectorRailBlock extends AbstractRailBlock {
   ...
   private void checkPressed(World p_176570_1_, BlockPos p_176570_2_, BlockState p_176570_3_) {
      ...
      if (flag1) {
         p_176570_1_.getBlockTicks().scheduleTick(p_176570_2_, this, this.getTickDelay(p_176570_1_));
      }
   ...
   public void onPlace(BlockState p_220082_1_, World p_220082_2_, BlockPos p_220082_3_, BlockState p_220082_4_, boolean p_220082_5_) {
      if (p_220082_4_.getBlock() != p_220082_1_.getBlock()) {
         ...
         this.checkPressed(p_220082_2_, p_220082_3_, p_220082_1_);
      }
   }
   ...
   public int getAnalogOutputSignal(BlockState p_180641_1_, World p_180641_2_, BlockPos p_180641_3_) {
      if (p_180641_1_.getValue(POWERED)) {
         ...
         List<MinecartCommandBlockEntity> list = this.getInteractingMinecartOfType(p_180641_2_, p_180641_3_, MinecartCommandBlockEntity.class, (Predicate<Entity>)null);
         if (!list.isEmpty()) {
