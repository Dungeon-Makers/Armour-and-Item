...
public class PistonBlock extends DirectionalBlock {
   ...
   public boolean func_229869_c_(BlockState p_229869_1_, IBlockReader p_229869_2_, BlockPos p_229869_3_) {
      return !p_229869_1_.getValue(EXTENDED);
   }
   ...
   private void checkIfExtend(World p_176316_1_, BlockPos p_176316_2_, BlockState p_176316_3_) {
      ...
      if (flag && !p_176316_3_.getValue(EXTENDED)) {
         ...
         int i = 1;
         if (blockstate.getBlock() == Blocks.MOVING_PISTON && blockstate.getValue(FACING) == direction) {
   ...
   public boolean triggerEvent(BlockState p_189539_1_, World p_189539_2_, BlockPos p_189539_3_, int p_189539_4_, int p_189539_5_) {
      ...
      if (p_189539_4_ == 0) {
         ...
         p_189539_2_.setBlock(p_189539_3_, Blocks.MOVING_PISTON.defaultBlockState().setValue(MovingPistonBlock.FACING, direction).setValue(MovingPistonBlock.TYPE, this.isSticky ? PistonType.STICKY : PistonType.DEFAULT), 3);
         ...
         if (this.isSticky) {
            ...
            if (!flag1) {
               if (p_189539_4_ != 1 || blockstate.isAir(p_189539_2_, blockpos) || !isPushable(blockstate, p_189539_2_, blockpos, direction.getOpposite(), false, direction) || blockstate.getPistonPushReaction() != PushReaction.NORMAL && block != Blocks.PISTON && block != Blocks.STICKY_PISTON) {
   ...
   public static boolean isPushable(BlockState p_185646_0_, World p_185646_1_, BlockPos p_185646_2_, Direction p_185646_3_, boolean p_185646_4_, Direction p_185646_5_) {
      ...
      if (block == Blocks.OBSIDIAN) {
         return false;
      } else if (!p_185646_1_.getWorldBorder().isWithinBounds(p_185646_2_)) {
         return false;
      } else if (p_185646_2_.getY() >= 0 && (p_185646_3_ != Direction.DOWN || p_185646_2_.getY() != 0)) {
         if (p_185646_2_.getY() <= p_185646_1_.getMaxBuildHeight() - 1 && (p_185646_3_ != Direction.UP || p_185646_2_.getY() != p_185646_1_.getMaxBuildHeight() - 1)) {
   ...
   private boolean moveBlocks(World p_176319_1_, BlockPos p_176319_2_, Direction p_176319_3_, boolean p_176319_4_) {
      ...
      if (!pistonblockstructurehelper.resolve()) {
         ...
         for(Entry<BlockPos, BlockState> entry : map.entrySet()) {
            ...
            blockstate3.func_196946_a(p_176319_1_, blockpos5, 2);
         ...
         for(int j1 = list.size() - 1; j1 >= 0; --j1) {
            p_176319_1_.updateNeighborsAt(list.get(j1), ablockstate[k++].getBlock());
         }
