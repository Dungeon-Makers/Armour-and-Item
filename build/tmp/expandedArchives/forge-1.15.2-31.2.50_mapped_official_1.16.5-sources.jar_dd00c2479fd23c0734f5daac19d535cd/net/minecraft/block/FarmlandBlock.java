...
public class FarmlandBlock extends Block {
   ...
   public void tick(BlockState p_225534_1_, ServerWorld p_225534_2_, BlockPos p_225534_3_, Random p_225534_4_) {
      if (!p_225534_1_.canSurvive(p_225534_2_, p_225534_3_)) {
         ...
         int i = p_225534_1_.getValue(MOISTURE);
         if (!isNearWater(p_225534_2_, p_225534_3_) && !p_225534_2_.isRainingAt(p_225534_3_.above())) {
            if (i > 0) {
               p_225534_2_.setBlock(p_225534_3_, p_225534_1_.setValue(MOISTURE, Integer.valueOf(i - 1)), 2);
            } else if (!isUnderCrops(p_225534_2_, p_225534_3_)) {
               turnToDirt(p_225534_1_, p_225534_2_, p_225534_3_);
            }
         } else if (i < 7) {
            p_225534_2_.setBlock(p_225534_3_, p_225534_1_.setValue(MOISTURE, Integer.valueOf(7)), 2);
         }
