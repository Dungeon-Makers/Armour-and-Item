...
public class BambooBlock extends Block implements IGrowable {
   ...
   public VoxelShape getCollisionShape(BlockState p_220071_1_, IBlockReader p_220071_2_, BlockPos p_220071_3_, ISelectionContext p_220071_4_) {
      Vec3d vec3d = p_220071_1_.getOffset(p_220071_2_, p_220071_3_);
   ...
   public void tick(BlockState p_225534_1_, ServerWorld p_225534_2_, BlockPos p_225534_3_, Random p_225534_4_) {
      ...
      } else if (p_225534_1_.getValue(STAGE) == 0) {
         if (true) {
            int i = this.getHeightBelowUpToMax(p_225534_2_, p_225534_3_) + 1;
            if (i < 16 && net.minecraftforge.common.ForgeHooks.onCropsGrowPre(p_225534_2_, p_225534_3_, p_225534_1_, p_225534_4_.nextInt(3) == 0 && p_225534_2_.isEmptyBlock(p_225534_3_.above()) && p_225534_2_.getRawBrightness(p_225534_3_.above(), 0) >= 9)) {
               this.growBamboo(p_225534_1_, p_225534_2_, p_225534_3_, p_225534_4_, i);
   ...
   public BlockState updateShape(BlockState p_196271_1_, Direction p_196271_2_, BlockState p_196271_3_, IWorld p_196271_4_, BlockPos p_196271_5_, BlockPos p_196271_6_) {
      ...
      if (p_196271_2_ == Direction.UP && p_196271_3_.getBlock() == Blocks.BAMBOO && p_196271_3_.getValue(AGE) > p_196271_1_.getValue(AGE)) {
         p_196271_4_.setBlock(p_196271_5_, p_196271_1_.func_177231_a(AGE), 2);
      }
   ...
   protected void growBamboo(BlockState p_220258_1_, World p_220258_2_, BlockPos p_220258_3_, Random p_220258_4_, int p_220258_5_) {
      ...
      int i = p_220258_1_.getValue(AGE) != 1 && blockstate1.getBlock() != Blocks.BAMBOO ? 0 : 1;
   ...
   protected int getHeightAboveUpToMax(IBlockReader p_220259_1_, BlockPos p_220259_2_) {
      int i;
      for(i = 0; i < 16 && p_220259_1_.getBlockState(p_220259_2_.above(i + 1)).getBlock() == Blocks.BAMBOO; ++i) {
         ;
      }
   ...
   protected int getHeightBelowUpToMax(IBlockReader p_220260_1_, BlockPos p_220260_2_) {
      int i;
      for(i = 0; i < 16 && p_220260_1_.getBlockState(p_220260_2_.below(i + 1)).getBlock() == Blocks.BAMBOO; ++i) {
         ;
      }
