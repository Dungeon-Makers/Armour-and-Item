...
public class CropsBlock extends BushBlock implements IGrowable {
   ...
   public void tick(BlockState p_225534_1_, ServerWorld p_225534_2_, BlockPos p_225534_3_, Random p_225534_4_) {
      ...
      if (p_225534_2_.getRawBrightness(p_225534_3_, 0) >= 9) {
         ...
         if (i < this.getMaxAge()) {
            float f = getGrowthSpeed(this, p_225534_2_, p_225534_3_);
            if (net.minecraftforge.common.ForgeHooks.onCropsGrowPre(p_225534_2_, p_225534_3_, p_225534_1_, p_225534_4_.nextInt((int)(25.0F / f) + 1) == 0)) {
               p_225534_2_.setBlock(p_225534_3_, this.getStateForAge(i + 1), 2);
      ...
      for(int i = -1; i <= 1; ++i) {
         for(int j = -1; j <= 1; ++j) {
            ...
            if (blockstate.canSustainPlant(p_180672_1_, blockpos.offset(i, 0, j), net.minecraft.util.Direction.UP, (net.minecraftforge.common.IPlantable)p_180672_0_)) {
               f1 = 1.0F;
               if (blockstate.isFertile(p_180672_1_, blockpos.offset(i, 0, j))) {
                  f1 = 3.0F;
               }
            }
