...
public class TallSeaGrassBlock extends ShearableDoublePlantBlock implements ILiquidContainer {
   public static final EnumProperty<DoubleBlockHalf> HALF = ShearableDoublePlantBlock.field_208063_b;
   ...
   protected boolean mayPlaceOn(BlockState p_200014_1_, IBlockReader p_200014_2_, BlockPos p_200014_3_) {
      return p_200014_1_.isFaceSturdy(p_200014_2_, p_200014_3_, Direction.UP) && p_200014_1_.getBlock() != Blocks.MAGMA_BLOCK;
   }
   ...
   public BlockState getStateForPlacement(BlockItemUseContext p_196258_1_) {
      ...
      if (blockstate != null) {
         IFluidState ifluidstate = p_196258_1_.getLevel().getFluidState(p_196258_1_.getClickedPos().above());
   ...
   public boolean canSurvive(BlockState p_196260_1_, IWorldReader p_196260_2_, BlockPos p_196260_3_) {
      if (p_196260_1_.getValue(HALF) == DoubleBlockHalf.UPPER) {
         ...
         return super.canSurvive(p_196260_1_, p_196260_2_, p_196260_3_) && ifluidstate.is(FluidTags.WATER) && ifluidstate.getAmount() == 8;
      }
   }
