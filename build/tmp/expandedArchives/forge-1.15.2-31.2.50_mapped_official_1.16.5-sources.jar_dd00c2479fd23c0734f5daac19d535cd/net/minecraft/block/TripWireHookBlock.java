...
public class TripWireHookBlock extends Block {
   ...
   public boolean canSurvive(BlockState p_196260_1_, IWorldReader p_196260_2_, BlockPos p_196260_3_) {
      ...
      return direction.getAxis().isHorizontal() && blockstate.isFaceSturdy(p_196260_2_, blockpos, direction) && !blockstate.isSignalSource();
   }
   ...
   public void calculateState(World p_176260_1_, BlockPos p_176260_2_, BlockState p_176260_3_, boolean p_176260_4_, boolean p_176260_5_, int p_176260_6_, @Nullable BlockState p_176260_7_) {
      ...
      for(int j = 1; j < 42; ++j) {
         ...
         if (blockstate.getBlock() != Blocks.TRIPWIRE && j != p_176260_6_) {
            ...
            if (j == p_176260_6_) {
               p_176260_1_.getBlockTicks().scheduleTick(p_176260_2_, this, this.getTickDelay(p_176260_1_));
               flag2 &= flag4;
            }
         }
      }
