...
public class ChestBlock extends AbstractChestBlock<ChestTileEntity> implements IWaterLoggable {
   ...
   public static IInventory getContainer(ChestBlock p_226916_0_, BlockState p_226916_1_, World p_226916_2_, BlockPos p_226916_3_, boolean p_226916_4_) {
      return p_226916_0_.combine(p_226916_1_, p_226916_2_, p_226916_3_, p_226916_4_).apply(CHEST_COMBINER).orElse((IInventory)null);
   }
   ...
   public INamedContainerProvider getMenuProvider(BlockState p_220052_1_, World p_220052_2_, BlockPos p_220052_3_) {
      return this.combine(p_220052_1_, p_220052_2_, p_220052_3_, false).apply(MENU_PROVIDER_COMBINER).orElse((INamedContainerProvider)null);
   }
