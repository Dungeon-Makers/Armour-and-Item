...
public abstract class SpreadableSnowyDirtBlock extends SnowyDirtBlock {
   ...
   public void tick(BlockState p_225534_1_, ServerWorld p_225534_2_, BlockPos p_225534_3_, Random p_225534_4_) {
      if (!canBeGrass(p_225534_1_, p_225534_2_, p_225534_3_)) {
         ...
         p_225534_2_.setBlockAndUpdate(p_225534_3_, Blocks.DIRT.defaultBlockState());
      } else {
         if (p_225534_2_.getMaxLocalRawBrightness(p_225534_3_.above()) >= 9) {
            BlockState blockstate = this.defaultBlockState();

            for(int i = 0; i < 4; ++i) {
               BlockPos blockpos = p_225534_3_.offset(p_225534_4_.nextInt(3) - 1, p_225534_4_.nextInt(5) - 3, p_225534_4_.nextInt(3) - 1);
               if (p_225534_2_.getBlockState(blockpos).getBlock() == Blocks.DIRT && canPropagate(blockstate, p_225534_2_, blockpos)) {
                  p_225534_2_.setBlockAndUpdate(blockpos, blockstate.setValue(SNOWY, Boolean.valueOf(p_225534_2_.getBlockState(blockpos.above()).getBlock() == Blocks.SNOW)));
               }
            }
         }
