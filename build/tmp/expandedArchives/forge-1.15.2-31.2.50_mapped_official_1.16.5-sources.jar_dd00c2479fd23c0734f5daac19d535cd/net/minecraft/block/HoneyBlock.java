...
public class HoneyBlock extends BreakableBlock {
   ...
   private void doSlideMovement(Entity p_226938_1_) {
      Vec3d vec3d = p_226938_1_.getDeltaMovement();
      if (vec3d.y < -0.13D) {
         double d0 = -0.05D / vec3d.y;
         p_226938_1_.setDeltaMovement(new Vec3d(vec3d.x * d0, -0.05D, vec3d.z * d0));
      } else {
         p_226938_1_.setDeltaMovement(new Vec3d(vec3d.x, -0.05D, vec3d.z));
      }
