...
public class VineBlock extends Block implements net.minecraftforge.common.IShearable {
      ...
      for(Direction direction : Direction.Plane.HORIZONTAL) {
         ...
         if (p_196545_1_.getValue(booleanproperty)) {
            ...
            if (!flag) {
               ...
               flag = blockstate.getBlock() == this && blockstate.getValue(booleanproperty);
            }
   ...
   public void tick(BlockState p_225534_1_, ServerWorld p_225534_2_, BlockPos p_225534_3_, Random p_225534_4_) {
      BlockState blockstate = this.getUpdatedState(p_225534_1_, p_225534_2_, p_225534_3_);
      if (blockstate != p_225534_1_) {
         if (this.hasFaces(blockstate)) {
            p_225534_2_.setBlock(p_225534_3_, blockstate, 2);
         } else {
            dropResources(p_225534_1_, p_225534_2_, p_225534_3_);
            p_225534_2_.removeBlock(p_225534_3_, false);
         }

      } else if (p_225534_2_.random.nextInt(4) == 0 && p_225534_2_.isAreaLoaded(p_225534_3_, 4)) { // Forge: check area to prevent loading unloaded chunks
         Direction direction = Direction.func_176741_a(p_225534_4_);
         BlockPos blockpos = p_225534_3_.above();
         if (direction.getAxis().isHorizontal() && !p_225534_1_.getValue(getPropertyForFace(direction))) {
            if (this.canSpread(p_225534_2_, p_225534_3_)) {
               BlockPos blockpos4 = p_225534_3_.relative(direction);
               ...
               if (blockstate5.isAir(p_225534_2_, blockpos4)) {
                  ...
                  boolean flag = p_225534_1_.getValue(getPropertyForFace(direction3));
                  boolean flag1 = p_225534_1_.getValue(getPropertyForFace(direction4));
                  BlockPos blockpos2 = blockpos4.relative(direction3);
                  BlockPos blockpos3 = blockpos4.relative(direction4);
                  if (flag && isAcceptableNeighbour(p_225534_2_, blockpos2, direction3)) {
                     p_225534_2_.setBlock(blockpos4, this.defaultBlockState().setValue(getPropertyForFace(direction3), Boolean.valueOf(true)), 2);
                  } else if (flag1 && isAcceptableNeighbour(p_225534_2_, blockpos3, direction4)) {
                     p_225534_2_.setBlock(blockpos4, this.defaultBlockState().setValue(getPropertyForFace(direction4), Boolean.valueOf(true)), 2);
                  } else {
                     Direction direction1 = direction.getOpposite();
                     if (flag && p_225534_2_.isEmptyBlock(blockpos2) && isAcceptableNeighbour(p_225534_2_, p_225534_3_.relative(direction3), direction1)) {
                        p_225534_2_.setBlock(blockpos2, this.defaultBlockState().setValue(getPropertyForFace(direction1), Boolean.valueOf(true)), 2);
                     } else if (flag1 && p_225534_2_.isEmptyBlock(blockpos3) && isAcceptableNeighbour(p_225534_2_, p_225534_3_.relative(direction4), direction1)) {
                        p_225534_2_.setBlock(blockpos3, this.defaultBlockState().setValue(getPropertyForFace(direction1), Boolean.valueOf(true)), 2);
                     } else if ((double)p_225534_2_.random.nextFloat() < 0.05D && isAcceptableNeighbour(p_225534_2_, blockpos4.above(), Direction.UP)) {
                        p_225534_2_.setBlock(blockpos4, this.defaultBlockState().setValue(UP, Boolean.valueOf(true)), 2);
                     }
                  }
               } else if (isAcceptableNeighbour(p_225534_2_, blockpos4, direction)) {
                  p_225534_2_.setBlock(p_225534_3_, p_225534_1_.setValue(getPropertyForFace(direction), Boolean.valueOf(true)), 2);
               }

            }
         } else {
            if (direction == Direction.UP && p_225534_3_.getY() < 255) {
               if (this.canSupportAtFace(p_225534_2_, p_225534_3_, direction)) {
                  p_225534_2_.setBlock(p_225534_3_, p_225534_1_.setValue(UP, Boolean.valueOf(true)), 2);
                  return;
               }

               if (p_225534_2_.isEmptyBlock(blockpos)) {
                  if (!this.canSpread(p_225534_2_, p_225534_3_)) {
                     return;
                  }
                  ...
                  for(Direction direction2 : Direction.Plane.HORIZONTAL) {
                     if (p_225534_4_.nextBoolean() || !isAcceptableNeighbour(p_225534_2_, blockpos.relative(direction2), Direction.UP)) {
                  ...
                  if (this.hasHorizontalConnection(blockstate4)) {
                     p_225534_2_.setBlock(blockpos, blockstate4, 2);
                  }
            ...
            if (p_225534_3_.getY() > 0) {
               BlockPos blockpos1 = p_225534_3_.below();
               BlockState blockstate1 = p_225534_2_.getBlockState(blockpos1);
               if (blockstate1.isAir(p_225534_2_, blockpos1) || blockstate1.getBlock() == this) {
                  BlockState blockstate2 = blockstate1.isAir(p_225534_2_, blockpos1) ? this.defaultBlockState() : blockstate1;
                  BlockState blockstate3 = this.copyRandomFaces(p_225534_1_, blockstate2, p_225534_4_);
                  if (blockstate2 != blockstate3 && this.hasHorizontalConnection(blockstate3)) {
                     p_225534_2_.setBlock(blockpos1, blockstate3, 2);
                  }
               }
            }
