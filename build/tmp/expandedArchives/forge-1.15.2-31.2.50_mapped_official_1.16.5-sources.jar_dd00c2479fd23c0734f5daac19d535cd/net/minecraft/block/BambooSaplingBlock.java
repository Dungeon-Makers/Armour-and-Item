...
public class BambooSaplingBlock extends Block implements IGrowable {
   ...
   public VoxelShape getShape(BlockState p_220053_1_, IBlockReader p_220053_2_, BlockPos p_220053_3_, ISelectionContext p_220053_4_) {
      ...
      return SAPLING_SHAPE.move(vec3d.x, vec3d.y, vec3d.z);
   }

   public void tick(BlockState p_225534_1_, ServerWorld p_225534_2_, BlockPos p_225534_3_, Random p_225534_4_) {
      if (p_225534_4_.nextInt(3) == 0 && p_225534_2_.isEmptyBlock(p_225534_3_.above()) && p_225534_2_.getRawBrightness(p_225534_3_.above(), 0) >= 9) {
         this.growBamboo(p_225534_2_, p_225534_3_);
      }
