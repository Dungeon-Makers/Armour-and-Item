...
public class FrostedIceBlock extends IceBlock {
      ...
      if ((p_225534_4_.nextInt(3) == 0 || this.fewerNeigboursThan(p_225534_2_, p_225534_3_, 4)) && p_225534_2_.getMaxLocalRawBrightness(p_225534_3_) > 11 - p_225534_1_.getValue(AGE) - p_225534_1_.getLightBlock(p_225534_2_, p_225534_3_) && this.slightlyMelt(p_225534_1_, p_225534_2_, p_225534_3_)) {
         try (BlockPos.PooledMutable blockpos$pooledmutable = BlockPos.PooledMutable.func_185346_s()) {
            for(Direction direction : Direction.values()) {
               blockpos$pooledmutable.set(p_225534_3_).move(direction);
               ...
               if (blockstate.getBlock() == this && !this.slightlyMelt(blockstate, p_225534_2_, blockpos$pooledmutable)) {
                  p_225534_2_.getBlockTicks().scheduleTick(blockpos$pooledmutable, this, MathHelper.nextInt(p_225534_4_, 20, 40));
               }
            }
         }
   ...
   private boolean fewerNeigboursThan(IBlockReader p_196456_1_, BlockPos p_196456_2_, int p_196456_3_) {
      ...
      try (BlockPos.PooledMutable blockpos$pooledmutable = BlockPos.PooledMutable.func_185346_s()) {
         for(Direction direction : Direction.values()) {
            blockpos$pooledmutable.set(p_196456_2_).move(direction);
