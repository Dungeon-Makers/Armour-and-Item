...
public class TNTBlock extends Block {
   ...
   public void wasExploded(World p_180652_1_, BlockPos p_180652_2_, Explosion p_180652_3_) {
      if (!p_180652_1_.isClientSide) {
         TNTEntity tntentity = new TNTEntity(p_180652_1_, (double)((float)p_180652_2_.getX() + 0.5F), (double)p_180652_2_.getY(), (double)((float)p_180652_2_.getZ() + 0.5F), p_180652_3_.getSourceMob());
   ...
   public void onProjectileHit(World p_220066_1_, BlockState p_220066_2_, BlockRayTraceResult p_220066_3_, Entity p_220066_4_) {
      if (!p_220066_1_.isClientSide && p_220066_4_ instanceof AbstractArrowEntity) {
