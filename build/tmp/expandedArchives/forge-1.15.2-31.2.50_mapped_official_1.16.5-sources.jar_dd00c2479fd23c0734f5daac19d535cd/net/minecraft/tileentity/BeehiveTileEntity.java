...
public class BeehiveTileEntity extends TileEntity implements ITickableTileEntity {
   ...
   private List<Entity> releaseAllOccupants(BlockState p_226965_1_, BeehiveTileEntity.State p_226965_2_) {
      ...
      this.stored.removeIf((p_226966_4_) -> {
         return this.func_226967_a_(p_226965_1_, p_226966_4_.entityData, list, p_226965_2_);
      });
      return list;
   }
   ...
   public boolean isSedated() {
      return CampfireBlock.func_226914_b_(this.level, this.getBlockPos(), 5);
   }
   ...
   private boolean func_226967_a_(BlockState p_226967_1_, CompoundNBT p_226967_2_, @Nullable List<Entity> p_226967_3_, BeehiveTileEntity.State p_226967_4_) {
      BlockPos blockpos = this.getBlockPos();
      if ((this.level.isNight() || this.level.isRaining()) && p_226967_4_ != BeehiveTileEntity.State.EMERGENCY) {
         return false;
      } else {
         p_226967_2_.remove("Passengers");
         p_226967_2_.remove("Leash");
         p_226967_2_.func_229681_c_("UUID");
         Direction direction = p_226967_1_.getValue(BeehiveBlock.FACING);
         ...
         if (flag && p_226967_4_ != BeehiveTileEntity.State.EMERGENCY) {
            ...
            Entity entity = EntityType.loadEntityRecursive(p_226967_2_, this.level, (p_226960_0_) -> {
               return p_226960_0_;
            });
            if (entity != null) {
               ...
               if (!entity.getType().is(EntityTypeTags.BEEHIVE_INHABITORS)) {
                  ...
                  if (entity instanceof BeeEntity) {
                     ...
                     if (p_226967_4_ == BeehiveTileEntity.State.HONEY_DELIVERED) {
                        ...
                        if (p_226967_1_.getBlock().is(BlockTags.BEEHIVES)) {
                           ...
                           if (i < 5) {
                              ...
                              this.level.setBlockAndUpdate(this.getBlockPos(), p_226967_1_.setValue(BeehiveBlock.HONEY_LEVEL, Integer.valueOf(i + j)));
                           }
                        }
                     }
                  ...
                  this.level.playSound((PlayerEntity)null, (double)blockpos2.getX(), (double)blockpos2.getY(), (double)blockpos2.getZ(), SoundEvents.BEEHIVE_EXIT, SoundCategory.BLOCKS, 1.0F, 1.0F);
   ...
   public void func_145839_a(CompoundNBT p_145839_1_) {
      ...
      this.stored.clear();
      ListNBT listnbt = p_145839_1_.getList("Bees", 10);
      ...
      if (p_145839_1_.contains("FlowerPos")) {
         this.savedFlowerPos = NBTUtil.readBlockPos(p_145839_1_.getCompound("FlowerPos"));
      }
   ...
   public ListNBT writeBees() {
      ...
      for(BeehiveTileEntity.Bee beehivetileentity$bee : this.stored) {
         beehivetileentity$bee.entityData.func_229681_c_("UUID");
         CompoundNBT compoundnbt = new CompoundNBT();
