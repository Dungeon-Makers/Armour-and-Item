...
public class ConduitTileEntity extends TileEntity implements ITickableTileEntity {
   ...
   public void func_145839_a(CompoundNBT p_145839_1_) {
      ...
      if (p_145839_1_.contains("target_uuid")) {
         this.destroyTargetUUID = NBTUtil.loadUUID(p_145839_1_.getCompound("target_uuid"));
      } else {
   ...
   public CompoundNBT save(CompoundNBT p_189515_1_) {
      ...
      if (this.destroyTarget != null) {
         p_189515_1_.put("target_uuid", NBTUtil.func_186862_a(this.destroyTarget.getUUID()));
      }
   ...
   private void applyEffects() {
      ...
      if (!list.isEmpty()) {
         for(PlayerEntity playerentity : list) {
            if (this.worldPosition.closerThan(new BlockPos(playerentity), (double)j) && playerentity.isInWaterOrRain()) {
   ...
   private void animationTick() {
      ...
      Vec3d vec3d = new Vec3d((double)this.worldPosition.getX() + 0.5D, (double)this.worldPosition.getY() + 1.5D + d0, (double)this.worldPosition.getZ() + 0.5D);
      ...
      if (this.destroyTarget != null) {
         Vec3d vec3d2 = new Vec3d(this.destroyTarget.getX(), this.destroyTarget.getEyeY(), this.destroyTarget.getZ());
