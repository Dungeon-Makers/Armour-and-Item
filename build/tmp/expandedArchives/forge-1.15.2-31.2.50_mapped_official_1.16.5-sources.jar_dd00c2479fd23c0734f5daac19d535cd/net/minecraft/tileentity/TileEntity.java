...
public abstract class TileEntity extends net.minecraftforge.common.capabilities.CapabilityProvider<TileEntity> implements net.minecraftforge.common.extensions.IForgeTileEntity {
   ...
   public void func_145839_a(CompoundNBT p_145839_1_) {
      this.worldPosition = new BlockPos(p_145839_1_.getInt("x"), p_145839_1_.getInt("y"), p_145839_1_.getInt("z"));
      if (p_145839_1_.contains("ForgeData")) this.customTileData = p_145839_1_.getCompound("ForgeData");
      if (getCapabilities() != null && p_145839_1_.contains("ForgeCaps")) deserializeCaps(p_145839_1_.getCompound("ForgeCaps"));
   }
   ...
   @Nullable
   public static TileEntity func_203403_c(CompoundNBT p_203403_0_) {
      String s = p_203403_0_.getString("id");
      return Registry.BLOCK_ENTITY_TYPE.func_218349_b(new ResourceLocation(s)).map((p_213134_1_) -> {
         try {
         ...
         try {
            p_213132_2_.func_145839_a(p_203403_0_);
            return p_213132_2_;
         } catch (Throwable throwable) {
   ...
   public double func_145835_a(double p_145835_1_, double p_145835_3_, double p_145835_5_) {
      double d0 = (double)this.worldPosition.getX() + 0.5D - p_145835_1_;
      double d1 = (double)this.worldPosition.getY() + 0.5D - p_145835_3_;
      double d2 = (double)this.worldPosition.getZ() + 0.5D - p_145835_5_;
