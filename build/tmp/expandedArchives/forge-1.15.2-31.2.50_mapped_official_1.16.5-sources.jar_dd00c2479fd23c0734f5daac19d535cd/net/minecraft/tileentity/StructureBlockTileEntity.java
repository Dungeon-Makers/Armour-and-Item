...
public class StructureBlockTileEntity extends TileEntity {
   ...
   public void func_145839_a(CompoundNBT p_145839_1_) {
      ...
      this.setStructureName(p_145839_1_.getString("name"));
      this.author = p_145839_1_.getString("author");
      this.metaData = p_145839_1_.getString("metadata");
      int i = MathHelper.clamp(p_145839_1_.getInt("posX"), -32, 32);
      int j = MathHelper.clamp(p_145839_1_.getInt("posY"), -32, 32);
      int k = MathHelper.clamp(p_145839_1_.getInt("posZ"), -32, 32);
      this.structurePos = new BlockPos(i, j, k);
      int l = MathHelper.clamp(p_145839_1_.getInt("sizeX"), 0, 32);
      int i1 = MathHelper.clamp(p_145839_1_.getInt("sizeY"), 0, 32);
      int j1 = MathHelper.clamp(p_145839_1_.getInt("sizeZ"), 0, 32);
   ...
   public boolean func_189714_c(boolean p_189714_1_) {
      if (this.mode == StructureMode.LOAD && !this.level.isClientSide && this.structureName != null) {
         ...
         return template == null ? false : this.func_227013_a_(p_189714_1_, template);
      } else {
         return false;
      }
   }
   ...
   public boolean func_227013_a_(boolean p_227013_1_, Template p_227013_2_) {
      ...
      if (p_227013_1_ && !flag) {
         ...
         p_227013_2_.func_186260_a(this.level, blockpos2, placementsettings);
         return true;
      }
   }
