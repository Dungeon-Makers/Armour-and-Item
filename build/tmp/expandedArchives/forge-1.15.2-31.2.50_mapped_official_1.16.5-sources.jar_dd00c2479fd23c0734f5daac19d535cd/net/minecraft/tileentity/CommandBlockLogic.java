...
public abstract class CommandBlockLogic implements ICommandSource {
   ...
   public void load(CompoundNBT p_145759_1_) {
      ...
      if (p_145759_1_.contains("CustomName", 8)) {
         this.setName(ITextComponent.Serializer.func_150699_a(p_145759_1_.getString("CustomName")));
      }
      ...
      if (p_145759_1_.contains("LastOutput", 8) && this.trackOutput) {
         try {
            this.lastOutput = ITextComponent.Serializer.func_150699_a(p_145759_1_.getString("LastOutput"));
   ...
   public boolean performCommand(World p_145755_1_) {
      if (!p_145755_1_.isClientSide && p_145755_1_.getGameTime() != this.lastExecution) {
         if ("Searge".equalsIgnoreCase(this.command)) {
            ...
            if (minecraftserver != null && minecraftserver.func_175578_N() && minecraftserver.isCommandBlockEnabled() && !StringUtils.isNullOrEmpty(this.command)) {
               try {
                  this.lastOutput = null;
   ...
   public void sendMessage(ITextComponent p_145747_1_) {
      if (this.trackOutput) {
         this.lastOutput = (new StringTextComponent("[" + TIME_FORMAT.format(new Date()) + "] ")).func_150257_a(p_145747_1_);
         this.onUpdated();
      }
   ...
   public boolean usedBy(PlayerEntity p_175574_1_) {
