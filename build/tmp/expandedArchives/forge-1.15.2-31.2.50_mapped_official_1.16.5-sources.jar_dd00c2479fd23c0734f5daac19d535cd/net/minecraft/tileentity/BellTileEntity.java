...
public class BellTileEntity extends TileEntity implements ITickableTileEntity {
   ...
   private void showBellParticles(World p_222826_1_) {
      if (p_222826_1_.isClientSide) {
         ...
         this.nearbyEntities.stream().filter(this::isRaiderWithinRange).forEach((p_222831_4_) -> {
            float f = 1.0F;
            float f1 = MathHelper.sqrt((p_222831_4_.getX() - (double)blockpos.getX()) * (p_222831_4_.getX() - (double)blockpos.getX()) + (p_222831_4_.getZ() - (double)blockpos.getZ()) * (p_222831_4_.getZ() - (double)blockpos.getZ()));
            double d0 = (double)((float)blockpos.getX() + 0.5F) + (double)(1.0F / f1) * (p_222831_4_.getX() - (double)blockpos.getX());
            double d1 = (double)((float)blockpos.getZ() + 0.5F) + (double)(1.0F / f1) * (p_222831_4_.getZ() - (double)blockpos.getZ());
