...
public class CampfireTileEntity extends TileEntity implements IClearable, ITickableTileEntity {
   ...
   public void func_145839_a(CompoundNBT p_145839_1_) {
      ...
      if (p_145839_1_.contains("CookingTimes", 11)) {
         int[] aint = p_145839_1_.getIntArray("CookingTimes");
         System.arraycopy(aint, 0, this.cookingProgress, 0, Math.min(this.cookingTime.length, aint.length));
      }

      if (p_145839_1_.contains("CookingTotalTimes", 11)) {
         int[] aint1 = p_145839_1_.getIntArray("CookingTotalTimes");
   ...
   public void dowse() {
      if (!this.getLevel().isClientSide) {
         InventoryHelper.dropContents(this.getLevel(), this.getBlockPos(), this.getItems());
      }
