...
public abstract class LockableLootTileEntity extends LockableTileEntity {
   ...
   public void unpackLootTable(@Nullable PlayerEntity p_184281_1_) {
      if (this.lootTable != null && this.level.getServer() != null) {
         ...
         this.lootTable = null;
         LootContext.Builder lootcontext$builder = (new LootContext.Builder((ServerWorld)this.level)).withParameter(LootParameters.field_216286_f, new BlockPos(this.worldPosition)).withOptionalRandomSeed(this.lootTableSeed);
         if (p_184281_1_ != null) {
