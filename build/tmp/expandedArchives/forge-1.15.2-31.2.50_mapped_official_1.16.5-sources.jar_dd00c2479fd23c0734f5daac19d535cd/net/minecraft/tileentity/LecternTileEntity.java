...
public class LecternTileEntity extends TileEntity implements IClearable, INamedContainerProvider {
   ...
   private CommandSource createCommandSourceStack(@Nullable PlayerEntity p_214039_1_) {
      ...
      Vec3d vec3d = new Vec3d((double)this.worldPosition.getX() + 0.5D, (double)this.worldPosition.getY() + 0.5D, (double)this.worldPosition.getZ() + 0.5D);
      return new CommandSource(ICommandSource.NULL, vec3d, Vec2f.ZERO, (ServerWorld)this.level, 2, s, itextcomponent, this.level.getServer(), p_214039_1_);
   }
   ...
   public void func_145839_a(CompoundNBT p_145839_1_) {
      ...
      if (p_145839_1_.contains("Book", 10)) {
         this.book = this.resolveBook(ItemStack.of(p_145839_1_.getCompound("Book")), (PlayerEntity)null);
      } else {
         this.book = ItemStack.EMPTY;
      }

      this.pageCount = WrittenBookItem.getPageCount(this.book);
      this.page = MathHelper.clamp(p_145839_1_.getInt("Page"), 0, this.pageCount - 1);
   }
