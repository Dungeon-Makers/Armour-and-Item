...
public class EnchantingTableTileEntity extends TileEntity implements INameable, ITickableTileEntity {
   ...
   public void tick() {
      ...
      this.oRot = this.rot;
      PlayerEntity playerentity = this.level.getNearestPlayer((double)((float)this.worldPosition.getX() + 0.5F), (double)((float)this.worldPosition.getY() + 0.5F), (double)((float)this.worldPosition.getZ() + 0.5F), 3.0D, false);
