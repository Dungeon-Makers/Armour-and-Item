...
public class ParticleTypes {
   ...
   private static BasicParticleType register(String p_218415_0_, boolean p_218415_1_) {
      return (BasicParticleType)Registry.<ParticleType<? extends IParticleData>>register(Registry.PARTICLE_TYPE, p_218415_0_, new BasicParticleType(p_218415_1_));
   }
   ...
   private static <T extends IParticleData> ParticleType<T> register(String p_218416_0_, IParticleData.IDeserializer<T> p_218416_1_) {
      return Registry.register(Registry.PARTICLE_TYPE, p_218416_0_, new ParticleType<>(false, p_218416_1_));
   }
}
