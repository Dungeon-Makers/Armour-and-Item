...
public class VillageSiege {
   ...
   public int func_225477_a(ServerWorld p_225477_1_, boolean p_225477_2_, boolean p_225477_3_) {
      if (!p_225477_1_.isDay() && p_225477_2_) {
         float f = p_225477_1_.func_72826_c(0.0F);
         if ((double)f == 0.5D) {
            this.siegeState = p_225477_1_.random.nextInt(10) == 0 ? VillageSiege.State.SIEGE_TONIGHT : VillageSiege.State.SIEGE_DONE;
         }
         ...
         if (this.siegeState == VillageSiege.State.SIEGE_DONE) {
            ...
            if (!this.hasSetupSiege) {
               if (!this.tryToSetupSiege(p_225477_1_)) {
                  return 0;
               }
   ...
   private void trySpawn(ServerWorld p_75530_1_) {
      ...
      if (vec3d != null) {
         ...
         try {
            ...
            zombieentity.finalizeSpawn(p_75530_1_, p_75530_1_.getCurrentDifficultyAt(new BlockPos(zombieentity)), SpawnReason.EVENT, (ILivingEntityData)null, (CompoundNBT)null);
         } catch (Exception exception) {
            exception.printStackTrace();
            return;
         }

         zombieentity.moveTo(vec3d.x, vec3d.y, vec3d.z, p_75530_1_.random.nextFloat() * 360.0F, 0.0F);
         p_75530_1_.addFreshEntity(zombieentity);
      }
   }
