...
public class PointOfInterestManager extends RegionSectionCache<PointOfInterestData> {
   ...
   public void add(BlockPos p_219135_1_, PointOfInterestType p_219135_2_) {
      this.func_219110_e(SectionPos.of(p_219135_1_).asLong()).add(p_219135_1_, p_219135_2_);
   }

   public void remove(BlockPos p_219140_1_) {
      this.func_219110_e(SectionPos.of(p_219140_1_).asLong()).remove(p_219140_1_);
   }
   ...
   public Stream<PointOfInterest> getInSquare(Predicate<PointOfInterestType> p_226353_1_, BlockPos p_226353_2_, int p_226353_3_, PointOfInterestManager.Status p_226353_4_) {
      return ChunkPos.rangeClosed(new ChunkPos(p_226353_2_), Math.floorDiv(p_226353_3_, 16)).flatMap((p_226350_3_) -> {
   ...
   public Stream<PointOfInterest> getInChunk(Predicate<PointOfInterestType> p_219137_1_, ChunkPos p_219137_2_, PointOfInterestManager.Status p_219137_3_) {
      return IntStream.range(0, 16).boxed().flatMap((p_219149_4_) -> {
         return this.func_219136_a(p_219137_1_, SectionPos.of(p_219137_2_, p_219149_4_).asLong(), p_219137_3_);
      });
   }
   ...
   private Stream<PointOfInterest> func_219136_a(Predicate<PointOfInterestType> p_219136_1_, long p_219136_2_, PointOfInterestManager.Status p_219136_4_) {
      return this.getOrLoad(p_219136_2_).map((p_219159_2_) -> {
   ...
   public Optional<BlockPos> func_219147_b(Predicate<PointOfInterestType> p_219147_1_, Predicate<BlockPos> p_219147_2_, BlockPos p_219147_3_, int p_219147_4_, PointOfInterestManager.Status p_219147_5_) {
      return this.getInRange(p_219147_1_, p_219147_3_, p_219147_4_, p_219147_5_).map(PointOfInterest::getPos).sorted(Comparator.comparingDouble((p_219160_1_) -> {
         return p_219160_1_.distSqr(p_219147_3_);
   ...
   public boolean release(BlockPos p_219142_1_) {
      return this.func_219110_e(SectionPos.of(p_219142_1_).asLong()).release(p_219142_1_);
   }

   public boolean exists(BlockPos p_219138_1_, Predicate<PointOfInterestType> p_219138_2_) {
      return this.getOrLoad(SectionPos.of(p_219138_1_).asLong()).map((p_219133_2_) -> {
         return p_219133_2_.exists(p_219138_1_, p_219138_2_);
      }).orElse(false);
   }

   public Optional<PointOfInterestType> getType(BlockPos p_219148_1_) {
      PointOfInterestData pointofinterestdata = this.func_219110_e(SectionPos.of(p_219148_1_).asLong());
   ...
   private boolean isVillageCenter(long p_219154_1_) {
      ...
      return optional == null ? false : optional.map((p_223144_0_) -> {
         return p_223144_0_.getRecords(PointOfInterestType.ALL, PointOfInterestManager.Status.IS_OCCUPIED).count() > 0L;
      }).orElse(false);
   }
   ...
   public void checkConsistencyWithBlocks(ChunkPos p_219139_1_, ChunkSection p_219139_2_) {
      ...
      Util.ifElse(this.getOrLoad(sectionpos.asLong()), (p_219130_3_) -> {
         p_219130_3_.refresh((p_219141_3_) -> {
            if (mayHavePoi(p_219139_2_)) {
               this.updateFromSection(p_219139_2_, sectionpos, p_219141_3_);
            }
   ...
   private static boolean mayHavePoi(ChunkSection p_219151_0_) {
      return PointOfInterestType.func_221038_e().anyMatch(p_219151_0_::func_222636_a);
   }
   ...
   private void updateFromSection(ChunkSection p_219132_1_, SectionPos p_219132_2_, BiConsumer<BlockPos, PointOfInterestType> p_219132_3_) {
      p_219132_2_.blocksInside().forEach((p_219143_2_) -> {
         BlockState blockstate = p_219132_1_.getBlockState(SectionPos.sectionRelative(p_219143_2_.getX()), SectionPos.sectionRelative(p_219143_2_.getY()), SectionPos.sectionRelative(p_219143_2_.getZ()));
   ...
   public void ensureLoadedAndValid(IWorldReader p_226347_1_, BlockPos p_226347_2_, int p_226347_3_) {
      SectionPos.aroundChunk(new ChunkPos(p_226347_2_), Math.floorDiv(p_226347_3_, 16)).map((p_226354_1_) -> {
         return Pair.of(p_226354_1_, this.getOrLoad(p_226354_1_.asLong()));
      }).filter((p_226352_0_) -> {
         return !p_226352_0_.getSecond().map(PointOfInterestData::isValid).orElse(false);
      }).map((p_226348_0_) -> {
         return p_226348_0_.getFirst().chunk();
      }).filter((p_226351_1_) -> {
         return this.loadedChunks.add(p_226351_1_.toLong());
      }).forEach((p_226346_1_) -> {
