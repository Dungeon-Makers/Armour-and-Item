...
public class StatePropertiesPredicate {
   ...
   public <S extends IStateHolder<S>> boolean matches(StateContainer<?, S> p_227182_1_, S p_227182_2_) {
   ...
   public static class Builder {
      ...
      public StatePropertiesPredicate.Builder hasProperty(IProperty<?> p_227194_1_, String p_227194_2_) {
         this.matchers.add(new StatePropertiesPredicate.ExactMatcher(p_227194_1_.getName(), p_227194_2_));
         return this;
      }

      public StatePropertiesPredicate.Builder hasProperty(IProperty<Integer> p_227192_1_, int p_227192_2_) {
         return this.hasProperty(p_227192_1_, Integer.toString(p_227192_2_));
      }

      public StatePropertiesPredicate.Builder hasProperty(IProperty<Boolean> p_227195_1_, boolean p_227195_2_) {
         return this.hasProperty(p_227195_1_, Boolean.toString(p_227195_2_));
      }

      public <T extends Comparable<T> & IStringSerializable> StatePropertiesPredicate.Builder hasProperty(IProperty<T> p_227193_1_, T p_227193_2_) {
         return this.hasProperty(p_227193_1_, ((IStringSerializable)p_227193_2_).getSerializedName());
      }
   ...
   static class ExactMatcher extends StatePropertiesPredicate.Matcher {
      ...
      protected <T extends Comparable<T>> boolean match(IStateHolder<?> p_225554_1_, IProperty<T> p_225554_2_) {
   ...
   abstract static class Matcher {
      ...
      public <S extends IStateHolder<S>> boolean match(StateContainer<?, S> p_227199_1_, S p_227199_2_) {
         IProperty<?> iproperty = p_227199_1_.getProperty(this.name);
         return iproperty == null ? false : this.match(p_227199_2_, iproperty);
      }

      protected abstract <T extends Comparable<T>> boolean match(IStateHolder<?> p_225554_1_, IProperty<T> p_225554_2_);
      ...
      public void checkState(StateContainer<?, ?> p_227200_1_, Consumer<String> p_227200_2_) {
         IProperty<?> iproperty = p_227200_1_.getProperty(this.name);
         if (iproperty == null) {
