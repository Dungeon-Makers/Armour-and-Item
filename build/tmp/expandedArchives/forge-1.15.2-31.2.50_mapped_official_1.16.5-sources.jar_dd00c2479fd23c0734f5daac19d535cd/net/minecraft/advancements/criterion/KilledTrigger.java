...
public class KilledTrigger extends AbstractCriterionTrigger<KilledTrigger.Instance> {
   ...
   public KilledTrigger.Instance func_192166_a(JsonObject p_192166_1_, JsonDeserializationContext p_192166_2_) {
      return new KilledTrigger.Instance(this.id, EntityPredicate.fromJson(p_192166_1_.get("entity")), DamageSourcePredicate.fromJson(p_192166_1_.get("killing_blow")));
   }
   ...
   public void trigger(ServerPlayerEntity p_192211_1_, Entity p_192211_2_, DamageSource p_192211_3_) {
      this.func_227070_a_(p_192211_1_.getAdvancements(), (p_226846_3_) -> {
         return p_226846_3_.func_192270_a(p_192211_1_, p_192211_2_, p_192211_3_);
      });
   }
   ...
   public static class Instance extends CriterionInstance {
      ...
      public Instance(ResourceLocation p_i47454_1_, EntityPredicate p_i47454_2_, DamageSourcePredicate p_i47454_3_) {
         super(p_i47454_1_);
         this.entityPredicate = p_i47454_2_;
      ...
      public boolean func_192270_a(ServerPlayerEntity p_192270_1_, Entity p_192270_2_, DamageSource p_192270_3_) {
         return !this.killingBlow.matches(p_192270_1_, p_192270_3_) ? false : this.entityPredicate.matches(p_192270_1_, p_192270_2_);
      }
