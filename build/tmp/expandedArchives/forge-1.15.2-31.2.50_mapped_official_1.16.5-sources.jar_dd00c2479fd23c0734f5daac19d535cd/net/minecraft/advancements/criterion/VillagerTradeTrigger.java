...
public class VillagerTradeTrigger extends AbstractCriterionTrigger<VillagerTradeTrigger.Instance> {
   ...
   public VillagerTradeTrigger.Instance func_192166_a(JsonObject p_192166_1_, JsonDeserializationContext p_192166_2_) {
      EntityPredicate entitypredicate = EntityPredicate.fromJson(p_192166_1_.get("villager"));
   ...
   public static class Instance extends CriterionInstance {
      ...
      public boolean func_215125_a(ServerPlayerEntity p_215125_1_, AbstractVillagerEntity p_215125_2_, ItemStack p_215125_3_) {
         if (!this.villager.matches(p_215125_1_, p_215125_2_)) {
            return false;
         } else {
            return this.item.matches(p_215125_3_);
         }
      }
