...
public class BlockPredicate {
   public static final BlockPredicate ANY = new BlockPredicate((Tag<Block>)null, (Block)null, StatePropertiesPredicate.ANY, NBTPredicate.ANY);
   @Nullable
   ...
   public boolean matches(ServerWorld p_226238_1_, BlockPos p_226238_2_) {
      if (this == ANY) {
         ...
         if (this.tag != null && !this.tag.func_199685_a_(block)) {
            return false;
   ...
   public static BlockPredicate fromJson(@Nullable JsonElement p_226237_0_) {
      if (p_226237_0_ != null && !p_226237_0_.isJsonNull()) {
         ...
         if (jsonobject.has("tag")) {
            ...
            tag = BlockTags.getAllTags().getTag(resourcelocation1);
            if (tag == null) {
   ...
   public static class Builder {
      ...
      public BlockPredicate.Builder of(Tag<Block> p_226244_1_) {
