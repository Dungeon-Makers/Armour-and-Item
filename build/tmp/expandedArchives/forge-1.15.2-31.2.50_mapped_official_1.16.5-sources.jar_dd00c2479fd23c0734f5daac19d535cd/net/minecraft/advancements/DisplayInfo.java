...
public class DisplayInfo {
   ...
   public static DisplayInfo fromJson(JsonObject p_192294_0_, JsonDeserializationContext p_192294_1_) {
      ITextComponent itextcomponent = JSONUtils.getAsObject(p_192294_0_, "title", p_192294_1_, ITextComponent.class);
      ITextComponent itextcomponent1 = JSONUtils.getAsObject(p_192294_0_, "description", p_192294_1_, ITextComponent.class);
