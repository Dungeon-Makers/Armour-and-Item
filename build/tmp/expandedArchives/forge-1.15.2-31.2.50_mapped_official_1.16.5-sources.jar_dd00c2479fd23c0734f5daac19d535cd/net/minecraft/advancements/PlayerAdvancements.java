...
public class PlayerAdvancements {
   ...
   private void func_192751_c() {
      for(Advancement advancement : this.field_192756_d.getAdvancements().getAllAdvancements()) {
   ...
   private void func_192740_f() {
      if (this.file.isFile()) {
         try (JsonReader jsonreader = new JsonReader(new StringReader(Files.toString(this.file, StandardCharsets.UTF_8)))) {
            ...
            dynamic = this.field_192756_d.getFixerUpper().update(DefaultTypeReferences.ADVANCEMENTS.getType(), dynamic, dynamic.get("DataVersion").asInt(0), SharedConstants.getCurrentVersion().getWorldVersion());
            ...
            for(Entry<ResourceLocation, AdvancementProgress> entry : stream.collect(Collectors.toList())) {
               Advancement advancement = this.field_192756_d.getAdvancements().getAdvancement(entry.getKey());
               if (advancement == null) {
      ...
      this.func_192748_e();
      if (net.minecraftforge.common.ForgeConfig.SERVER.fixAdvancementLoading.get()) net.minecraftforge.common.AdvancementLoadFix.loadVisibility(this, this.visible, this.visibilityChanged, this.advancements, this.progressChanged, this::shouldBeVisible); else
      ...
      if (advancementprogress.grantProgress(p_192750_2_)) {
         ...
         if (!flag1 && advancementprogress.isDone()) {
            ...
            if (p_192750_1_.getDisplay() != null && p_192750_1_.getDisplay().shouldAnnounceChat() && this.player.level.getGameRules().getBoolean(GameRules.RULE_ANNOUNCE_ADVANCEMENTS)) {
               this.field_192756_d.getPlayerList().func_148539_a(new TranslationTextComponent("chat.type.advancement." + p_192750_1_.getDisplay().getFrame().getName(), this.player.getDisplayName(), p_192750_1_.getChatComponent()));
            }
