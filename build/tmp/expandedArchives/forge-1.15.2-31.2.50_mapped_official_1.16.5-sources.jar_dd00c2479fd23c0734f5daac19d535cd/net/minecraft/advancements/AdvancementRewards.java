...
public class AdvancementRewards {
   ...
   public void grant(ServerPlayerEntity p_192113_1_) {
      ...
      LootContext lootcontext = (new LootContext.Builder(p_192113_1_.getLevel())).withParameter(LootParameters.THIS_ENTITY, p_192113_1_).withParameter(LootParameters.field_216286_f, new BlockPos(p_192113_1_)).withRandom(p_192113_1_.getRandom()).withLuck(p_192113_1_.getLuck()).create(LootParameterSets.ADVANCEMENT_REWARD); // FORGE: luck to LootContext
      boolean flag = false;
   ...
   public static class Deserializer implements JsonDeserializer<AdvancementRewards> {
      public AdvancementRewards deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException {
         JsonObject jsonobject = JSONUtils.convertToJsonObject(p_deserialize_1_, "rewards");
         int i = JSONUtils.getAsInt(jsonobject, "experience", 0);
         JsonArray jsonarray = JSONUtils.getAsJsonArray(jsonobject, "loot", new JsonArray());
         ...
         JsonArray jsonarray1 = JSONUtils.getAsJsonArray(jsonobject, "recipes", new JsonArray());
         ...
         if (jsonobject.has("function")) {
            functionobject$cacheablefunction = new FunctionObject.CacheableFunction(new ResourceLocation(JSONUtils.getAsString(jsonobject, "function")));
         } else {
