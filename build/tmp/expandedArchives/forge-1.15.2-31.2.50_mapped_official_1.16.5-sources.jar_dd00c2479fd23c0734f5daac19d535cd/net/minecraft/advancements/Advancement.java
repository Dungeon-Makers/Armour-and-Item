...
public class Advancement {
   ...
   public Advancement(ResourceLocation p_i47472_1_, @Nullable Advancement p_i47472_2_, @Nullable DisplayInfo p_i47472_3_, AdvancementRewards p_i47472_4_, Map<String, Criterion> p_i47472_5_, String[][] p_i47472_6_) {
      ...
      if (p_i47472_3_ == null) {
         ...
         ITextComponent itextcomponent1 = itextcomponent.func_212638_h().func_211708_a(textformatting).func_150258_a("\n").func_150257_a(p_i47472_3_.getDescription());
         ITextComponent itextcomponent2 = itextcomponent.func_212638_h().func_211710_a((p_211567_1_) -> {
            p_211567_1_.func_150209_a(new HoverEvent(HoverEvent.Action.SHOW_TEXT, itextcomponent1));
         });
         this.chatComponent = (new StringTextComponent("[")).func_150257_a(itextcomponent2).func_150258_a("]").func_211708_a(textformatting);
      }
   ...
   public static class Builder {
      ...
      public static Advancement.Builder func_192059_a(JsonObject p_192059_0_, JsonDeserializationContext p_192059_1_) {
         ResourceLocation resourcelocation = p_192059_0_.has("parent") ? new ResourceLocation(JSONUtils.getAsString(p_192059_0_, "parent")) : null;
         DisplayInfo displayinfo = p_192059_0_.has("display") ? DisplayInfo.fromJson(JSONUtils.getAsJsonObject(p_192059_0_, "display"), p_192059_1_) : null;
         AdvancementRewards advancementrewards = JSONUtils.getAsObject(p_192059_0_, "rewards", AdvancementRewards.EMPTY, p_192059_1_, AdvancementRewards.class);
         Map<String, Criterion> map = Criterion.func_192144_b(JSONUtils.getAsJsonObject(p_192059_0_, "criteria"), p_192059_1_);
         if (map.isEmpty()) {
            throw new JsonSyntaxException("Advancement criteria cannot be empty");
         } else {
            JsonArray jsonarray = JSONUtils.getAsJsonArray(p_192059_0_, "requirements", new JsonArray());
