...
public class ArmorStandEntity extends LivingEntity {
   ...
   private void brokenByAnything(DamageSource p_213816_1_) {
      ...
      for(int j = 0; j < this.armorItems.size(); ++j) {
         ...
         if (!itemstack1.isEmpty()) {
            Block.popResource(this.level, (new BlockPos(this)).above(), itemstack1);
   ...
   public boolean skipAttackInteraction(Entity p_85031_1_) {
      return p_85031_1_ instanceof PlayerEntity && !this.level.mayInteract((PlayerEntity)p_85031_1_, new BlockPos(this));
   }
