...
public class EnderCrystalEntity extends Entity {
   ...
   public void tick() {
      ...
      if (!this.level.isClientSide) {
         ...
         if (this.level.dimension instanceof EndDimension && this.level.getBlockState(blockpos).isAir()) {
   ...
   private void onDestroyedBy(DamageSource p_184519_1_) {
      if (this.level.dimension instanceof EndDimension) {
         EndDimension enddimension = (EndDimension)this.level.dimension;
         DragonFightManager dragonfightmanager = enddimension.func_186063_s();
