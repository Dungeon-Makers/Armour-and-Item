...
public class ItemEntity extends Entity {
   ...
   public final float bobOffs = (float)(Math.random() * Math.PI * 2.0D);
   ...
   public void tick() {
      ...
      if (this.getItem().isEmpty()) {
         ...
         this.hasImpulse |= this.func_70072_I();
         if (!this.level.isClientSide) {
   ...
   public void addAdditionalSaveData(CompoundNBT p_213281_1_) {
      ...
      if (this.getThrower() != null) {
         p_213281_1_.put("Thrower", NBTUtil.func_186862_a(this.getThrower()));
      }

      if (this.getOwner() != null) {
         p_213281_1_.put("Owner", NBTUtil.func_186862_a(this.getOwner()));
      }
   ...
   public void readAdditionalSaveData(CompoundNBT p_70037_1_) {
      ...
      if (p_70037_1_.contains("Owner", 10)) {
         this.owner = NBTUtil.loadUUID(p_70037_1_.getCompound("Owner"));
      }

      if (p_70037_1_.contains("Thrower", 10)) {
         this.thrower = NBTUtil.loadUUID(p_70037_1_.getCompound("Thrower"));
      }
