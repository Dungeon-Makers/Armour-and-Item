...
public abstract class ContainerMinecartEntity extends AbstractMinecartEntity implements IInventory, INamedContainerProvider {
   ...
   public void unpackLootTable(@Nullable PlayerEntity p_184288_1_) {
      if (this.lootTable != null && this.level.getServer() != null) {
         ...
         this.lootTable = null;
         LootContext.Builder lootcontext$builder = (new LootContext.Builder((ServerWorld)this.level)).withParameter(LootParameters.field_216286_f, new BlockPos(this)).withOptionalRandomSeed(this.lootTableSeed);
