...
public class BoatEntity extends Entity {
   ...
   public boolean hurt(DamageSource p_70097_1_, float p_70097_2_) {
      if (this.isInvulnerableTo(p_70097_1_)) {
         ...
         if (p_70097_1_ instanceof IndirectEntityDamageSource && p_70097_1_.getEntity() != null && this.hasPassenger(p_70097_1_.getEntity())) {
            return false;
         } else {
   ...
   public boolean interact(PlayerEntity p_184230_1_, Hand p_184230_2_) {
      if (p_184230_1_.isSecondaryUseActive()) {
         ...
         return !this.level.isClientSide && this.outOfControlTicks < 60.0F ? p_184230_1_.startRiding(this) : false;
      }
   }
   ...
   protected void checkFallDamage(double p_184231_1_, boolean p_184231_3_, BlockState p_184231_4_, BlockPos p_184231_5_) {
      ...
      if (!this.isPassenger()) {
         if (p_184231_3_) {
            ...
            this.fallDistance = 0.0F;
         } else if (!this.level.getFluidState((new BlockPos(this)).below()).is(FluidTags.WATER) && p_184231_1_ < 0.0D) {
