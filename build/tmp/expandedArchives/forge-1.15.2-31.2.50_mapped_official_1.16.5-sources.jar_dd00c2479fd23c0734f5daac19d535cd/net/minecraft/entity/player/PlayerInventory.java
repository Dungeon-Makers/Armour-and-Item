...
public class PlayerInventory implements IInventory, INameable {
   ...
   public int func_195408_a(Predicate<ItemStack> p_195408_1_, int p_195408_2_) {
      int i = 0;
      ...
      if (!this.carried.isEmpty() && p_195408_1_.test(this.carried)) {
         int l = p_195408_2_ <= 0 ? this.carried.getCount() : Math.min(p_195408_2_ - i, this.carried.getCount());
         i += l;
         if (p_195408_2_ != 0) {
            this.carried.shrink(l);
   ...
   public boolean func_184432_b(BlockState p_184432_1_) {
      return this.getItem(this.selected).isCorrectToolForDrops(p_184432_1_);
   }
      ...
      if (!(p_70449_1_ <= 0.0F)) {
         ...
         for(int i = 0; i < this.armor.size(); ++i) {
            ...
            if (itemstack.getItem() instanceof ArmorItem) {
               int j = i;
               itemstack.hurtAndBreak((int)p_70449_1_, this.player, (p_214023_1_) -> {
   ...
   @OnlyIn(Dist.CLIENT)
   public boolean contains(Tag<Item> p_199712_1_) {
      label23:
      for(List<ItemStack> list : this.compartments) {
         Iterator iterator = list.iterator();
         ...
         while(true) {
            ...
            ItemStack itemstack = (ItemStack)iterator.next();
            if (!itemstack.isEmpty() && p_199712_1_.func_199685_a_(itemstack.getItem())) {
               break;
            }
         }
