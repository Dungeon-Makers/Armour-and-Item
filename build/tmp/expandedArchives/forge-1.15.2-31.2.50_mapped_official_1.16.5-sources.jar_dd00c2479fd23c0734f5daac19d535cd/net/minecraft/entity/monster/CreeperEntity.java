...
public class CreeperEntity extends MonsterEntity implements IChargeableMob {
   ...
   protected boolean func_184645_a(PlayerEntity p_184645_1_, Hand p_184645_2_) {
      ...
      if (itemstack.getItem() == Items.FLINT_AND_STEEL) {
         this.level.playSound(p_184645_1_, this.getX(), this.getY(), this.getZ(), SoundEvents.FLINTANDSTEEL_USE, this.getSoundSource(), 1.0F, this.random.nextFloat() * 0.4F + 0.8F);
         if (!this.level.isClientSide) {
            this.ignite();
            itemstack.hurtAndBreak(1, p_184645_1_, (p_213625_1_) -> {
               p_213625_1_.broadcastBreakEvent(p_184645_2_);
            });
         }
