...
public class WitchEntity extends AbstractRaiderEntity implements IRangedAttackMob {
   ...
   private static final AttributeModifier SPEED_MODIFIER_DRINKING = (new AttributeModifier(SPEED_MODIFIER_DRINKING_UUID, "Drinking speed penalty", -0.25D, AttributeModifier.Operation.ADDITION)).func_111168_a(false);
   ...
   protected void func_110147_ax() {
      ...
      this.getAttribute(SharedMonsterAttributes.field_111267_a).setBaseValue(26.0D);
      ...
      if (!this.level.isClientSide && this.isAlive()) {
         ...
         if (this.isDrinkingPotion()) {
            if (this.usingTime-- <= 0) {
               ...
               this.getAttribute(SharedMonsterAttributes.field_111263_d).removeModifier(SPEED_MODIFIER_DRINKING);
            }
         } else {
            Potion potion = null;
            ...
            if (potion != null) {
               ...
               iattributeinstance.removeModifier(SPEED_MODIFIER_DRINKING);
               iattributeinstance.addModifier(SPEED_MODIFIER_DRINKING);
            }
         }
   ...
   public void performRangedAttack(LivingEntity p_82196_1_, float p_82196_2_) {
      if (!this.isDrinkingPotion()) {
         Vec3d vec3d = p_82196_1_.getDeltaMovement();
         double d0 = p_82196_1_.getX() + vec3d.x - this.getX();
         double d1 = p_82196_1_.getEyeY() - (double)1.1F - this.getY();
         double d2 = p_82196_1_.getZ() + vec3d.z - this.getZ();
         ...
         potionentity.func_184541_a(PotionUtils.setPotion(new ItemStack(Items.SPLASH_POTION), potion));
