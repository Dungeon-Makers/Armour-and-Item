...
public abstract class AbstractRaiderEntity extends PatrollerEntity {
         ...
         if (this.canJoinRaid()) {
            if (raid == null) {
               if (this.level.getGameTime() % 20L == 0L) {
                  Raid raid1 = ((ServerWorld)this.level).getRaidAt(new BlockPos(this));
   ...
   public void die(DamageSource p_70645_1_) {
      if (this.level instanceof ServerWorld) {
         ...
         if (this.isPatrolLeader() && raid == null && ((ServerWorld)this.level).getRaidAt(new BlockPos(this)) == null) {
   ...
   static class InvadeHomeGoal extends Goal {
      ...
      public void tick() {
         if (this.raider.getNavigation().isDone()) {
            Vec3d vec3d = new Vec3d(this.poiPos);
            Vec3d vec3d1 = RandomPositionGenerator.getPosTowards(this.raider, 16, 7, vec3d, (double)((float)Math.PI / 10F));
            if (vec3d1 == null) {
               vec3d1 = RandomPositionGenerator.getPosTowards(this.raider, 8, 7, vec3d);
            }
