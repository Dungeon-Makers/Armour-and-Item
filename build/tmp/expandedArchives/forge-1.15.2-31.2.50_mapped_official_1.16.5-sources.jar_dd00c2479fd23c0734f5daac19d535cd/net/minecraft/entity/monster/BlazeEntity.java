...
public class BlazeEntity extends MonsterEntity {
   ...
   static class FireballAttackGoal extends Goal {
            ...
            if (d0 < 4.0D) {
               ...
               if (this.attackTime <= 0) {
                  ...
                  if (this.attackStep > 1) {
                     ...
                     this.blaze.level.levelEvent((PlayerEntity)null, 1018, new BlockPos(this.blaze), 0);
      ...
      private double getFollowDistance() {
         return this.blaze.getAttribute(SharedMonsterAttributes.field_111265_b).getValue();
      }
   }
}