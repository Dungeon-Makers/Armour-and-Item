...
public class VindicatorEntity extends AbstractIllagerEntity {
   ...
   protected void customServerAiStep() {
      if (!this.isNoAi()) {
         PathNavigator pathnavigator = this.getNavigation();
         if (pathnavigator instanceof GroundPathNavigator) {
            boolean flag = ((ServerWorld)this.level).isRaided(new BlockPos(this));
            ((GroundPathNavigator)pathnavigator).setCanOpenDoors(flag);
         }
      }
