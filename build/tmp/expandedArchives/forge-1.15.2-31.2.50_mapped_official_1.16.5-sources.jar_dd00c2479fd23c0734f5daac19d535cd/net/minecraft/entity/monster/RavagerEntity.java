...
public class RavagerEntity extends AbstractRaiderEntity {
   ...
   protected void func_110147_ax() {
      ...
      this.getAttribute(SharedMonsterAttributes.field_111263_d).setBaseValue(0.3D);
      this.getAttribute(SharedMonsterAttributes.field_111266_c).setBaseValue(0.5D);
      this.getAttribute(SharedMonsterAttributes.field_111264_e).setBaseValue(12.0D);
   ...
   public void aiStep() {
      ...
      if (this.isAlive()) {
         if (this.isImmobile()) {
            this.getAttribute(SharedMonsterAttributes.field_111263_d).setBaseValue(0.0D);
         } else {
            double d0 = this.getTarget() != null ? 0.35D : 0.3D;
            double d1 = this.getAttribute(SharedMonsterAttributes.field_111263_d).getBaseValue();
            this.getAttribute(SharedMonsterAttributes.field_111263_d).setBaseValue(MathHelper.lerp(0.1D, d1, d0));
         }
