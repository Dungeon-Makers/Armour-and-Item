...
public class SlimeEntity extends MobEntity implements IMob {
   ...
   protected void setSize(int p_70799_1_, boolean p_70799_2_) {
      ...
      this.getAttribute(SharedMonsterAttributes.field_111267_a).setBaseValue((double)(p_70799_1_ * p_70799_1_));
      this.getAttribute(SharedMonsterAttributes.field_111263_d).setBaseValue((double)(0.2F + 0.1F * (float)p_70799_1_));
      this.getAttribute(SharedMonsterAttributes.field_111264_e).setBaseValue((double)p_70799_1_);
      if (p_70799_2_) {
   ...
   public void remove(boolean keepData) {
      int i = this.getSize();
      if (!this.level.isClientSide && i > 1 && this.getHealth() <= 0.0F && !this.removed) {
         ...
         for(int k = 0; k < j; ++k) {
            ...
            slimeentity.moveTo(this.getX() + (double)f, this.getY() + 0.5D, this.getZ() + (double)f1, this.random.nextFloat() * 360.0F, 0.0F);
   ...
   public static boolean checkSlimeSpawnRules(EntityType<SlimeEntity> p_223366_0_, IWorld p_223366_1_, SpawnReason p_223366_2_, BlockPos p_223366_3_, Random p_223366_4_) {
      if (p_223366_1_.getLevelData().func_76067_t().handleSlimeSpawnReduction(p_223366_4_, p_223366_1_) && p_223366_4_.nextInt(4) != 1) {
         return false;
      } else {
         if (p_223366_1_.getDifficulty() != Difficulty.PEACEFUL) {
            Biome biome = p_223366_1_.getBiome(p_223366_3_);
            if (biome == Biomes.SWAMP && p_223366_3_.getY() > 50 && p_223366_3_.getY() < 70 && p_223366_4_.nextFloat() < 0.5F && p_223366_4_.nextFloat() < p_223366_1_.func_130001_d() && p_223366_1_.getMaxLocalRawBrightness(p_223366_3_) <= p_223366_4_.nextInt(8)) {
      ...
      public void tick() {
         ...
         if (this.operation != MovementController.Action.MOVE_TO) {
            ...
            if (this.mob.onGround) {
               this.mob.setSpeed((float)(this.speedModifier * this.mob.getAttribute(SharedMonsterAttributes.field_111263_d).getValue()));
               if (this.jumpDelay-- <= 0) {
