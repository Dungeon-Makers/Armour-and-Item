...
public class IllusionerEntity extends SpellcastingIllagerEntity implements IRangedAttackMob {
   ...
   protected void func_110147_ax() {
      ...
      this.getAttribute(SharedMonsterAttributes.field_111265_b).setBaseValue(18.0D);
      this.getAttribute(SharedMonsterAttributes.field_111267_a).setBaseValue(32.0D);
   }
         ...
         if (this.hurtTime != 1 && this.tickCount % 1200 != 0) {
            if (this.hurtTime == this.hurtDuration - 1) {
               ...
               for(int k = 0; k < 4; ++k) {
                  ...
                  this.clientSideIllusionOffsets[1][k] = new Vec3d(0.0D, 0.0D, 0.0D);
               }
            }
         } else {
            this.clientSideIllusionTicks = 3;
   ...
   @OnlyIn(Dist.CLIENT)
   public Vec3d[] getIllusionOffsets(float p_193098_1_) {
      if (this.clientSideIllusionTicks <= 0) {
   ...
   public void performRangedAttack(LivingEntity p_82196_1_, float p_82196_2_) {
      ...
      if (this.getMainHandItem().getItem() instanceof net.minecraft.item.BowItem)
         abstractarrowentity = ((net.minecraft.item.BowItem)this.getMainHandItem().getItem()).customeArrow(abstractarrowentity);
   ...
   class BlindnessSpellGoal extends SpellcastingIllagerEntity.UseSpellGoal {
      ...
      public boolean canUse() {
         if (!super.canUse()) {
            ...
            return IllusionerEntity.this.level.getCurrentDifficultyAt(new BlockPos(IllusionerEntity.this)).isHarderThan((float)Difficulty.NORMAL.ordinal());
         }
      }
