...
public class HuskEntity extends ZombieEntity {
   ...
   public static boolean checkHuskSpawnRules(EntityType<HuskEntity> p_223334_0_, IWorld p_223334_1_, SpawnReason p_223334_2_, BlockPos p_223334_3_, Random p_223334_4_) {
   ...
   protected void doUnderWaterConversion() {
      ...
      this.level.levelEvent((PlayerEntity)null, 1041, new BlockPos(this), 0);
   }
