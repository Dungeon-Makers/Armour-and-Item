...
public class DrownedEntity extends ZombieEntity implements IRangedAttackMob {
   ...
   protected void addBehaviourGoals() {
      ...
      this.targetSelector.addGoal(1, (new HurtByTargetGoal(this, DrownedEntity.class)).setAlertOthers(ZombiePigmanEntity.class));
   ...
   public static boolean checkDrownedSpawnRules(EntityType<DrownedEntity> p_223332_0_, IWorld p_223332_1_, SpawnReason p_223332_2_, BlockPos p_223332_3_, Random p_223332_4_) {
   ...
   protected boolean canReplaceCurrentItem(ItemStack p_208003_1_, ItemStack p_208003_2_, EquipmentSlotType p_208003_3_) {
      if (p_208003_2_.getItem() == Items.NAUTILUS_SHELL) {
         ...
         return p_208003_1_.getItem() == Items.TRIDENT ? true : super.canReplaceCurrentItem(p_208003_1_, p_208003_2_, p_208003_3_);
      }
   }
   ...
   static class GoToBeachGoal extends MoveToBlockGoal {
      ...
      protected boolean isValidTarget(IWorldReader p_179488_1_, BlockPos p_179488_2_) {
         ...
         return p_179488_1_.isEmptyBlock(blockpos) && p_179488_1_.isEmptyBlock(blockpos.above()) ? p_179488_1_.getBlockState(p_179488_2_).entityCanStandOnFace(p_179488_1_, p_179488_2_, this.drowned) : false;
      }
   ...
   static class GoToWaterGoal extends Goal {
      ...
      private Vec3d getWaterPos() {
         ...
         for(int i = 0; i < 10; ++i) {
            ...
            if (this.level.getBlockState(blockpos1).getBlock() == Blocks.WATER) {
   ...
   static class MoveHelperController extends MovementController {
      ...
      public void tick() {
         ...
         if (this.drowned.wantsToSwim() && this.drowned.isInWater()) {
            ...
            float f1 = (float)(this.speedModifier * this.drowned.getAttribute(SharedMonsterAttributes.field_111263_d).getValue());
   ...
   static class SwimUpGoal extends Goal {
      ...
      public void tick() {
         if (this.drowned.getY() < (double)(this.seaLevel - 1) && (this.drowned.getNavigation().isDone() || this.drowned.closeToNextPos())) {
            Vec3d vec3d = RandomPositionGenerator.getPosTowards(this.drowned, 4, 8, new Vec3d(this.drowned.getX(), (double)(this.seaLevel - 1), this.drowned.getZ()));
            if (vec3d == null) {
               this.stuck = true;
               return;
            }
