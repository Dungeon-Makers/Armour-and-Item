...
public class EndermanEntity extends MonsterEntity {
   ...
   private static final AttributeModifier SPEED_MODIFIER_ATTACKING = (new AttributeModifier(SPEED_MODIFIER_ATTACKING_UUID, "Attacking speed boost", (double)0.15F, AttributeModifier.Operation.ADDITION)).func_111168_a(false);
   ...
   protected void func_110147_ax() {
      ...
      this.getAttribute(SharedMonsterAttributes.field_111267_a).setBaseValue(40.0D);
      this.getAttribute(SharedMonsterAttributes.field_111263_d).setBaseValue((double)0.3F);
      this.getAttribute(SharedMonsterAttributes.field_111264_e).setBaseValue(7.0D);
      this.getAttribute(SharedMonsterAttributes.field_111265_b).setBaseValue(64.0D);
   }
   ...
   public void setTarget(@Nullable LivingEntity p_70624_1_) {
      ...
      if (p_70624_1_ == null) {
         ...
         iattributeinstance.removeModifier(SPEED_MODIFIER_ATTACKING);
      } else {
         this.targetChangeTime = this.tickCount;
         this.entityData.set(DATA_CREEPY, true);
         if (!iattributeinstance.hasModifier(SPEED_MODIFIER_ATTACKING)) {
            iattributeinstance.addModifier(SPEED_MODIFIER_ATTACKING);
         }
      }
   ...
   private boolean isLookingAtMe(PlayerEntity p_70821_1_) {
      ...
      if (itemstack.getItem() == Blocks.CARVED_PUMPKIN.asItem()) {
         ...
         Vec3d vec3d = p_70821_1_.getViewVector(1.0F).normalize();
         Vec3d vec3d1 = new Vec3d(this.getX() - p_70821_1_.getX(), this.getEyeY() - p_70821_1_.getEyeY(), this.getZ() - p_70821_1_.getZ());
   ...
   private boolean teleportTowards(Entity p_70816_1_) {
      Vec3d vec3d = new Vec3d(this.getX() - p_70816_1_.getX(), this.getY(0.5D) - p_70816_1_.getEyeY(), this.getZ() - p_70816_1_.getZ());
   ...
   public boolean hurt(DamageSource p_70097_1_, float p_70097_2_) {
      if (this.isInvulnerableTo(p_70097_1_)) {
         return false;
      } else if (!(p_70097_1_ instanceof IndirectEntityDamageSource) && p_70097_1_ != DamageSource.field_191552_t) {
         boolean flag = super.hurt(p_70097_1_, p_70097_2_);
         if (!this.level.isClientSide() && p_70097_1_.isBypassArmor() && this.random.nextInt(10) != 0) {
            this.teleport();
         }
   ...
   static class FindPlayerGoal extends NearestAttackableTargetGoal<PlayerEntity> {
      ...
      public FindPlayerGoal(EndermanEntity p_i45842_1_) {
         ...
         this.startAggroTargetConditions = (new EntityPredicate()).range(this.getFollowDistance()).selector((p_220790_1_) -> {
            return p_i45842_1_.isLookingAtMe((PlayerEntity)p_220790_1_);
         });
      }
   ...
   static class PlaceBlockGoal extends Goal {
      ...
      public void tick() {
         ...
         IWorld iworld = this.enderman.level;
         ...
         if (blockstate2 != null && this.canPlaceBlock(iworld, blockpos, blockstate2, blockstate, blockstate1, blockpos1)  && !net.minecraftforge.event.ForgeEventFactory.onBlockPlace(enderman, new net.minecraftforge.common.util.BlockSnapshot(iworld, blockpos, blockstate1), net.minecraft.util.Direction.UP)) {
      ...
      private boolean canPlaceBlock(IWorldReader p_220836_1_, BlockPos p_220836_2_, BlockState p_220836_3_, BlockState p_220836_4_, BlockState p_220836_5_, BlockPos p_220836_6_) {
         return p_220836_4_.isAir(p_220836_1_, p_220836_2_) && !p_220836_5_.isAir(p_220836_1_, p_220836_6_) && p_220836_5_.func_224756_o(p_220836_1_, p_220836_6_) && p_220836_3_.canSurvive(p_220836_1_, p_220836_2_);
      }
   }
   ...
   static class TakeBlockGoal extends Goal {
      ...
      public void tick() {
         ...
         BlockRayTraceResult blockraytraceresult = world.clip(new RayTraceContext(vec3d, vec3d1, RayTraceContext.BlockMode.OUTLINE, RayTraceContext.FluidMode.NONE, this.enderman));
