...
public class ZombieVillagerEntity extends ZombieEntity implements IVillagerDataHolder {
   ...
   public boolean func_184645_a(PlayerEntity p_184645_1_, Hand p_184645_2_) {
      ...
      if (itemstack.getItem() == Items.GOLDEN_APPLE && this.hasEffect(Effects.WEAKNESS)) {
         if (!p_184645_1_.abilities.instabuild) {
            itemstack.shrink(1);
         }

         if (!this.level.isClientSide) {
            this.startConverting(p_184645_1_.getUUID(), this.random.nextInt(2401) + 3600);
   ...
   private void finishConversion(ServerWorld p_213791_1_) {
      ...
      villagerentity.finalizeSpawn(p_213791_1_, p_213791_1_.getCurrentDifficultyAt(new BlockPos(villagerentity)), SpawnReason.CONVERSION, (ILivingEntityData)null, (CompoundNBT)null);
      if (this.isBaby()) {
      ...
      p_213791_1_.addFreshEntity(villagerentity);
      if (this.conversionStarter != null) {
      ...
      p_213791_1_.levelEvent((PlayerEntity)null, 1027, new BlockPos(this), 0);
   }
