...
public class EvokerEntity extends SpellcastingIllagerEntity {
   ...
   protected void func_110147_ax() {
      ...
      this.getAttribute(SharedMonsterAttributes.field_111265_b).setBaseValue(12.0D);
   ...
   class SummonSpellGoal extends SpellcastingIllagerEntity.UseSpellGoal {
      ...
      protected void performSpellCasting() {
         for(int i = 0; i < 3; ++i) {
            BlockPos blockpos = (new BlockPos(EvokerEntity.this)).offset(-2 + EvokerEntity.this.random.nextInt(5), 1, -2 + EvokerEntity.this.random.nextInt(5));
            VexEntity vexentity = EntityType.VEX.create(EvokerEntity.this.level);
            vexentity.moveTo(blockpos, 0.0F, 0.0F);
            vexentity.finalizeSpawn(EvokerEntity.this.level, EvokerEntity.this.level.getCurrentDifficultyAt(blockpos), SpawnReason.MOB_SUMMONED, (ILivingEntityData)null, (CompoundNBT)null);
            vexentity.setOwner(EvokerEntity.this);
            vexentity.setBoundOrigin(blockpos);
            vexentity.setLimitedLife(20 * (30 + EvokerEntity.this.random.nextInt(90)));
            EvokerEntity.this.level.addFreshEntity(vexentity);
         }
