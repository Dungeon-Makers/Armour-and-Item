...
public class VexEntity extends MonsterEntity {
   ...
   protected void func_110147_ax() {
      ...
      this.getAttribute(SharedMonsterAttributes.field_111267_a).setBaseValue(14.0D);
   ...
   class ChargeAttackGoal extends Goal {
      ...
      public void start() {
         ...
         VexEntity.this.moveControl.setWantedPosition(vec3d.x, vec3d.y, vec3d.z, 1.0D);
   ...
   class MoveHelperController extends MovementController {
      ...
      public void tick() {
         if (this.operation == MovementController.Action.MOVE_TO) {
            Vec3d vec3d = new Vec3d(this.wantedX - VexEntity.this.getX(), this.wantedY - VexEntity.this.getY(), this.wantedZ - VexEntity.this.getZ());
            ...
            if (d0 < VexEntity.this.getBoundingBox().getSize()) {
               ...
               VexEntity.this.setDeltaMovement(VexEntity.this.getDeltaMovement().add(vec3d.scale(this.speedModifier * 0.05D / d0)));
               if (VexEntity.this.getTarget() == null) {
                  Vec3d vec3d1 = VexEntity.this.getDeltaMovement();
                  VexEntity.this.yRot = -((float)MathHelper.atan2(vec3d1.x, vec3d1.z)) * (180F / (float)Math.PI);
