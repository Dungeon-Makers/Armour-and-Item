...
public class RangedBowAttackGoal<T extends MonsterEntity & IRangedAttackMob> extends Goal {
   ...
   protected boolean isHoldingBow() {
      return this.mob.getMainHandItem().getItem() instanceof BowItem || this.mob.getOffhandItem().getItem() instanceof BowItem;
   }
      ...
      if (livingentity != null) {
         ...
         if (this.mob.isUsingItem()) {
            if (!flag && this.seeTime < -60) {
               ...
               if (i >= 20) {
                  this.mob.stopUsingItem();
                  ((IRangedAttackMob)this.mob).performRangedAttack(livingentity, BowItem.getPowerForTime(i));
