...
public class NearestBedSensor extends Sensor<MobEntity> {
   ...
   protected void doTick(ServerWorld p_212872_1_, MobEntity p_212872_2_) {
      if (p_212872_2_.isBaby()) {
         ...
         Stream<BlockPos> stream = pointofinterestmanager.findAll(PointOfInterestType.HOME.getPredicate(), predicate, new BlockPos(p_212872_2_), 48, PointOfInterestManager.Status.ANY);
