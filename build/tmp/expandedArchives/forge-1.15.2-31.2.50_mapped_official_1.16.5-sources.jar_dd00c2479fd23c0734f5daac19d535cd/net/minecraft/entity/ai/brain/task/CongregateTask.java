...
public class CongregateTask extends Task<LivingEntity> {
   ...
   protected boolean checkExtraStartConditions(ServerWorld p_212832_1_, LivingEntity p_212832_2_) {
      ...
      return p_212832_1_.getRandom().nextInt(100) == 0 && optional.isPresent() && Objects.equals(p_212832_1_.func_201675_m().func_186058_p(), optional.get().func_218177_a()) && optional.get().pos().closerThan(p_212832_2_.position(), 4.0D) && brain.getMemory(MemoryModuleType.VISIBLE_LIVING_ENTITIES).get().stream().anyMatch((p_220570_0_) -> {
