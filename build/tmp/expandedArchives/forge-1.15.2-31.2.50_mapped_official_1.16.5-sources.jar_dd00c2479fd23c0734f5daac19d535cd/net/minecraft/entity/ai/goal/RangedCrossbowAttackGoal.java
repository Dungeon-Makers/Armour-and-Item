...
public class RangedCrossbowAttackGoal<T extends MonsterEntity & IRangedAttackMob & ICrossbowUser> extends Goal {
   ...
   private boolean isHoldingCrossbow() {
      return this.mob.func_213382_a(Items.CROSSBOW);
   }
   ...
   public void stop() {
      ...
      if (this.mob.isUsingItem()) {
         ...
         ((ICrossbowUser)this.mob).setChargingCrossbow(false);
      ...
      if (livingentity != null) {
         ...
         if (this.crossbowState == RangedCrossbowAttackGoal.CrossbowState.UNCHARGED) {
            if (!flag2) {
               ...
               ((ICrossbowUser)this.mob).setChargingCrossbow(true);
            }
            ...
            ((IRangedAttackMob)this.mob).performRangedAttack(livingentity, 1.0F);
