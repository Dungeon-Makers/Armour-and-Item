...
public class RandomPositionGenerator {
   @Nullable
   public static Vec3d getPos(CreatureEntity p_75463_0_, int p_75463_1_, int p_75463_2_) {
      return generateRandomPos(p_75463_0_, p_75463_1_, p_75463_2_, 0, (Vec3d)null, true, (double)((float)Math.PI / 2F), p_75463_0_::getWalkTargetValue, false, 0, 0, true);
   }

   @Nullable
   public static Vec3d getAirPos(CreatureEntity p_226338_0_, int p_226338_1_, int p_226338_2_, int p_226338_3_, @Nullable Vec3d p_226338_4_, double p_226338_5_) {
   ...
   @Nullable
   public static Vec3d getLandPos(CreatureEntity p_221024_0_, int p_221024_1_, int p_221024_2_, ToDoubleFunction<BlockPos> p_221024_3_) {
      return generateRandomPos(p_221024_0_, p_221024_1_, p_221024_2_, 0, (Vec3d)null, false, 0.0D, p_221024_3_, true, 0, 0, true);
   }

   @Nullable
   public static Vec3d getAboveLandPos(CreatureEntity p_226340_0_, int p_226340_1_, int p_226340_2_, Vec3d p_226340_3_, float p_226340_4_, int p_226340_5_, int p_226340_6_) {
   ...
   @Nullable
   public static Vec3d getPosTowards(CreatureEntity p_75464_0_, int p_75464_1_, int p_75464_2_, Vec3d p_75464_3_) {
      Vec3d vec3d = p_75464_3_.subtract(p_75464_0_.getX(), p_75464_0_.getY(), p_75464_0_.getZ());
      return generateRandomPos(p_75464_0_, p_75464_1_, p_75464_2_, 0, vec3d, true, (double)((float)Math.PI / 2F), p_75464_0_::getWalkTargetValue, false, 0, 0, true);
   }

   @Nullable
   public static Vec3d getPosTowards(CreatureEntity p_203155_0_, int p_203155_1_, int p_203155_2_, Vec3d p_203155_3_, double p_203155_4_) {
      Vec3d vec3d = p_203155_3_.subtract(p_203155_0_.getX(), p_203155_0_.getY(), p_203155_0_.getZ());
      return generateRandomPos(p_203155_0_, p_203155_1_, p_203155_2_, 0, vec3d, true, p_203155_4_, p_203155_0_::getWalkTargetValue, false, 0, 0, true);
   }

   @Nullable
   public static Vec3d getAirPosTowards(CreatureEntity p_226344_0_, int p_226344_1_, int p_226344_2_, int p_226344_3_, Vec3d p_226344_4_, double p_226344_5_) {
      Vec3d vec3d = p_226344_4_.subtract(p_226344_0_.getX(), p_226344_0_.getY(), p_226344_0_.getZ());
      return generateRandomPos(p_226344_0_, p_226344_1_, p_226344_2_, p_226344_3_, vec3d, false, p_226344_5_, p_226344_0_::getWalkTargetValue, true, 0, 0, false);
   }

   @Nullable
   public static Vec3d getPosAvoid(CreatureEntity p_75461_0_, int p_75461_1_, int p_75461_2_, Vec3d p_75461_3_) {
      Vec3d vec3d = p_75461_0_.position().subtract(p_75461_3_);
      return generateRandomPos(p_75461_0_, p_75461_1_, p_75461_2_, 0, vec3d, true, (double)((float)Math.PI / 2F), p_75461_0_::getWalkTargetValue, false, 0, 0, true);
   }

   @Nullable
   public static Vec3d getLandPosAvoid(CreatureEntity p_223548_0_, int p_223548_1_, int p_223548_2_, Vec3d p_223548_3_) {
      Vec3d vec3d = p_223548_0_.position().subtract(p_223548_3_);
      return generateRandomPos(p_223548_0_, p_223548_1_, p_223548_2_, 0, vec3d, false, (double)((float)Math.PI / 2F), p_223548_0_::getWalkTargetValue, true, 0, 0, true);
   }

   @Nullable
   private static Vec3d generateRandomPos(CreatureEntity p_226339_0_, int p_226339_1_, int p_226339_2_, int p_226339_3_, @Nullable Vec3d p_226339_4_, boolean p_226339_5_, double p_226339_6_, ToDoubleFunction<BlockPos> p_226339_8_, boolean p_226339_9_, int p_226339_10_, int p_226339_11_, boolean p_226339_12_) {
         ...
         if (blockpos1 != null) {
            ...
            if (blockpos3.getY() >= 0 && blockpos3.getY() <= p_226339_0_.level.getMaxBuildHeight() && (!flag || p_226339_0_.isWithinRestriction(blockpos3)) && (!p_226339_12_ || pathnavigator.isStableDestination(blockpos3))) {
               ...
               if (p_226339_5_ || !p_226339_0_.level.getFluidState(blockpos3).is(FluidTags.WATER)) {
                  PathNodeType pathnodetype = WalkNodeProcessor.func_227480_b_(p_226339_0_.level, blockpos3.getX(), blockpos3.getY(), blockpos3.getZ());
