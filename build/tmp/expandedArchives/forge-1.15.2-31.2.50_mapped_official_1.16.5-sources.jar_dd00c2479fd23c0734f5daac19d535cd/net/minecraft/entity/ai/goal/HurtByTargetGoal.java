...
public class HurtByTargetGoal extends TargetGoal {
   ...
   protected void alertOthers() {
      ...
      List<MobEntity> list = this.mob.level.getLoadedEntitiesOfClass(this.mob.getClass(), (new AxisAlignedBB(this.mob.getX(), this.mob.getY(), this.mob.getZ(), this.mob.getX() + 1.0D, this.mob.getY() + 1.0D, this.mob.getZ() + 1.0D)).inflate(d0, 10.0D, d0));
