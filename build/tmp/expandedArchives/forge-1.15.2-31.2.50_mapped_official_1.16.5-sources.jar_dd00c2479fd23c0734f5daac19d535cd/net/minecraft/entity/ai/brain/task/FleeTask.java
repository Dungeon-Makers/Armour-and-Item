...
public class FleeTask extends Task<CreatureEntity> {
   ...
   protected boolean checkExtraStartConditions(ServerWorld p_212832_1_, CreatureEntity p_212832_2_) {
      Entity entity = p_212832_2_.getBrain().getMemory(this.field_220541_a).get();
      return p_212832_2_.distanceToSqr(entity) < 36.0D;
   }
   ...
   public static void func_220540_a(CreatureEntity p_220540_0_, Entity p_220540_1_, float p_220540_2_) {
      for(int i = 0; i < 10; ++i) {
         Vec3d vec3d = RandomPositionGenerator.getLandPosAvoid(p_220540_0_, 16, 7, p_220540_1_.position());
         if (vec3d != null) {
