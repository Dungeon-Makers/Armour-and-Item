...
public class InteractWithDoorTask extends Task<LivingEntity> {
   public InteractWithDoorTask() {
      super(ImmutableMap.of(MemoryModuleType.PATH, MemoryModuleStatus.VALUE_PRESENT, MemoryModuleType.INTERACTABLE_DOORS, MemoryModuleStatus.VALUE_PRESENT, MemoryModuleType.DOORS_TO_CLOSE, MemoryModuleStatus.REGISTERED));
   }
   ...
   protected void start(ServerWorld p_212831_1_, LivingEntity p_212831_2_, long p_212831_3_) {
      ...
      int i = path.getNextNodeIndex() - 1;
      this.func_220434_a(p_212831_1_, list1, set, i, p_212831_2_, brain);
   }
   ...
   private Set<BlockPos> func_220436_a(ServerWorld p_220436_1_, List<GlobalPos> p_220436_2_, List<BlockPos> p_220436_3_) {
      return p_220436_2_.stream().filter((p_220432_1_) -> {
         return p_220432_1_.func_218177_a() == p_220436_1_.func_201675_m().func_186058_p();
      }).map(GlobalPos::pos).filter(p_220436_3_::contains).collect(Collectors.toSet());
   }
   ...
   private void func_220434_a(ServerWorld p_220434_1_, List<BlockPos> p_220434_2_, Set<BlockPos> p_220434_3_, int p_220434_4_, LivingEntity p_220434_5_, Brain<?> p_220434_6_) {
      p_220434_3_.forEach((p_225447_4_) -> {
         ...
         if (BlockTags.WOODEN_DOORS.func_199685_a_(block) && block instanceof DoorBlock) {
            ...
            if (!p_220434_6_.getMemory(MemoryModuleType.DOORS_TO_CLOSE).isPresent() && flag) {
               p_220434_6_.setMemory(MemoryModuleType.DOORS_TO_CLOSE, Sets.newHashSet(globalpos));
            } else {
               p_220434_6_.getMemory(MemoryModuleType.DOORS_TO_CLOSE).ifPresent((p_225450_2_) -> {
                  if (flag) {
   ...
   public static void func_225449_a(ServerWorld p_225449_0_, List<BlockPos> p_225449_1_, int p_225449_2_, LivingEntity p_225449_3_, Brain<?> p_225449_4_) {
      p_225449_4_.getMemory(MemoryModuleType.DOORS_TO_CLOSE).ifPresent((p_225451_4_) -> {
         ...
         while(iterator.hasNext()) {
            ...
            if (p_225449_0_.func_201675_m().func_186058_p() != globalpos.func_218177_a()) {
               iterator.remove();
            } else {
               BlockState blockstate = p_225449_0_.getBlockState(blockpos);
               Block block = blockstate.getBlock();
               if (BlockTags.WOODEN_DOORS.func_199685_a_(block) && block instanceof DoorBlock && i < p_225449_2_ && blockpos.closerThan(p_225449_3_.position(), 4.0D)) {
                  ((DoorBlock)block).func_176512_a(p_225449_0_, blockpos, false);
                  iterator.remove();
               }
            }
         }
