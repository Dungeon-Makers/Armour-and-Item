...
public class FarmTask extends Task<VillagerEntity> {
   ...
   protected boolean checkExtraStartConditions(ServerWorld p_212832_1_, VillagerEntity p_212832_2_) {
      if (!net.minecraftforge.event.ForgeEventFactory.getMobGriefingEvent(p_212832_1_, p_212832_2_)) {
         ...
         this.field_220423_b = p_212832_2_.hasFarmSeeds();
         this.field_220424_c = false;
         Inventory inventory = p_212832_2_.getInventory();
         ...
         for(int i1 = -1; i1 <= 1; ++i1) {
            for(int k = -1; k <= 1; ++k) {
               for(int l = -1; l <= 1; ++l) {
                  blockpos$mutable.set(p_212832_2_.getX() + (double)i1, p_212832_2_.getY() + (double)k, p_212832_2_.getZ() + (double)l);
         ...
         return (this.field_220423_b || this.field_220424_c) && this.aboveFarmlandPos != null;
      }
   }
