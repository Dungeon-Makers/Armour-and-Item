...
public class VillagerTasks {
   ...
   public static ImmutableList<Pair<Integer, ? extends Task<? super VillagerEntity>>> getPanicPackage(VillagerProfession p_220636_0_, float p_220636_1_) {
      ...
      return ImmutableList.of(Pair.of(0, new ClearHurtTask()), Pair.of(1, new FleeTask(MemoryModuleType.NEAREST_HOSTILE, f)), Pair.of(1, new FleeTask(MemoryModuleType.HURT_BY_ENTITY, f)), Pair.of(3, new FindWalkTargetTask(f, 2, 2)), getMinimalLookBehavior());
   }
   ...
   public static ImmutableList<Pair<Integer, ? extends Task<? super VillagerEntity>>> getHidePackage(VillagerProfession p_220644_0_, float p_220644_1_) {
      int i = 2;
      return ImmutableList.of(Pair.of(0, new ExpireHidingTask(15, 2)), Pair.of(1, new FindHidingPlaceTask(32, p_220644_1_ * 1.25F, 2)), getMinimalLookBehavior());
   }
