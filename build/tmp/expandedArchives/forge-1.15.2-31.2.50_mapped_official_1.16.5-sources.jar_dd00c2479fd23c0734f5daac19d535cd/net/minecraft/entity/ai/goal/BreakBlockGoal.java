...
public class BreakBlockGoal extends MoveToBlockGoal {
   ...
   private BlockPos getPosWithBlock(BlockPos p_203115_1_, IBlockReader p_203115_2_) {
      if (p_203115_2_.getBlockState(p_203115_1_).getBlock() == this.blockToRemove) {
         return p_203115_1_;
      } else {
         ...
         for(BlockPos blockpos : ablockpos) {
            if (p_203115_2_.getBlockState(blockpos).getBlock() == this.blockToRemove) {
               return blockpos;
            }
         }
   ...
   protected boolean isValidTarget(IWorldReader p_179488_1_, BlockPos p_179488_2_) {
      ...
      if (ichunk == null) {
         ...
         return ichunk.getBlockState(p_179488_2_).getBlock() == this.blockToRemove && ichunk.getBlockState(p_179488_2_.above()).isAir() && ichunk.getBlockState(p_179488_2_.above(2)).isAir();
      }
   }
}
