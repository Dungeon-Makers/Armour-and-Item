...
public class ExpirePOITask extends Task<LivingEntity> {
   ...
   protected boolean checkExtraStartConditions(ServerWorld p_212832_1_, LivingEntity p_212832_2_) {
      ...
      return Objects.equals(p_212832_1_.func_201675_m().func_186058_p(), globalpos.func_218177_a()) && globalpos.pos().closerThan(p_212832_2_.position(), 5.0D);
   }
   ...
   protected void start(ServerWorld p_212831_1_, LivingEntity p_212831_2_, long p_212831_3_) {
      ...
      ServerWorld serverworld = p_212831_1_.getServer().getLevel(globalpos.func_218177_a());
      if (this.poiDoesntExist(serverworld, blockpos)) {
         brain.eraseMemory(this.memoryType);
      } else if (this.bedIsOccupied(serverworld, blockpos, p_212831_2_)) {
         brain.eraseMemory(this.memoryType);
