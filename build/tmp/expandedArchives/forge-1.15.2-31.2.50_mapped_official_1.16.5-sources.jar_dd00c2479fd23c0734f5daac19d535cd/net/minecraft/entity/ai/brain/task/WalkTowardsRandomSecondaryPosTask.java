   ...
   protected boolean checkExtraStartConditions(ServerWorld p_212832_1_, VillagerEntity p_212832_2_) {
      ...
      if (optional.isPresent() && optional1.isPresent()) {
         ...
         if (!list.isEmpty()) {
            ...
            return this.targetPos != null && Objects.equals(p_212832_1_.func_201675_m().func_186058_p(), this.targetPos.func_218177_a()) && optional1.get().pos().closerThan(p_212832_2_.position(), (double)this.maxDistanceFromPoi);
         }
      }
