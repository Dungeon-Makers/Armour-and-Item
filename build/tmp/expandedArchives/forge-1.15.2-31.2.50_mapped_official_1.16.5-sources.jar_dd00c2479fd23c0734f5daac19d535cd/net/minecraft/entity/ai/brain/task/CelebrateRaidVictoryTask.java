...
public class CelebrateRaidVictoryTask extends Task<VillagerEntity> {
   ...
   protected boolean checkExtraStartConditions(ServerWorld p_212832_1_, VillagerEntity p_212832_2_) {
      BlockPos blockpos = new BlockPos(p_212832_2_);
   ...
   protected void tick(ServerWorld p_212833_1_, VillagerEntity p_212833_2_, long p_212833_3_) {
      ...
      if (random.nextInt(200) == 0 && MoveToSkylightTask.hasNoBlocksAbove(p_212833_1_, p_212833_2_, new BlockPos(p_212833_2_))) {
         ...
         FireworkRocketEntity fireworkrocketentity = new FireworkRocketEntity(p_212833_2_.level, p_212833_2_.getX(), p_212833_2_.getEyeY(), p_212833_2_.getZ(), itemstack);
