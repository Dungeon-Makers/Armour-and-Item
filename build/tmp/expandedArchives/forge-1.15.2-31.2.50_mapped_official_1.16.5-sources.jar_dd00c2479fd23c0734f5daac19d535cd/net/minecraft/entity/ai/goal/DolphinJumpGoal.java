...
public class DolphinJumpGoal extends JumpGoal {
   ...
   public boolean canContinueToUse() {
      ...
      return (!(d0 * d0 < (double)0.03F) || this.dolphin.xRot == 0.0F || !(Math.abs(this.dolphin.xRot) < 10.0F) || !this.dolphin.isInWater()) && !this.dolphin.onGround;
   }
   ...
   public void tick() {
      ...
      if (!flag) {
         IFluidState ifluidstate = this.dolphin.level.getFluidState(new BlockPos(this.dolphin));
