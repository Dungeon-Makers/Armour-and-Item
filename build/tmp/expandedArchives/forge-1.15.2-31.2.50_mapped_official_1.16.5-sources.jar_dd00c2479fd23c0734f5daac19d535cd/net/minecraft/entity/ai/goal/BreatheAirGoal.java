...
public class BreatheAirGoal extends Goal {
   ...
   private boolean givesAir(IWorldReader p_205140_1_, BlockPos p_205140_2_) {
      ...
      return (p_205140_1_.getFluidState(p_205140_2_).isEmpty() || blockstate.getBlock() == Blocks.BUBBLE_COLUMN) && blockstate.isPathfindable(p_205140_1_, p_205140_2_, PathType.LAND);
   }
}