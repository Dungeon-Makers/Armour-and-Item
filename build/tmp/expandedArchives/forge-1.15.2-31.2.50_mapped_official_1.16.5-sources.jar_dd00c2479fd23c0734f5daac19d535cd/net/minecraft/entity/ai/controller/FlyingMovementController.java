   ...
   public void tick() {
      if (this.operation == MovementController.Action.MOVE_TO) {
         ...
         if (this.mob.onGround) {
            f1 = (float)(this.speedModifier * this.mob.getAttribute(SharedMonsterAttributes.field_111263_d).getValue());
         } else {
            f1 = (float)(this.speedModifier * this.mob.getAttribute(SharedMonsterAttributes.field_193334_e).getValue());
         }
