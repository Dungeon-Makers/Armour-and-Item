...
public class FindWalkTargetTask extends Task<CreatureEntity> {
   ...
   private void setTargetedPos(CreatureEntity p_220594_1_, SectionPos p_220594_2_) {
      Optional<Vec3d> optional = Optional.ofNullable(RandomPositionGenerator.getPosTowards(p_220594_1_, this.maxXyDist, this.maxYDist, new Vec3d(p_220594_2_.center())));
   ...
   private void setRandomPos(CreatureEntity p_220593_1_) {
      Optional<Vec3d> optional = Optional.ofNullable(RandomPositionGenerator.getLandPos(p_220593_1_, this.maxXyDist, this.maxYDist));
