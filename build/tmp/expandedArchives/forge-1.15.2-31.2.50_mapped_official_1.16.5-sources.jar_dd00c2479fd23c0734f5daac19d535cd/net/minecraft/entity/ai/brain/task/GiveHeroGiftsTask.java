   ...
   private List<ItemStack> getItemToThrow(VillagerEntity p_220399_1_) {
      if (p_220399_1_.isBaby()) {
         ...
         if (gifts.containsKey(villagerprofession)) {
            ...
            LootContext.Builder lootcontext$builder = (new LootContext.Builder((ServerWorld)p_220399_1_.level)).withParameter(LootParameters.field_216286_f, new BlockPos(p_220399_1_)).withParameter(LootParameters.THIS_ENTITY, p_220399_1_).withRandom(p_220399_1_.getRandom());
