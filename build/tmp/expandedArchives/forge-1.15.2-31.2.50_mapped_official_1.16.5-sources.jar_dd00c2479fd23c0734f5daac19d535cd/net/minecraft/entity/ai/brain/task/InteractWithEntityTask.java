...
public class InteractWithEntityTask<E extends LivingEntity, T extends LivingEntity> extends Task<E> {
   ...
   public InteractWithEntityTask(EntityType<? extends T> p_i50363_1_, int p_i50363_2_, Predicate<E> p_i50363_3_, Predicate<T> p_i50363_4_, MemoryModuleType<T> p_i50363_5_, float p_i50363_6_, int p_i50363_7_) {
      super(ImmutableMap.of(MemoryModuleType.LOOK_TARGET, MemoryModuleStatus.REGISTERED, MemoryModuleType.WALK_TARGET, MemoryModuleStatus.VALUE_ABSENT, p_i50363_5_, MemoryModuleStatus.VALUE_ABSENT, MemoryModuleType.VISIBLE_LIVING_ENTITIES, MemoryModuleStatus.VALUE_PRESENT));
   ...
   protected boolean checkExtraStartConditions(ServerWorld p_212832_1_, E p_212832_2_) {
      return this.selfFilter.test(p_212832_2_) && p_212832_2_.getBrain().getMemory(MemoryModuleType.VISIBLE_LIVING_ENTITIES).get().stream().anyMatch((p_220444_1_) -> {
         return this.type.equals(p_220444_1_.getType()) && this.targetFilter.test((T)p_220444_1_);
      });
   }
   ...
   protected void start(ServerWorld p_212831_1_, E p_212831_2_, long p_212831_3_) {
      ...
      brain.getMemory(MemoryModuleType.VISIBLE_LIVING_ENTITIES).ifPresent((p_220437_3_) -> {
         p_220437_3_.stream().filter((p_220440_1_) -> {
            ...
            brain.setMemory(MemoryModuleType.WALK_TARGET, new WalkTarget(new EntityPosWrapper(p_220438_2_), this.speedModifier, this.maxDist));
         });
      });
   }
}