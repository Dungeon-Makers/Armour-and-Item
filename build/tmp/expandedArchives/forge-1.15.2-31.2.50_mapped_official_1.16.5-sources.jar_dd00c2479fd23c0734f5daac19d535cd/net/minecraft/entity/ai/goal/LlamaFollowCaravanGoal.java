...
public class LlamaFollowCaravanGoal extends Goal {
   ...
   public void tick() {
      if (this.llama.inCaravan()) {
         ...
         float f = 2.0F;
         Vec3d vec3d = (new Vec3d(llamaentity.getX() - this.llama.getX(), llamaentity.getY() - this.llama.getY(), llamaentity.getZ() - this.llama.getZ())).normalize().scale(Math.max(d0 - 2.0D, 0.0D));
