...
public class FollowOwnerGoal extends Goal {
   ...
   public boolean canUse() {
      ...
      if (livingentity == null) {
         ...
         return false;
      } else if (this.tamable.func_70906_o()) {
         return false;
   ...
   private boolean maybeTeleportTo(int p_226328_1_, int p_226328_2_, int p_226328_3_) {
      if (Math.abs((double)p_226328_1_ - this.owner.getX()) < 2.0D && Math.abs((double)p_226328_3_ - this.owner.getZ()) < 2.0D) {
         ...
         this.tamable.moveTo((double)((float)p_226328_1_ + 0.5F), (double)p_226328_2_, (double)((float)p_226328_3_ + 0.5F), this.tamable.yRot, this.tamable.xRot);
         this.navigation.stop();
         return true;
      }
   }
   ...
   private boolean canTeleportTo(BlockPos p_226329_1_) {
      PathNodeType pathnodetype = WalkNodeProcessor.func_227480_b_(this.level, p_226329_1_.getX(), p_226329_1_.getY(), p_226329_1_.getZ());
      if (pathnodetype != PathNodeType.WALKABLE) {
         ...
         if (!this.canFly && blockstate.getBlock() instanceof LeavesBlock) {
            ...
            BlockPos blockpos = p_226329_1_.subtract(new BlockPos(this.tamable));
