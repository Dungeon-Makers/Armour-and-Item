...
public abstract class AbstractAttributeMap {
   ...
   public void func_111147_b(Multimap<String, AttributeModifier> p_111147_1_) {
      for(Entry<String, AttributeModifier> entry : p_111147_1_.entries()) {
         ...
         if (iattributeinstance != null) {
            iattributeinstance.removeModifier(entry.getValue());
            iattributeinstance.addModifier(entry.getValue());
         }
      }
   ...
   public void func_226303_a_(AbstractAttributeMap p_226303_1_) {
      this.func_111146_a().forEach((p_226304_1_) -> {
         IAttributeInstance iattributeinstance = p_226303_1_.func_111151_a(p_226304_1_.getAttribute());
         if (iattributeinstance != null) {
