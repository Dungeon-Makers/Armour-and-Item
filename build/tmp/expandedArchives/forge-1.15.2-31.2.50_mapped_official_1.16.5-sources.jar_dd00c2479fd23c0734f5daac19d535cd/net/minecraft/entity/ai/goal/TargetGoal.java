...
public abstract class TargetGoal extends Goal {
   ...
   protected double getFollowDistance() {
      IAttributeInstance iattributeinstance = this.mob.getAttribute(SharedMonsterAttributes.field_111265_b);
   ...
   protected boolean canAttack(@Nullable LivingEntity p_220777_1_, EntityPredicate p_220777_2_) {
      if (p_220777_1_ == null) {
         ...
         return false;
      } else if (!this.mob.isWithinRestriction(new BlockPos(p_220777_1_))) {
         return false;
      } else {
         if (this.mustReach) {
