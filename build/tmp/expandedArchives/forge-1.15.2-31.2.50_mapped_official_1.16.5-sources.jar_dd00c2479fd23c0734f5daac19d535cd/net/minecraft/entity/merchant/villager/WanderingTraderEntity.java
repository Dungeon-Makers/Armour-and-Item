      ...
      if (flag) {
         ...
         if (this.getOffers().isEmpty()) {
            ...
            if (!this.level.isClientSide) {
               this.setTradingPlayer(p_184645_1_);
               this.openTradingScreen(p_184645_1_, this.getDisplayName(), 1);
            }
      ...
      public void tick() {
         ...
         if (blockpos != null && WanderingTraderEntity.this.navigation.isDone()) {
            if (this.isTooFarAway(blockpos, 10.0D)) {
               ...
               WanderingTraderEntity.this.navigation.moveTo(vec3d1.x, vec3d1.y, vec3d1.z, this.speedModifier);
            } else {
