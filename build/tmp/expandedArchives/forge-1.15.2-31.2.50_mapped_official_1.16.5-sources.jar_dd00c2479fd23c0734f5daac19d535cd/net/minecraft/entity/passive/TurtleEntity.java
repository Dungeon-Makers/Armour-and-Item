...
public class TurtleEntity extends AnimalEntity {
   ...
   public static boolean checkTurtleSpawnRules(EntityType<TurtleEntity> p_223322_0_, IWorld p_223322_1_, SpawnReason p_223322_2_, BlockPos p_223322_3_, Random p_223322_4_) {
      return p_223322_3_.getY() < p_223322_1_.getSeaLevel() + 4 && p_223322_1_.getBlockState(p_223322_3_.below()).getBlock() == Blocks.SAND && p_223322_1_.getRawBrightness(p_223322_3_, 0) > 8;
   }
   ...
   public float getWalkTargetValue(BlockPos p_205022_1_, IWorldReader p_205022_2_) {
      if (!this.isGoingHome() && p_205022_2_.getFluidState(p_205022_1_).is(FluidTags.WATER)) {
         ...
         return p_205022_2_.getBlockState(p_205022_1_.below()).getBlock() == Blocks.SAND ? 10.0F : p_205022_2_.getBrightness(p_205022_1_) - 0.5F;
      }
   }
   ...
   static class GoHomeGoal extends Goal {
      ...
      public void tick() {
         ...
         if (this.turtle.getNavigation().isDone()) {
            ...
            Vec3d vec3d1 = RandomPositionGenerator.getPosTowards(this.turtle, 16, 3, vec3d, (double)((float)Math.PI / 10F));
            if (vec3d1 == null) {
               vec3d1 = RandomPositionGenerator.getPosTowards(this.turtle, 8, 7, vec3d);
            }

            if (vec3d1 != null && !flag && this.turtle.level.getBlockState(new BlockPos(vec3d1)).getBlock() != Blocks.WATER) {
               vec3d1 = RandomPositionGenerator.getPosTowards(this.turtle, 16, 5, vec3d);
            }
   ...
   static class MoveHelperController extends MovementController {
      ...
      public void tick() {
         ...
         if (this.operation == MovementController.Action.MOVE_TO && !this.turtle.getNavigation().isDone()) {
            ...
            float f1 = (float)(this.speedModifier * this.turtle.getAttribute(SharedMonsterAttributes.field_111263_d).getValue());
