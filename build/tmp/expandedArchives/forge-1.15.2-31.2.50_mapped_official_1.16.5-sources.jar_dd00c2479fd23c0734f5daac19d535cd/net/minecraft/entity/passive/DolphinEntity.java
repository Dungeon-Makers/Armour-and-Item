...
public class DolphinEntity extends WaterMobEntity {
   ...
   protected void func_110147_ax() {
      ...
      this.getAttribute(SharedMonsterAttributes.field_111263_d).setBaseValue((double)1.2F);
   ...
   public static boolean checkDolphinSpawnRules(EntityType<DolphinEntity> p_223364_0_, IWorld p_223364_1_, SpawnReason p_223364_2_, BlockPos p_223364_3_, Random p_223364_4_) {
      return p_223364_3_.getY() > 45 && p_223364_3_.getY() < p_223364_1_.getSeaLevel() && (p_223364_1_.getBiome(p_223364_3_) != Biomes.OCEAN || p_223364_1_.getBiome(p_223364_3_) != Biomes.DEEP_OCEAN) && p_223364_1_.getFluidState(p_223364_3_).is(FluidTags.WATER);
   }
      ...
      public void tick() {
         ...
         if (this.operation == MovementController.Action.MOVE_TO && !this.dolphin.getNavigation().isDone()) {
            ...
            if (d3 < (double)2.5000003E-7F) {
               ...
               float f1 = (float)(this.speedModifier * this.dolphin.getAttribute(SharedMonsterAttributes.field_111263_d).getValue());
               if (this.dolphin.isInWater()) {
   ...
   static class SwimToTreasureGoal extends Goal {
      ...
      public void start() {
         if (this.dolphin.level instanceof ServerWorld) {
            ...
            String s = (double)serverworld.random.nextFloat() >= 0.5D ? "Ocean_Ruin" : "Shipwreck";
            BlockPos blockpos1 = serverworld.func_211157_a(s, blockpos, 50, false);
            if (blockpos1 == null) {
               BlockPos blockpos2 = serverworld.func_211157_a(s.equals("Ocean_Ruin") ? "Shipwreck" : "Ocean_Ruin", blockpos, 50, false);
               if (blockpos2 == null) {
                  this.stuck = true;
                  return;
               }
      ...
      public void tick() {
         ...
         if (this.dolphin.closeToNextPos() || this.dolphin.getNavigation().isDone()) {
            ...
            Vec3d vec3d1 = RandomPositionGenerator.getPosTowards(this.dolphin, 16, 1, vec3d, (double)((float)Math.PI / 8F));
            if (vec3d1 == null) {
               vec3d1 = RandomPositionGenerator.getPosTowards(this.dolphin, 8, 4, vec3d);
            }
            ...
            if (vec3d1 != null) {
               ...
               if (!world.getFluidState(blockpos).is(FluidTags.WATER) || !world.getBlockState(blockpos).isPathfindable(world, blockpos, PathType.WATER)) {
                  vec3d1 = RandomPositionGenerator.getPosTowards(this.dolphin, 8, 5, vec3d);
               }
            }
