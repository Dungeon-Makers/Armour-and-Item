...
public abstract class AbstractFishEntity extends WaterMobEntity {
   ...
   public static boolean checkFishSpawnRules(EntityType<? extends AbstractFishEntity> p_223363_0_, IWorld p_223363_1_, SpawnReason p_223363_2_, BlockPos p_223363_3_, Random p_223363_4_) {
      return p_223363_1_.getBlockState(p_223363_3_).getBlock() == Blocks.WATER && p_223363_1_.getBlockState(p_223363_3_.above()).getBlock() == Blocks.WATER;
   }
   ...
   protected boolean func_184645_a(PlayerEntity p_184645_1_, Hand p_184645_2_) {
      ...
      if (itemstack.getItem() == Items.WATER_BUCKET && this.isAlive()) {
         ...
         if (!this.level.isClientSide) {
            CriteriaTriggers.FILLED_BUCKET.trigger((ServerPlayerEntity)p_184645_1_, itemstack1);
         }
   ...
   static class MoveHelperController extends MovementController {
      ...
      public void tick() {
         ...
         if (this.operation == MovementController.Action.MOVE_TO && !this.fish.getNavigation().isDone()) {
            ...
            float f1 = (float)(this.speedModifier * this.fish.getAttribute(SharedMonsterAttributes.field_111263_d).getValue());
