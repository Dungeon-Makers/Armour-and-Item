...
public abstract class TameableEntity extends AnimalEntity {
   ...
   public void addAdditionalSaveData(CompoundNBT p_213281_1_) {
      ...
      p_213281_1_.putBoolean("Sitting", this.func_70906_o());
   }
   ...
   public void readAdditionalSaveData(CompoundNBT p_70037_1_) {
      ...
      if (this.field_70911_d != null) {
         this.field_70911_d.func_75270_a(p_70037_1_.getBoolean("Sitting"));
      }

      this.func_70904_g(p_70037_1_.getBoolean("Sitting"));
   }
