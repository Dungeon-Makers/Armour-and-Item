...
public class ParrotEntity extends ShoulderRidingEntity implements IFlyingAnimal {
   ...
   protected void func_110147_ax() {
      ...
      this.getAttribute(SharedMonsterAttributes.field_111267_a).setBaseValue(6.0D);
      this.getAttribute(SharedMonsterAttributes.field_193334_e).setBaseValue((double)0.4F);
   ...
   private static boolean imitateNearbyMobs(World p_192006_0_, Entity p_192006_1_) {
      if (p_192006_1_.isAlive() && !p_192006_1_.isSilent() && p_192006_0_.random.nextInt(50) == 0) {
   ...
   public boolean func_184645_a(PlayerEntity p_184645_1_, Hand p_184645_2_) {
      ...
      if (itemstack.getItem() instanceof SpawnEggItem) {
         ...
         if (!this.level.isClientSide) {
            if (this.random.nextInt(10) == 0 && !net.minecraftforge.event.ForgeEventFactory.onAnimalTame(this, p_184645_1_)) {
         ...
         if (p_184645_1_.isCreative() || !this.isInvulnerable()) {
            this.hurt(DamageSource.playerAttack(p_184645_1_), Float.MAX_VALUE);
         }

         return true;
      } else if (!this.isFlying() && this.isTame() && this.isOwnedBy(p_184645_1_)) {
         if (!this.level.isClientSide) {
   ...
   public static boolean checkParrotSpawnRules(EntityType<ParrotEntity> p_223317_0_, IWorld p_223317_1_, SpawnReason p_223317_2_, BlockPos p_223317_3_, Random p_223317_4_) {
      Block block = p_223317_1_.getBlockState(p_223317_3_.below()).getBlock();
      return (block.is(BlockTags.LEAVES) || block == Blocks.GRASS_BLOCK || block instanceof LogBlock || block == Blocks.AIR) && p_223317_1_.getRawBrightness(p_223317_3_, 0) > 8;
   }
   ...
   public static void func_192005_a(World p_192005_0_, Entity p_192005_1_) {
      if (!p_192005_1_.isSilent() && !imitateNearbyMobs(p_192005_0_, p_192005_1_) && p_192005_0_.random.nextInt(200) == 0) {
         p_192005_0_.playSound((PlayerEntity)null, p_192005_1_.getX(), p_192005_1_.getY(), p_192005_1_.getZ(), func_192003_a(p_192005_0_.random), p_192005_1_.getSoundSource(), 1.0F, getPitch(p_192005_0_.random));
      }
   ...
   public SoundEvent getAmbientSound() {
      return func_192003_a(this.random);
   }
   ...
   private static SoundEvent func_192003_a(Random p_192003_0_) {
      if (p_192003_0_.nextInt(1000) == 0) {
         ...
         return getImitatedSound(list.get(p_192003_0_.nextInt(list.size())));
      } else {
