...
public class LlamaEntity extends AbstractChestedHorseEntity implements IRangedAttackMob {
   ...
   protected boolean handleEating(PlayerEntity p_190678_1_, ItemStack p_190678_2_) {
      ...
      if (flag && !this.isSilent()) {
         this.level.playSound((PlayerEntity)null, this.getX(), this.getY(), this.getZ(), SoundEvents.LLAMA_EAT, this.getSoundSource(), 1.0F, 1.0F + (this.random.nextFloat() - this.random.nextFloat()) * 0.2F);
      }
   ...
   public boolean isArmor(ItemStack p_190682_1_) {
      ...
      return ItemTags.CARPETS.func_199685_a_(item);
   }
   ...
   public LlamaEntity func_90011_a(AgeableEntity p_90011_1_) {
      LlamaEntity llamaentity = this.makeBabyLlama();
      this.setOffspringAttributes(p_90011_1_, llamaentity);
      LlamaEntity llamaentity1 = (LlamaEntity)p_90011_1_;
