...
public abstract class AbstractHorseEntity extends AnimalEntity implements IInventoryChangedListener, IJumpingMount {
   ...
   public boolean canBeLeashed(PlayerEntity p_184652_1_) {
      return super.canBeLeashed(p_184652_1_) && this.getMobType() != CreatureAttribute.UNDEAD;
   }
   ...
   public boolean hurt(DamageSource p_70097_1_, float p_70097_2_) {
      ...
      return this.isVehicle() && entity != null && this.hasIndirectPassenger(entity) ? false : super.hurt(p_70097_1_, p_70097_2_);
   }
   ...
   private void eating() {
      this.openMouth();
      if (!this.isSilent()) {
         this.level.playSound((PlayerEntity)null, this.getX(), this.getY(), this.getZ(), SoundEvents.HORSE_EAT, this.getSoundSource(), 1.0F, 1.0F + (this.random.nextFloat() - this.random.nextFloat()) * 0.2F);
      }
   ...
   protected void func_110232_cE() {
      if (!this.level.isClientSide) {
         this.func_110251_o(!this.inventory.getItem(0).isEmpty() && this.func_190685_dA());
      }
   }
   ...
   public double getCustomJump() {
      return this.getAttribute(field_110271_bv).getValue();
   }
   ...
   protected void func_110147_ax() {
      ...
      this.getAttribute(SharedMonsterAttributes.field_111267_a).setBaseValue(53.0D);
      this.getAttribute(SharedMonsterAttributes.field_111263_d).setBaseValue((double)0.225F);
   }
      ...
      if (this.isAlive()) {
         if (this.isVehicle() && this.canBeControlledByRider() && this.isSaddled()) {
            ...
            if (this.isControlledByLocalInstance()) {
               this.setSpeed((float)this.getAttribute(SharedMonsterAttributes.field_111263_d).getValue());
   ...
   public void addAdditionalSaveData(CompoundNBT p_213281_1_) {
      ...
      if (this.getOwnerUUID() != null) {
         p_213281_1_.putString("OwnerUUID", this.getOwnerUUID().toString());
      }
   ...
   public void readAdditionalSaveData(CompoundNBT p_70037_1_) {
      ...
      if (iattributeinstance != null) {
         this.getAttribute(SharedMonsterAttributes.field_111263_d).setBaseValue(iattributeinstance.getBaseValue() * 0.25D);
      }
   ...
   protected void setOffspringAttributes(AgeableEntity p_190681_1_, AbstractHorseEntity p_190681_2_) {
      double d0 = this.getAttribute(SharedMonsterAttributes.field_111267_a).getBaseValue() + p_190681_1_.getAttribute(SharedMonsterAttributes.field_111267_a).getBaseValue() + (double)this.generateRandomMaxHealth();
      p_190681_2_.getAttribute(SharedMonsterAttributes.field_111267_a).setBaseValue(d0 / 3.0D);
      double d1 = this.getAttribute(field_110271_bv).getBaseValue() + p_190681_1_.getAttribute(field_110271_bv).getBaseValue() + this.generateRandomJumpStrength();
      p_190681_2_.getAttribute(field_110271_bv).setBaseValue(d1 / 3.0D);
      double d2 = this.getAttribute(SharedMonsterAttributes.field_111263_d).getBaseValue() + p_190681_1_.getAttribute(SharedMonsterAttributes.field_111263_d).getBaseValue() + this.generateRandomSpeed();
      p_190681_2_.getAttribute(SharedMonsterAttributes.field_111263_d).setBaseValue(d2 / 3.0D);
   }
   ...
   public boolean setSlot(int p_174820_1_, ItemStack p_174820_2_) {
      ...
      if (i >= 0 && i < 2 && i < this.inventory.getContainerSize()) {
         if (i == 0 && p_174820_2_.getItem() != Items.SADDLE) {
            return false;
         } else if (i != 1 || this.func_190677_dK() && this.isArmor(p_174820_2_)) {
