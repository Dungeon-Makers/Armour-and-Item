...
public class RabbitEntity extends AnimalEntity {
   ...
   protected float getJumpPower() {
      if (!this.horizontalCollision && (!this.moveControl.hasWanted() || !(this.moveControl.getWantedY() > this.getY() + 0.5D))) {
         ...
         if (path != null && path.getNextNodeIndex() < path.getNodeCount()) {
            Vec3d vec3d = path.getNextEntityPos(this);
   ...
   protected void func_110147_ax() {
      ...
      this.getAttribute(SharedMonsterAttributes.field_111267_a).setBaseValue(3.0D);
   ...
   public RabbitEntity func_90011_a(AgeableEntity p_90011_1_) {
      RabbitEntity rabbitentity = EntityType.RABBIT.create(this.level);
      int i = this.getRandomRabbitType(this.level);
      if (this.random.nextInt(20) != 0) {
         if (p_90011_1_ instanceof RabbitEntity && this.random.nextBoolean()) {
   ...
   public void setRabbitType(int p_175529_1_) {
      if (p_175529_1_ == 99) {
         this.getAttribute(SharedMonsterAttributes.field_188791_g).setBaseValue(8.0D);
   ...
   public static boolean checkRabbitSpawnRules(EntityType<RabbitEntity> p_223321_0_, IWorld p_223321_1_, SpawnReason p_223321_2_, BlockPos p_223321_3_, Random p_223321_4_) {
      Block block = p_223321_1_.getBlockState(p_223321_3_.below()).getBlock();
      return (block == Blocks.GRASS_BLOCK || block == Blocks.SNOW || block == Blocks.SAND) && p_223321_1_.getRawBrightness(p_223321_3_, 0) > 8;
   }
