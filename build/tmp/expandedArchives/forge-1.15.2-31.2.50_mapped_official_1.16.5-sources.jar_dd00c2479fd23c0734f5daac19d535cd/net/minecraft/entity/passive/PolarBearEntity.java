...
public class PolarBearEntity extends AnimalEntity {
   ...
   protected void func_110147_ax() {
      ...
      this.getAttribute(SharedMonsterAttributes.field_111265_b).setBaseValue(20.0D);
   ...
   public static boolean checkPolarBearSpawnRules(EntityType<PolarBearEntity> p_223320_0_, IWorld p_223320_1_, SpawnReason p_223320_2_, BlockPos p_223320_3_, Random p_223320_4_) {
      ...
      if (biome != Biomes.FROZEN_OCEAN && biome != Biomes.DEEP_FROZEN_OCEAN) {
         ...
         return p_223320_1_.getRawBrightness(p_223320_3_, 0) > 8 && p_223320_1_.getBlockState(p_223320_3_.below()).getBlock() == Blocks.ICE;
      }
   }
