...
public class PandaEntity extends AnimalEntity {
   ...
   public PandaEntity.Type getMainGene() {
      return PandaEntity.Type.byId(this.entityData.get(MAIN_GENE_ID));
   }

   public void setMainGene(PandaEntity.Type p_213589_1_) {
      if (p_213589_1_.getId() > 6) {
         p_213589_1_ = PandaEntity.Type.getRandom(this.random);
      }
   ...
   public PandaEntity.Type getHiddenGene() {
      return PandaEntity.Type.byId(this.entityData.get(HIDDEN_GENE_ID));
   }

   public void setHiddenGene(PandaEntity.Type p_213541_1_) {
      if (p_213541_1_.getId() > 6) {
         p_213541_1_ = PandaEntity.Type.getRandom(this.random);
      }
   ...
   public AgeableEntity func_90011_a(AgeableEntity p_90011_1_) {
      PandaEntity pandaentity = EntityType.PANDA.create(this.level);
      if (p_90011_1_ instanceof PandaEntity) {
         pandaentity.setGeneFromParents(this, (PandaEntity)p_90011_1_);
      }
   ...
   protected void func_110147_ax() {
      ...
      this.getAttribute(SharedMonsterAttributes.field_111263_d).setBaseValue((double)0.15F);
      this.func_110140_aT().func_111150_b(SharedMonsterAttributes.field_111264_e).setBaseValue(6.0D);
   }

   public PandaEntity.Type getVariant() {
      return PandaEntity.Type.getVariantFromGenes(this.getMainGene(), this.getHiddenGene());
   }

   public boolean isLazy() {
      return this.getVariant() == PandaEntity.Type.LAZY;
   }

   public boolean isWorried() {
      return this.getVariant() == PandaEntity.Type.WORRIED;
   }

   public boolean isPlayful() {
      return this.getVariant() == PandaEntity.Type.PLAYFUL;
   }

   public boolean isWeak() {
      return this.getVariant() == PandaEntity.Type.WEAK;
   }

   public boolean isAggressive() {
      return this.getVariant() == PandaEntity.Type.AGGRESSIVE;
   }
   ...
   private void addEatingParticles() {
      if (this.getEatCounter() % 5 == 0) {
         ...
         for(int i = 0; i < 6; ++i) {
            ...
            this.level.addParticle(new ItemParticleData(ParticleTypes.ITEM, this.getItemBySlot(EquipmentSlotType.MAINHAND)), vec3d1.x, vec3d1.y, vec3d1.z, vec3d.x, vec3d.y + 0.05D, vec3d.z);
         }
      }
   ...
   private void afterSneeze() {
      Vec3d vec3d = this.getDeltaMovement();
      this.level.addParticle(ParticleTypes.SNEEZE, this.getX() - (double)(this.getBbWidth() + 1.0F) * 0.5D * (double)MathHelper.sin(this.yBodyRot * ((float)Math.PI / 180F)), this.getEyeY() - (double)0.1F, this.getZ() + (double)(this.getBbWidth() + 1.0F) * 0.5D * (double)MathHelper.cos(this.yBodyRot * ((float)Math.PI / 180F)), vec3d.x, 0.0D, vec3d.z);
   ...
   public ILivingEntityData finalizeSpawn(IWorld p_213386_1_, DifficultyInstance p_213386_2_, SpawnReason p_213386_3_, @Nullable ILivingEntityData p_213386_4_, @Nullable CompoundNBT p_213386_5_) {
      this.setMainGene(PandaEntity.Type.getRandom(this.random));
      this.setHiddenGene(PandaEntity.Type.getRandom(this.random));
      this.setAttributes();
      if (p_213386_4_ == null) {
   ...
   public void setAttributes() {
      ...
      if (this.isLazy()) {
         this.getAttribute(SharedMonsterAttributes.field_111263_d).setBaseValue((double)0.07F);
      }
   ...
   public boolean func_184645_a(PlayerEntity p_184645_1_, Hand p_184645_2_) {
      ...
      if (itemstack.getItem() instanceof SpawnEggItem) {
         ...
         if (this.isBaby()) {
            ...
            if (!itemstack1.isEmpty() && !p_184645_1_.abilities.instabuild) {
            ...
            for(int j = 0; j < 8; ++j) {
               for(int k = 0; k <= j; k = k > 0 ? -k : 1 - k) {
                  for(int l = k < j && k > -j ? j : 0; l <= j; l = l > 0 ? -l : 1 - l) {
                     ...
                     if (this.level.getBlockState(blockpos$mutable).getBlock() == Blocks.BAMBOO) {
                        return true;
                     }
                  }
               }
   ...
   public static enum Type {
      ...
      private static final PandaEntity.Type[] BY_ID = Arrays.stream(values()).sorted(Comparator.comparingInt(PandaEntity.Type::getId)).toArray((p_221102_0_) -> {
      ...
      private static PandaEntity.Type getVariantFromGenes(PandaEntity.Type p_221101_0_, PandaEntity.Type p_221101_1_) {
      ...
      public static PandaEntity.Type byId(int p_221105_0_) {
      ...
      public static PandaEntity.Type getRandom(Random p_221104_0_) {
