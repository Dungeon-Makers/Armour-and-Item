...
public class CatEntity extends TameableEntity {
   ...
   protected void func_110147_ax() {
      ...
      this.func_110140_aT().func_111150_b(SharedMonsterAttributes.field_111264_e).setBaseValue(3.0D);
   }
   ...
   public CatEntity func_90011_a(AgeableEntity p_90011_1_) {
      CatEntity catentity = EntityType.CAT.create(this.level);
      if (p_90011_1_ instanceof CatEntity) {
         if (this.random.nextBoolean()) {
            catentity.setCatType(this.getCatType());
         } else {
            catentity.setCatType(((CatEntity)p_90011_1_).getCatType());
         }
         ...
         if (this.isTame()) {
            ...
            if (this.random.nextBoolean()) {
               ...
               catentity.setCollarColor(((CatEntity)p_90011_1_).getCollarColor());
            }
         }
      }
   ...
   public ILivingEntityData finalizeSpawn(IWorld p_213386_1_, DifficultyInstance p_213386_2_, SpawnReason p_213386_3_, @Nullable ILivingEntityData p_213386_4_, @Nullable CompoundNBT p_213386_5_) {
      ...
      if (p_213386_1_.func_130001_d() > 0.9F) {
         this.setCatType(this.random.nextInt(11));
      } else {
         this.setCatType(this.random.nextInt(10));
      }

      if (Feature.field_202334_l.func_202366_b(p_213386_1_, new BlockPos(this))) {
         this.setCatType(10);
   ...
   public boolean func_184645_a(PlayerEntity p_184645_1_, Hand p_184645_2_) {
      ...
      if (itemstack.getItem() instanceof SpawnEggItem) {
         ...
         return this.isTame() && this.isOwnedBy(p_184645_1_) || this.isFood(itemstack);
      } else {
         if (this.isTame()) {
            if (this.isOwnedBy(p_184645_1_)) {
         ...
         boolean flag1 = super.func_184645_a(p_184645_1_, p_184645_2_);
         if (flag1) {
            this.setPersistenceRequired();
         }
   ...
   static class MorningGiftGoal extends Goal {
      ...
      public boolean canContinueToUse() {
         return this.cat.isTame() && !this.cat.func_70906_o() && this.ownerPlayer != null && this.ownerPlayer.isSleeping() && this.goalPos != null && !this.spaceIsOccupied();
      }
      ...
      public void stop() {
         ...
         float f = this.cat.level.func_72826_c(1.0F);
      ...
      private void giveMorningGift() {
         ...
         blockpos$mutable.func_189535_a(this.cat);
         ...
         LootContext.Builder lootcontext$builder = (new LootContext.Builder((ServerWorld)this.cat.level)).withParameter(LootParameters.field_216286_f, blockpos$mutable).withParameter(LootParameters.THIS_ENTITY, this.cat).withRandom(random);

         for(ItemStack itemstack : loottable.getRandomItems(lootcontext$builder.create(LootParameterSets.GIFT))) {
            this.cat.level.addFreshEntity(new ItemEntity(this.cat.level, (double)((float)blockpos$mutable.getX() - MathHelper.sin(this.cat.yBodyRot * ((float)Math.PI / 180F))), (double)blockpos$mutable.getY(), (double)((float)blockpos$mutable.getZ() + MathHelper.cos(this.cat.yBodyRot * ((float)Math.PI / 180F))), itemstack));
         }
