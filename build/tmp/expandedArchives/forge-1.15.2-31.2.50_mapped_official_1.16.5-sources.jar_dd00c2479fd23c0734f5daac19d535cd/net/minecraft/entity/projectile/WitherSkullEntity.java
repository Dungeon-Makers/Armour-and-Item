      ...
      if (!this.level.isClientSide) {
         if (p_70227_1_.getType() == RayTraceResult.Type.ENTITY) {
            ...
            if (this.field_70235_a != null) {
               if (entity.hurt(DamageSource.mobAttack(this.field_70235_a), 8.0F)) {
                  if (entity.isAlive()) {
         ...
         Explosion.Mode explosion$mode = net.minecraftforge.event.ForgeEventFactory.getMobGriefingEvent(this.level, this.field_70235_a) ? Explosion.Mode.DESTROY : Explosion.Mode.NONE;
