...
public abstract class MobEntity extends LivingEntity {
   ...
   protected void func_110147_ax() {
      ...
      this.func_110140_aT().func_111150_b(SharedMonsterAttributes.field_111265_b).setBaseValue(16.0D);
   ...
   public float getPathfindingMalus(PathNodeType p_184643_1_) {
      Float f = this.pathfindingMalus.get(p_184643_1_);
   ...
   protected void pickUpItem(ItemEntity p_175445_1_) {
      ...
      boolean flag = this.canReplaceCurrentItem(itemstack, itemstack1, equipmentslottype);
   ...
   protected boolean canReplaceCurrentItem(ItemStack p_208003_1_, ItemStack p_208003_2_, EquipmentSlotType p_208003_3_) {
      boolean flag = true;
      if (!p_208003_2_.isEmpty()) {
         if (p_208003_3_.getType() == EquipmentSlotType.Group.HAND) {
            if (p_208003_1_.getItem() instanceof SwordItem && !(p_208003_2_.getItem() instanceof SwordItem)) {
               ...
               if (sworditem.getDamage() == sworditem1.getDamage()) {
                  flag = p_208003_1_.getDamageValue() < p_208003_2_.getDamageValue() || p_208003_1_.hasTag() && !p_208003_2_.hasTag();
               } else {
                  flag = sworditem.getDamage() > sworditem1.getDamage();
               }
            ...
            if (armoritem.getDefense() == armoritem1.getDefense()) {
               ...
               flag = armoritem.getDefense() > armoritem1.getDefense();
            }
         } else {
            flag = false;
         }
   ...
   public void checkDespawn() {
      if (this.level.getDifficulty() == Difficulty.PEACEFUL && this.shouldDespawnInPeaceful()) {
         ...
         if (entity != null) {
            ...
            if (d0 > 16384.0D && this.removeWhenFarAway(d0)) {
               this.remove();
            }

            if (this.noActionTime > 600 && this.random.nextInt(800) == 0 && d0 > 1024.0D && this.removeWhenFarAway(d0)) {
               this.remove();
            } else if (d0 < 1024.0D) {
               this.noActionTime = 0;
            }
   ...
   protected void populateDefaultEquipmentEnchantments(DifficultyInstance p_180483_1_) {
      ...
      if (!this.getMainHandItem().isEmpty() && this.random.nextFloat() < 0.25F * f) {
         this.setItemSlot(EquipmentSlotType.MAINHAND, EnchantmentHelper.enchantItem(this.random, this.getMainHandItem(), (int)(5.0F + f * (float)this.random.nextInt(18)), false));
      }
   ...
   public ILivingEntityData finalizeSpawn(IWorld p_213386_1_, DifficultyInstance p_213386_2_, SpawnReason p_213386_3_, @Nullable ILivingEntityData p_213386_4_, @Nullable CompoundNBT p_213386_5_) {
      this.getAttribute(SharedMonsterAttributes.field_111265_b).addModifier(new AttributeModifier("Random spawn bonus", this.random.nextGaussian() * 0.05D, AttributeModifier.Operation.MULTIPLY_BASE));
   ...
   public final boolean interact(PlayerEntity p_184230_1_, Hand p_184230_2_) {
      if (!this.isAlive()) {
         return false;
         ...
         if (itemstack.getItem() == Items.LEAD && this.canBeLeashed(p_184230_1_)) {
            this.setLeashedTo(p_184230_1_, true);
            itemstack.shrink(1);
            return true;
         } else {
            return this.func_184645_a(p_184230_1_, p_184230_2_) ? true : super.interact(p_184230_1_, p_184230_2_);
         }
      }
   }
   ...
   public boolean doHurtTarget(Entity p_70652_1_) {
      ...
      float f1 = (float)this.getAttribute(SharedMonsterAttributes.field_221120_g).getValue();
      ...
      if (flag) {
         if (f1 > 0.0F && p_70652_1_ instanceof LivingEntity) {
            ((LivingEntity)p_70652_1_).func_70653_a(this, f1 * 0.5F, (double)MathHelper.sin(this.yRot * ((float)Math.PI / 180F)), (double)(-MathHelper.cos(this.yRot * ((float)Math.PI / 180F))));
   ...
   public boolean func_213382_a(Item p_213382_1_) {
      return this.getMainHandItem().getItem() == p_213382_1_ || this.getOffhandItem().getItem() == p_213382_1_;
   }
}
