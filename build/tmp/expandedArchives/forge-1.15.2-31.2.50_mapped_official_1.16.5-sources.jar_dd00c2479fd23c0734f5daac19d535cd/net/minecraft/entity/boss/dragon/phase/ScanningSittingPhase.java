   ...
   public void doServerTick() {
      ...
      if (livingentity != null) {
         if (this.scanningTime > 25) {
            ...
            Vec3d vec3d1 = (new Vec3d((double)MathHelper.sin(this.dragon.yRot * ((float)Math.PI / 180F)), 0.0D, (double)(-MathHelper.cos(this.dragon.yRot * ((float)Math.PI / 180F))))).normalize();
         ...
         if (livingentity != null) {
            ...
            this.dragon.getPhaseManager().getPhase(PhaseType.CHARGING_PLAYER).setTarget(new Vec3d(livingentity.getX(), livingentity.getY(), livingentity.getZ()));
         }
      }
