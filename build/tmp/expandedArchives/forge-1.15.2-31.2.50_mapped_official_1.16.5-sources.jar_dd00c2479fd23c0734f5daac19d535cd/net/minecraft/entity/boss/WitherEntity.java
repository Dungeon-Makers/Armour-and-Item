...
public class WitherEntity extends MonsterEntity implements IChargeableMob, IRangedAttackMob {
   ...
   public void aiStep() {
      ...
      if (getHorizontalDistanceSqr(vec3d) > 0.05D) {
         this.yRot = (float)MathHelper.atan2(vec3d.z, vec3d.x) * (180F / (float)Math.PI) - 90.0F;
      }
      ...
      if (this.getInvulnerableTicks() > 0) {
         ...
         if (this.destroyBlocksTick > 0) {
            ...
            if (this.destroyBlocksTick == 0 && net.minecraftforge.event.ForgeEventFactory.getMobGriefingEvent(this.level, this)) {
               ...
               if (flag) {
                  this.level.levelEvent((PlayerEntity)null, 1022, new BlockPos(this), 0);
               }
            }
         }
   ...
   public static boolean canDestroy(BlockState p_181033_0_) {
      return !p_181033_0_.isAir() && !BlockTags.WITHER_IMMUNE.func_199685_a_(p_181033_0_.getBlock());
   }
   ...
   private void performRangedAttack(int p_82209_1_, double p_82209_2_, double p_82209_4_, double p_82209_6_, boolean p_82209_8_) {
      this.level.levelEvent((PlayerEntity)null, 1024, new BlockPos(this), 0);
   ...
   protected void func_110147_ax() {
      ...
      this.getAttribute(SharedMonsterAttributes.field_111267_a).setBaseValue(300.0D);
      this.getAttribute(SharedMonsterAttributes.field_111263_d).setBaseValue((double)0.6F);
      this.getAttribute(SharedMonsterAttributes.field_111265_b).setBaseValue(40.0D);
      this.getAttribute(SharedMonsterAttributes.field_188791_g).setBaseValue(4.0D);
   }
