...
public class Effect extends net.minecraftforge.registries.ForgeRegistryEntry<Effect> implements net.minecraftforge.common.extensions.IForgeEffect {
   private final Map<IAttribute, AttributeModifier> attributeModifiers = Maps.newHashMap();
   ...
   public Effect addAttributeModifier(IAttribute p_220304_1_, String p_220304_2_, double p_220304_3_, AttributeModifier.Operation p_220304_5_) {
   ...
   public void removeAttributeModifiers(LivingEntity p_111187_1_, AbstractAttributeMap p_111187_2_, int p_111187_3_) {
   ...
   public void addAttributeModifiers(LivingEntity p_111185_1_, AbstractAttributeMap p_111185_2_, int p_111185_3_) {
      for(Entry<IAttribute, AttributeModifier> entry : this.attributeModifiers.entrySet()) {
         IAttributeInstance iattributeinstance = p_111185_2_.func_111151_a(entry.getKey());
         if (iattributeinstance != null) {
            AttributeModifier attributemodifier = entry.getValue();
            iattributeinstance.removeModifier(attributemodifier);
            iattributeinstance.addModifier(new AttributeModifier(attributemodifier.getId(), this.getDescriptionId() + " " + p_111185_3_, this.getAttributeModifierValue(p_111185_3_, attributemodifier), attributemodifier.getOperation()));
         }
      }
