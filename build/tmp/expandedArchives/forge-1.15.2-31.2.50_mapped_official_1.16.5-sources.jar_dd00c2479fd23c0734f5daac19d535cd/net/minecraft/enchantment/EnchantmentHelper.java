...
public class EnchantmentHelper {
   ...
   public static Map<Enchantment, Integer> deserializeEnchantments(ListNBT p_226652_0_) {
      ...
      for(int i = 0; i < p_226652_0_.size(); ++i) {
         ...
         Registry.ENCHANTMENT.func_218349_b(ResourceLocation.tryParse(compoundnbt.getString("id"))).ifPresent((p_226651_2_) -> {
   ...
   private static void runIterationOnItem(EnchantmentHelper.IEnchantmentVisitor p_77518_0_, ItemStack p_77518_1_) {
      if (!p_77518_1_.isEmpty()) {
         ...
         for(int i = 0; i < listnbt.size(); ++i) {
            ...
            Registry.ENCHANTMENT.func_218349_b(ResourceLocation.tryParse(s)).ifPresent((p_222184_2_) -> {
   ...
   public static Entry<EquipmentSlotType, ItemStack> getRandomItemWith(Enchantment p_222189_0_, LivingEntity p_222189_1_) {
      Map<EquipmentSlotType, ItemStack> map = p_222189_0_.getSlotItems(p_222189_1_);
      if (map.isEmpty()) {
         return null;
      } else {
         ...
         for(Entry<EquipmentSlotType, ItemStack> entry : map.entrySet()) {
            ...
            if (!itemstack.isEmpty() && getItemEnchantmentLevel(p_222189_0_, itemstack) > 0) {
               list.add(entry);
            }
         }

         return list.isEmpty() ? null : list.get(p_222189_1_.getRandom().nextInt(list.size()));
      }
   }
   ...
   public static List<EnchantmentData> getAvailableEnchantmentResults(int p_185291_0_, ItemStack p_185291_1_, boolean p_185291_2_) {
      ...
      for(Enchantment enchantment : Registry.ENCHANTMENT) {
         if ((!enchantment.isTreasureOnly() || p_185291_2_) && (enchantment.canApplyAtEnchantingTable(p_185291_1_) || (flag && enchantment.isAllowedOnBooks()))) {
