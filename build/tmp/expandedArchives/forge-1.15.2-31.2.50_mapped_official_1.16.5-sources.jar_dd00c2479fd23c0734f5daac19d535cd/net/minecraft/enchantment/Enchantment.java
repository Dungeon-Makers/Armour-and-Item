...
public abstract class Enchantment extends net.minecraftforge.registries.ForgeRegistryEntry<Enchantment> {
   ...
   public ITextComponent getFullname(int p_200305_1_) {
      ITextComponent itextcomponent = new TranslationTextComponent(this.getDescriptionId());
      if (this.isCurse()) {
      ...
      if (p_200305_1_ != 1 || this.getMaxLevel() != 1) {
         itextcomponent.func_150258_a(" ").func_150257_a(new TranslationTextComponent("enchantment.level." + p_200305_1_));
      }
