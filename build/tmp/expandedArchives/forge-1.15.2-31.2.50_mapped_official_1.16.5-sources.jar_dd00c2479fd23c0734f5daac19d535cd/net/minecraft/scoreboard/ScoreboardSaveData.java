...
public class ScoreboardSaveData extends WorldSavedData {
   ...
   protected void loadTeams(ListNBT p_96498_1_) {
      for(int i = 0; i < p_96498_1_.size(); ++i) {
         ...
         ITextComponent itextcomponent = ITextComponent.Serializer.func_150699_a(compoundnbt.getString("DisplayName"));
         ...
         if (compoundnbt.contains("MemberNamePrefix", 8)) {
            ITextComponent itextcomponent1 = ITextComponent.Serializer.func_150699_a(compoundnbt.getString("MemberNamePrefix"));
         ...
         if (compoundnbt.contains("MemberNameSuffix", 8)) {
            ITextComponent itextcomponent2 = ITextComponent.Serializer.func_150699_a(compoundnbt.getString("MemberNameSuffix"));
