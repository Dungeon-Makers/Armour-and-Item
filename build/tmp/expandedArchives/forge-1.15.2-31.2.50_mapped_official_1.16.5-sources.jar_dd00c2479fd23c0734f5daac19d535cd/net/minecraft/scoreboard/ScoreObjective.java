...
public class ScoreObjective {
   ...
   public ITextComponent getFormattedDisplayName() {
      return TextComponentUtils.func_197676_a(this.displayName.func_212638_h().func_211710_a((p_211544_1_) -> {
         p_211544_1_.func_150209_a(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new StringTextComponent(this.getName())));
      }));
   }
