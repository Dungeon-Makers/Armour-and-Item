...
public class RealmsBrokenWorldScreen extends RealmsScreen {
   ...
   public RealmsBrokenWorldScreen(RealmsScreen p_i51776_1_, RealmsMainScreen p_i51776_2_, long p_i51776_3_) {
      this.lastScreen = p_i51776_1_;
      this.mainScreen = p_i51776_2_;
      this.serverId = p_i51776_3_;
   }
   ...
   public void addButtons() {
      for(Entry<Integer, RealmsWorldOptions> entry : this.serverData.slots.entrySet()) {
         ...
         boolean flag = entry.getKey() != this.serverData.activeSlot || this.serverData.worldType.equals(RealmsServer.ServerType.MINIGAME);
         RealmsButton realmsbutton;
         if (flag) {
            realmsbutton = new RealmsBrokenWorldScreen.PlayButton(field_224082_l.get(entry.getKey() - 1), this.getFramePositionX(entry.getKey()), getLocalizedString("mco.brokenworld.play"));
         } else {
            realmsbutton = new RealmsBrokenWorldScreen.DownloadButton(field_224084_n.get(entry.getKey() - 1), this.getFramePositionX(entry.getKey()), getLocalizedString("mco.brokenworld.download"));
         }
         ...
         this.buttonsAdd(new RealmsButton(field_224083_m.get(entry.getKey() - 1), this.getFramePositionX(entry.getKey()), RealmsConstants.func_225109_a(10), 80, 20, getLocalizedString("mco.brokenworld.reset")) {
            public void onPress() {
               ...
               if (i != RealmsBrokenWorldScreen.this.serverData.activeSlot || RealmsBrokenWorldScreen.this.serverData.worldType.equals(RealmsServer.ServerType.MINIGAME)) {
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      ...
      String[] astring = this.message.split("\\\\n");
      ...
      if (this.serverData != null) {
         for(Entry<Integer, RealmsWorldOptions> entry : this.serverData.slots.entrySet()) {
            if ((entry.getValue()).templateImage != null && (entry.getValue()).templateId != -1L) {
               this.func_224053_a(this.getFramePositionX(entry.getKey()), RealmsConstants.func_225109_a(1) + 5, p_render_1_, p_render_2_, this.serverData.activeSlot == entry.getKey() && !this.isMinigame(), entry.getValue().getSlotName(entry.getKey()), entry.getKey(), (entry.getValue()).templateId, (entry.getValue()).templateImage, (entry.getValue()).empty);
            } else {
               this.func_224053_a(this.getFramePositionX(entry.getKey()), RealmsConstants.func_225109_a(1) + 5, p_render_1_, p_render_2_, this.serverData.activeSlot == entry.getKey() && !this.isMinigame(), entry.getValue().getSlotName(entry.getKey()), entry.getKey(), -1L, (String)null, (entry.getValue()).empty);
            }
         }
      ...
      if (!p_confirmResult_1_) {
         ...
         if (p_confirmResult_2_ != 13 && p_confirmResult_2_ != 14) {
            if (field_224084_n.contains(p_confirmResult_2_)) {
               this.downloadWorld(field_224084_n.indexOf(p_confirmResult_2_) + 1);
            } else if (field_224085_o.contains(p_confirmResult_2_)) {
               this.slotsThatHasBeenDownloaded.add(field_224085_o.indexOf(p_confirmResult_2_) + 1);
               this.childrenClear();
               this.addButtons();
            }
         } else {
            (new Thread(() -> {
               RealmsClient realmsclient = RealmsClient.create();
               if (this.serverData.state.equals(RealmsServer.Status.CLOSED)) {
                  RealmsTasks.OpenServerTask realmstasks$openservertask = new RealmsTasks.OpenServerTask(this.serverData, this, this.lastScreen, true);
   ...
   private void downloadWorld(int p_224066_1_) {
      ...
      try {
         ...
         RealmsDownloadLatestWorldScreen realmsdownloadlatestworldscreen = new RealmsDownloadLatestWorldScreen(this, worlddownload, this.serverData.name + " (" + this.serverData.slots.get(p_224066_1_).getSlotName(p_224066_1_) + ")");
   ...
   private void func_224053_a(int p_224053_1_, int p_224053_2_, int p_224053_3_, int p_224053_4_, boolean p_224053_5_, String p_224053_6_, int p_224053_7_, long p_224053_8_, String p_224053_10_, boolean p_224053_11_) {
      if (p_224053_11_) {
         ...
         RealmsTextureManager.bindWorldTemplate(String.valueOf(p_224053_8_), p_224053_10_);
   ...
   private void func_224056_c(int p_224056_1_) {
      RealmsTasks.SwitchSlotTask realmstasks$switchslottask = new RealmsTasks.SwitchSlotTask(this.serverData.id, p_224056_1_, this, 13);
   ...
   class PlayButton extends RealmsButton {
      ...
      public void onPress() {
         ...
         if ((RealmsBrokenWorldScreen.this.serverData.slots.get(i)).empty) {
