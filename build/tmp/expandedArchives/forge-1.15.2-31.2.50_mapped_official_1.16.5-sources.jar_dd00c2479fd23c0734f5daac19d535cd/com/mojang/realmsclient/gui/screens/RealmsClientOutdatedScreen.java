...
public class RealmsClientOutdatedScreen extends RealmsScreen {
   ...
   public RealmsClientOutdatedScreen(RealmsScreen p_i51775_1_, boolean p_i51775_2_) {
      this.lastScreen = p_i51775_1_;
      this.outdated = p_i51775_2_;
   }
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      ...
      String s = getLocalizedString(this.outdated ? "mco.client.outdated.title" : "mco.client.incompatible.title");
      this.drawCenteredString(s, this.width() / 2, RealmsConstants.func_225109_a(3), 16711680);
      int i = this.outdated ? 2 : 3;

      for(int j = 0; j < i; ++j) {
         String s1 = getLocalizedString((this.outdated ? "mco.client.outdated.msg.line" : "mco.client.incompatible.msg.line") + (j + 1));
