...
public class RealmsConfirmScreen extends RealmsScreen {
   ...
   public RealmsConfirmScreen(RealmsScreen p_i51773_1_, String p_i51773_2_, String p_i51773_3_, int p_i51773_4_) {
      ...
      this.title1 = p_i51773_2_;
      this.title2 = p_i51773_3_;
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      ...
      this.drawCenteredString(this.title1, this.width() / 2, RealmsConstants.func_225109_a(3), 16777215);
      this.drawCenteredString(this.title2, this.width() / 2, RealmsConstants.func_225109_a(5), 16777215);
