...
public class RealmsTasks {
   ...
   public static class CloseServerTask extends LongRunningTask {
      ...
      public void run() {
         ...
         for(int i = 0; i < 25; ++i) {
            ...
            try {
               boolean flag = realmsclient.close(this.field_224994_b.id);
               if (flag) {
                  this.field_224995_c.stateChanged();
               ...
               RealmsTasks.func_225182_b(retrycallexception.delaySeconds);
      ...
      public void run() {
         ...
         while(i < 25) {
            try {
               ...
               WorldDownload worlddownload = realmsclient.requestDownloadInfo(this.field_224996_b, this.field_224997_c);
   ...
   public static class OpenServerTask extends LongRunningTask {
      ...
      public void run() {
         ...
         for(int i = 0; i < 25; ++i) {
            ...
            try {
               boolean flag = realmsclient.open(this.field_225000_b.id);
               if (flag) {
                  if (this.field_225001_c instanceof RealmsConfigureWorldScreen) {
                     ((RealmsConfigureWorldScreen)this.field_225001_c).stateChanged();
                  }

                  this.field_225000_b.state = RealmsServer.Status.OPEN;
                  if (this.field_225002_d) {
                     ((RealmsMainScreen)this.field_225003_e).play(this.field_225000_b, this.field_225001_c);
                  } else {
   ...
   public static class RealmsGetServerDetailsTask extends LongRunningTask {
      ...
      public void run() {
         ...
         for(int j = 0; j < 40 && !this.aborted(); ++j) {
            try {
               realmsserveraddress = realmsclient.join(this.field_225007_b.id);
               flag = true;
            } catch (RetryCallException retrycallexception) {
   ...
   public static class ResettingWorldTask extends LongRunningTask {
      ...
      public void run() {
         RealmsClient realmsclient = RealmsClient.create();
         this.setTitle(this.field_225020_i);
         int i = 0;
         ...
         while(i < 25) {
            try {
               ...
               if (this.field_225014_c != null) {
                  realmsclient.resetWorldWithTemplate(this.field_225017_f, this.field_225014_c.id);
               } else {
                  realmsclient.resetWorldWithSeed(this.field_225017_f, this.field_225013_b, this.field_225015_d, this.field_225016_e);
               }
      ...
      public void run() {
         ...
         while(i < 25) {
            try {
               ...
               realmsclient.restoreWorld(this.field_225022_c, this.field_225021_b.backupId);
               RealmsTasks.func_225182_b(1);
               if (this.aborted()) {
                  return;
               }

               Realms.setScreen(this.field_225023_d.getNewScreen());
               return;
            } catch (RetryCallException retrycallexception) {
               if (this.aborted()) {
                  return;
      ...
      public void run() {
         ...
         for(int i = 0; i < 25; ++i) {
            try {
               ...
               if (realmsclient.putIntoMinigameMode(this.field_225024_b, this.field_225025_c.id)) {
      ...
      public void run() {
         ...
         for(int i = 0; i < 25; ++i) {
            try {
               ...
               if (realmsclient.switchSlot(this.field_225027_b, this.field_225028_c)) {
   ...
   public static class WorldCreationTask extends LongRunningTask {
      ...
      public void run() {
         ...
         try {
            realmsclient.initializeWorld(this.field_225036_d, this.field_225034_b, this.field_225035_c);
