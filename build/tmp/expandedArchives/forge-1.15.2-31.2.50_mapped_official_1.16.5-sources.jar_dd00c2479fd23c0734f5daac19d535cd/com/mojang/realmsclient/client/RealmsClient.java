...
public class RealmsClient {
   ...
   public RealmsClient(String p_i51790_1_, String p_i51790_2_, Proxy p_i51790_3_) {
      this.sessionId = p_i51790_1_;
      this.username = p_i51790_2_;
      RealmsClientConfig.setProxy(p_i51790_3_);
   }
   ...
   public RealmsServer getOwnWorld(long p_224935_1_) throws RealmsServiceException, IOException {
   ...
   public RealmsServerAddress join(long p_224904_1_) throws RealmsServiceException, IOException {
   ...
   public void initializeWorld(long p_224900_1_, String p_224900_3_, String p_224900_4_) throws RealmsServiceException, IOException {
   ...
   public RealmsServer invite(long p_224910_1_, String p_224910_3_) throws RealmsServiceException, IOException {
      PlayerInfo playerinfo = new PlayerInfo();
      playerinfo.setName(p_224910_3_);
      String s = this.url("invites" + "/$WORLD_ID".replace("$WORLD_ID", String.valueOf(p_224910_1_)));
      String s1 = this.execute(Request.post(s, field_224949_f.toJson(playerinfo)));
      return RealmsServer.parse(s1);
   }
   ...
   public void update(long p_224922_1_, String p_224922_3_, String p_224922_4_) throws RealmsServiceException, UnsupportedEncodingException {
      ...
      this.execute(Request.post(s, field_224949_f.toJson(realmsdescriptiondto)));
   }

   public void updateSlot(long p_224925_1_, int p_224925_3_, RealmsWorldOptions p_224925_4_) throws RealmsServiceException, UnsupportedEncodingException {
   ...
   public Boolean open(long p_224942_1_) throws RealmsServiceException, IOException {
      String s = this.url("worlds" + "/$WORLD_ID/open".replace("$WORLD_ID", String.valueOf(p_224942_1_)));
      String s1 = this.execute(Request.put(s, ""));
      return Boolean.valueOf(s1);
   }

   public Boolean close(long p_224932_1_) throws RealmsServiceException, IOException {
      String s = this.url("worlds" + "/$WORLD_ID/close".replace("$WORLD_ID", String.valueOf(p_224932_1_)));
      String s1 = this.execute(Request.put(s, ""));
      return Boolean.valueOf(s1);
   }

   public Boolean resetWorldWithSeed(long p_224943_1_, String p_224943_3_, Integer p_224943_4_, boolean p_224943_5_) throws RealmsServiceException, IOException {
      ...
      String s1 = this.execute(Request.post(s, field_224949_f.toJson(realmsworldresetdto), 30000, 80000));
      return Boolean.valueOf(s1);
   }

   public Boolean resetWorldWithTemplate(long p_224924_1_, String p_224924_3_) throws RealmsServiceException, IOException {
   ...
   public Subscription subscriptionFor(long p_224933_1_) throws RealmsServiceException, IOException {
   ...
   public int pendingInvitesCount() throws RealmsServiceException {
      String s = this.url("invites/count/pending");
      String s1 = this.execute(Request.get(s));
   ...
   public UploadInfo requestUploadInfo(long p_224934_1_, String p_224934_3_) throws RealmsServiceException {
      ...
      return UploadInfo.parse(this.execute(Request.put(s, s1)));
   }
   ...
   public void sendPingResults(PingResult p_224903_1_) throws RealmsServiceException {
      ...
      this.execute(Request.post(s, field_224949_f.toJson(p_224903_1_)));
   }
   ...
   public void deleteWorld(long p_224916_1_) throws RealmsServiceException, IOException {
   ...
   private String url(String p_224907_1_, String p_224907_2_) {
      try {
         URI uri = new URI(currentEnvironment.protocol, currentEnvironment.baseUrl, "/" + p_224907_1_, p_224907_2_, (String)null);
   ...
   private String execute(Request<?> p_224938_1_) throws RealmsServiceException {
      ...
      p_224938_1_.cookie("version", Realms.getMinecraftVersionString());
