...
public class RealmsWorldOptions extends ValueObject {
   ...
   public static RealmsWorldOptions parse(JsonObject p_parse_0_) {
      RealmsWorldOptions realmsworldoptions = new RealmsWorldOptions(JsonUtils.getBooleanOr("pvp", p_parse_0_, true), JsonUtils.getBooleanOr("spawnAnimals", p_parse_0_, true), JsonUtils.getBooleanOr("spawnMonsters", p_parse_0_, true), JsonUtils.getBooleanOr("spawnNPCs", p_parse_0_, true), JsonUtils.getIntOr("spawnProtection", p_parse_0_, 0), JsonUtils.getBooleanOr("commandBlocks", p_parse_0_, false), JsonUtils.getIntOr("difficulty", p_parse_0_, 2), JsonUtils.getIntOr("gameMode", p_parse_0_, 0), JsonUtils.getBooleanOr("forceGameMode", p_parse_0_, false), JsonUtils.getStringOr("slotName", p_parse_0_, ""));
      realmsworldoptions.templateId = JsonUtils.getLongOr("worldTemplateId", p_parse_0_, -1L);
      realmsworldoptions.templateImage = JsonUtils.getStringOr("worldTemplateImage", p_parse_0_, templateImageDefault);
      realmsworldoptions.adventureMap = JsonUtils.getBooleanOr("adventureMap", p_parse_0_, false);
      return realmsworldoptions;
   }
