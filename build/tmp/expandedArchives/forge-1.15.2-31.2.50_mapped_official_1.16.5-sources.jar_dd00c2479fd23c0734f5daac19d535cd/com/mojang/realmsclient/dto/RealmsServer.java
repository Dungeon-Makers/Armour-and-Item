...
public class RealmsServer extends ValueObject {
   ...
   public static RealmsServer parse(JsonObject p_parse_0_) {
      ...
      try {
         realmsserver.id = JsonUtils.getLongOr("id", p_parse_0_, -1L);
         realmsserver.remoteSubscriptionId = JsonUtils.getStringOr("remoteSubscriptionId", p_parse_0_, (String)null);
         realmsserver.name = JsonUtils.getStringOr("name", p_parse_0_, (String)null);
         realmsserver.motd = JsonUtils.getStringOr("motd", p_parse_0_, (String)null);
         realmsserver.state = getState(JsonUtils.getStringOr("state", p_parse_0_, RealmsServer.Status.CLOSED.name()));
         realmsserver.owner = JsonUtils.getStringOr("owner", p_parse_0_, (String)null);
         ...
         realmsserver.daysLeft = JsonUtils.getIntOr("daysLeft", p_parse_0_, 0);
         realmsserver.expired = JsonUtils.getBooleanOr("expired", p_parse_0_, false);
         realmsserver.expiredTrial = JsonUtils.getBooleanOr("expiredTrial", p_parse_0_, false);
         realmsserver.worldType = getWorldType(JsonUtils.getStringOr("worldType", p_parse_0_, RealmsServer.ServerType.NORMAL.name()));
         realmsserver.ownerUUID = JsonUtils.getStringOr("ownerUUID", p_parse_0_, "");
         ...
         realmsserver.minigameName = JsonUtils.getStringOr("minigameName", p_parse_0_, (String)null);
         realmsserver.activeSlot = JsonUtils.getIntOr("activeSlot", p_parse_0_, -1);
         realmsserver.minigameId = JsonUtils.getIntOr("minigameId", p_parse_0_, -1);
         realmsserver.minigameImage = JsonUtils.getStringOr("minigameImage", p_parse_0_, (String)null);
      } catch (Exception exception) {
   ...
   public static class ServerComparator implements Comparator<RealmsServer> {
      ...
      public int compare(RealmsServer p_compare_1_, RealmsServer p_compare_2_) {
         return ComparisonChain.start().compareTrueFirst(p_compare_1_.state.equals(RealmsServer.Status.UNINITIALIZED), p_compare_2_.state.equals(RealmsServer.Status.UNINITIALIZED)).compareTrueFirst(p_compare_1_.expiredTrial, p_compare_2_.expiredTrial).compareTrueFirst(p_compare_1_.owner.equals(this.refOwner), p_compare_2_.owner.equals(this.refOwner)).compareFalseFirst(p_compare_1_.expired, p_compare_2_.expired).compareTrueFirst(p_compare_1_.state.equals(RealmsServer.Status.OPEN), p_compare_2_.state.equals(RealmsServer.Status.OPEN)).compare(p_compare_1_.id, p_compare_2_.id).result();
      }
   }
